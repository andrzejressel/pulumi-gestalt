...
pub mod service {
    ...
    pub struct ServiceArgs {
        ...
        pub grpc_config: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub openapi_config: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub protoc_output_base64: pulumi_gestalt_rust::Input<Option<String>>,
    ...
    fn __create(
        ...
        let grpc_config_binding = args.grpc_config.get_output(ctx);
        let openapi_config_binding = args.openapi_config.get_output(ctx);
        let project_binding = args.project.get_output(ctx);
        let protoc_output_base64_binding = args.protoc_output_base64.get_output(ctx);
