...
pub mod cx_flow {
    ...
    fn __create(
        ...
        let is_default_start_flow_binding = args.is_default_start_flow.get_output(ctx);
        let language_code_binding = args.language_code.get_output(ctx);
        let nlu_settings_binding = args.nlu_settings.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &is_default_start_flow_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &nlu_settings_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "parent".into(),
