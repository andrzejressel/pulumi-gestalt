...
pub mod git_repository_link {
    ...
    fn __create(
        ...
        let clone_uri_binding = args.clone_uri.get_output(ctx);
        let etag_binding = args.etag.get_output(ctx);
        let git_repository_link_id_binding = args.git_repository_link_id.get_output(ctx);
        let labels_binding = args.labels.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let parent_connection_binding = args.parent_connection.get_output(ctx);
