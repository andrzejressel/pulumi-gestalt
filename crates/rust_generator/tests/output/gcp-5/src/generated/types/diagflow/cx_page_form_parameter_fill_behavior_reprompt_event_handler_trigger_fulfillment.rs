...
pub struct CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillment {
    /// Conditional cases for this fulfillment.
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "conditionalCases")]
    pub r#conditional_cases: Option<Vec<super::super::types::diagflow::CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentConditionalCase>>,
    /// The list of rich message responses to present to the user.
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "messages")]
    pub r#messages: Option<Vec<super::super::types::diagflow::CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentMessage>>,
    ...
    pub r#set_parameter_actions: Option<Vec<super::super::types::diagflow::CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillmentSetParameterAction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillment {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "return_partial_responses".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "set_parameter_actions".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CxPageFormParameterFillBehaviorRepromptEventHandlerTriggerFulfillment {
