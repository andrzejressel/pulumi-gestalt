...
pub struct CxPageEventHandlerTriggerFulfillmentMessage {
    ...
    pub r#conversation_success: Option<Box<super::super::types::diagflow::CxPageEventHandlerTriggerFulfillmentMessageConversationSuccess>>,
    ...
    pub r#live_agent_handoff: Option<Box<super::super::types::diagflow::CxPageEventHandlerTriggerFulfillmentMessageLiveAgentHandoff>>,
    /// A text or ssml response that is preferentially used for TTS output audio synthesis, as described in the comment on the ResponseMessage message.
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "outputAudioText")]
    pub r#output_audio_text: Option<Box<super::super::types::diagflow::CxPageEventHandlerTriggerFulfillmentMessageOutputAudioText>>,
    ...
    pub r#play_audio: Option<Box<super::super::types::diagflow::CxPageEventHandlerTriggerFulfillmentMessagePlayAudio>>,
    /// Represents the signal that telles the client to transfer the phone call connected to the agent to a third-party endpoint.
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "telephonyTransferCall")]
    pub r#telephony_transfer_call: Option<Box<super::super::types::diagflow::CxPageEventHandlerTriggerFulfillmentMessageTelephonyTransferCall>>,
    /// The text response message.
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "text")]
    pub r#text: Option<Box<super::super::types::diagflow::CxPageEventHandlerTriggerFulfillmentMessageText>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CxPageEventHandlerTriggerFulfillmentMessage {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CxPageEventHandlerTriggerFulfillmentMessage {
