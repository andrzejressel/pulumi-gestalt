...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CxWebhookServiceDirectory {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "generic_web_service".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#generic_web_service,
                )
                .await,
            );
            map.insert(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CxWebhookServiceDirectory {
