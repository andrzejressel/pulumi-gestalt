...
pub struct CxPageTransitionRouteTriggerFulfillmentMessage {
    ...
    pub r#conversation_success: Option<Box<super::super::types::diagflow::CxPageTransitionRouteTriggerFulfillmentMessageConversationSuccess>>,
    ...
    pub r#live_agent_handoff: Option<Box<super::super::types::diagflow::CxPageTransitionRouteTriggerFulfillmentMessageLiveAgentHandoff>>,
    /// A text or ssml response that is preferentially used for TTS output audio synthesis, as described in the comment on the ResponseMessage message.
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "outputAudioText")]
    pub r#output_audio_text: Option<Box<super::super::types::diagflow::CxPageTransitionRouteTriggerFulfillmentMessageOutputAudioText>>,
    ...
    pub r#play_audio: Option<Box<super::super::types::diagflow::CxPageTransitionRouteTriggerFulfillmentMessagePlayAudio>>,
    /// Represents the signal that telles the client to transfer the phone call connected to the agent to a third-party endpoint.
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "telephonyTransferCall")]
    pub r#telephony_transfer_call: Option<Box<super::super::types::diagflow::CxPageTransitionRouteTriggerFulfillmentMessageTelephonyTransferCall>>,
    /// The text response message.
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "text")]
    pub r#text: Option<Box<super::super::types::diagflow::CxPageTransitionRouteTriggerFulfillmentMessageText>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CxPageTransitionRouteTriggerFulfillmentMessage {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CxPageTransitionRouteTriggerFulfillmentMessage {
