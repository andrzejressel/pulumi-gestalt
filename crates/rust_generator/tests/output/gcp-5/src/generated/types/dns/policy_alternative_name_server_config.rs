...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PolicyAlternativeNameServerConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "target_name_servers".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#target_name_servers,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PolicyAlternativeNameServerConfig {
