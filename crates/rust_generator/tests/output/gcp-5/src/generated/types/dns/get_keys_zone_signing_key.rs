...
pub struct GetKeysZoneSigningKey {
    ...
    pub r#digests: Vec<super::super::types::dns::GetKeysZoneSigningKeyDigest>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetKeysZoneSigningKey {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetKeysZoneSigningKey {
