            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#default_language_code: {
                        let field_value = match fields_map.get("defaultLanguageCode") {
                            Some(value) => value,
                            None => bail!("Missing field 'defaultLanguageCode' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#location: {
