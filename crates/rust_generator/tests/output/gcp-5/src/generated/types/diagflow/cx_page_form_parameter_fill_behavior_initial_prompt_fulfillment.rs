...
pub struct CxPageFormParameterFillBehaviorInitialPromptFulfillment {
    /// Conditional cases for this fulfillment.
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "conditionalCases")]
    pub r#conditional_cases: Option<Vec<super::super::types::diagflow::CxPageFormParameterFillBehaviorInitialPromptFulfillmentConditionalCase>>,
    /// The list of rich message responses to present to the user.
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "messages")]
    pub r#messages: Option<Vec<super::super::types::diagflow::CxPageFormParameterFillBehaviorInitialPromptFulfillmentMessage>>,
    ...
    pub r#set_parameter_actions: Option<Vec<super::super::types::diagflow::CxPageFormParameterFillBehaviorInitialPromptFulfillmentSetParameterAction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CxPageFormParameterFillBehaviorInitialPromptFulfillment {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CxPageFormParameterFillBehaviorInitialPromptFulfillment {
