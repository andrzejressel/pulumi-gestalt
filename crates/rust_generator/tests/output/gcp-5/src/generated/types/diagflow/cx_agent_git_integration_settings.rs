...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CxAgentGitIntegrationSettings {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "github_settings".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#github_settings,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CxAgentGitIntegrationSettings {
