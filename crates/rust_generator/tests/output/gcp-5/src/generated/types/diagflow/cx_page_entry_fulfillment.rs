...
pub struct CxPageEntryFulfillment {
    /// Conditional cases for this fulfillment.
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "conditionalCases")]
    pub r#conditional_cases: Option<Vec<super::super::types::diagflow::CxPageEntryFulfillmentConditionalCase>>,
    /// The list of rich message responses to present to the user.
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "messages")]
    pub r#messages: Option<Vec<super::super::types::diagflow::CxPageEntryFulfillmentMessage>>,
    ...
    pub r#set_parameter_actions: Option<Vec<super::super::types::diagflow::CxPageEntryFulfillmentSetParameterAction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CxPageEntryFulfillment {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CxPageEntryFulfillment {
