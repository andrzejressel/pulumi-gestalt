...
pub struct CxFlowEventHandlerTriggerFulfillment {
    ...
    pub r#conditional_cases: Option<Vec<super::super::types::diagflow::CxFlowEventHandlerTriggerFulfillmentConditionalCase>>,
    /// The list of rich message responses to present to the user.
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "messages")]
    pub r#messages: Option<Vec<super::super::types::diagflow::CxFlowEventHandlerTriggerFulfillmentMessage>>,
    ...
    pub r#set_parameter_actions: Option<Vec<super::super::types::diagflow::CxFlowEventHandlerTriggerFulfillmentSetParameterAction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CxFlowEventHandlerTriggerFulfillment {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CxFlowEventHandlerTriggerFulfillment {
