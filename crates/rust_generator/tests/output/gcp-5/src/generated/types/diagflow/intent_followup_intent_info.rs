...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for IntentFollowupIntentInfo {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "followup_intent_name".to_string(),
            ...
            map.insert(
                "parent_followup_intent_name".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for IntentFollowupIntentInfo {
