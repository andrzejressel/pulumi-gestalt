...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TargetSiteSiteVerificationInfo {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "site_verification_state".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for TargetSiteSiteVerificationInfo {
