...
pub mod three_tier_virtual_instance {
    ...
    pub struct ThreeTierVirtualInstanceArgs {
        ...
        #[builder(into)]
        pub three_tier_configuration: pulumi_gestalt_rust::Input<
    ...
    fn __create(
        ...
        let app_location_binding = args.app_location.get_output(ctx);
        ...
        let sap_fqdn_binding = args.sap_fqdn.get_output(ctx);
