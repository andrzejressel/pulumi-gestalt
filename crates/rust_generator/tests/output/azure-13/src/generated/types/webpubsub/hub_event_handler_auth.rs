...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for HubEventHandlerAuth {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "managed_identity_id".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#managed_identity_id,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for HubEventHandlerAuth {
