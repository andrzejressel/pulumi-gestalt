...
pub struct PolicyManagedRulesExclusionExcludedRuleSetRuleGroup {
    /// One or more Rule IDs for exclusion.
    #[builder(into)]
    #[serde(rename = "excludedRules")]
    pub r#excluded_rules: Option<Vec<String>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PolicyManagedRulesExclusionExcludedRuleSetRuleGroup {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PolicyManagedRulesExclusionExcludedRuleSetRuleGroup {
