...
pub struct PolicyManagedRulesManagedRuleSetRuleGroupOverride {
    ...
    #[builder(into)]
    #[serde(rename = "rules")]
    pub r#rules: Option<Vec<super::super::types::waf::PolicyManagedRulesManagedRuleSetRuleGroupOverrideRule>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PolicyManagedRulesManagedRuleSetRuleGroupOverride {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PolicyManagedRulesManagedRuleSetRuleGroupOverride {
