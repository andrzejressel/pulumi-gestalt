...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PolicyCustomRuleMatchCondition {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PolicyCustomRuleMatchCondition {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#match_variables: {
                        let field_value = match fields_map.get("matchVariables") {
                            Some(value) => value,
                            None => bail!("Missing field 'matchVariables' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#negation_condition: {
                        let field_value = match fields_map.get("negationCondition") {
                            Some(value) => value,
                            None => bail!("Missing field 'negationCondition' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#operator: {
