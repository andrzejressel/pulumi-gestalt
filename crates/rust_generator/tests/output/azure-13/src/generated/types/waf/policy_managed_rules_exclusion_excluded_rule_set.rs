...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PolicyManagedRulesExclusionExcludedRuleSet {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PolicyManagedRulesExclusionExcludedRuleSet {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#rule_groups: {
                        let field_value = match fields_map.get("rule_groups") {
                            Some(value) => value,
                            None => bail!("Missing field 'rule_groups' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
