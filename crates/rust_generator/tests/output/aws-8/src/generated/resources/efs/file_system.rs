...
pub mod file_system {
    ...
    pub struct FileSystemArgs {
        ...
        pub availability_zone_name: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub lifecycle_policies: pulumi_gestalt_rust::Input<
            Option<Vec<super::super::types::efs::FileSystemLifecyclePolicy>>,
        >,
        /// The file system performance mode. Can be either `"generalPurpose"` or `"maxIO"` (Default: `"generalPurpose"`).
        #[builder(into, default)]
        pub performance_mode: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub protection: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub throughput_mode: pulumi_gestalt_rust::Input<Option<String>>,
    }
    #[allow(dead_code)]
