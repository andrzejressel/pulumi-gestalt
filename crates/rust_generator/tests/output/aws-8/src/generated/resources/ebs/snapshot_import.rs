...
pub mod snapshot_import {
    ...
    fn __create(
        ...
        let client_data_binding = args.client_data.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let disk_container_binding = args.disk_container.get_output(ctx);
        let encrypted_binding = args.encrypted.get_output(ctx);
        let kms_key_id_binding = args.kms_key_id.get_output(ctx);
        let permanent_restore_binding = args.permanent_restore.get_output(ctx);
        let role_name_binding = args.role_name.get_output(ctx);
        let storage_tier_binding = args.storage_tier.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let temporary_restore_days_binding = args.temporary_restore_days.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &client_data_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &disk_container_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "encrypted".into(),
