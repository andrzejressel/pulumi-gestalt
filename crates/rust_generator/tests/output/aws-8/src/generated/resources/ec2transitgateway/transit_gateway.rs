...
pub mod transit_gateway {
    ...
    pub struct TransitGatewayArgs {
        ...
        #[builder(into, default)]
        pub multicast_support: pulumi_gestalt_rust::Input<Option<String>>,
    ...
    fn __create(
        ...
        let multicast_support_binding = args.multicast_support.get_output(ctx);
        ...
        let transit_gateway_cidr_blocks_binding = args
            ...
            .get_output(ctx);
        let vpn_ecmp_support_binding = args.vpn_ecmp_support.get_output(ctx);
