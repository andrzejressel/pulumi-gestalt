...
pub mod instance_metadata_defaults {
    ...
    fn __create(
        ...
        let http_endpoint_binding = args.http_endpoint.get_output(ctx);
        let http_put_response_hop_limit_binding = args
            .http_put_response_hop_limit
            .get_output(ctx);
        let http_tokens_binding = args.http_tokens.get_output(ctx);
        let instance_metadata_tags_binding = args.instance_metadata_tags.get_output(ctx);
