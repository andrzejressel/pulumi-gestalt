...
pub mod traffic_mirror_filter {
    ...
    pub struct TrafficMirrorFilterArgs {
        ...
        #[builder(into, default)]
        pub network_services: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
    ...
    fn __create(
        ...
        let network_services_binding = args.network_services.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &network_services_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "tags".into(),
