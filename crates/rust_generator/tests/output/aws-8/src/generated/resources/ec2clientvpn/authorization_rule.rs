...
pub mod authorization_rule {
    ...
    fn __create(
        ...
        let access_group_id_binding = args.access_group_id.get_output(ctx);
        let authorize_all_groups_binding = args.authorize_all_groups.get_output(ctx);
        let client_vpn_endpoint_id_binding = args.client_vpn_endpoint_id.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let target_network_cidr_binding = args.target_network_cidr.get_output(ctx);
