...
pub mod cluster {
    ...
    pub struct ClusterArgs {
        ...
        #[builder(into, default)]
        pub num_cache_nodes: pulumi_gestalt_rust::Input<Option<i32>>,
        /// Specify the outpost mode that will apply to the cache cluster creation. Valid values are `"single-outpost"` and `"cross-outpost"`, however AWS currently only supports `"single-outpost"` mode.
        #[builder(into, default)]
        pub outpost_mode: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub preferred_availability_zones: pulumi_gestalt_rust::Input<
            Option<Vec<String>>,
        >,
        /// The outpost ARN in which the cache cluster will be created.
        #[builder(into, default)]
        pub preferred_outpost_arn: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub snapshot_arns: pulumi_gestalt_rust::Input<Option<String>>,
