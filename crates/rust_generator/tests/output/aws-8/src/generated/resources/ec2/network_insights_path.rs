...
pub mod network_insights_path {
    ...
    fn __create(
        ...
        let destination_ip_binding = args.destination_ip.get_output(ctx);
        ...
        let source_ip_binding = args.source_ip.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &destination_ip_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "destinationPort".into(),
                    value: &destination_port_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "protocol".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "sourceIp".into(),
                    value: &source_ip_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "tags".into(),
