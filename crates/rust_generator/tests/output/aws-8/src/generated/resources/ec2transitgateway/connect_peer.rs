...
pub mod connect_peer {
    ...
    pub struct ConnectPeerArgs {
        ...
        #[builder(into)]
        pub inside_cidr_blocks: pulumi_gestalt_rust::Input<Vec<String>>,
        ...
        #[builder(into, default)]
        pub transit_gateway_address: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &transit_gateway_address_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
