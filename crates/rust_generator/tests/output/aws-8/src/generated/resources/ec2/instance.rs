...
pub mod instance {
    ...
    pub struct InstanceArgs {
        ...
        #[builder(into, default)]
        pub cpu_core_count: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub cpu_threads_per_core: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub hibernation: pulumi_gestalt_rust::Input<Option<bool>>,
        /// ID of a dedicated host that the instance will be assigned to. Use when an instance is to be launched on a specific dedicated host.
        #[builder(into, default)]
        pub host_id: pulumi_gestalt_rust::Input<Option<String>>,
        /// ARN of the host resource group in which to launch the instances. If you specify an ARN, omit the `tenancy` parameter or set it to `host`.
        #[builder(into, default)]
        pub host_resource_group_arn: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub placement_partition_number: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub volume_tags: pulumi_gestalt_rust::Input<
            Option<std::collections::HashMap<String, String>>,
        >,
    ...
    pub struct InstanceResult {
        ...
        pub instance_lifecycle: pulumi_gestalt_rust::Output<String>,
        /// Describes the market (purchasing) option for the instances. See Market Options below for details on attributes.
        ...
        pub spot_instance_request_id: pulumi_gestalt_rust::Output<String>,
        /// VPC Subnet ID to launch in.
    ...
    fn __create(
        ...
        InstanceResult {
            ...
            instance_lifecycle: o.get_field("instanceLifecycle"),
            ...
            spot_instance_request_id: o.get_field("spotInstanceRequestId"),
