...
pub mod spot_instance_request {
    ...
    pub struct SpotInstanceRequestArgs {
        ...
        #[builder(into, default)]
        pub block_duration_minutes: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub launch_group: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub spot_type: pulumi_gestalt_rust::Input<Option<String>>,
