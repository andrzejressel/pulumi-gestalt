...
pub mod vpc_endpoint {
    ...
    pub struct VpcEndpointArgs {
        ...
        #[builder(into, default)]
        pub dns_options: pulumi_gestalt_rust::Input<
        ...
        /// Defaults to `false`.
        #[builder(into, default)]
        pub private_dns_enabled: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub service_region: pulumi_gestalt_rust::Input<Option<String>>,
        /// Subnet configuration for the endpoint, used to select specific IPv4 and/or IPv6 addresses to the endpoint. See subnet_configuration below.
        #[builder(into, default)]
        pub subnet_configurations: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub vpc_endpoint_type: pulumi_gestalt_rust::Input<Option<String>>,
    ...
    fn __create(
        ...
        let dns_options_binding = args.dns_options.get_output(ctx);
        let ip_address_type_binding = args.ip_address_type.get_output(ctx);
        let policy_binding = args.policy.get_output(ctx);
        let private_dns_enabled_binding = args.private_dns_enabled.get_output(ctx);
        let route_table_ids_binding = args.route_table_ids.get_output(ctx);
        ...
        let service_region_binding = args.service_region.get_output(ctx);
        let subnet_configurations_binding = args.subnet_configurations.get_output(ctx);
        let subnet_ids_binding = args.subnet_ids.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let vpc_endpoint_type_binding = args.vpc_endpoint_type.get_output(ctx);
