...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for SpotInstanceRequestCapacityReservationSpecificationCapacityReservationTarget {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "capacity_reservation_resource_group_arn".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for SpotInstanceRequestCapacityReservationSpecificationCapacityReservationTarget {
