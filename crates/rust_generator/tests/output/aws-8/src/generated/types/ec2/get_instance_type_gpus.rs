...
pub struct GetInstanceTypeGpus {
    #[builder(into)]
    #[serde(rename = "count")]
    pub r#count: i32,
    #[builder(into)]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetInstanceTypeGpus {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetInstanceTypeGpus {
