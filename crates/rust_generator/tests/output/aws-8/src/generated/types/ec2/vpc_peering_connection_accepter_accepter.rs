...
pub struct VpcPeeringConnectionAccepterAccepter {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for VpcPeeringConnectionAccepterAccepter {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "allow_remote_vpc_dns_resolution".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for VpcPeeringConnectionAccepterAccepter {
