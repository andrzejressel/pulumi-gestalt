...
pub struct GetNetworkInsightsAnalysisExplanationAclRule {
    ...
    pub r#port_ranges: Vec<super::super::types::ec2::GetNetworkInsightsAnalysisExplanationAclRulePortRange>,
    #[builder(into)]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetNetworkInsightsAnalysisExplanationAclRule {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetNetworkInsightsAnalysisExplanationAclRule {
