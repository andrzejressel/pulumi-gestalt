...
pub struct NetworkInsightsAnalysisForwardPathComponentInboundHeader {
    ...
    pub r#destination_port_ranges: Option<Vec<super::super::types::ec2::NetworkInsightsAnalysisForwardPathComponentInboundHeaderDestinationPortRange>>,
    #[builder(into)]
    ...
    pub r#source_port_ranges: Option<Vec<super::super::types::ec2::NetworkInsightsAnalysisForwardPathComponentInboundHeaderSourcePortRange>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for NetworkInsightsAnalysisForwardPathComponentInboundHeader {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for NetworkInsightsAnalysisForwardPathComponentInboundHeader {
