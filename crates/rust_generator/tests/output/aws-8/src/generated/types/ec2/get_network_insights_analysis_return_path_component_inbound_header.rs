...
pub struct GetNetworkInsightsAnalysisReturnPathComponentInboundHeader {
    #[builder(into)]
    #[serde(rename = "destinationAddresses")]
    pub r#destination_addresses: Vec<String>,
    #[builder(into)]
    #[serde(rename = "destinationPortRanges")]
    pub r#destination_port_ranges: Vec<super::super::types::ec2::GetNetworkInsightsAnalysisReturnPathComponentInboundHeaderDestinationPortRange>,
    #[builder(into)]
    ...
    pub r#source_port_ranges: Vec<super::super::types::ec2::GetNetworkInsightsAnalysisReturnPathComponentInboundHeaderSourcePortRange>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetNetworkInsightsAnalysisReturnPathComponentInboundHeader {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetNetworkInsightsAnalysisReturnPathComponentInboundHeader {
