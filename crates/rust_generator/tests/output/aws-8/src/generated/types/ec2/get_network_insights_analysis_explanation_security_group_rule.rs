...
pub struct GetNetworkInsightsAnalysisExplanationSecurityGroupRule {
    ...
    pub r#port_ranges: Vec<super::super::types::ec2::GetNetworkInsightsAnalysisExplanationSecurityGroupRulePortRange>,
    #[builder(into)]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetNetworkInsightsAnalysisExplanationSecurityGroupRule {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetNetworkInsightsAnalysisExplanationSecurityGroupRule {
