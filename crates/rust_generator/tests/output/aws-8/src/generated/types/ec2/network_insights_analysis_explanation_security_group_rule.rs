...
pub struct NetworkInsightsAnalysisExplanationSecurityGroupRule {
    ...
    pub r#port_ranges: Option<Vec<super::super::types::ec2::NetworkInsightsAnalysisExplanationSecurityGroupRulePortRange>>,
    #[builder(into)]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for NetworkInsightsAnalysisExplanationSecurityGroupRule {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for NetworkInsightsAnalysisExplanationSecurityGroupRule {
