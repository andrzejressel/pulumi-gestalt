...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetAmiProductCode {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "product_code_id".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#product_code_id,
                )
                .await,
            );
            map.insert(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetAmiProductCode {
