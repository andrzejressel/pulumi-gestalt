            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#issuer_cert_authority: {
                        let field_value = match fields_map.get("issuerCertAuthority") {
                            Some(value) => value,
                            None => bail!("Missing field 'issuerCertAuthority' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
