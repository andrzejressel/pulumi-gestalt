            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#carrier_gateway_id: {
                        let field_value = match fields_map.get("carrierGatewayId") {
                            Some(value) => value,
                            None => bail!("Missing field 'carrierGatewayId' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                    ...
                    r#local_gateway_id: {
                        let field_value = match fields_map.get("localGatewayId") {
                            Some(value) => value,
                            None => bail!("Missing field 'localGatewayId' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#nat_gateway_id: {
