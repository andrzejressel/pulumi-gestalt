...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetMulticastDomainSource {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "group_ip_address".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#group_ip_address,
                )
                .await,
            );
            map.insert(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetMulticastDomainSource {
