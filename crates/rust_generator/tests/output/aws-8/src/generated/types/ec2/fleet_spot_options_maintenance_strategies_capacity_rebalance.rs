...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FleetSpotOptionsMaintenanceStrategiesCapacityRebalance {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FleetSpotOptionsMaintenanceStrategiesCapacityRebalance {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#termination_delay: {
                        let field_value = match fields_map.get("termination_delay") {
                            Some(value) => value,
                            None => bail!("Missing field 'termination_delay' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
