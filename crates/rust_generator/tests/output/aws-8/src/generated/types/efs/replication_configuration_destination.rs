            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#availability_zone_name: {
                        let field_value = match fields_map.get("availabilityZoneName") {
                            Some(value) => value,
                            None => bail!("Missing field 'availabilityZoneName' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
