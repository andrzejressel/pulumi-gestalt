...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ReplicationConfigurationDestination {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "availability_zone_name".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ReplicationConfigurationDestination {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#availability_zone_name: {
                        let field_value = match fields_map.get("availability_zone_name") {
                            Some(value) => value,
                            None => bail!("Missing field 'availability_zone_name' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
