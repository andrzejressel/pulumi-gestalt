...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GlobalReplicationGroupGlobalNodeGroup {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "global_node_group_id".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GlobalReplicationGroupGlobalNodeGroup {
