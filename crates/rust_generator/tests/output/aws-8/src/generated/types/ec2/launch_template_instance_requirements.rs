...
pub struct LaunchTemplateInstanceRequirements {
    ...
    pub r#accelerator_count: Box<Option<super::super::types::ec2::LaunchTemplateInstanceRequirementsAcceleratorCount>>,
    ...
    pub r#accelerator_total_memory_mib: Box<Option<super::super::types::ec2::LaunchTemplateInstanceRequirementsAcceleratorTotalMemoryMib>>,
    ...
    pub r#baseline_ebs_bandwidth_mbps: Box<Option<super::super::types::ec2::LaunchTemplateInstanceRequirementsBaselineEbsBandwidthMbps>>,
    ...
    pub r#memory_gib_per_vcpu: Box<Option<super::super::types::ec2::LaunchTemplateInstanceRequirementsMemoryGibPerVcpu>>,
    ...
    pub r#network_bandwidth_gbps: Box<Option<super::super::types::ec2::LaunchTemplateInstanceRequirementsNetworkBandwidthGbps>>,
    /// Block describing the minimum and maximum number of network interfaces. Default is no minimum or maximum.
    #[builder(into)]
    #[serde(rename = "networkInterfaceCount")]
    pub r#network_interface_count: Box<Option<super::super::types::ec2::LaunchTemplateInstanceRequirementsNetworkInterfaceCount>>,
    ...
    pub r#total_local_storage_gb: Box<Option<super::super::types::ec2::LaunchTemplateInstanceRequirementsTotalLocalStorageGb>>,
