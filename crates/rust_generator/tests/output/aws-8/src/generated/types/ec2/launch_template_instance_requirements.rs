...
pub struct LaunchTemplateInstanceRequirements {
    /// Block describing the minimum and maximum number of accelerators (GPUs, FPGAs, or AWS Inferentia chips). Default is no minimum or maximum.
    #[builder(into)]
    #[serde(rename = "acceleratorCount")]
    pub r#accelerator_count: Option<Box<super::super::types::ec2::LaunchTemplateInstanceRequirementsAcceleratorCount>>,
    ...
    pub r#accelerator_total_memory_mib: Option<Box<super::super::types::ec2::LaunchTemplateInstanceRequirementsAcceleratorTotalMemoryMib>>,
    ...
    pub r#baseline_ebs_bandwidth_mbps: Option<Box<super::super::types::ec2::LaunchTemplateInstanceRequirementsBaselineEbsBandwidthMbps>>,
    ...
    pub r#memory_gib_per_vcpu: Option<Box<super::super::types::ec2::LaunchTemplateInstanceRequirementsMemoryGibPerVcpu>>,
    /// Block describing the minimum and maximum amount of memory (MiB). Default is no maximum.
    #[builder(into)]
    #[serde(rename = "memoryMib")]
    pub r#memory_mib: Box<super::super::types::ec2::LaunchTemplateInstanceRequirementsMemoryMib>,
    /// Block describing the minimum and maximum amount of network bandwidth, in gigabits per second (Gbps). Default is no minimum or maximum.
    #[builder(into)]
    #[serde(rename = "networkBandwidthGbps")]
    pub r#network_bandwidth_gbps: Option<Box<super::super::types::ec2::LaunchTemplateInstanceRequirementsNetworkBandwidthGbps>>,
    /// Block describing the minimum and maximum number of network interfaces. Default is no minimum or maximum.
    #[builder(into)]
    #[serde(rename = "networkInterfaceCount")]
    pub r#network_interface_count: Option<Box<super::super::types::ec2::LaunchTemplateInstanceRequirementsNetworkInterfaceCount>>,
    ...
    pub r#total_local_storage_gb: Option<Box<super::super::types::ec2::LaunchTemplateInstanceRequirementsTotalLocalStorageGb>>,
    /// Block describing the minimum and maximum number of vCPUs. Default is no maximum.
    #[builder(into)]
    #[serde(rename = "vcpuCount")]
    pub r#vcpu_count: Box<super::super::types::ec2::LaunchTemplateInstanceRequirementsVcpuCount>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for LaunchTemplateInstanceRequirements {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for LaunchTemplateInstanceRequirements {
