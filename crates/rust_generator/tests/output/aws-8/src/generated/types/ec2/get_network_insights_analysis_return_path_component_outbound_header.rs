...
pub struct GetNetworkInsightsAnalysisReturnPathComponentOutboundHeader {
    ...
    pub r#destination_port_ranges: Vec<super::super::types::ec2::GetNetworkInsightsAnalysisReturnPathComponentOutboundHeaderDestinationPortRange>,
    #[builder(into)]
    ...
    pub r#source_port_ranges: Vec<super::super::types::ec2::GetNetworkInsightsAnalysisReturnPathComponentOutboundHeaderSourcePortRange>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetNetworkInsightsAnalysisReturnPathComponentOutboundHeader {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetNetworkInsightsAnalysisReturnPathComponentOutboundHeader {
