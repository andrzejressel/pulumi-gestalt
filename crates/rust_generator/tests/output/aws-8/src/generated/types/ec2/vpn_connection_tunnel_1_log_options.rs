...
pub struct VpnConnectionTunnel1LogOptions {
    ...
    pub r#cloudwatch_log_options: Option<Box<super::super::types::ec2::VpnConnectionTunnel1LogOptionsCloudwatchLogOptions>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for VpnConnectionTunnel1LogOptions {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "cloudwatch_log_options".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for VpnConnectionTunnel1LogOptions {
