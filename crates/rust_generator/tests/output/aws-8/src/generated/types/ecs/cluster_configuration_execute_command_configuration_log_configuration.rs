            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#cloud_watch_encryption_enabled: {
                        let field_value = match fields_map.get("cloudWatchEncryptionEnabled") {
                            Some(value) => value,
                            None => bail!("Missing field 'cloudWatchEncryptionEnabled' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#cloud_watch_log_group_name: {
                        let field_value = match fields_map.get("cloudWatchLogGroupName") {
                            Some(value) => value,
                            None => bail!("Missing field 'cloudWatchLogGroupName' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#s_3_bucket_encryption_enabled: {
                        let field_value = match fields_map.get("s3BucketEncryptionEnabled") {
                            Some(value) => value,
                            None => bail!("Missing field 's3BucketEncryptionEnabled' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#s_3_bucket_name: {
