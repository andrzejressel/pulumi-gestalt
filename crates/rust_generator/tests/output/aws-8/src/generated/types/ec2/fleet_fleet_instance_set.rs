...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FleetFleetInstanceSet {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FleetFleetInstanceSet {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#instance_ids: {
                        let field_value = match fields_map.get("instanceIds") {
                            Some(value) => value,
                            None => bail!("Missing field 'instanceIds' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
