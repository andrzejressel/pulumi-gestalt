...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ServiceAlarms {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ServiceAlarms {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#alarm_names: {
                        let field_value = match fields_map.get("alarm_names") {
                            Some(value) => value,
                            None => bail!("Missing field 'alarm_names' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
