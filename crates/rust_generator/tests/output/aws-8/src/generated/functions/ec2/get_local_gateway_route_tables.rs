...
pub mod get_local_gateway_route_tables {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct GetLocalGatewayRouteTablesArgs {
    ...
    #[allow(dead_code)]
    pub struct GetLocalGatewayRouteTablesResult {
    ...
    pub fn invoke(
        ...
        args: GetLocalGatewayRouteTablesArgs,
