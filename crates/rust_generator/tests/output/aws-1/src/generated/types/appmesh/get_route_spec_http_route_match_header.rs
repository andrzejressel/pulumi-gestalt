...
pub struct GetRouteSpecHttpRouteMatchHeader {
    ...
    pub r#matches: Vec<super::super::types::appmesh::GetRouteSpecHttpRouteMatchHeaderMatch>,
    /// Name of the route.
    #[builder(into)]
    #[serde(rename = "name")]
    pub r#name: String,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetRouteSpecHttpRouteMatchHeader {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetRouteSpecHttpRouteMatchHeader {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#matches: {
                        ...
                        <Vec<super::super::types::appmesh::GetRouteSpecHttpRouteMatchHeaderMatch> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#name: {
