...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetVirtualRouterSpec {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetVirtualRouterSpec {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#listeners: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualRouterSpecListener> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
