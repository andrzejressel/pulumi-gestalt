...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for VirtualNodeSpecListenerTlsCertificate {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for VirtualNodeSpecListenerTlsCertificate {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#acm: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualNodeSpecListenerTlsCertificateAcm>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#file: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualNodeSpecListenerTlsCertificateFile>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#sds: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualNodeSpecListenerTlsCertificateSds>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
