...
pub struct GetRouteSpecHttp2RouteMatchHeaderMatch {
    ...
    #[builder(into)]
    #[serde(rename = "ranges")]
    pub r#ranges: Vec<super::super::types::appmesh::GetRouteSpecHttp2RouteMatchHeaderMatchRange>,
    #[builder(into)]
    #[serde(rename = "regex")]
    pub r#regex: String,
    #[builder(into)]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetRouteSpecHttp2RouteMatchHeaderMatch {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("ranges".to_string(), self.r#ranges.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetRouteSpecHttp2RouteMatchHeaderMatch {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#ranges: {
                        ...
                        <Vec<super::super::types::appmesh::GetRouteSpecHttp2RouteMatchHeaderMatchRange> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#regex: {
