            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#backend_defaults: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualGatewaySpecBackendDefaults>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#listeners: {
                        ...
                        <Vec<super::super::types::appmesh::VirtualGatewaySpecListener> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#logging: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualGatewaySpecLogging>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
