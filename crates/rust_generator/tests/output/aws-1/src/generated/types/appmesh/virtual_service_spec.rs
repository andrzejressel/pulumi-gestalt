...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for VirtualServiceSpec {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for VirtualServiceSpec {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#provider: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualServiceSpecProvider>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
