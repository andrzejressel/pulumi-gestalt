...
pub struct GetRouteSpecHttp2RouteTimeoutPerRequest {
    #[builder(into)]
    #[serde(rename = "unit")]
    pub r#unit: String,
    #[builder(into)]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetRouteSpecHttp2RouteTimeoutPerRequest {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetRouteSpecHttp2RouteTimeoutPerRequest {
