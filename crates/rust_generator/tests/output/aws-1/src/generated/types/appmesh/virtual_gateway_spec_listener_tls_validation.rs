            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#subject_alternative_names: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualGatewaySpecListenerTlsValidationSubjectAlternativeNames>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#trust: {
                        ...
                        <Box<super::super::types::appmesh::VirtualGatewaySpecListenerTlsValidationTrust> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
