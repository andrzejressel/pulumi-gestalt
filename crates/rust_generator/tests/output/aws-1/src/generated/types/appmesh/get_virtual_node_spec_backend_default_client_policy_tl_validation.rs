...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetVirtualNodeSpecBackendDefaultClientPolicyTlValidation {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetVirtualNodeSpecBackendDefaultClientPolicyTlValidation {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#subject_alternative_names: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualNodeSpecBackendDefaultClientPolicyTlValidationSubjectAlternativeName> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#trusts: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualNodeSpecBackendDefaultClientPolicyTlValidationTrust> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
