            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#headers: {
                        ...
                        <Option<Vec<super::super::types::appmesh::RouteSpecHttpRouteMatchHeader>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#method: {
                    ...
                    r#path: {
                        ...
                        <Option<Box<super::super::types::appmesh::RouteSpecHttpRouteMatchPath>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#port: {
                    ...
                    r#query_parameters: {
                        ...
                        <Option<Vec<super::super::types::appmesh::RouteSpecHttpRouteMatchQueryParameter>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#scheme: {
