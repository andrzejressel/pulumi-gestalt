...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ServiceNetworkConfigurationEgressConfiguration {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("egress_type".to_string(), self.r#egress_type.to_pulumi_value().await);
            map.insert("vpc_connector_arn".to_string(), self.r#vpc_connector_arn.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ServiceNetworkConfigurationEgressConfiguration {
