...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for VirtualGatewaySpecLoggingAccessLog {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for VirtualGatewaySpecLoggingAccessLog {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#file: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualGatewaySpecLoggingAccessLogFile>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
