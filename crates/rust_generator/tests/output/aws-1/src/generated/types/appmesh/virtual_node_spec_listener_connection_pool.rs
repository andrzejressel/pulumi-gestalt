...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for VirtualNodeSpecListenerConnectionPool {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for VirtualNodeSpecListenerConnectionPool {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#grpc: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualNodeSpecListenerConnectionPoolGrpc>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#http_2_s: {
                        ...
                        <Option<Vec<super::super::types::appmesh::VirtualNodeSpecListenerConnectionPoolHttp2>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#https: {
                        ...
                        <Option<Vec<super::super::types::appmesh::VirtualNodeSpecListenerConnectionPoolHttp>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#tcps: {
                        ...
                        <Option<Vec<super::super::types::appmesh::VirtualNodeSpecListenerConnectionPoolTcp>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
