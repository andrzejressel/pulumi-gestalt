...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for VirtualNodeSpecListenerTimeoutHttp {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for VirtualNodeSpecListenerTimeoutHttp {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#idle: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualNodeSpecListenerTimeoutHttpIdle>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#per_request: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualNodeSpecListenerTimeoutHttpPerRequest>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
