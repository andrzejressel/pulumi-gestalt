...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RouteSpecHttpRoute {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RouteSpecHttpRoute {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#action: {
                        ...
                        <Box<super::super::types::appmesh::RouteSpecHttpRouteAction> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#match_: {
                        ...
                        <Box<super::super::types::appmesh::RouteSpecHttpRouteMatch> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#retry_policy: {
                        ...
                        <Option<Box<super::super::types::appmesh::RouteSpecHttpRouteRetryPolicy>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#timeout: {
                        ...
                        <Option<Box<super::super::types::appmesh::RouteSpecHttpRouteTimeout>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
