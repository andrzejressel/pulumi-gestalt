...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetVirtualGatewaySpecBackendDefaultClientPolicyTlCertificate {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetVirtualGatewaySpecBackendDefaultClientPolicyTlCertificate {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#files: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualGatewaySpecBackendDefaultClientPolicyTlCertificateFile> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#sds: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualGatewaySpecBackendDefaultClientPolicyTlCertificateSd> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
