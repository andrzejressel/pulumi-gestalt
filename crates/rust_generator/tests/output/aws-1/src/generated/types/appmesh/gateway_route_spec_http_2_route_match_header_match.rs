...
pub struct GatewayRouteSpecHttp2RouteMatchHeaderMatch {
    ...
    #[builder(into)]
    #[serde(rename = "range")]
    pub r#range: Option<Box<super::super::types::appmesh::GatewayRouteSpecHttp2RouteMatchHeaderMatchRange>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GatewayRouteSpecHttp2RouteMatchHeaderMatch {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GatewayRouteSpecHttp2RouteMatchHeaderMatch {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#range: {
                        ...
                        <Option<Box<super::super::types::appmesh::GatewayRouteSpecHttp2RouteMatchHeaderMatchRange>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#regex: {
