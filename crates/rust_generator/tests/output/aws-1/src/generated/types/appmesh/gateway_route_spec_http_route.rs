...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GatewayRouteSpecHttpRoute {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GatewayRouteSpecHttpRoute {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#action: {
                        ...
                        <Box<super::super::types::appmesh::GatewayRouteSpecHttpRouteAction> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#match_: {
                        ...
                        <Box<super::super::types::appmesh::GatewayRouteSpecHttpRouteMatch> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
