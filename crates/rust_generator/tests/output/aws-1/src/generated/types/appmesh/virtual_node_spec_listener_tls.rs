...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for VirtualNodeSpecListenerTls {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for VirtualNodeSpecListenerTls {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#certificate: {
                        ...
                        <Box<super::super::types::appmesh::VirtualNodeSpecListenerTlsCertificate> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#mode: {
                    ...
                    r#validation: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualNodeSpecListenerTlsValidation>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
