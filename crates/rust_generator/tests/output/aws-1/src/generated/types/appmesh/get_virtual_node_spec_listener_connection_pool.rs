...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetVirtualNodeSpecListenerConnectionPool {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetVirtualNodeSpecListenerConnectionPool {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#grpcs: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualNodeSpecListenerConnectionPoolGrpc> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#http_2_s: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualNodeSpecListenerConnectionPoolHttp2> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#https: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualNodeSpecListenerConnectionPoolHttp> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#tcps: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualNodeSpecListenerConnectionPoolTcp> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
