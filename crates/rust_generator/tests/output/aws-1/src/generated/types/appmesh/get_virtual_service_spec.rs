...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetVirtualServiceSpec {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetVirtualServiceSpec {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#providers: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualServiceSpecProvider> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
