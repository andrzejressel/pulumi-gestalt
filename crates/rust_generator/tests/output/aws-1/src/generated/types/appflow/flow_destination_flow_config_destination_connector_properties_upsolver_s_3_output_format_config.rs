            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#aggregation_config: {
                        ...
                        <Option<Box<super::super::types::appflow::FlowDestinationFlowConfigDestinationConnectorPropertiesUpsolverS3OutputFormatConfigAggregationConfig>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#file_type: {
                    ...
                    r#prefix_config: {
                        ...
                        <Box<super::super::types::appflow::FlowDestinationFlowConfigDestinationConnectorPropertiesUpsolverS3OutputFormatConfigPrefixConfig> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
