...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ConnectorProfileConnectorProfileConfig {
    ...
    > {
        async move {
            ...
            map.insert("connector_profile_credentials".to_string(), self.r#connector_profile_credentials.to_pulumi_value().await);
            map.insert("connector_profile_properties".to_string(), self.r#connector_profile_properties.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#connector_profile_credentials: {
                        ...
                        <Box<super::super::types::appflow::ConnectorProfileConnectorProfileConfigConnectorProfileCredentials> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#connector_profile_properties: {
                        ...
                        <Box<super::super::types::appflow::ConnectorProfileConnectorProfileConfigConnectorProfileProperties> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
