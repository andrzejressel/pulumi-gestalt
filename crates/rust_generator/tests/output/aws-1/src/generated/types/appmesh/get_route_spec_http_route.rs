...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetRouteSpecHttpRoute {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetRouteSpecHttpRoute {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#actions: {
                        ...
                        <Vec<super::super::types::appmesh::GetRouteSpecHttpRouteAction> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#matches: {
                        ...
                        <Vec<super::super::types::appmesh::GetRouteSpecHttpRouteMatch> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#retry_policies: {
                        ...
                        <Vec<super::super::types::appmesh::GetRouteSpecHttpRouteRetryPolicy> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#timeouts: {
                        ...
                        <Vec<super::super::types::appmesh::GetRouteSpecHttpRouteTimeout> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
