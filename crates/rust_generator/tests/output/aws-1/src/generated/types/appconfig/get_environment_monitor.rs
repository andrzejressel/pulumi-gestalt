...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetEnvironmentMonitor {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("alarm_arn".to_string(), self.r#alarm_arn.to_pulumi_value().await);
            map.insert("alarm_role_arn".to_string(), self.r#alarm_role_arn.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetEnvironmentMonitor {
