...
pub struct GetVirtualNodeSpecLoggingAccessLogFileFormatJson {
    #[builder(into)]
    #[serde(rename = "key")]
    pub r#key: String,
    #[builder(into)]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetVirtualNodeSpecLoggingAccessLogFileFormatJson {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetVirtualNodeSpecLoggingAccessLogFileFormatJson {
