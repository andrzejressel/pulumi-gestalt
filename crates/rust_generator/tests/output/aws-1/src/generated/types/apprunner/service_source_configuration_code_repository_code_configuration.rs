...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ServiceSourceConfigurationCodeRepositoryCodeConfiguration {
    ...
    > {
        async move {
            ...
            map.insert("code_configuration_values".to_string(), self.r#code_configuration_values.to_pulumi_value().await);
            map.insert("configuration_source".to_string(), self.r#configuration_source.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#code_configuration_values: {
                        ...
                        <Option<Box<super::super::types::apprunner::ServiceSourceConfigurationCodeRepositoryCodeConfigurationCodeConfigurationValues>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
