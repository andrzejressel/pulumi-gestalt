...
pub struct GetImageStateChangeReason {
    #[builder(into)]
    #[serde(rename = "code")]
    pub r#code: String,
    #[builder(into)]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetImageStateChangeReason {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("code".to_string(), self.r#code.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetImageStateChangeReason {
