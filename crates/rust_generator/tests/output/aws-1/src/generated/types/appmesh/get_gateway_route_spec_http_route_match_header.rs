...
pub struct GetGatewayRouteSpecHttpRouteMatchHeader {
    ...
    pub r#matches: Vec<super::super::types::appmesh::GetGatewayRouteSpecHttpRouteMatchHeaderMatch>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetGatewayRouteSpecHttpRouteMatchHeader {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetGatewayRouteSpecHttpRouteMatchHeader {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#matches: {
                        ...
                        <Vec<super::super::types::appmesh::GetGatewayRouteSpecHttpRouteMatchHeaderMatch> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#name: {
