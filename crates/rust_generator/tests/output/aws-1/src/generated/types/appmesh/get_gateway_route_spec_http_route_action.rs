...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetGatewayRouteSpecHttpRouteAction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetGatewayRouteSpecHttpRouteAction {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#rewrites: {
                        ...
                        <Vec<super::super::types::appmesh::GetGatewayRouteSpecHttpRouteActionRewrite> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#targets: {
                        ...
                        <Vec<super::super::types::appmesh::GetGatewayRouteSpecHttpRouteActionTarget> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
