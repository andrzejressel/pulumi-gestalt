...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GatewayRouteSpecHttpRouteMatchQueryParameter {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GatewayRouteSpecHttpRouteMatchQueryParameter {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#match_: {
                        ...
                        <Option<Box<super::super::types::appmesh::GatewayRouteSpecHttpRouteMatchQueryParameterMatch>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#name: {
