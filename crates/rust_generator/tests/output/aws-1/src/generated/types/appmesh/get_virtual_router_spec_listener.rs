...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetVirtualRouterSpecListener {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetVirtualRouterSpecListener {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#port_mappings: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualRouterSpecListenerPortMapping> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
