...
pub struct GatewayRouteSpecHttpRouteMatchHeaderMatchRange {
    /// End of the range.
    #[builder(into)]
    #[serde(rename = "end")]
    pub r#end: i32,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GatewayRouteSpecHttpRouteMatchHeaderMatchRange {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GatewayRouteSpecHttpRouteMatchHeaderMatchRange {
