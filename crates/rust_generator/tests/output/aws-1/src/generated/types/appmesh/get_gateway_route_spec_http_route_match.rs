...
pub struct GetGatewayRouteSpecHttpRouteMatch {
    ...
    pub r#headers: Vec<super::super::types::appmesh::GetGatewayRouteSpecHttpRouteMatchHeader>,
    #[builder(into)]
    #[serde(rename = "hostnames")]
    pub r#hostnames: Vec<super::super::types::appmesh::GetGatewayRouteSpecHttpRouteMatchHostname>,
    #[builder(into)]
    #[serde(rename = "paths")]
    pub r#paths: Vec<super::super::types::appmesh::GetGatewayRouteSpecHttpRouteMatchPath>,
    #[builder(into)]
    #[serde(rename = "port")]
    pub r#port: i32,
    #[builder(into)]
    ...
    pub r#query_parameters: Vec<super::super::types::appmesh::GetGatewayRouteSpecHttpRouteMatchQueryParameter>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetGatewayRouteSpecHttpRouteMatch {
    fn to_pulumi_value(
        &self,
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#query_parameters: {
                        let field_value = match fields_map.get("queryParameters") {
                            Some(value) => value,
                            None => bail!("Missing field 'queryParameters' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
