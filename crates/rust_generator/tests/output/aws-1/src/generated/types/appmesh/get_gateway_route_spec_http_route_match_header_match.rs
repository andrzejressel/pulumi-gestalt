...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetGatewayRouteSpecHttpRouteMatchHeaderMatch {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetGatewayRouteSpecHttpRouteMatchHeaderMatch {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#ranges: {
                        ...
                        <Vec<super::super::types::appmesh::GetGatewayRouteSpecHttpRouteMatchHeaderMatchRange> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#regex: {
