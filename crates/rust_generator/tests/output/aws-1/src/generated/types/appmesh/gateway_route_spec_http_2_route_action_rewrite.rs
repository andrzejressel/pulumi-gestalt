...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GatewayRouteSpecHttp2RouteActionRewrite {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GatewayRouteSpecHttp2RouteActionRewrite {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#hostname: {
                        ...
                        <Option<Box<super::super::types::appmesh::GatewayRouteSpecHttp2RouteActionRewriteHostname>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#path: {
                        ...
                        <Option<Box<super::super::types::appmesh::GatewayRouteSpecHttp2RouteActionRewritePath>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#prefix: {
                        ...
                        <Option<Box<super::super::types::appmesh::GatewayRouteSpecHttp2RouteActionRewritePrefix>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
