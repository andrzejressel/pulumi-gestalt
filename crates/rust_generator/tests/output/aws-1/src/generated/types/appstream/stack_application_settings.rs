...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for StackApplicationSettings {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("settings_group".to_string(), self.r#settings_group.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for StackApplicationSettings {
