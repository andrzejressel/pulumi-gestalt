...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for VirtualGatewaySpecLoggingAccessLogFile {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for VirtualGatewaySpecLoggingAccessLogFile {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#format: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualGatewaySpecLoggingAccessLogFileFormat>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#path: {
