...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for VirtualGatewaySpecBackendDefaults {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for VirtualGatewaySpecBackendDefaults {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#client_policy: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualGatewaySpecBackendDefaultsClientPolicy>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
