...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ResolverCachingConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("caching_keys".to_string(), self.r#caching_keys.to_pulumi_value().await);
            map.insert("ttl".to_string(), self.r#ttl.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ResolverCachingConfig {
