...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for VirtualRouterSpec {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for VirtualRouterSpec {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#listeners: {
                        ...
                        <Option<Vec<super::super::types::appmesh::VirtualRouterSpecListener>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
