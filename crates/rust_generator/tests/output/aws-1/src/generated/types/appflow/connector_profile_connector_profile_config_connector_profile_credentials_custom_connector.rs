...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnector {
    ...
    > {
        async move {
            ...
            map.insert("api_key".to_string(), self.r#api_key.to_pulumi_value().await);
            map.insert("authentication_type".to_string(), self.r#authentication_type.to_pulumi_value().await);
            map.insert("basic".to_string(), self.r#basic.to_pulumi_value().await);
            map.insert("custom".to_string(), self.r#custom.to_pulumi_value().await);
            map.insert("oauth_2".to_string(), self.r#oauth_2.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#api_key: {
                        ...
                        <Option<Box<super::super::types::appflow::ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnectorApiKey>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    ...
                    r#basic: {
                        ...
                        <Option<Box<super::super::types::appflow::ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnectorBasic>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#custom: {
                        ...
                        <Option<Box<super::super::types::appflow::ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnectorCustom>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#oauth_2: {
                        ...
                        <Option<Box<super::super::types::appflow::ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnectorOauth2>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
