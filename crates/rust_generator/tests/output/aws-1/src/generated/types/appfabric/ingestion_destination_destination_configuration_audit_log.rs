...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for IngestionDestinationDestinationConfigurationAuditLog {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for IngestionDestinationDestinationConfigurationAuditLog {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#destination: {
                        ...
                        <Option<Box<super::super::types::appfabric::IngestionDestinationDestinationConfigurationAuditLogDestination>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
