...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetGatewayRouteSpecHttpRouteMatchQueryParameter {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetGatewayRouteSpecHttpRouteMatchQueryParameter {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#matches: {
                        ...
                        <Vec<super::super::types::appmesh::GetGatewayRouteSpecHttpRouteMatchQueryParameterMatch> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#name: {
