...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FlowTriggerConfig {
    ...
    > {
        async move {
            ...
            map.insert("trigger_properties".to_string(), self.r#trigger_properties.to_pulumi_value().await);
            map.insert("trigger_type".to_string(), self.r#trigger_type.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#trigger_properties: {
                        ...
                        <Option<Box<super::super::types::appflow::FlowTriggerConfigTriggerProperties>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#trigger_type: {
