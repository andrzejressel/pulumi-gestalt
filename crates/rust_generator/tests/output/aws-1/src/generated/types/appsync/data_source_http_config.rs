...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DataSourceHttpConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("authorization_config".to_string(), self.r#authorization_config.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DataSourceHttpConfig {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#authorization_config: {
                        ...
                        <Option<Box<super::super::types::appsync::DataSourceHttpConfigAuthorizationConfig>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#endpoint: {
