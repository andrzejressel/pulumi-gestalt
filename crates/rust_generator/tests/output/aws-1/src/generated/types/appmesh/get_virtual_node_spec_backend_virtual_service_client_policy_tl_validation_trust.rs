            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#acms: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualNodeSpecBackendVirtualServiceClientPolicyTlValidationTrustAcm> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#files: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualNodeSpecBackendVirtualServiceClientPolicyTlValidationTrustFile> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#sds: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualNodeSpecBackendVirtualServiceClientPolicyTlValidationTrustSd> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
