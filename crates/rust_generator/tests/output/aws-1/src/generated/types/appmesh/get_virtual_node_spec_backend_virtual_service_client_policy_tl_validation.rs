            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#subject_alternative_names: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualNodeSpecBackendVirtualServiceClientPolicyTlValidationSubjectAlternativeName> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#trusts: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualNodeSpecBackendVirtualServiceClientPolicyTlValidationTrust> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
