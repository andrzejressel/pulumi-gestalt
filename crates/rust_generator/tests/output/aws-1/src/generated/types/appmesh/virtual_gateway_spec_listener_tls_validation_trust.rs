...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for VirtualGatewaySpecListenerTlsValidationTrust {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for VirtualGatewaySpecListenerTlsValidationTrust {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#file: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualGatewaySpecListenerTlsValidationTrustFile>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#sds: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualGatewaySpecListenerTlsValidationTrustSds>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
