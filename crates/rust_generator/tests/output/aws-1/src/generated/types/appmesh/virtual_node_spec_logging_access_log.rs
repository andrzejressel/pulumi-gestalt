...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for VirtualNodeSpecLoggingAccessLog {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for VirtualNodeSpecLoggingAccessLog {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#file: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualNodeSpecLoggingAccessLogFile>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
