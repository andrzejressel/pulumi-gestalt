...
pub struct GetRouteSpecHttpRouteMatchHeaderMatch {
    ...
    #[builder(into)]
    #[serde(rename = "ranges")]
    pub r#ranges: Vec<super::super::types::appmesh::GetRouteSpecHttpRouteMatchHeaderMatchRange>,
    #[builder(into)]
    #[serde(rename = "regex")]
    pub r#regex: String,
    #[builder(into)]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetRouteSpecHttpRouteMatchHeaderMatch {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetRouteSpecHttpRouteMatchHeaderMatch {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#ranges: {
                        ...
                        <Vec<super::super::types::appmesh::GetRouteSpecHttpRouteMatchHeaderMatchRange> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#regex: {
