...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ImageBuilderDomainJoinInfo {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("directory_name".to_string(), self.r#directory_name.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ImageBuilderDomainJoinInfo {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#directory_name: {
                        let field_value = match fields_map.get("directory_name") {
                            Some(value) => value,
                            None => bail!("Missing field 'directory_name' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
