...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ImageBuilderAccessEndpoint {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ImageBuilderAccessEndpoint {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#vpce_id: {
                        let field_value = match fields_map.get("vpceId") {
                            Some(value) => value,
                            None => bail!("Missing field 'vpceId' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
