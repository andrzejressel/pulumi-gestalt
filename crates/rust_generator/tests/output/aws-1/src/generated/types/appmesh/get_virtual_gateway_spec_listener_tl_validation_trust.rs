...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetVirtualGatewaySpecListenerTlValidationTrust {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetVirtualGatewaySpecListenerTlValidationTrust {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#files: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualGatewaySpecListenerTlValidationTrustFile> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#sds: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualGatewaySpecListenerTlValidationTrustSd> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
