            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#acms: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualNodeSpecBackendDefaultClientPolicyTlValidationTrustAcm> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#files: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualNodeSpecBackendDefaultClientPolicyTlValidationTrustFile> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#sds: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualNodeSpecBackendDefaultClientPolicyTlValidationTrustSd> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
