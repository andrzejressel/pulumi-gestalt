...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RouteSpecTcpRoute {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RouteSpecTcpRoute {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#action: {
                        ...
                        <Box<super::super::types::appmesh::RouteSpecTcpRouteAction> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#match_: {
                        ...
                        <Option<Box<super::super::types::appmesh::RouteSpecTcpRouteMatch>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#timeout: {
                        ...
                        <Option<Box<super::super::types::appmesh::RouteSpecTcpRouteTimeout>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
