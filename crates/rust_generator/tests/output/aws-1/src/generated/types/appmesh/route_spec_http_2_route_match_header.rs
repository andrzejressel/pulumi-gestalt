...
pub struct RouteSpecHttp2RouteMatchHeader {
    ...
    #[builder(into)]
    #[serde(rename = "match")]
    pub r#match_: Option<Box<super::super::types::appmesh::RouteSpecHttp2RouteMatchHeaderMatch>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RouteSpecHttp2RouteMatchHeader {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RouteSpecHttp2RouteMatchHeader {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#match_: {
                        ...
                        <Option<Box<super::super::types::appmesh::RouteSpecHttp2RouteMatchHeaderMatch>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#name: {
