            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#s_3_input_format_config: {
                        let field_value = match fields_map.get("s3InputFormatConfig") {
                            Some(value) => value,
                            None => bail!("Missing field 's3InputFormatConfig' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
