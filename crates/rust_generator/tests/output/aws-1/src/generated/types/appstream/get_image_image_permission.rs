...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetImageImagePermission {
    ...
    > {
        async move {
            ...
            map.insert("allow_fleet".to_string(), self.r#allow_fleet.to_pulumi_value().await);
            map.insert("allow_image_builder".to_string(), self.r#allow_image_builder.to_pulumi_value().await);
