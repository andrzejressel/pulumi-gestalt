...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for VirtualGatewaySpecListenerTlsCertificate {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for VirtualGatewaySpecListenerTlsCertificate {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#acm: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualGatewaySpecListenerTlsCertificateAcm>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#file: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualGatewaySpecListenerTlsCertificateFile>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#sds: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualGatewaySpecListenerTlsCertificateSds>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
