...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FlowDestinationFlowConfigDestinationConnectorPropertiesSalesforce {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FlowDestinationFlowConfigDestinationConnectorPropertiesSalesforce {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#error_handling_config: {
                        ...
                        <Option<Box<super::super::types::appflow::FlowDestinationFlowConfigDestinationConnectorPropertiesSalesforceErrorHandlingConfig>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#id_field_names: {
