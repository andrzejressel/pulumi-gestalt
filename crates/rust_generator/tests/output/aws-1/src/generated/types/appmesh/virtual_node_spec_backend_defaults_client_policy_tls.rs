...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for VirtualNodeSpecBackendDefaultsClientPolicyTls {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for VirtualNodeSpecBackendDefaultsClientPolicyTls {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#certificate: {
                        ...
                        <Option<Box<super::super::types::appmesh::VirtualNodeSpecBackendDefaultsClientPolicyTlsCertificate>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#enforce: {
                    ...
                    r#validation: {
                        ...
                        <Box<super::super::types::appmesh::VirtualNodeSpecBackendDefaultsClientPolicyTlsValidation> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
