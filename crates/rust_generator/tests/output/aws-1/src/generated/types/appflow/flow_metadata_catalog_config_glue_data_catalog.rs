...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FlowMetadataCatalogConfigGlueDataCatalog {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("table_prefix".to_string(), self.r#table_prefix.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FlowMetadataCatalogConfigGlueDataCatalog {
