...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsInforNexus {
    ...
    > {
        async move {
            ...
            map.insert("datakey".to_string(), self.r#datakey.to_pulumi_value().await);
            map.insert("secret_access_key".to_string(), self.r#secret_access_key.to_pulumi_value().await);
