    ...
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#base_table_ttl: {
                        let field_value = match fields_map.get("baseTableTtl") {
                            Some(value) => value,
                            None => bail!("Missing field 'baseTableTtl' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#delta_sync_table_name: {
                        let field_value = match fields_map.get("deltaSyncTableName") {
                            Some(value) => value,
                            None => bail!("Missing field 'deltaSyncTableName' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#delta_sync_table_ttl: {
                        let field_value = match fields_map.get("deltaSyncTableTtl") {
                            Some(value) => value,
                            None => bail!("Missing field 'deltaSyncTableTtl' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
