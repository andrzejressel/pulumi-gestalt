...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for StackStorageConnector {
    ...
    > {
        async move {
            ...
            map.insert("domains".to_string(), self.r#domains.to_pulumi_value().await);
            map.insert("resource_identifier".to_string(), self.r#resource_identifier.to_pulumi_value().await);
