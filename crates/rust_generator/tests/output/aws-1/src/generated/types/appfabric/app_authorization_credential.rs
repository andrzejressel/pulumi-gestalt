...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AppAuthorizationCredential {
    ...
    > {
        async move {
            ...
            map.insert("api_key_credentials".to_string(), self.r#api_key_credentials.to_pulumi_value().await);
            map.insert("oauth_2_credential".to_string(), self.r#oauth_2_credential.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#api_key_credentials: {
                        ...
                        <Option<Vec<super::super::types::appfabric::AppAuthorizationCredentialApiKeyCredential>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#oauth_2_credential: {
                        ...
                        <Option<Box<super::super::types::appfabric::AppAuthorizationCredentialOauth2Credential>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
