...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetVirtualNodeSpecListenerTimeoutHttp {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetVirtualNodeSpecListenerTimeoutHttp {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#idles: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualNodeSpecListenerTimeoutHttpIdle> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#per_requests: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualNodeSpecListenerTimeoutHttpPerRequest> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
