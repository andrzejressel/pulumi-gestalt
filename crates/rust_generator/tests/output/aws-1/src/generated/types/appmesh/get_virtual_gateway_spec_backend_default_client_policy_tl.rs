            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#certificates: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualGatewaySpecBackendDefaultClientPolicyTlCertificate> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#enforce: {
                    ...
                    r#validations: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualGatewaySpecBackendDefaultClientPolicyTlValidation> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
