            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#headers: {
                        ...
                        <Option<Vec<super::super::types::appmesh::GatewayRouteSpecHttpRouteMatchHeader>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#hostname: {
                        ...
                        <Option<Box<super::super::types::appmesh::GatewayRouteSpecHttpRouteMatchHostname>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#path: {
                        ...
                        <Option<Box<super::super::types::appmesh::GatewayRouteSpecHttpRouteMatchPath>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#port: {
                    ...
                    r#query_parameters: {
                        ...
                        <Option<Vec<super::super::types::appmesh::GatewayRouteSpecHttpRouteMatchQueryParameter>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
