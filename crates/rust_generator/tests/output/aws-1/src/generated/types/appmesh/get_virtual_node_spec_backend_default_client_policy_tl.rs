...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetVirtualNodeSpecBackendDefaultClientPolicyTl {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetVirtualNodeSpecBackendDefaultClientPolicyTl {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#certificates: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualNodeSpecBackendDefaultClientPolicyTlCertificate> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#enforce: {
                    ...
                    r#validations: {
                        ...
                        <Vec<super::super::types::appmesh::GetVirtualNodeSpecBackendDefaultClientPolicyTlValidation> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
