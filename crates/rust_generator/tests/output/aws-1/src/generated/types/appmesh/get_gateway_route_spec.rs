            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#grpc_routes: {
                        ...
                        <Vec<super::super::types::appmesh::GetGatewayRouteSpecGrpcRoute> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#http_2_routes: {
                        ...
                        <Vec<super::super::types::appmesh::GetGatewayRouteSpecHttp2Route> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#http_routes: {
                        ...
                        <Vec<super::super::types::appmesh::GetGatewayRouteSpecHttpRoute> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#priority: {
