...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetRouteSpecTcpRoute {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetRouteSpecTcpRoute {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#actions: {
                        ...
                        <Vec<super::super::types::appmesh::GetRouteSpecTcpRouteAction> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#matches: {
                        ...
                        <Vec<super::super::types::appmesh::GetRouteSpecTcpRouteMatch> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#timeouts: {
                        ...
                        <Vec<super::super::types::appmesh::GetRouteSpecTcpRouteTimeout> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
