...
pub mod flow {
    ...
    fn __create(
        ...
        let destination_flow_configs_binding = args
            ...
            .get_output(ctx);
        let kms_arn_binding = args.kms_arn.get_output(ctx);
        let metadata_catalog_config_binding = args
            .metadata_catalog_config
            .get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let source_flow_config_binding = args.source_flow_config.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let tasks_binding = args.tasks.get_output(ctx);
        let trigger_config_binding = args.trigger_config.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &destination_flow_configs_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "kmsArn".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &metadata_catalog_config_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &source_flow_config_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "tags".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "tasks".into(),
                    value: &tasks_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "triggerConfig".into(),
                    value: &trigger_config_binding.drop_type(),
                },
            ],
            options,
        };
