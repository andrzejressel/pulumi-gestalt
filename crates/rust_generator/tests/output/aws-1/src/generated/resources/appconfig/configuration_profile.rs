...
pub mod configuration_profile {
    ...
    pub struct ConfigurationProfileArgs {
        ...
        #[builder(into)]
        pub location_uri: pulumi_gestalt_rust::Input<String>,
        ...
        #[builder(into, default)]
        pub retrieval_role_arn: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub validators: pulumi_gestalt_rust::Input<
    ...
    fn __create(
        ...
        let retrieval_role_arn_binding = args.retrieval_role_arn.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let type__binding = args.type_.get_output(ctx);
        let validators_binding = args.validators.get_output(ctx);
