...
pub mod deployment {
    ...
    fn __create(
        ...
        let configuration_profile_id_binding = args
            ...
            .get_output(ctx);
        let configuration_version_binding = args.configuration_version.get_output(ctx);
        let deployment_strategy_id_binding = args.deployment_strategy_id.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &configuration_profile_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "configurationVersion".into(),
                    value: &configuration_version_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "deploymentStrategyId".into(),
                    value: &deployment_strategy_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
