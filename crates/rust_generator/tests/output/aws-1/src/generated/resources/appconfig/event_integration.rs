...
pub mod event_integration {
    ...
    fn __create(
        ...
        let event_filter_binding = args.event_filter.get_output(ctx);
        let eventbridge_bus_binding = args.eventbridge_bus.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &event_filter_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "eventbridgeBus".into(),
                    value: &eventbridge_bus_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
