...
pub mod regex_pattern_set {
    ...
    pub struct RegexPatternSetArgs {
        ...
        #[builder(into, default)]
        pub regular_expressions: pulumi_gestalt_rust::Input<
    ...
    fn __create(
        ...
        let regular_expressions_binding = args.regular_expressions.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &regular_expressions_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "scope".into(),
