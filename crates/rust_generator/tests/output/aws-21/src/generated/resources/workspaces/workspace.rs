...
pub mod workspace {
    ...
    fn __create(
        ...
        let user_volume_encryption_enabled_binding = args
            ...
            .get_output(ctx);
        let volume_encryption_key_binding = args.volume_encryption_key.get_output(ctx);
        let workspace_properties_binding = args.workspace_properties.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &root_volume_encryption_enabled_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "tags".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &user_volume_encryption_enabled_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "volumeEncryptionKey".into(),
                    value: &volume_encryption_key_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
