...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ListenerRuleMatchHttpMatchHeaderMatch {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("case_sensitive".to_string(), self.r#case_sensitive.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ListenerRuleMatchHttpMatchHeaderMatch {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#match_: {
                        ...
                        <Box<super::super::types::vpclattice::ListenerRuleMatchHttpMatchHeaderMatchMatch> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#name: {
