...
pub struct WebAclRuleStatementRateBasedStatementCustomKeyHeader {
    ...
    pub r#text_transformations: Vec<super::super::types::wafv2::WebAclRuleStatementRateBasedStatementCustomKeyHeaderTextTransformation>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WebAclRuleStatementRateBasedStatementCustomKeyHeader {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WebAclRuleStatementRateBasedStatementCustomKeyHeader {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#text_transformations: {
                        ...
                        <Vec<super::super::types::wafv2::WebAclRuleStatementRateBasedStatementCustomKeyHeaderTextTransformation> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
