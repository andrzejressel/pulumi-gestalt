...
pub struct RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern {
    /// An empty configuration block that is used for inspecting all headers.
    #[builder(into)]
    #[serde(rename = "all")]
    pub r#all: Option<Box<super::super::types::wafv2::RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPatternAll>>,
    #[builder(into)]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#all: {
                        ...
                        <Option<Box<super::super::types::wafv2::RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPatternAll>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#excluded_cookies: {
