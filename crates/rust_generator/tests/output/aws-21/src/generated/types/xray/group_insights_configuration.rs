...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GroupInsightsConfiguration {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("insights_enabled".to_string(), self.r#insights_enabled.to_pulumi_value().await);
            map.insert("notifications_enabled".to_string(), self.r#notifications_enabled.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GroupInsightsConfiguration {
