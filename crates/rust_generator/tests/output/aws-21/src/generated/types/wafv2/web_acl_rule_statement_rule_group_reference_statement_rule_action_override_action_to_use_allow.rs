            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#custom_request_handling: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleStatementRuleGroupReferenceStatementRuleActionOverrideActionToUseAllowCustomRequestHandling>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
