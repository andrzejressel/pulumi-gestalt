...
pub struct WebAclRuleStatementSqliMatchStatement {
    ...
    pub r#field_to_match: Option<Box<super::super::types::wafv2::WebAclRuleStatementSqliMatchStatementFieldToMatch>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WebAclRuleStatementSqliMatchStatement {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WebAclRuleStatementSqliMatchStatement {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#field_to_match: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleStatementSqliMatchStatementFieldToMatch>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#sensitivity_level: {
                    ...
                    r#text_transformations: {
                        ...
                        <Vec<super::super::types::wafv2::WebAclRuleStatementSqliMatchStatementTextTransformation> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
