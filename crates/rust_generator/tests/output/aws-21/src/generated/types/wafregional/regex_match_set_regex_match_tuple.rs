            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#regex_pattern_set_id: {
                        let field_value = match fields_map.get("regexPatternSetId") {
                            Some(value) => value,
                            None => bail!("Missing field 'regexPatternSetId' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
