...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetListenerDefaultActionForwardTargetGroup {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("target_group_identifier".to_string(), self.r#target_group_identifier.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetListenerDefaultActionForwardTargetGroup {
