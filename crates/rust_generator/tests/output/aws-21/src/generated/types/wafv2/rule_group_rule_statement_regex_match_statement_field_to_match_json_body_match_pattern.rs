...
pub struct RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#all: {
                        ...
                        <Option<Box<super::super::types::wafv2::RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPatternAll>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#included_paths: {
