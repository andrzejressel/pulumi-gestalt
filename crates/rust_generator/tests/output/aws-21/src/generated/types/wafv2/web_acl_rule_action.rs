...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WebAclRuleAction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WebAclRuleAction {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#allow: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleActionAllow>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#block: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleActionBlock>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#captcha: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleActionCaptcha>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#challenge: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleActionChallenge>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#count: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleActionCount>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
