...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RateBasedRulePredicate {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("data_id".to_string(), self.r#data_id.to_pulumi_value().await);
            map.insert("negated".to_string(), self.r#negated.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RateBasedRulePredicate {
