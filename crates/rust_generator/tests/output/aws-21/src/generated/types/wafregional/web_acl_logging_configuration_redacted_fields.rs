    ...
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#field_to_matches: {
                        let field_value = match fields_map.get("fieldToMatches") {
                            Some(value) => value,
                            None => bail!("Missing field 'fieldToMatches' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
