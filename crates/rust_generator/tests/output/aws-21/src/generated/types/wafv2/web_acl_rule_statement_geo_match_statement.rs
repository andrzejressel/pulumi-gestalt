...
pub struct WebAclRuleStatementGeoMatchStatement {
    ...
    pub r#forwarded_ip_config: Option<Box<super::super::types::wafv2::WebAclRuleStatementGeoMatchStatementForwardedIpConfig>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WebAclRuleStatementGeoMatchStatement {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WebAclRuleStatementGeoMatchStatement {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#forwarded_ip_config: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleStatementGeoMatchStatementForwardedIpConfig>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
