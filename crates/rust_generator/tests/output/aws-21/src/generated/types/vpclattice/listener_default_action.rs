            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#fixed_response: {
                        ...
                        <Option<Box<super::super::types::vpclattice::ListenerDefaultActionFixedResponse>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#forwards: {
                        ...
                        <Option<Vec<super::super::types::vpclattice::ListenerDefaultActionForward>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
