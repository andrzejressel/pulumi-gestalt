            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#action: {
                        ...
                        <Option<Box<super::super::types::waf::WebAclRuleAction>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#override_action: {
                        ...
                        <Option<Box<super::super::types::waf::WebAclRuleOverrideAction>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#priority: {
