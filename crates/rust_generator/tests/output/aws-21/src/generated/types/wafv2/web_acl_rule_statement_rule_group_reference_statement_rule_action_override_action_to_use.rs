            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#allow: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleStatementRuleGroupReferenceStatementRuleActionOverrideActionToUseAllow>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#block: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleStatementRuleGroupReferenceStatementRuleActionOverrideActionToUseBlock>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#captcha: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleStatementRuleGroupReferenceStatementRuleActionOverrideActionToUseCaptcha>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#challenge: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleStatementRuleGroupReferenceStatementRuleActionOverrideActionToUseChallenge>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#count: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleStatementRuleGroupReferenceStatementRuleActionOverrideActionToUseCount>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
