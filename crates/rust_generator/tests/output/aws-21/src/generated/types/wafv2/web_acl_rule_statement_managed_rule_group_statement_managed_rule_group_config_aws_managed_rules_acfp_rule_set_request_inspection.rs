...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAcfpRuleSetRequestInspection {
    ...
    > {
        async move {
            ...
            map.insert("address_fields".to_string(), self.r#address_fields.to_pulumi_value().await);
            map.insert("email_field".to_string(), self.r#email_field.to_pulumi_value().await);
            ...
            map.insert("phone_number_fields".to_string(), self.r#phone_number_fields.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#address_fields: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAcfpRuleSetRequestInspectionAddressFields>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#email_field: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAcfpRuleSetRequestInspectionEmailField>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#password_field: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAcfpRuleSetRequestInspectionPasswordField>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#payload_type: {
                    ...
                    r#phone_number_fields: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAcfpRuleSetRequestInspectionPhoneNumberFields>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#username_field: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAcfpRuleSetRequestInspectionUsernameField>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
