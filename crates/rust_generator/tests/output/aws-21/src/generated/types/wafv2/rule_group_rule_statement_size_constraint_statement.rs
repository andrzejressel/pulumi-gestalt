...
pub struct RuleGroupRuleStatementSizeConstraintStatement {
    ...
    pub r#field_to_match: Option<Box<super::super::types::wafv2::RuleGroupRuleStatementSizeConstraintStatementFieldToMatch>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RuleGroupRuleStatementSizeConstraintStatement {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RuleGroupRuleStatementSizeConstraintStatement {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#field_to_match: {
                        ...
                        <Option<Box<super::super::types::wafv2::RuleGroupRuleStatementSizeConstraintStatementFieldToMatch>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#size: {
                    ...
                    r#text_transformations: {
                        ...
                        <Vec<super::super::types::wafv2::RuleGroupRuleStatementSizeConstraintStatementTextTransformation> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
