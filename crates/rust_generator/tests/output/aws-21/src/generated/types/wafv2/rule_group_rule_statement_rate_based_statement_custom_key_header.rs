...
pub struct RuleGroupRuleStatementRateBasedStatementCustomKeyHeader {
    ...
    pub r#text_transformations: Vec<super::super::types::wafv2::RuleGroupRuleStatementRateBasedStatementCustomKeyHeaderTextTransformation>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RuleGroupRuleStatementRateBasedStatementCustomKeyHeader {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RuleGroupRuleStatementRateBasedStatementCustomKeyHeader {
