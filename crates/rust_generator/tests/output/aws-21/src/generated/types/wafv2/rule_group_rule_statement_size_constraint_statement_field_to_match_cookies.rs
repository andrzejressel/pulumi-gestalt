...
pub struct RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookies {
    ...
    pub r#match_patterns: Vec<super::super::types::wafv2::RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookiesMatchPattern>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookies {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookies {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#match_patterns: {
                        ...
                        <Vec<super::super::types::wafv2::RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookiesMatchPattern> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#match_scope: {
