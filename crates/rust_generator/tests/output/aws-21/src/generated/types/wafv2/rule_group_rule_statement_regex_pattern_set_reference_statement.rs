            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#field_to_match: {
                        ...
                        <Option<Box<super::super::types::wafv2::RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatch>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#text_transformations: {
                        ...
                        <Vec<super::super::types::wafv2::RuleGroupRuleStatementRegexPatternSetReferenceStatementTextTransformation> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
