...
pub struct WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatement {
    ...
    pub r#forwarded_ip_config: Box<Option<super::super::types::wafv2::WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatementForwardedIpConfig>>,
}
