...
pub struct WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatement {
    ...
    pub r#forwarded_ip_config: Option<Box<super::super::types::wafv2::WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatementForwardedIpConfig>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatement {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("country_codes".to_string(), self.r#country_codes.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatement {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#forwarded_ip_config: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatementForwardedIpConfig>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
