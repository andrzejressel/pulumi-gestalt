...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAcfpRuleSetResponseInspectionBodyContains {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("failure_strings".to_string(), self.r#failure_strings.to_pulumi_value().await);
            map.insert("success_strings".to_string(), self.r#success_strings.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WebAclRuleStatementManagedRuleGroupStatementManagedRuleGroupConfigAwsManagedRulesAcfpRuleSetResponseInspectionBodyContains {
