...
pub struct WebAclRuleStatementRegexMatchStatementFieldToMatchHeader {
    ...
    pub r#match_pattern: Box<super::super::types::wafv2::WebAclRuleStatementRegexMatchStatementFieldToMatchHeaderMatchPattern>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WebAclRuleStatementRegexMatchStatementFieldToMatchHeader {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WebAclRuleStatementRegexMatchStatementFieldToMatchHeader {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#match_pattern: {
                        ...
                        <Box<super::super::types::wafv2::WebAclRuleStatementRegexMatchStatementFieldToMatchHeaderMatchPattern> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#match_scope: {
