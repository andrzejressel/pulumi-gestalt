...
pub struct WebAclRuleVisibilityConfig {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WebAclRuleVisibilityConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("cloudwatch_metrics_enabled".to_string(), self.r#cloudwatch_metrics_enabled.to_pulumi_value().await);
            map.insert("metric_name".to_string(), self.r#metric_name.to_pulumi_value().await);
            map.insert("sampled_requests_enabled".to_string(), self.r#sampled_requests_enabled.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WebAclRuleVisibilityConfig {
