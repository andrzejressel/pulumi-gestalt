            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#ip_set_forwarded_ip_config: {
                        ...
                        <Option<Box<super::super::types::wafv2::RuleGroupRuleStatementRateBasedStatementScopeDownStatementIpSetReferenceStatementIpSetForwardedIpConfig>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
