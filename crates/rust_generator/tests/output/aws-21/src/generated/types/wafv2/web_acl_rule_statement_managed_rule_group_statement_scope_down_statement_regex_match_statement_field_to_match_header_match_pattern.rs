            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#all: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementRegexMatchStatementFieldToMatchHeaderMatchPatternAll>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#excluded_headers: {
