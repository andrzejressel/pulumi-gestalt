            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#all: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementSqliMatchStatementFieldToMatchCookiesMatchPatternAll>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#excluded_cookies: {
