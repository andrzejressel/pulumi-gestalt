...
pub struct RuleGroupActivatedRule {
    ...
    #[builder(into)]
    #[serde(rename = "action")]
    pub r#action: Box<super::super::types::wafregional::RuleGroupActivatedRuleAction>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RuleGroupActivatedRule {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("rule_id".to_string(), self.r#rule_id.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RuleGroupActivatedRule {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#action: {
                        ...
                        <Box<super::super::types::wafregional::RuleGroupActivatedRuleAction> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#priority: {
