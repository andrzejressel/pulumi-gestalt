...
pub struct RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookies {
    ...
    pub r#match_patterns: Vec<super::super::types::wafv2::RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesMatchPattern>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookies {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookies {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#match_patterns: {
                        ...
                        <Vec<super::super::types::wafv2::RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesMatchPattern> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#match_scope: {
