...
pub struct WebAclRuleStatementByteMatchStatement {
    /// Part of a web request that you want AWS WAF to inspect. See `field_to_match` below for details.
    #[builder(into)]
    #[serde(rename = "fieldToMatch")]
    pub r#field_to_match: Option<Box<super::super::types::wafv2::WebAclRuleStatementByteMatchStatementFieldToMatch>>,
    ...
    pub r#text_transformations: Vec<super::super::types::wafv2::WebAclRuleStatementByteMatchStatementTextTransformation>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WebAclRuleStatementByteMatchStatement {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WebAclRuleStatementByteMatchStatement {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#field_to_match: {
                        ...
                        <Option<Box<super::super::types::wafv2::WebAclRuleStatementByteMatchStatementFieldToMatch>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    ...
                    r#text_transformations: {
                        ...
                        <Vec<super::super::types::wafv2::WebAclRuleStatementByteMatchStatementTextTransformation> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
