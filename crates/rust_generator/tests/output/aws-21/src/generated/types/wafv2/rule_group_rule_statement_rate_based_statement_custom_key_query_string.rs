...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RuleGroupRuleStatementRateBasedStatementCustomKeyQueryString {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RuleGroupRuleStatementRateBasedStatementCustomKeyQueryString {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#text_transformations: {
                        ...
                        <Vec<super::super::types::wafv2::RuleGroupRuleStatementRateBasedStatementCustomKeyQueryStringTextTransformation> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
