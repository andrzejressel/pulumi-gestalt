...
pub struct WebAclRuleStatementByteMatchStatementFieldToMatchHeader {
    ...
    pub r#match_pattern: Box<super::super::types::wafv2::WebAclRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WebAclRuleStatementByteMatchStatementFieldToMatchHeader {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WebAclRuleStatementByteMatchStatementFieldToMatchHeader {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#match_pattern: {
                        ...
                        <Box<super::super::types::wafv2::WebAclRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#match_scope: {
