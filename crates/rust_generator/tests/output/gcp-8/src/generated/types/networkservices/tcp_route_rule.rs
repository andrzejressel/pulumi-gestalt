...
pub struct TcpRouteRule {
    ...
    pub r#matches: Option<Vec<super::super::types::networkservices::TcpRouteRuleMatch>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TcpRouteRule {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for TcpRouteRule {
