...
pub struct AuthorizationPolicyRuleSource {
    ...
    pub r#ip_blocks: Option<Vec<String>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AuthorizationPolicyRuleSource {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AuthorizationPolicyRuleSource {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#ip_blocks: {
                        let field_value = match fields_map.get("ip_blocks") {
                            Some(value) => value,
                            None => bail!("Missing field 'ip_blocks' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
