...
pub struct PolicyBasedRouteWarning {
    ...
    #[builder(into)]
    pub r#data: Option<std::collections::BTreeMap<String, String>>,
    /// (Output)
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PolicyBasedRouteWarning {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PolicyBasedRouteWarning {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#warning_message: {
                        let field_value = match fields_map.get("warningMessage") {
                            Some(value) => value,
                            None => bail!("Missing field 'warningMessage' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
