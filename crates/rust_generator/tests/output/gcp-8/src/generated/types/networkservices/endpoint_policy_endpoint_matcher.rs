...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EndpointPolicyEndpointMatcher {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "metadata_label_matcher".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#metadata_label_matcher,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for EndpointPolicyEndpointMatcher {
