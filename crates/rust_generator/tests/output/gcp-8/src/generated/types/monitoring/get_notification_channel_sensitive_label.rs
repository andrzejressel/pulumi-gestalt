...
pub struct GetNotificationChannelSensitiveLabel {
    ...
    pub r#service_key: String,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetNotificationChannelSensitiveLabel {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetNotificationChannelSensitiveLabel {
