...
pub struct AuthorizationPolicyRuleDestinationHttpHeaderMatch {
    ...
    pub r#regex_match: String,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AuthorizationPolicyRuleDestinationHttpHeaderMatch {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AuthorizationPolicyRuleDestinationHttpHeaderMatch {
