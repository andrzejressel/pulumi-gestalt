...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AlertPolicyCondition {
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "condition_matched_log".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "condition_monitoring_query_language".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "condition_prometheus_query_language".to_string(),
                ToPulumiValue::to_pulumi_value(
