...
pub mod mirroring_deployment_group {
    ...
    pub struct MirroringDeploymentGroupResult {
        ...
        ///
        /// - - -
        pub mirroring_deployment_group_id: pulumi_gestalt_rust::Output<String>,
        /// (Output)
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &mirroring_deployment_group_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "network".into(),
        ...
        MirroringDeploymentGroupResult {
            ...
            mirroring_deployment_group_id: o.get_field("mirroringDeploymentGroupId"),
