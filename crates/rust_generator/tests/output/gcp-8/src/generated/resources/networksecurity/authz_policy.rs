...
pub mod authz_policy {
    ...
    fn __create(
        ...
        let custom_provider_binding = args.custom_provider.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let http_rules_binding = args.http_rules.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &custom_provider_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "httpRules".into(),
                    value: &http_rules_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "labels".into(),
        ...
        AuthzPolicyResult {
            ...
            http_rules: o.get_field("httpRules"),
