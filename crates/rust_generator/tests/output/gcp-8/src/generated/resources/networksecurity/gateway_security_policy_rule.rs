...
pub mod gateway_security_policy_rule {
    ...
    fn __create(
        ...
        let application_matcher_binding = args.application_matcher.get_output(ctx);
        let basic_profile_binding = args.basic_profile.get_output(ctx);
        ...
        let session_matcher_binding = args.session_matcher.get_output(ctx);
        let tls_inspection_enabled_binding = args.tls_inspection_enabled.get_output(ctx);
