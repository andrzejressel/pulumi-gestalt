...
pub mod runtime_iam_member {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct RuntimeIamMemberArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::Input<
            Option<super::super::types::notebooks::RuntimeIamMemberCondition>,
        >,
        ...
        #[builder(into)]
        pub runtime_name: pulumi_gestalt_rust::Input<String>,
    }
    #[allow(dead_code)]
    pub struct RuntimeIamMemberResult {
    ...
    fn __create(
        ...
        let runtime_name_binding = args.runtime_name.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:notebooks/runtimeIamMember:RuntimeIamMember".into(),
            name: name.to_string(),
