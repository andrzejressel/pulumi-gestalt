...
pub mod tls_inspection_policy {
    ...
    fn __create(
        ...
        let custom_tls_features_binding = args.custom_tls_features.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let exclude_public_ca_set_binding = args.exclude_public_ca_set.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let min_tls_version_binding = args.min_tls_version.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let project_binding = args.project.get_output(ctx);
        let tls_feature_profile_binding = args.tls_feature_profile.get_output(ctx);
        let trust_config_binding = args.trust_config.get_output(ctx);
