...
pub mod backup_policy {
    ...
    fn __create(
        ...
        let daily_backup_limit_binding = args.daily_backup_limit.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let enabled_binding = args.enabled.get_output(ctx);
        let labels_binding = args.labels.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let monthly_backup_limit_binding = args.monthly_backup_limit.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let project_binding = args.project.get_output(ctx);
        let weekly_backup_limit_binding = args.weekly_backup_limit.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &daily_backup_limit_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &monthly_backup_limit_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &weekly_backup_limit_binding.drop_type(),
                },
            ],
            options,
        };
