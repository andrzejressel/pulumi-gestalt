...
pub mod edge_cache_origin {
    ...
    pub struct EdgeCacheOriginArgs {
        ...
        pub aws_v4_authentication: pulumi_gestalt_rust::Input<
            Option<
        ...
        #[builder(into, default)]
        pub failover_origin: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub max_attempts: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into)]
        pub origin_address: pulumi_gestalt_rust::Input<String>,
        /// The override actions, including url rewrites and header
        /// additions, for requests that use this origin.
        /// Structure is documented below.
        #[builder(into, default)]
        pub origin_override_action: pulumi_gestalt_rust::Input<
            Option<
        ...
        /// Structure is documented below.
        #[builder(into, default)]
        pub origin_redirect: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub retry_conditions: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &aws_v4_authentication_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &failover_origin_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "labels".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &max_attempts_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &origin_address_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "originOverrideAction".into(),
                    value: &origin_override_action_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "originRedirect".into(),
                    value: &origin_redirect_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "port".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &retry_conditions_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "timeout".into(),
