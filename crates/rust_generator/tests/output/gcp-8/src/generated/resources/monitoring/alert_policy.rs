...
pub mod alert_policy {
    ...
    pub struct AlertPolicyArgs {
        ...
        pub alert_strategy: pulumi_gestalt_rust::Input<
        ...
        #[builder(into)]
        pub combiner: pulumi_gestalt_rust::Input<String>,
        ...
        /// documentation.
        #[builder(into, default)]
        pub documentation: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub notification_channels: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        #[builder(into, default)]
