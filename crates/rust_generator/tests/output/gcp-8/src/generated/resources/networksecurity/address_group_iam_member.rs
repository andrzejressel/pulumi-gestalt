...
pub mod address_group_iam_member {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct AddressGroupIamMemberArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::networksecurity::AddressGroupIamMemberCondition>,
        >,
    ...
    #[allow(dead_code)]
    pub struct AddressGroupIamMemberResult {
