...
pub mod intercept_deployment {
    ...
    pub struct InterceptDeploymentArgs {
        ...
        #[builder(into)]
        pub intercept_deployment_group: pulumi_gestalt_rust::Input<String>,
        ...
        /// - - -
        #[builder(into)]
        pub intercept_deployment_id: pulumi_gestalt_rust::Input<String>,
    ...
    fn __create(
        ...
        let forwarding_rule_binding = args.forwarding_rule.get_output(ctx);
