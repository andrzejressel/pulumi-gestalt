...
pub mod client_tls_policy {
    ...
    fn __create(
        ...
        let server_validation_cas_binding = args.server_validation_cas.get_output(ctx);
        let sni_binding = args.sni.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &server_validation_cas_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "sni".into(),
