...
pub mod uptime_check_config {
    ...
    pub struct UptimeCheckConfigArgs {
        ...
        pub checker_type: pulumi_gestalt_rust::Input<Option<String>>,
        /// The expected content on the page the check is run against. Currently, only the first entry in the list is supported, and other entries will be ignored. The server will look for an exact match of the string in the page response's content. This field is optional and should only be specified if a content match is required.
        /// Structure is documented below.
        #[builder(into, default)]
        pub content_matchers: pulumi_gestalt_rust::Input<
        ...
        /// Structure is documented below.
        #[builder(into, default)]
        pub http_check: pulumi_gestalt_rust::Input<
        ...
        /// uptime checks:
        #[builder(into, default)]
        pub monitored_resource: pulumi_gestalt_rust::Input<
        ...
        /// Structure is documented below.
        #[builder(into, default)]
        pub resource_group: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub selected_regions: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        /// A Synthetic Monitor deployed to a Cloud Functions V2 instance.
        /// Structure is documented below.
        #[builder(into, default)]
        pub synthetic_monitor: pulumi_gestalt_rust::Input<
            Option<super::super::types::monitoring::UptimeCheckConfigSyntheticMonitor>,
        >,
        /// Contains information needed to make a TCP check.
        /// Structure is documented below.
        #[builder(into, default)]
        pub tcp_check: pulumi_gestalt_rust::Input<
