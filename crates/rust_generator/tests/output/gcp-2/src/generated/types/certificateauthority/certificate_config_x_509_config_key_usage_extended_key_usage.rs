...
pub struct CertificateConfigX509ConfigKeyUsageExtendedKeyUsage {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CertificateConfigX509ConfigKeyUsageExtendedKeyUsage {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CertificateConfigX509ConfigKeyUsageExtendedKeyUsage {
