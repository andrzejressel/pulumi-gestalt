...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TriggerBuildArtifacts {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for TriggerBuildArtifacts {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#maven_artifacts: {
                        let field_value = match fields_map.get("mavenArtifacts") {
                            Some(value) => value,
                            None => bail!("Missing field 'mavenArtifacts' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#npm_packages: {
                        let field_value = match fields_map.get("npmPackages") {
                            Some(value) => value,
                            None => bail!("Missing field 'npmPackages' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#objects: {
