...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BlockchainNodesConnectionInfoEndpointInfo {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "json_rpc_api_endpoint".to_string(),
            ...
            map.insert(
                "websockets_api_endpoint".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BlockchainNodesConnectionInfoEndpointInfo {
