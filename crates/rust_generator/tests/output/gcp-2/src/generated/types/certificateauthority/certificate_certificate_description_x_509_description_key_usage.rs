...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CertificateCertificateDescriptionX509DescriptionKeyUsage {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CertificateCertificateDescriptionX509DescriptionKeyUsage {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#base_key_usages: {
                        let field_value = match fields_map.get("baseKeyUsages") {
                            Some(value) => value,
                            None => bail!("Missing field 'baseKeyUsages' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
