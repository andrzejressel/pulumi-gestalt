...
pub struct GetAuthorityConfigX509ConfigCaOption {
    ...
    pub r#max_issuer_path_length: i32,
    ...
    pub r#zero_max_issuer_path_length: bool,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetAuthorityConfigX509ConfigCaOption {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetAuthorityConfigX509ConfigCaOption {
