...
pub struct CertificateCertificateDescriptionX509Description {
    ...
    pub r#additional_extensions: Option<Vec<super::super::types::certificateauthority::CertificateCertificateDescriptionX509DescriptionAdditionalExtension>>,
    /// (Output)
    ...
    pub r#ca_options: Option<Vec<super::super::types::certificateauthority::CertificateCertificateDescriptionX509DescriptionCaOption>>,
    /// (Output)
    /// Indicates the intended use for keys that correspond to a certificate.
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "keyUsages")]
    pub r#key_usages: Option<Vec<super::super::types::certificateauthority::CertificateCertificateDescriptionX509DescriptionKeyUsage>>,
    /// (Output)
    /// Describes the X.509 name constraints extension.
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "nameConstraints")]
    pub r#name_constraints: Option<Vec<super::super::types::certificateauthority::CertificateCertificateDescriptionX509DescriptionNameConstraint>>,
    /// (Output)
    /// Describes the X.509 certificate policy object identifiers, per https://tools.ietf.org/html/rfc5280#section-4.2.1.4.
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "policyIds")]
    pub r#policy_ids: Option<Vec<super::super::types::certificateauthority::CertificateCertificateDescriptionX509DescriptionPolicyId>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CertificateCertificateDescriptionX509Description {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CertificateCertificateDescriptionX509Description {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#key_usages: {
                        let field_value = match fields_map.get("keyUsages") {
                            Some(value) => value,
                            None => bail!("Missing field 'keyUsages' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#name_constraints: {
