...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TargetCustomTarget {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "custom_target_type".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#custom_target_type,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for TargetCustomTarget {
