...
pub struct FunctionServiceConfigSecretVolume {
    ...
    #[builder(into)]
    pub r#versions: Option<Vec<super::super::types::cloudfunctionsv2::FunctionServiceConfigSecretVolumeVersion>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FunctionServiceConfigSecretVolume {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FunctionServiceConfigSecretVolume {
