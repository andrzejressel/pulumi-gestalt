...
pub struct GetFunctionEventTrigger {
    ...
    pub r#event_filters: Vec<super::super::types::cloudfunctionsv2::GetFunctionEventTriggerEventFilter>,
    ...
    pub r#trigger_region: String,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetFunctionEventTrigger {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetFunctionEventTrigger {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#trigger_region: {
                        let field_value = match fields_map.get("triggerRegion") {
                            Some(value) => value,
                            None => bail!("Missing field 'triggerRegion' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
