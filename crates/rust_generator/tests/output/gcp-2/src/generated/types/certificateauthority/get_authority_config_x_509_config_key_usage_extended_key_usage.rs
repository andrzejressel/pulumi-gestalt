...
pub struct GetAuthorityConfigX509ConfigKeyUsageExtendedKeyUsage {
    ...
    pub r#client_auth: bool,
    /// Corresponds to OID 1.3.6.1.5.5.7.3.3. Officially described as "Signing of downloadable executable code client authentication".
    #[builder(into)]
    #[serde(rename = "codeSigning")]
    pub r#code_signing: bool,
    /// Corresponds to OID 1.3.6.1.5.5.7.3.4. Officially described as "Email protection".
    #[builder(into)]
    #[serde(rename = "emailProtection")]
    pub r#email_protection: bool,
    /// Corresponds to OID 1.3.6.1.5.5.7.3.9. Officially described as "Signing OCSP responses".
    #[builder(into)]
    #[serde(rename = "ocspSigning")]
    pub r#ocsp_signing: bool,
    /// Corresponds to OID 1.3.6.1.5.5.7.3.1. Officially described as "TLS WWW server authentication", though regularly used for non-WWW TLS.
    #[builder(into)]
    #[serde(rename = "serverAuth")]
    pub r#server_auth: bool,
    /// Corresponds to OID 1.3.6.1.5.5.7.3.8. Officially described as "Binding the hash of an object to a time".
    #[builder(into)]
    #[serde(rename = "timeStamping")]
    pub r#time_stamping: bool,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetAuthorityConfigX509ConfigKeyUsageExtendedKeyUsage {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetAuthorityConfigX509ConfigKeyUsageExtendedKeyUsage {
