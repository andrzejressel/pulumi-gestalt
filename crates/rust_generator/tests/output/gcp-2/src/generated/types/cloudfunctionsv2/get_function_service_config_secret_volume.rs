...
pub struct GetFunctionServiceConfigSecretVolume {
    ...
    #[builder(into)]
    pub r#versions: Vec<super::super::types::cloudfunctionsv2::GetFunctionServiceConfigSecretVolumeVersion>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetFunctionServiceConfigSecretVolume {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetFunctionServiceConfigSecretVolume {
