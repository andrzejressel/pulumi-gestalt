...
pub struct CaPoolIssuancePolicyBaselineValuesKeyUsage {
    ...
    pub r#unknown_extended_key_usages: Option<Vec<super::super::types::certificateauthority::CaPoolIssuancePolicyBaselineValuesKeyUsageUnknownExtendedKeyUsage>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CaPoolIssuancePolicyBaselineValuesKeyUsage {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CaPoolIssuancePolicyBaselineValuesKeyUsage {
