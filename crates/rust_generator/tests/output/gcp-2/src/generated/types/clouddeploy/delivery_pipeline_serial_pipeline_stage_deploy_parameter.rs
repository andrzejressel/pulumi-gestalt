...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DeliveryPipelineSerialPipelineStageDeployParameter {
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "match_target_labels".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#match_target_labels,
                )
                .await,
            );
            map.insert(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DeliveryPipelineSerialPipelineStageDeployParameter {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#match_target_labels: {
                        let field_value = match fields_map.get("match_target_labels") {
                            Some(value) => value,
                            None => bail!("Missing field 'match_target_labels' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
