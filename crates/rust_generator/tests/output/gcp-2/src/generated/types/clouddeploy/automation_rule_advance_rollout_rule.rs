...
pub struct AutomationRuleAdvanceRolloutRule {
    ...
    pub r#source_phases: Option<Vec<String>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AutomationRuleAdvanceRolloutRule {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AutomationRuleAdvanceRolloutRule {
