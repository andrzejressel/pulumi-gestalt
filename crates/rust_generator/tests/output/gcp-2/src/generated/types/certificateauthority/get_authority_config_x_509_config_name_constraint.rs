...
pub struct GetAuthorityConfigX509ConfigNameConstraint {
    ...
    pub r#excluded_dns_names: Vec<String>,
    ...
    pub r#excluded_email_addresses: Vec<String>,
    ...
    pub r#excluded_ip_ranges: Vec<String>,
    /// Contains the excluded URIs that apply to the host part of the name.
    /// The value can be a hostname or a domain with a
    /// leading period (like '.example.com')
    #[builder(into)]
    #[serde(rename = "excludedUris")]
    pub r#excluded_uris: Vec<String>,
    ...
    pub r#permitted_dns_names: Vec<String>,
    ...
    pub r#permitted_email_addresses: Vec<String>,
    ...
    pub r#permitted_ip_ranges: Vec<String>,
    /// Contains the permitted URIs that apply to the host part of the name.
    /// The value can be a hostname or a domain with a
    /// leading period (like '.example.com')
    #[builder(into)]
    #[serde(rename = "permittedUris")]
    pub r#permitted_uris: Vec<String>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetAuthorityConfigX509ConfigNameConstraint {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetAuthorityConfigX509ConfigNameConstraint {
