...
pub mod ca_pool {
    ...
    fn __create(
        ...
        let issuance_policy_binding = args.issuance_policy.get_output(ctx);
        let labels_binding = args.labels.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let project_binding = args.project.get_output(ctx);
        let publishing_options_binding = args.publishing_options.get_output(ctx);
        ...
        CaPoolResult {
            ...
            publishing_options: o.get_field("publishingOptions"),
