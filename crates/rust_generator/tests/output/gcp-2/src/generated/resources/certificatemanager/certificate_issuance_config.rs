...
pub mod certificate_issuance_config {
    ...
    pub struct CertificateIssuanceConfigArgs {
        ...
        #[builder(into)]
        pub certificate_authority_config: pulumi_gestalt_rust::Input<
        ...
        #[builder(into)]
        pub key_algorithm: pulumi_gestalt_rust::Input<String>,
        ...
        #[builder(into)]
        pub lifetime: pulumi_gestalt_rust::Input<String>,
        ...
        #[builder(into)]
        pub rotation_window_percentage: pulumi_gestalt_rust::Input<i32>,
    }
    #[allow(dead_code)]
