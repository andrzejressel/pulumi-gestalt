...
pub mod function_iam_binding {
    ...
    pub struct FunctionIamBindingArgs {
        ...
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::cloudfunctionsv2::FunctionIamBindingCondition>,
        >,
    ...
    fn __create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:cloudfunctionsv2/functionIamBinding:FunctionIamBinding".into(),
            name: name.to_string(),
