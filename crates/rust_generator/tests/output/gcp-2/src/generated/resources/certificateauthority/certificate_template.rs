...
pub mod certificate_template {
    ...
    pub struct CertificateTemplateArgs {
        ...
        #[builder(into, default)]
        pub identity_constraints: pulumi_gestalt_rust::Input<
            Option<
        ...
        #[builder(into, default)]
        pub maximum_lifetime: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        /// Structure is documented below.
        #[builder(into, default)]
        pub passthrough_extensions: pulumi_gestalt_rust::Input<
            Option<
        ...
        /// Structure is documented below.
        #[builder(into, default)]
        pub predefined_values: pulumi_gestalt_rust::Input<
            Option<
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &identity_constraints_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "labels".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &maximum_lifetime_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &passthrough_extensions_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "predefinedValues".into(),
                    value: &predefined_values_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "project".into(),
