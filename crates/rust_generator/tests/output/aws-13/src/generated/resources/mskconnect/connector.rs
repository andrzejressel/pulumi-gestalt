...
pub mod connector {
    ...
    fn __create(
        ...
        let kafka_cluster_binding = args.kafka_cluster.get_output(ctx);
        ...
        let kafka_cluster_encryption_in_transit_binding = args
            ...
            .get_output(ctx);
        let kafkaconnect_version_binding = args.kafkaconnect_version.get_output(ctx);
        let log_delivery_binding = args.log_delivery.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let plugins_binding = args.plugins.get_output(ctx);
        let service_execution_role_arn_binding = args
            .service_execution_role_arn
            .get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let worker_configuration_binding = args.worker_configuration.get_output(ctx);
