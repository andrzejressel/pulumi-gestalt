...
pub mod replicator {
    ...
    fn __create(
        ...
        let kafka_clusters_binding = args.kafka_clusters.get_output(ctx);
        let replication_info_list_binding = args.replication_info_list.get_output(ctx);
        let replicator_name_binding = args.replicator_name.get_output(ctx);
