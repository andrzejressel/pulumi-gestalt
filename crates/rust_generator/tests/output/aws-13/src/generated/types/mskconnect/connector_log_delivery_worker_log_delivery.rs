            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#cloudwatch_logs: {
                        ...
                        <Option<Box<super::super::types::mskconnect::ConnectorLogDeliveryWorkerLogDeliveryCloudwatchLogs>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#firehose: {
                        ...
                        <Option<Box<super::super::types::mskconnect::ConnectorLogDeliveryWorkerLogDeliveryFirehose>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#s_3: {
                        ...
                        <Option<Box<super::super::types::mskconnect::ConnectorLogDeliveryWorkerLogDeliveryS3>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
