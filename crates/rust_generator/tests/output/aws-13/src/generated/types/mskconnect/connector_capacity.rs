            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#provisioned_capacity: {
                        let field_value = match fields_map.get("provisionedCapacity") {
                            Some(value) => value,
                            None => bail!("Missing field 'provisionedCapacity' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
