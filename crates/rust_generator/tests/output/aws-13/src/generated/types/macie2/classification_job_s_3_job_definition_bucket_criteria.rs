...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClassificationJobS3JobDefinitionBucketCriteria {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("excludes".to_string(), self.r#excludes.to_pulumi_value().await);
            map.insert("includes".to_string(), self.r#includes.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ClassificationJobS3JobDefinitionBucketCriteria {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#excludes: {
                        ...
                        <Option<Box<super::super::types::macie2::ClassificationJobS3JobDefinitionBucketCriteriaExcludes>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#includes: {
                        ...
                        <Option<Box<super::super::types::macie2::ClassificationJobS3JobDefinitionBucketCriteriaIncludes>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
