            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#simple_scope_term: {
                        ...
                        <Option<Box<super::super::types::macie2::ClassificationJobS3JobDefinitionScopingExcludesAndSimpleScopeTerm>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#tag_scope_term: {
                        ...
                        <Option<Box<super::super::types::macie2::ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTerm>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
