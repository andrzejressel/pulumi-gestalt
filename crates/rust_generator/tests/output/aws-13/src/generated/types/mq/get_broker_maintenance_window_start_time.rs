...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetBrokerMaintenanceWindowStartTime {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("time_of_day".to_string(), self.r#time_of_day.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetBrokerMaintenanceWindowStartTime {
