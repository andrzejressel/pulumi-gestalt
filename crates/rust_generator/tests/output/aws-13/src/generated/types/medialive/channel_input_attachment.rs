...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ChannelInputAttachment {
    ...
    > {
        async move {
            ...
            map.insert("automatic_input_failover_settings".to_string(), self.r#automatic_input_failover_settings.to_pulumi_value().await);
            map.insert("input_attachment_name".to_string(), self.r#input_attachment_name.to_pulumi_value().await);
            map.insert("input_id".to_string(), self.r#input_id.to_pulumi_value().await);
            map.insert("input_settings".to_string(), self.r#input_settings.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#automatic_input_failover_settings: {
                        ...
                        <Option<Box<super::super::types::medialive::ChannelInputAttachmentAutomaticInputFailoverSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    ...
                    r#input_settings: {
                        ...
                        <Option<Box<super::super::types::medialive::ChannelInputAttachmentInputSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
