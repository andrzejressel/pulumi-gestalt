...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ChannelEncoderSettingsMotionGraphicsConfigurationMotionGraphicsSettings {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "html_motion_graphics_settings".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#html_motion_graphics_settings,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ChannelEncoderSettingsMotionGraphicsConfigurationMotionGraphicsSettings {
