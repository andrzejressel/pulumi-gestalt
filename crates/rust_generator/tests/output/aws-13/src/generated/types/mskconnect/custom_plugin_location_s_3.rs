...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CustomPluginLocationS3 {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("object_version".to_string(), self.r#object_version.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CustomPluginLocationS3 {
