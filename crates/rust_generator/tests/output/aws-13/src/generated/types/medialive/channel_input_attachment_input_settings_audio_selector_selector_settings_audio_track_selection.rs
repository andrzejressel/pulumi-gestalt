    ...
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#dolby_e_decode: {
                        let field_value = match fields_map.get("dolbyEDecode") {
                            Some(value) => value,
                            None => bail!("Missing field 'dolbyEDecode' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
