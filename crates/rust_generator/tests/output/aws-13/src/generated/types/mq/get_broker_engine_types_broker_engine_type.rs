...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetBrokerEngineTypesBrokerEngineType {
    ...
    > {
        async move {
            ...
            map.insert("engine_versions".to_string(), self.r#engine_versions.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#engine_versions: {
                        ...
                        <Vec<super::super::types::mq::GetBrokerEngineTypesBrokerEngineTypeEngineVersion> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
