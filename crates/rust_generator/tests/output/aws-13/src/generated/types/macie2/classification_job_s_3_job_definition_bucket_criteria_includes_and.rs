            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#simple_criterion: {
                        ...
                        <Option<Box<super::super::types::macie2::ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndSimpleCriterion>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#tag_criterion: {
                        ...
                        <Option<Box<super::super::types::macie2::ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndTagCriterion>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
