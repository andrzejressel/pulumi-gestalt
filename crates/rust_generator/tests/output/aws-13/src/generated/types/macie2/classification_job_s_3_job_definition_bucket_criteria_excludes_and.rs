...
pub struct ClassificationJobS3JobDefinitionBucketCriteriaExcludesAnd {
    ...
    pub r#simple_criterion: Box<Option<super::super::types::macie2::ClassificationJobS3JobDefinitionBucketCriteriaExcludesAndSimpleCriterion>>,
    ...
    pub r#tag_criterion: Box<Option<super::super::types::macie2::ClassificationJobS3JobDefinitionBucketCriteriaExcludesAndTagCriterion>>,
}
