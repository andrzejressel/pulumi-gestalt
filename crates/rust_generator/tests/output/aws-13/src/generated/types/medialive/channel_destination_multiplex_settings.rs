...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ChannelDestinationMultiplexSettings {
    ...
    > {
        async move {
            ...
            map.insert("multiplex_id".to_string(), self.r#multiplex_id.to_pulumi_value().await);
            map.insert("program_name".to_string(), self.r#program_name.to_pulumi_value().await);
