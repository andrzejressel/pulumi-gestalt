...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ChannelEncoderSettingsAudioDescriptionRemixSettingsChannelMapping {
    ...
    > {
        async move {
            ...
            map.insert("input_channel_levels".to_string(), self.r#input_channel_levels.to_pulumi_value().await);
            map.insert("output_channel".to_string(), self.r#output_channel.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#input_channel_levels: {
                        ...
                        <Vec<super::super::types::medialive::ChannelEncoderSettingsAudioDescriptionRemixSettingsChannelMappingInputChannelLevel> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#output_channel: {
