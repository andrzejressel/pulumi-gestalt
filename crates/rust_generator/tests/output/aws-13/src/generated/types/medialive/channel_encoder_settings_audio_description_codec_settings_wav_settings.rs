...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ChannelEncoderSettingsAudioDescriptionCodecSettingsWavSettings {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("bit_depth".to_string(), self.r#bit_depth.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ChannelEncoderSettingsAudioDescriptionCodecSettingsWavSettings {
