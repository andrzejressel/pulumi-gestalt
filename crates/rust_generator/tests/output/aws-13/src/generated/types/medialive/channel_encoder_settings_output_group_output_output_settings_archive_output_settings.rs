...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettings {
    ...
    > {
        async move {
            ...
            map.insert("extension".to_string(), self.r#extension.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#container_settings: {
                        ...
                        <Option<Box<super::super::types::medialive::ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#extension: {
