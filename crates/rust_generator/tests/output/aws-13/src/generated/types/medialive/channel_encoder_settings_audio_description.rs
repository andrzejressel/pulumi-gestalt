...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ChannelEncoderSettingsAudioDescription {
    ...
    > {
        async move {
            ...
            map.insert("audio_normalization_settings".to_string(), self.r#audio_normalization_settings.to_pulumi_value().await);
            map.insert("audio_selector_name".to_string(), self.r#audio_selector_name.to_pulumi_value().await);
            map.insert("audio_type".to_string(), self.r#audio_type.to_pulumi_value().await);
            map.insert("audio_type_control".to_string(), self.r#audio_type_control.to_pulumi_value().await);
            map.insert("audio_watermark_settings".to_string(), self.r#audio_watermark_settings.to_pulumi_value().await);
            map.insert("codec_settings".to_string(), self.r#codec_settings.to_pulumi_value().await);
            map.insert("language_code".to_string(), self.r#language_code.to_pulumi_value().await);
            map.insert("language_code_control".to_string(), self.r#language_code_control.to_pulumi_value().await);
            map.insert("name".to_string(), self.r#name.to_pulumi_value().await);
            map.insert("remix_settings".to_string(), self.r#remix_settings.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#audio_normalization_settings: {
                        ...
                        <Option<Box<super::super::types::medialive::ChannelEncoderSettingsAudioDescriptionAudioNormalizationSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    ...
                    r#audio_watermark_settings: {
                        ...
                        <Option<Box<super::super::types::medialive::ChannelEncoderSettingsAudioDescriptionAudioWatermarkSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#codec_settings: {
                        ...
                        <Option<Box<super::super::types::medialive::ChannelEncoderSettingsAudioDescriptionCodecSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#language_code: {
                    ...
                    r#remix_settings: {
                        ...
                        <Option<Box<super::super::types::medialive::ChannelEncoderSettingsAudioDescriptionRemixSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#stream_name: {
