...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettingsHlsSettings {
    ...
    > {
        async move {
            ...
            map.insert("audio_only_hls_settings".to_string(), self.r#audio_only_hls_settings.to_pulumi_value().await);
            map.insert("fmp_4_hls_settings".to_string(), self.r#fmp_4_hls_settings.to_pulumi_value().await);
            map.insert("frame_capture_hls_settings".to_string(), self.r#frame_capture_hls_settings.to_pulumi_value().await);
            map.insert("standard_hls_settings".to_string(), self.r#standard_hls_settings.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#audio_only_hls_settings: {
                        ...
                        <Option<Box<super::super::types::medialive::ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettingsHlsSettingsAudioOnlyHlsSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#fmp_4_hls_settings: {
                        ...
                        <Option<Box<super::super::types::medialive::ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettingsHlsSettingsFmp4HlsSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#frame_capture_hls_settings: {
                        ...
                        <Option<Box<super::super::types::medialive::ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettingsHlsSettingsFrameCaptureHlsSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#standard_hls_settings: {
                        ...
                        <Option<Box<super::super::types::medialive::ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettingsHlsSettingsStandardHlsSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
