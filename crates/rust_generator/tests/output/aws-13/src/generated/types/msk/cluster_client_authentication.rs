...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClusterClientAuthentication {
    ...
    > {
        async move {
            ...
            map.insert("unauthenticated".to_string(), self.r#unauthenticated.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#sasl: {
                        ...
                        <Option<Box<super::super::types::msk::ClusterClientAuthenticationSasl>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#tls: {
                        ...
                        <Option<Box<super::super::types::msk::ClusterClientAuthenticationTls>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#unauthenticated: {
