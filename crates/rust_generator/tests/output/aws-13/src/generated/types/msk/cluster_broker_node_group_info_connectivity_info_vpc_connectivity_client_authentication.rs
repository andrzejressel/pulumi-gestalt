...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClusterBrokerNodeGroupInfoConnectivityInfoVpcConnectivityClientAuthentication {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("sasl".to_string(), self.r#sasl.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ClusterBrokerNodeGroupInfoConnectivityInfoVpcConnectivityClientAuthentication {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#sasl: {
                        ...
                        <Option<Box<super::super::types::msk::ClusterBrokerNodeGroupInfoConnectivityInfoVpcConnectivityClientAuthenticationSasl>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#tls: {
