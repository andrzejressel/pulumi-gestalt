...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettingsHlsSettingsAudioOnlyHlsSettings {
    ...
    > {
        async move {
            ...
            map.insert("audio_group_id".to_string(), self.r#audio_group_id.to_pulumi_value().await);
            map.insert("audio_only_image".to_string(), self.r#audio_only_image.to_pulumi_value().await);
            map.insert("audio_track_type".to_string(), self.r#audio_track_type.to_pulumi_value().await);
            map.insert("segment_type".to_string(), self.r#segment_type.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#audio_only_image: {
                        ...
                        <Option<Box<super::super::types::medialive::ChannelEncoderSettingsOutputGroupOutputOutputSettingsHlsOutputSettingsHlsSettingsAudioOnlyHlsSettingsAudioOnlyImage>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#audio_track_type: {
