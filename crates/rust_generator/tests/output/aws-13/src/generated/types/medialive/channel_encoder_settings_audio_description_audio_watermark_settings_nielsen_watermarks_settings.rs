...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ChannelEncoderSettingsAudioDescriptionAudioWatermarkSettingsNielsenWatermarksSettings {
    ...
    > {
        async move {
            ...
            map.insert("nielsen_cbet_settings".to_string(), self.r#nielsen_cbet_settings.to_pulumi_value().await);
            map.insert("nielsen_distribution_type".to_string(), self.r#nielsen_distribution_type.to_pulumi_value().await);
            map.insert("nielsen_naes_ii_nw_settings".to_string(), self.r#nielsen_naes_ii_nw_settings.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#nielsen_cbet_settings: {
                        ...
                        <Option<Box<super::super::types::medialive::ChannelEncoderSettingsAudioDescriptionAudioWatermarkSettingsNielsenWatermarksSettingsNielsenCbetSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    ...
                    r#nielsen_naes_ii_nw_settings: {
                        ...
                        <Option<Vec<super::super::types::medialive::ChannelEncoderSettingsAudioDescriptionAudioWatermarkSettingsNielsenWatermarksSettingsNielsenNaesIiNwSetting>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
