...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BrokerInstance {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("console_url".to_string(), self.r#console_url.to_pulumi_value().await);
            map.insert("endpoints".to_string(), self.r#endpoints.to_pulumi_value().await);
            map.insert("ip_address".to_string(), self.r#ip_address.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BrokerInstance {
