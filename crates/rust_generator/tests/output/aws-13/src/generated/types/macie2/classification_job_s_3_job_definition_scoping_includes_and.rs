...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClassificationJobS3JobDefinitionScopingIncludesAnd {
    ...
    > {
        async move {
            ...
            map.insert("simple_scope_term".to_string(), self.r#simple_scope_term.to_pulumi_value().await);
            map.insert("tag_scope_term".to_string(), self.r#tag_scope_term.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#simple_scope_term: {
                        ...
                        <Option<Box<super::super::types::macie2::ClassificationJobS3JobDefinitionScopingIncludesAndSimpleScopeTerm>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#tag_scope_term: {
                        ...
                        <Option<Box<super::super::types::macie2::ClassificationJobS3JobDefinitionScopingIncludesAndTagScopeTerm>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
