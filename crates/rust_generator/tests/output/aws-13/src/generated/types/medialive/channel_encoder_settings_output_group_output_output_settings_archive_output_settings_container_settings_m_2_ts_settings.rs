...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2TsSettings {
    ...
    > {
        async move {
            ...
            map.insert("absent_input_audio_behavior".to_string(), self.r#absent_input_audio_behavior.to_pulumi_value().await);
            map.insert("arib".to_string(), self.r#arib.to_pulumi_value().await);
            map.insert("arib_captions_pid".to_string(), self.r#arib_captions_pid.to_pulumi_value().await);
            map.insert("arib_captions_pid_control".to_string(), self.r#arib_captions_pid_control.to_pulumi_value().await);
            map.insert("audio_buffer_model".to_string(), self.r#audio_buffer_model.to_pulumi_value().await);
            ...
            map.insert("audio_stream_type".to_string(), self.r#audio_stream_type.to_pulumi_value().await);
            map.insert("bitrate".to_string(), self.r#bitrate.to_pulumi_value().await);
            map.insert("buffer_model".to_string(), self.r#buffer_model.to_pulumi_value().await);
            map.insert("cc_descriptor".to_string(), self.r#cc_descriptor.to_pulumi_value().await);
            map.insert("dvb_nit_settings".to_string(), self.r#dvb_nit_settings.to_pulumi_value().await);
            map.insert("dvb_sdt_settings".to_string(), self.r#dvb_sdt_settings.to_pulumi_value().await);
            map.insert("dvb_sub_pids".to_string(), self.r#dvb_sub_pids.to_pulumi_value().await);
            map.insert("dvb_tdt_settings".to_string(), self.r#dvb_tdt_settings.to_pulumi_value().await);
            map.insert("dvb_teletext_pid".to_string(), self.r#dvb_teletext_pid.to_pulumi_value().await);
            map.insert("ebif".to_string(), self.r#ebif.to_pulumi_value().await);
            map.insert("ebp_audio_interval".to_string(), self.r#ebp_audio_interval.to_pulumi_value().await);
            map.insert("ebp_lookahead_ms".to_string(), self.r#ebp_lookahead_ms.to_pulumi_value().await);
            map.insert("ebp_placement".to_string(), self.r#ebp_placement.to_pulumi_value().await);
            map.insert("ecm_pid".to_string(), self.r#ecm_pid.to_pulumi_value().await);
            map.insert("es_rate_in_pes".to_string(), self.r#es_rate_in_pes.to_pulumi_value().await);
            map.insert("etv_platform_pid".to_string(), self.r#etv_platform_pid.to_pulumi_value().await);
            map.insert("etv_signal_pid".to_string(), self.r#etv_signal_pid.to_pulumi_value().await);
            map.insert("fragment_time".to_string(), self.r#fragment_time.to_pulumi_value().await);
            map.insert("klv".to_string(), self.r#klv.to_pulumi_value().await);
            map.insert("klv_data_pids".to_string(), self.r#klv_data_pids.to_pulumi_value().await);
            map.insert("nielsen_id_3_behavior".to_string(), self.r#nielsen_id_3_behavior.to_pulumi_value().await);
            map.insert("null_packet_bitrate".to_string(), self.r#null_packet_bitrate.to_pulumi_value().await);
            ...
            map.insert("rate_mode".to_string(), self.r#rate_mode.to_pulumi_value().await);
            map.insert("scte_27_pids".to_string(), self.r#scte_27_pids.to_pulumi_value().await);
            map.insert("scte_35_control".to_string(), self.r#scte_35_control.to_pulumi_value().await);
            map.insert("scte_35_pid".to_string(), self.r#scte_35_pid.to_pulumi_value().await);
            map.insert("segmentation_markers".to_string(), self.r#segmentation_markers.to_pulumi_value().await);
            map.insert("segmentation_style".to_string(), self.r#segmentation_style.to_pulumi_value().await);
            map.insert("segmentation_time".to_string(), self.r#segmentation_time.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#dvb_nit_settings: {
                        ...
                        <Option<Box<super::super::types::medialive::ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2TsSettingsDvbNitSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#dvb_sdt_settings: {
                        ...
                        <Option<Box<super::super::types::medialive::ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2TsSettingsDvbSdtSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#dvb_sub_pids: {
                    ...
                    r#dvb_tdt_settings: {
                        ...
                        <Option<Box<super::super::types::medialive::ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2TsSettingsDvbTdtSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#dvb_teletext_pid: {
