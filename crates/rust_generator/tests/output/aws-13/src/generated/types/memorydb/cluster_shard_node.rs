...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClusterShardNode {
    ...
    > {
        async move {
            ...
            map.insert("create_time".to_string(), self.r#create_time.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#endpoints: {
                        ...
                        <Option<Vec<super::super::types::memorydb::ClusterShardNodeEndpoint>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#name: {
