...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ChannelInputAttachmentInputSettingsNetworkInputSettings {
    ...
    > {
        async move {
            ...
            map.insert("hls_input_settings".to_string(), self.r#hls_input_settings.to_pulumi_value().await);
            map.insert("server_validation".to_string(), self.r#server_validation.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#hls_input_settings: {
                        ...
                        <Option<Box<super::super::types::medialive::ChannelInputAttachmentInputSettingsNetworkInputSettingsHlsInputSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#server_validation: {
