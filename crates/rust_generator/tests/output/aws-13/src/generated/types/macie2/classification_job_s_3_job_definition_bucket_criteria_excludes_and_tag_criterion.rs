...
pub struct ClassificationJobS3JobDefinitionBucketCriteriaExcludesAndTagCriterion {
    ...
    pub r#tag_values: Option<Vec<super::super::types::macie2::ClassificationJobS3JobDefinitionBucketCriteriaExcludesAndTagCriterionTagValue>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClassificationJobS3JobDefinitionBucketCriteriaExcludesAndTagCriterion {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ClassificationJobS3JobDefinitionBucketCriteriaExcludesAndTagCriterion {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#tag_values: {
                        ...
                        <Option<Vec<super::super::types::macie2::ClassificationJobS3JobDefinitionBucketCriteriaExcludesAndTagCriterionTagValue>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
