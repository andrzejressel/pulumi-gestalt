...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettings {
    ...
    > {
        async move {
            ...
            map.insert("raw_settings".to_string(), self.r#raw_settings.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#m_2_ts_settings: {
                        ...
                        <Option<Box<super::super::types::medialive::ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsM2TsSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#raw_settings: {
                        ...
                        <Option<Box<super::super::types::medialive::ChannelEncoderSettingsOutputGroupOutputOutputSettingsArchiveOutputSettingsContainerSettingsRawSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
