...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BrokerUser {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("console_access".to_string(), self.r#console_access.to_pulumi_value().await);
            map.insert("groups".to_string(), self.r#groups.to_pulumi_value().await);
            map.insert("password".to_string(), self.r#password.to_pulumi_value().await);
            map.insert("replication_user".to_string(), self.r#replication_user.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BrokerUser {
