...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ChannelEncoderSettingsCaptionDescriptionDestinationSettingsEbuTtDDestinationSettings {
    ...
    > {
        async move {
            ...
            map.insert("copyright_holder".to_string(), self.r#copyright_holder.to_pulumi_value().await);
            map.insert("fill_line_gap".to_string(), self.r#fill_line_gap.to_pulumi_value().await);
            map.insert("font_family".to_string(), self.r#font_family.to_pulumi_value().await);
