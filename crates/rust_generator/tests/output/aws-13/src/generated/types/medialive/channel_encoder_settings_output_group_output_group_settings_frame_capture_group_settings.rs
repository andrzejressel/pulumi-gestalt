...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ChannelEncoderSettingsOutputGroupOutputGroupSettingsFrameCaptureGroupSettings {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("frame_capture_cdn_settings".to_string(), self.r#frame_capture_cdn_settings.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ChannelEncoderSettingsOutputGroupOutputGroupSettingsFrameCaptureGroupSettings {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#destination: {
                        ...
                        <Box<super::super::types::medialive::ChannelEncoderSettingsOutputGroupOutputGroupSettingsFrameCaptureGroupSettingsDestination> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#frame_capture_cdn_settings: {
                        ...
                        <Option<Box<super::super::types::medialive::ChannelEncoderSettingsOutputGroupOutputGroupSettingsFrameCaptureGroupSettingsFrameCaptureCdnSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
