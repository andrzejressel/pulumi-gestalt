...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for MultiplexMultiplexSettings {
    ...
    > {
        async move {
            ...
            map.insert("maximum_video_buffer_delay_milliseconds".to_string(), self.r#maximum_video_buffer_delay_milliseconds.to_pulumi_value().await);
            map.insert("transport_stream_bitrate".to_string(), self.r#transport_stream_bitrate.to_pulumi_value().await);
            map.insert("transport_stream_id".to_string(), self.r#transport_stream_id.to_pulumi_value().await);
            map.insert("transport_stream_reserved_bitrate".to_string(), self.r#transport_stream_reserved_bitrate.to_pulumi_value().await);
