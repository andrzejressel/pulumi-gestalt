...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetClusterBrokerNodeGroupInfoStorageInfoEbsStorageInfo {
    ...
    > {
        async move {
            ...
            map.insert("provisioned_throughputs".to_string(), self.r#provisioned_throughputs.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#provisioned_throughputs: {
                        ...
                        <Vec<super::super::types::msk::GetClusterBrokerNodeGroupInfoStorageInfoEbsStorageInfoProvisionedThroughput> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#volume_size: {
