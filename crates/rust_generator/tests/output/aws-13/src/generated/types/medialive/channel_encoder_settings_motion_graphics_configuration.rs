...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ChannelEncoderSettingsMotionGraphicsConfiguration {
    ...
    > {
        async move {
            ...
            map.insert("motion_graphics_insertion".to_string(), self.r#motion_graphics_insertion.to_pulumi_value().await);
            map.insert("motion_graphics_settings".to_string(), self.r#motion_graphics_settings.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#motion_graphics_settings: {
                        ...
                        <Box<super::super::types::medialive::ChannelEncoderSettingsMotionGraphicsConfigurationMotionGraphicsSettings> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
