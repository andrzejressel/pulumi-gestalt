...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClassificationJobUserPausedDetail {
    ...
    > {
        async move {
            ...
            map.insert("job_expires_at".to_string(), self.r#job_expires_at.to_pulumi_value().await);
            map.insert("job_imminent_expiration_health_event_arn".to_string(), self.r#job_imminent_expiration_health_event_arn.to_pulumi_value().await);
            map.insert("job_paused_at".to_string(), self.r#job_paused_at.to_pulumi_value().await);
