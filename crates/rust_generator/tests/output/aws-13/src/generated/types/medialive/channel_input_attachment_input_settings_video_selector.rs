...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ChannelInputAttachmentInputSettingsVideoSelector {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("color_space".to_string(), self.r#color_space.to_pulumi_value().await);
            map.insert("color_space_usage".to_string(), self.r#color_space_usage.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ChannelInputAttachmentInputSettingsVideoSelector {
