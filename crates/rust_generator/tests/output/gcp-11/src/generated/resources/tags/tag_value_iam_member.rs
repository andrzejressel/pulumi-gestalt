...
pub mod tag_value_iam_member {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct TagValueIamMemberArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::tags::TagValueIamMemberCondition>,
        >,
    ...
    #[allow(dead_code)]
    pub struct TagValueIamMemberResult {
