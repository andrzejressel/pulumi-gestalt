...
pub mod ai_feature_store {
    ...
    pub struct AiFeatureStoreArgs {
        ...
        /// Structure is documented below.
        #[builder(into, default)]
        pub online_serving_config: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub online_storage_ttl_days: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &online_serving_config_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "onlineStorageTtlDays".into(),
                    value: &online_storage_ttl_days_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "project".into(),
