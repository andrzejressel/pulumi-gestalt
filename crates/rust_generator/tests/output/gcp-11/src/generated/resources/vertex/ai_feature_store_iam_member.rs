...
pub mod ai_feature_store_iam_member {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct AiFeatureStoreIamMemberArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::vertex::AiFeatureStoreIamMemberCondition>,
        >,
    ...
    #[allow(dead_code)]
    pub struct AiFeatureStoreIamMemberResult {
    ...
    fn __create(
        ...
        let featurestore_binding = args.featurestore.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:vertex/aiFeatureStoreIamMember:AiFeatureStoreIamMember".into(),
            name: name.to_string(),
