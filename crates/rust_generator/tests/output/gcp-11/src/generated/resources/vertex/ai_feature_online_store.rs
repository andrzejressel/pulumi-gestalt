...
pub mod ai_feature_online_store {
    ...
    fn __create(
        ...
        let bigtable_binding = args.bigtable.get_output(ctx);
        let dedicated_serving_endpoint_binding = args
            .dedicated_serving_endpoint
            .get_output(ctx);
        let embedding_management_binding = args.embedding_management.get_output(ctx);
        let force_destroy_binding = args.force_destroy.get_output(ctx);
        let labels_binding = args.labels.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let optimized_binding = args.optimized.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "bigtable".into(),
                    value: &bigtable_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "dedicatedServingEndpoint".into(),
                    value: &dedicated_serving_endpoint_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "embeddingManagement".into(),
                    value: &embedding_management_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "optimized".into(),
                    value: &optimized_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "project".into(),
