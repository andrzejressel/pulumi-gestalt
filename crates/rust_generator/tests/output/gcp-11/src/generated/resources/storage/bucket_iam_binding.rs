...
pub mod bucket_iam_binding {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct BucketIAMBindingArgs {
        ...
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::storage::BucketIamBindingCondition>,
        >,
    ...
    #[allow(dead_code)]
    pub struct BucketIAMBindingResult {
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:storage/bucketIAMBinding:BucketIAMBinding".into(),
            name: name.to_string(),
