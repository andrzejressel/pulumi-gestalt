...
pub mod transfer_job {
    ...
    fn __create(
        ...
        let event_stream_binding = args.event_stream.get_output(ctx);
        ...
        let transfer_spec_binding = args.transfer_spec.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &event_stream_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
