...
pub struct GetDatabaseInstanceSettingIpConfiguration {
    ...
    pub r#authorized_networks: Vec<super::super::types::sql::GetDatabaseInstanceSettingIpConfigurationAuthorizedNetwork>,
    ...
    pub r#psc_configs: Vec<super::super::types::sql::GetDatabaseInstanceSettingIpConfigurationPscConfig>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetDatabaseInstanceSettingIpConfiguration {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetDatabaseInstanceSettingIpConfiguration {
