...
pub struct AiIndexMetadataConfig {
    ...
    #[builder(into)]
    pub r#approximate_neighbors_count: Option<i32>,
    ...
    #[builder(into)]
    pub r#feature_norm_type: Option<String>,
    ...
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#algorithm_config: {
                        let field_value = match fields_map.get("algorithmConfig") {
                            Some(value) => value,
                            None => bail!("Missing field 'algorithmConfig' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
