...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for InstanceAutoscalingConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "asymmetric_autoscaling_options".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for InstanceAutoscalingConfig {
