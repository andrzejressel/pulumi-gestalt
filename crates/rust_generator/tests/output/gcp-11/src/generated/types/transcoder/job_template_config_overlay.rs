...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for JobTemplateConfigOverlay {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for JobTemplateConfigOverlay {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#animations: {
                        let field_value = match fields_map.get("animations") {
                            Some(value) => value,
                            None => bail!("Missing field 'animations' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
