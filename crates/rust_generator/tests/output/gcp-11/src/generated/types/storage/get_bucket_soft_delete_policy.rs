...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetBucketSoftDeletePolicy {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "retention_duration_seconds".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetBucketSoftDeletePolicy {
