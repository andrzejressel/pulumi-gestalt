...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for UserPasswordPolicyStatus {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "password_expiration_time".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for UserPasswordPolicyStatus {
