...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for V2VmDataDisk {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for V2VmDataDisk {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#source_disk: {
                        let field_value = match fields_map.get("source_disk") {
                            Some(value) => value,
                            None => bail!("Missing field 'source_disk' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
