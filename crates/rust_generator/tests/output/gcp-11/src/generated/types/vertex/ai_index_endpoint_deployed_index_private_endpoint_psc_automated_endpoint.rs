...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AiIndexEndpointDeployedIndexPrivateEndpointPscAutomatedEndpoint {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AiIndexEndpointDeployedIndexPrivateEndpointPscAutomatedEndpoint {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#match_address: {
                        let field_value = match fields_map.get("match_address") {
                            Some(value) => value,
                            None => bail!("Missing field 'match_address' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
