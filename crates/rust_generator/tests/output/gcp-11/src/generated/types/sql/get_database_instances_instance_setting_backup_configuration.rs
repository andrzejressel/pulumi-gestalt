...
pub struct GetDatabaseInstancesInstanceSettingBackupConfiguration {
    #[builder(into)]
    #[serde(rename = "backupRetentionSettings")]
    pub r#backup_retention_settings: Vec<super::super::types::sql::GetDatabaseInstancesInstanceSettingBackupConfigurationBackupRetentionSetting>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetDatabaseInstancesInstanceSettingBackupConfiguration {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetDatabaseInstancesInstanceSettingBackupConfiguration {
