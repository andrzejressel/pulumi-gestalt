...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetDatabaseInstancesInstanceSettingBackupConfigurationBackupRetentionSetting {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "retained_backups".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#retained_backups,
                )
                .await,
            );
            map.insert(
                "retention_unit".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#retention_unit,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetDatabaseInstancesInstanceSettingBackupConfigurationBackupRetentionSetting {
