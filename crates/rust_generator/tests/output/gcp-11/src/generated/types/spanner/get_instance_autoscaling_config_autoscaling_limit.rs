...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetInstanceAutoscalingConfigAutoscalingLimit {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "max_processing_units".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "min_processing_units".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetInstanceAutoscalingConfigAutoscalingLimit {
