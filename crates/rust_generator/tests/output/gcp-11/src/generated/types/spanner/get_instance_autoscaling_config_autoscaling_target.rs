...
pub struct GetInstanceAutoscalingConfigAutoscalingTarget {
    ...
    pub r#high_priority_cpu_utilization_percent: i32,
    /// Specifies the target storage utilization percentage that the autoscaler
    /// should be trying to achieve for the instance.
    /// This number is on a scale from 0 (no utilization) to 100 (full utilization).
    #[builder(into)]
    #[serde(rename = "storageUtilizationPercent")]
    pub r#storage_utilization_percent: i32,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetInstanceAutoscalingConfigAutoscalingTarget {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetInstanceAutoscalingConfigAutoscalingTarget {
