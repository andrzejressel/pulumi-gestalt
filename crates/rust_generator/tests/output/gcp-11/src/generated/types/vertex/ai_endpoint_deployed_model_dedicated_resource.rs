...
pub struct AiEndpointDeployedModelDedicatedResource {
    ...
    pub r#autoscaling_metric_specs: Option<Vec<super::super::types::vertex::AiEndpointDeployedModelDedicatedResourceAutoscalingMetricSpec>>,
    /// (Output)
    /// The specification of a single machine used by the prediction.
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "machineSpecs")]
    pub r#machine_specs: Option<Vec<super::super::types::vertex::AiEndpointDeployedModelDedicatedResourceMachineSpec>>,
    /// (Output)
    ...
    pub r#min_replica_count: Option<i32>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AiEndpointDeployedModelDedicatedResource {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AiEndpointDeployedModelDedicatedResource {
