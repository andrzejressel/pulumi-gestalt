...
pub struct ReplicationRecoveryPlanShutdownRecoveryGroupPostAction {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ReplicationRecoveryPlanShutdownRecoveryGroupPostAction {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "fail_over_directions".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "manual_action_instruction".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ReplicationRecoveryPlanShutdownRecoveryGroupPostAction {
