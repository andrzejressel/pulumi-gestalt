...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetContainersContainer {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "resource_manager_id".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#resource_manager_id,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetContainersContainer {
