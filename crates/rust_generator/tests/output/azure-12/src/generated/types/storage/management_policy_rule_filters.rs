...
pub struct ManagementPolicyRuleFilters {
    ...
    pub r#match_blob_index_tags: Option<Vec<super::super::types::storage::ManagementPolicyRuleFiltersMatchBlobIndexTag>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ManagementPolicyRuleFilters {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "match_blob_index_tags".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ManagementPolicyRuleFilters {
