            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#configuration_parameter: {
                        let field_value = match fields_map.get("configurationParameter") {
                            Some(value) => value,
                            None => bail!("Missing field 'configurationParameter' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
