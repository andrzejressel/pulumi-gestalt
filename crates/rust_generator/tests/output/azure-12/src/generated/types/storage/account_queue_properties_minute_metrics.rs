...
pub struct AccountQueuePropertiesMinuteMetrics {
    ...
    pub r#include_apis: Option<bool>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AccountQueuePropertiesMinuteMetrics {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AccountQueuePropertiesMinuteMetrics {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#include_apis: {
                        let field_value = match fields_map.get("include_apis") {
                            Some(value) => value,
                            None => bail!("Missing field 'include_apis' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
