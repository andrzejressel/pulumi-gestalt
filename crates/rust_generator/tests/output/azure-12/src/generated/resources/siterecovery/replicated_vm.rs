...
pub mod replicated_vm {
    ...
    pub struct ReplicatedVMArgs {
        ...
        #[builder(into)]
        pub source_recovery_protection_container_name: pulumi_gestalt_rust::Input<
            String,
        >,
        ...
        #[builder(into, default)]
        pub target_capacity_reservation_group_id: pulumi_gestalt_rust::Input<
            Option<String>,
        >,
        /// Specifies the Edge Zone within the Azure Region where this Managed Kubernetes Cluster should exist. Changing this forces a new resource to be created.
        #[builder(into, default)]
        pub target_edge_zone: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub target_virtual_machine_scale_set_id: pulumi_gestalt_rust::Input<
            Option<String>,
        >,
        ...
        #[builder(into, default)]
        pub unmanaged_disks: pulumi_gestalt_rust::Input<
