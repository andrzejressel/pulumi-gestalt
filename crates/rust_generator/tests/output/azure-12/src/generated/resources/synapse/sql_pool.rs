...
pub mod sql_pool {
    ...
    fn __create(
        ...
        let data_encrypted_binding = args.data_encrypted.get_output(ctx);
        let geo_backup_policy_enabled_binding = args
            .geo_backup_policy_enabled
            .get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let recovery_database_id_binding = args.recovery_database_id.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &data_encrypted_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "geoBackupPolicyEnabled".into(),
                    value: &geo_backup_policy_enabled_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &recovery_database_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "restore".into(),
