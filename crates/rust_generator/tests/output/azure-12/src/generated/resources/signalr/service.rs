...
pub mod service {
    ...
    fn __create(
        ...
        let aad_auth_enabled_binding = args.aad_auth_enabled.get_output(ctx);
        ...
        let live_trace_binding = args.live_trace.get_output(ctx);
        let live_trace_enabled_binding = args.live_trace_enabled.get_output(ctx);
        let local_auth_enabled_binding = args.local_auth_enabled.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let messaging_logs_enabled_binding = args.messaging_logs_enabled.get_output(ctx);
        ...
        let serverless_connection_timeout_in_seconds_binding = args
            ...
            .get_output(ctx);
        let service_mode_binding = args.service_mode.get_output(ctx);
        let sku_binding = args.sku.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let tls_client_cert_enabled_binding = args
            .tls_client_cert_enabled
            .get_output(ctx);
        let upstream_endpoints_binding = args.upstream_endpoints.get_output(ctx);
