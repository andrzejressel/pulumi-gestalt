...
pub mod local_user {
    ...
    fn __create(
        ...
        let permission_scopes_binding = args.permission_scopes.get_output(ctx);
        let ssh_authorized_keys_binding = args.ssh_authorized_keys.get_output(ctx);
        let ssh_key_enabled_binding = args.ssh_key_enabled.get_output(ctx);
        let ssh_password_enabled_binding = args.ssh_password_enabled.get_output(ctx);
