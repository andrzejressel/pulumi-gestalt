...
pub mod service_network_acl {
    ...
    fn __create(
        ...
        let private_endpoints_binding = args.private_endpoints.get_output(ctx);
        let public_network_binding = args.public_network.get_output(ctx);
        let signalr_service_id_binding = args.signalr_service_id.get_output(ctx);
