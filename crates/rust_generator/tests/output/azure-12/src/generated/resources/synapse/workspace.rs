...
pub mod workspace {
    ...
    pub struct WorkspaceArgs {
        ...
        pub azure_devops_repo: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub data_exfiltration_protection_enabled: pulumi_gestalt_rust::Input<
            Option<bool>,
        >,
        /// A `github_repo` block as defined below.
        #[builder(into, default)]
        pub github_repo: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub linking_allowed_for_aad_tenant_ids: pulumi_gestalt_rust::Input<
            Option<Vec<String>>,
        >,
    ...
    fn __create(
        ...
        let azure_devops_repo_binding = args.azure_devops_repo.get_output(ctx);
        let azuread_authentication_only_binding = args
            .azuread_authentication_only
            .get_output(ctx);
        let compute_subnet_id_binding = args.compute_subnet_id.get_output(ctx);
        ...
        let data_exfiltration_protection_enabled_binding = args
            ...
            .get_output(ctx);
        let github_repo_binding = args.github_repo.get_output(ctx);
