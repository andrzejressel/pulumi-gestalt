...
pub mod account_network_rules {
    ...
    pub struct AccountNetworkRulesArgs {
        ...
        pub bypasses: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        ...
        #[builder(into, default)]
        pub ip_rules: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        /// One or more `private_link_access` block as defined below.
        #[builder(into, default)]
        pub private_link_access_rules: pulumi_gestalt_rust::Input<
            Option<
                Vec<
    ...
    fn __create(
        ...
        let bypasses_binding = args.bypasses.get_output(ctx);
        let default_action_binding = args.default_action.get_output(ctx);
        let ip_rules_binding = args.ip_rules.get_output(ctx);
