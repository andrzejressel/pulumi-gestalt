...
pub mod job {
    ...
    pub struct JobArgs {
        ...
        pub compatibility_level: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub content_storage_policy: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub data_locale: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub events_late_arrival_max_delay_in_seconds: pulumi_gestalt_rust::Input<
            Option<i32>,
        >,
        ...
        #[builder(into, default)]
        pub events_out_of_order_max_delay_in_seconds: pulumi_gestalt_rust::Input<
            Option<i32>,
        >,
        ...
        #[builder(into, default)]
        pub job_storage_accounts: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub output_error_policy: pulumi_gestalt_rust::Input<Option<String>>,
