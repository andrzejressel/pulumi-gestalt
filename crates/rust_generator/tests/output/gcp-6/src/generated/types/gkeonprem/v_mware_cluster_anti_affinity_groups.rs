...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for VMwareClusterAntiAffinityGroups {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "aag_config_disabled".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#aag_config_disabled,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for VMwareClusterAntiAffinityGroups {
