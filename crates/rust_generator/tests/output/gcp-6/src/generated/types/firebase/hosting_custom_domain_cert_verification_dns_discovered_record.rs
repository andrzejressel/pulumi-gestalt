...
pub struct HostingCustomDomainCertVerificationDnsDiscoveredRecord {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for HostingCustomDomainCertVerificationDnsDiscoveredRecord {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for HostingCustomDomainCertVerificationDnsDiscoveredRecord {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#required_action: {
                        let field_value = match fields_map.get("requiredAction") {
                            Some(value) => value,
                            None => bail!("Missing field 'requiredAction' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#type_: {
