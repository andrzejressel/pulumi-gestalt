...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BareMetalClusterNodeConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BareMetalClusterNodeConfig {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#container_runtime: {
                        let field_value = match fields_map.get("container_runtime") {
                            Some(value) => value,
                            None => bail!("Missing field 'container_runtime' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
