...
pub struct BareMetalAdminClusterControlPlane {
    ...
    pub r#api_server_args: Option<Vec<super::super::types::gkeonprem::BareMetalAdminClusterControlPlaneApiServerArg>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BareMetalAdminClusterControlPlane {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "control_plane_node_pool_config".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BareMetalAdminClusterControlPlane {
