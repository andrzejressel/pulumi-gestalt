...
pub struct BareMetalAdminClusterStatus {
    ...
    pub r#conditions: Option<Vec<super::super::types::gkeonprem::BareMetalAdminClusterStatusCondition>>,
    /// (Output)
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BareMetalAdminClusterStatus {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BareMetalAdminClusterStatus {
