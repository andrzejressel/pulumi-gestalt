...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BackupPlanBackupConfigEncryptionKey {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "gcp_kms_encryption_key".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#gcp_kms_encryption_key,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BackupPlanBackupConfigEncryptionKey {
