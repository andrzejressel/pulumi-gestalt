...
pub struct GetOrganizationPolicyListPolicy {
    ...
    #[builder(into)]
    #[serde(rename = "allows")]
    pub r#allows: Vec<super::super::types::folder::GetOrganizationPolicyListPolicyAllow>,
    /// One or the other must be set.
    #[builder(into)]
    #[serde(rename = "denies")]
    pub r#denies: Vec<super::super::types::folder::GetOrganizationPolicyListPolicyDeny>,
