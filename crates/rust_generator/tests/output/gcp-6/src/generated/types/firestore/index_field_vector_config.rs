...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for IndexFieldVectorConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for IndexFieldVectorConfig {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#flat: {
                        let field_value = match fields_map.get("flat") {
                            Some(value) => value,
                            None => bail!("Missing field 'flat' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
