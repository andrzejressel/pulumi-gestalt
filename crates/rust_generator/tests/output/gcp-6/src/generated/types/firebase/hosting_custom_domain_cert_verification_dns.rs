...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for HostingCustomDomainCertVerificationDns {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for HostingCustomDomainCertVerificationDns {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#check_time: {
                        let field_value = match fields_map.get("checkTime") {
                            Some(value) => value,
                            None => bail!("Missing field 'checkTime' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
