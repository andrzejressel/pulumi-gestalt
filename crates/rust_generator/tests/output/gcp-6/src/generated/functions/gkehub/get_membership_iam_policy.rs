...
pub mod get_membership_iam_policy {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct GetMembershipIamPolicyArgs {
    ...
    #[allow(dead_code)]
    pub struct GetMembershipIamPolicyResult {
    ...
    pub fn invoke(
        ...
        args: GetMembershipIamPolicyArgs,
        ...
        let request = pulumi_gestalt_rust::InvokeResourceRequest {
            token: "gcp:gkehub/getMembershipIamPolicy:getMembershipIamPolicy".into(),
