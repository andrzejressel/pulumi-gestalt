...
pub mod feature {
    ...
    pub struct FeatureResult {
        ...
        /// Optional. Fleet Default Membership Configuration.
        /// Structure is documented below.
        pub fleet_default_member_config: pulumi_gestalt_rust::Output<
            Option<super::super::types::gkehub::FeatureFleetDefaultMemberConfig>,
        >,
        /// GCP labels for this Feature.
        /// **Note**: This field is non-authoritative, and will only manage the labels present in your configuration.
        ...
        /// Structure is documented below.
        pub resource_states: pulumi_gestalt_rust::Output<
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &fleet_default_member_config_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "labels".into(),
        ...
        FeatureResult {
            ...
            fleet_default_member_config: o.get_field("fleetDefaultMemberConfig"),
            labels: o.get_field("labels"),
            location: o.get_field("location"),
            name: o.get_field("name"),
            project: o.get_field("project"),
            pulumi_labels: o.get_field("pulumiLabels"),
            resource_states: o.get_field("resourceStates"),
