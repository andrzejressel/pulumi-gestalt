...
pub mod restore_plan_iam_binding {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct RestorePlanIamBindingArgs {
    ...
    #[allow(dead_code)]
    pub struct RestorePlanIamBindingResult {
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:gkebackup/restorePlanIamBinding:RestorePlanIamBinding".into(),
            name: name.to_string(),
