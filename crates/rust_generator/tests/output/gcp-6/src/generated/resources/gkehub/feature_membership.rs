...
pub mod feature_membership {
    ...
    fn __create(
        ...
        let configmanagement_binding = args.configmanagement.get_output(ctx);
        let feature_binding = args.feature.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let membership_binding = args.membership.get_output(ctx);
        let membership_location_binding = args.membership_location.get_output(ctx);
        let mesh_binding = args.mesh.get_output(ctx);
        let policycontroller_binding = args.policycontroller.get_output(ctx);
