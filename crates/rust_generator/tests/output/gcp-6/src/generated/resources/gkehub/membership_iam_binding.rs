...
pub mod membership_iam_binding {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct MembershipIamBindingArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::gkehub::MembershipIamBindingCondition>,
        >,
    ...
    #[allow(dead_code)]
    pub struct MembershipIamBindingResult {
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:gkehub/membershipIamBinding:MembershipIamBinding".into(),
            name: name.to_string(),
