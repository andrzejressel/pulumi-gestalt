...
pub mod scope_iam_member {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct ScopeIamMemberArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::gkehub::ScopeIamMemberCondition>,
        >,
    ...
    #[allow(dead_code)]
    pub struct ScopeIamMemberResult {
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:gkehub/scopeIamMember:ScopeIamMember".into(),
            name: name.to_string(),
