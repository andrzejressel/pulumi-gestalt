...
pub mod android_app {
    ...
    pub struct AndroidAppArgs {
        ...
        #[builder(into, default)]
        pub sha1_hashes: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        /// The SHA256 certificate hashes for the AndroidApp.
        #[builder(into, default)]
        pub sha256_hashes: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
    }
    #[allow(dead_code)]
    ...
    fn __create(
        ...
        let api_key_id_binding = args.api_key_id.get_output(ctx);
        ...
        let sha1_hashes_binding = args.sha1_hashes.get_output(ctx);
        let sha256_hashes_binding = args.sha256_hashes.get_output(ctx);
