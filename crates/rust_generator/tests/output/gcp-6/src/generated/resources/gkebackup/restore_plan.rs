...
pub mod restore_plan {
    ...
    fn __create(
        ...
        let backup_plan_binding = args.backup_plan.get_output(ctx);
        ...
        let restore_config_binding = args.restore_config.get_output(ctx);
        ...
        RestorePlanResult {
            ...
            restore_config: o.get_field("restoreConfig"),
