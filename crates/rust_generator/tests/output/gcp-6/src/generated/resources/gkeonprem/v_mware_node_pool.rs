...
pub mod v_mware_node_pool {
    ...
    fn __create(
        ...
        let node_pool_autoscaling_binding = args.node_pool_autoscaling.get_output(ctx);
        let project_binding = args.project.get_output(ctx);
        let vmware_cluster_binding = args.vmware_cluster.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &node_pool_autoscaling_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "project".into(),
        ...
        VMwareNodePoolResult {
            ...
            node_pool_autoscaling: o.get_field("nodePoolAutoscaling"),
            ...
            vmware_cluster: o.get_field("vmwareCluster"),
        }
    }
}
