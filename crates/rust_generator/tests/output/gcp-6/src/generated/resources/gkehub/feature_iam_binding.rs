...
pub mod feature_iam_binding {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct FeatureIamBindingArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::gkehub::FeatureIamBindingCondition>,
        >,
    ...
    #[allow(dead_code)]
    pub struct FeatureIamBindingResult {
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:gkehub/featureIamBinding:FeatureIamBinding".into(),
            name: name.to_string(),
