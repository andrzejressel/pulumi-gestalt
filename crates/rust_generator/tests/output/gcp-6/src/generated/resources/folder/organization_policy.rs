...
pub mod organization_policy {
    ...
    fn __create(
        ...
        let boolean_policy_binding = args.boolean_policy.get_output(ctx);
        let constraint_binding = args.constraint.get_output(ctx);
        let folder_binding = args.folder.get_output(ctx);
        let list_policy_binding = args.list_policy.get_output(ctx);
        let restore_policy_binding = args.restore_policy.get_output(ctx);
