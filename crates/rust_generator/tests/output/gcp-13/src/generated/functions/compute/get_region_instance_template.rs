...
pub mod get_region_instance_template {
    ...
    pub struct GetRegionInstanceTemplateResult {
        pub advanced_machine_features: pulumi_gestalt_rust::Output<
            Vec<
                super::super::super::types::compute::GetRegionInstanceTemplateAdvancedMachineFeature,
            >,
        >,
        ...
        pub confidential_instance_configs: pulumi_gestalt_rust::Output<
            Vec<
                super::super::super::types::compute::GetRegionInstanceTemplateConfidentialInstanceConfig,
            >,
        >,
        ...
        pub disks: pulumi_gestalt_rust::Output<
            Vec<super::super::super::types::compute::GetRegionInstanceTemplateDisk>,
        >,
        ...
        pub guest_accelerators: pulumi_gestalt_rust::Output<
            Vec<
                super::super::super::types::compute::GetRegionInstanceTemplateGuestAccelerator,
            >,
        >,
        ...
        pub network_interfaces: pulumi_gestalt_rust::Output<
            Vec<
                super::super::super::types::compute::GetRegionInstanceTemplateNetworkInterface,
            >,
        >,
        ...
        pub network_performance_configs: pulumi_gestalt_rust::Output<
            Vec<
                super::super::super::types::compute::GetRegionInstanceTemplateNetworkPerformanceConfig,
            >,
        >,
        ...
        pub reservation_affinities: pulumi_gestalt_rust::Output<
            Vec<
                super::super::super::types::compute::GetRegionInstanceTemplateReservationAffinity,
            >,
        >,
        ...
        pub schedulings: pulumi_gestalt_rust::Output<
            Vec<super::super::super::types::compute::GetRegionInstanceTemplateScheduling>,
        >,
        ...
        pub service_accounts: pulumi_gestalt_rust::Output<
            Vec<
                super::super::super::types::compute::GetRegionInstanceTemplateServiceAccount,
            >,
        >,
        ...
        pub shielded_instance_configs: pulumi_gestalt_rust::Output<
            Vec<
                super::super::super::types::compute::GetRegionInstanceTemplateShieldedInstanceConfig,
            >,
        >,
