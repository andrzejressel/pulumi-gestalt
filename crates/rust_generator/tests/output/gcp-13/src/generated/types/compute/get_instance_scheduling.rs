...
pub struct GetInstanceScheduling {
    ...
    pub r#local_ssd_recovery_timeouts: Vec<super::super::types::compute::GetInstanceSchedulingLocalSsdRecoveryTimeout>,
    ...
    pub r#max_run_durations: Vec<super::super::types::compute::GetInstanceSchedulingMaxRunDuration>,
    #[builder(into)]
    ...
    pub r#node_affinities: Vec<super::super::types::compute::GetInstanceSchedulingNodeAffinity>,
    ...
    pub r#on_instance_stop_actions: Vec<super::super::types::compute::GetInstanceSchedulingOnInstanceStopAction>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetInstanceScheduling {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetInstanceScheduling {
