...
pub struct GetRegionInstanceTemplateDisk {
    ...
    pub r#disk_encryption_keys: Vec<super::super::types::compute::GetRegionInstanceTemplateDiskDiskEncryptionKey>,
    ...
    pub r#source_image_encryption_keys: Vec<super::super::types::compute::GetRegionInstanceTemplateDiskSourceImageEncryptionKey>,
    ...
    pub r#source_snapshot_encryption_keys: Vec<super::super::types::compute::GetRegionInstanceTemplateDiskSourceSnapshotEncryptionKey>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetRegionInstanceTemplateDisk {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetRegionInstanceTemplateDisk {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#disk_encryption_keys: {
                        let field_value = match fields_map.get("diskEncryptionKeys") {
                            Some(value) => value,
                            None => bail!("Missing field 'diskEncryptionKeys' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#disk_name: {
                    ...
                    r#source_image_encryption_keys: {
                        let field_value = match fields_map.get("sourceImageEncryptionKeys") {
                            Some(value) => value,
                            None => bail!("Missing field 'sourceImageEncryptionKeys' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#source_snapshot: {
                    ...
                    r#source_snapshot_encryption_keys: {
                        let field_value = match fields_map.get("sourceSnapshotEncryptionKeys") {
                            Some(value) => value,
                            None => bail!("Missing field 'sourceSnapshotEncryptionKeys' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#type_: {
