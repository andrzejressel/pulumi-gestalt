...
pub struct UrlMapPathMatcherDefaultRouteActionRetryPolicy {
    ...
    pub r#per_try_timeout: Option<Box<super::super::types::compute::UrlMapPathMatcherDefaultRouteActionRetryPolicyPerTryTimeout>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for UrlMapPathMatcherDefaultRouteActionRetryPolicy {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for UrlMapPathMatcherDefaultRouteActionRetryPolicy {
