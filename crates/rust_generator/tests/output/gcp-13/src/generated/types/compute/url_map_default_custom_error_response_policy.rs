...
pub struct UrlMapDefaultCustomErrorResponsePolicy {
    ...
    pub r#error_response_rules: Option<Vec<super::super::types::compute::UrlMapDefaultCustomErrorResponsePolicyErrorResponseRule>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for UrlMapDefaultCustomErrorResponsePolicy {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for UrlMapDefaultCustomErrorResponsePolicy {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#error_response_rules: {
                        let field_value = match fields_map.get("errorResponseRules") {
                            Some(value) => value,
                            None => bail!("Missing field 'errorResponseRules' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#error_service: {
                        let field_value = match fields_map.get("errorService") {
                            Some(value) => value,
                            None => bail!("Missing field 'errorService' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
