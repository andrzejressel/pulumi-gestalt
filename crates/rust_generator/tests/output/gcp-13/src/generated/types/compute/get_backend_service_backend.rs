...
pub struct GetBackendServiceBackend {
    ...
    pub r#max_connections_per_endpoint: i32,
    ...
    pub r#max_connections_per_instance: i32,
    ...
    pub r#max_rate_per_endpoint: f64,
    ...
    pub r#max_rate_per_instance: f64,
    /// Used when balancingMode is UTILIZATION. This ratio defines the
    /// CPU utilization target for the group. Valid range is [0.0, 1.0].
    #[builder(into)]
    #[serde(rename = "maxUtilization")]
    pub r#max_utilization: f64,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetBackendServiceBackend {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "max_connections_per_endpoint".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "max_connections_per_instance".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "max_rate_per_endpoint".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "max_rate_per_instance".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetBackendServiceBackend {
