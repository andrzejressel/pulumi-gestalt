...
pub struct NetworkFirewallPolicyWithRulesRuleMatchLayer4Config {
    /// (Output)
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for NetworkFirewallPolicyWithRulesRuleMatchLayer4Config {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for NetworkFirewallPolicyWithRulesRuleMatchLayer4Config {
