...
pub struct GetRegionInstanceGroupManagerUpdatePolicy {
    ...
    pub r#instance_redistribution_type: String,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetRegionInstanceGroupManagerUpdatePolicy {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetRegionInstanceGroupManagerUpdatePolicy {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#instance_redistribution_type: {
                        let field_value = match fields_map.get("instanceRedistributionType") {
                            Some(value) => value,
                            None => bail!("Missing field 'instanceRedistributionType' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
