        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#rsa_encrypted_key: {
                        let field_value = match fields_map.get("rsa_encrypted_key") {
                            Some(value) => value,
                            None => bail!("Missing field 'rsa_encrypted_key' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#sha_256: {
