...
pub struct RegionNetworkFirewallPolicyRuleMatchLayer4Config {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RegionNetworkFirewallPolicyRuleMatchLayer4Config {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RegionNetworkFirewallPolicyRuleMatchLayer4Config {
