...
pub struct RegionUrlMapPathMatcherRouteRuleMatchRule {
    ...
    pub r#header_matches: Option<Vec<super::super::types::compute::RegionUrlMapPathMatcherRouteRuleMatchRuleHeaderMatch>>,
    ...
    pub r#metadata_filters: Option<Vec<super::super::types::compute::RegionUrlMapPathMatcherRouteRuleMatchRuleMetadataFilter>>,
    ...
    pub r#query_parameter_matches: Option<Vec<super::super::types::compute::RegionUrlMapPathMatcherRouteRuleMatchRuleQueryParameterMatch>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RegionUrlMapPathMatcherRouteRuleMatchRule {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RegionUrlMapPathMatcherRouteRuleMatchRule {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#metadata_filters: {
                        let field_value = match fields_map.get("metadataFilters") {
                            Some(value) => value,
                            None => bail!("Missing field 'metadataFilters' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
