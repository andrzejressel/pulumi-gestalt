...
pub struct GetRouterNatSubnetwork {
    ...
    pub r#secondary_ip_range_names: Vec<String>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetRouterNatSubnetwork {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetRouterNatSubnetwork {
