...
pub struct GetInstanceSchedulingNodeAffinity {
    #[builder(into)]
    #[serde(rename = "key")]
    pub r#key: String,
    #[builder(into)]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetInstanceSchedulingNodeAffinity {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetInstanceSchedulingNodeAffinity {
