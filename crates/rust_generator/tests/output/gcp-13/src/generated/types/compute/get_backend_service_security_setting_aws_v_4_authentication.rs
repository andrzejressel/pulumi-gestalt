...
pub struct GetBackendServiceSecuritySettingAwsV4Authentication {
    ...
    pub r#access_key_version: String,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetBackendServiceSecuritySettingAwsV4Authentication {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetBackendServiceSecuritySettingAwsV4Authentication {
