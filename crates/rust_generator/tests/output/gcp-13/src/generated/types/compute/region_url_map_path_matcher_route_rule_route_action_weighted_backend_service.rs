...
pub struct RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendService {
    ...
    pub r#header_action: Option<Box<super::super::types::compute::RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderAction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendService {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendService {
