...
pub struct InstanceFromMachineImageBootDisk {
    ...
    pub r#initialize_params: Option<Box<super::super::types::compute::InstanceFromMachineImageBootDiskInitializeParams>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for InstanceFromMachineImageBootDisk {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for InstanceFromMachineImageBootDisk {
