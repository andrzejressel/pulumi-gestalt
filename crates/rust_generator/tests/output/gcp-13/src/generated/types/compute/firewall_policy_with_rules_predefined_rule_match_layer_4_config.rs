...
pub struct FirewallPolicyWithRulesPredefinedRuleMatchLayer4Config {
    /// (Output)
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FirewallPolicyWithRulesPredefinedRuleMatchLayer4Config {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FirewallPolicyWithRulesPredefinedRuleMatchLayer4Config {
