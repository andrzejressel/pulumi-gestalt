...
pub struct GetInstanceGroupManagerStatus {
    ...
    pub r#all_instances_configs: Vec<super::super::types::compute::GetInstanceGroupManagerStatusAllInstancesConfig>,
    ...
    pub r#statefuls: Vec<super::super::types::compute::GetInstanceGroupManagerStatusStateful>,
    /// A status of consistency of Instances' versions with their target version specified by version field on Instance Group Manager.
    #[builder(into)]
    #[serde(rename = "versionTargets")]
    pub r#version_targets: Vec<super::super::types::compute::GetInstanceGroupManagerStatusVersionTarget>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetInstanceGroupManagerStatus {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetInstanceGroupManagerStatus {
