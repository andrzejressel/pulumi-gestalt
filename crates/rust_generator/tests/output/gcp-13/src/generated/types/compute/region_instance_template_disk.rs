...
pub struct RegionInstanceTemplateDisk {
    ...
    pub r#disk_encryption_key: Option<Box<super::super::types::compute::RegionInstanceTemplateDiskDiskEncryptionKey>>,
    ...
    pub r#source_image_encryption_key: Option<Box<super::super::types::compute::RegionInstanceTemplateDiskSourceImageEncryptionKey>>,
    ...
    pub r#source_snapshot_encryption_key: Option<Box<super::super::types::compute::RegionInstanceTemplateDiskSourceSnapshotEncryptionKey>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RegionInstanceTemplateDisk {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RegionInstanceTemplateDisk {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#source_image_encryption_key: {
                        let field_value = match fields_map.get("source_image_encryption_key") {
                            Some(value) => value,
                            None => bail!("Missing field 'source_image_encryption_key' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#source_snapshot: {
                    ...
                    r#source_snapshot_encryption_key: {
                        let field_value = match fields_map.get("source_snapshot_encryption_key") {
                            Some(value) => value,
                            None => bail!("Missing field 'source_snapshot_encryption_key' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#type_: {
