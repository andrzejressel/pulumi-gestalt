...
pub struct RegionHealthCheckHttp2HealthCheck {
    ...
    pub r#request_path: Option<String>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RegionHealthCheckHttp2HealthCheck {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RegionHealthCheckHttp2HealthCheck {
