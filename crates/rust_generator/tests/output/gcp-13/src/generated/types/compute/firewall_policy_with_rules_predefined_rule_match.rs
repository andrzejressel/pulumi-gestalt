...
pub struct FirewallPolicyWithRulesPredefinedRuleMatch {
    ...
    pub r#layer_4_configs: Option<Vec<super::super::types::compute::FirewallPolicyWithRulesPredefinedRuleMatchLayer4Config>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FirewallPolicyWithRulesPredefinedRuleMatch {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FirewallPolicyWithRulesPredefinedRuleMatch {
