...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ReservationSpecificReservationInstanceProperties {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ReservationSpecificReservationInstanceProperties {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#local_ssds: {
                        let field_value = match fields_map.get("localSsds") {
                            Some(value) => value,
                            None => bail!("Missing field 'localSsds' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#machine_type: {
