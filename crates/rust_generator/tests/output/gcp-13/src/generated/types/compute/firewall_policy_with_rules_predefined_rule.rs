...
pub struct FirewallPolicyWithRulesPredefinedRule {
    ...
    pub r#matches: Option<Vec<super::super::types::compute::FirewallPolicyWithRulesPredefinedRuleMatch>>,
    /// (Output)
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FirewallPolicyWithRulesPredefinedRule {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FirewallPolicyWithRulesPredefinedRule {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#target_resources: {
                        let field_value = match fields_map.get("targetResources") {
                            Some(value) => value,
                            None => bail!("Missing field 'targetResources' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
