...
pub struct GetInstanceGroupManagerInstanceLifecyclePolicy {
    /// Default behavior for all instance or health check failures.
    #[builder(into)]
    #[serde(rename = "defaultActionOnFailure")]
    pub r#default_action_on_failure: String,
    /// Specifies whether to apply the group's latest configuration when repairing a VM. Valid options are: YES, NO. If YES and you updated the group's instance template or per-instance configurations after the VM was created, then these changes are applied when VM is repaired. If NO (default), then updates are applied in accordance with the group's update policy type.
    #[builder(into)]
    #[serde(rename = "forceUpdateOnRepair")]
    pub r#force_update_on_repair: String,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetInstanceGroupManagerInstanceLifecyclePolicy {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "default_action_on_failure".to_string(),
            ...
            map.insert(
                "force_update_on_repair".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetInstanceGroupManagerInstanceLifecyclePolicy {
