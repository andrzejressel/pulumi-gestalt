...
pub struct RegionUrlMapDefaultRouteActionRetryPolicy {
    ...
    pub r#per_try_timeout: Option<Box<super::super::types::compute::RegionUrlMapDefaultRouteActionRetryPolicyPerTryTimeout>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RegionUrlMapDefaultRouteActionRetryPolicy {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RegionUrlMapDefaultRouteActionRetryPolicy {
