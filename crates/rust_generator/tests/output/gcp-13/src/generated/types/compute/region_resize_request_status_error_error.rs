...
pub struct RegionResizeRequestStatusErrorError {
    ...
    pub r#error_details: Option<Vec<super::super::types::compute::RegionResizeRequestStatusErrorErrorErrorDetail>>,
    /// (Output)
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RegionResizeRequestStatusErrorError {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RegionResizeRequestStatusErrorError {
