...
pub struct RegionAutoscalerAutoscalingPolicyMetric {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RegionAutoscalerAutoscalingPolicyMetric {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RegionAutoscalerAutoscalingPolicyMetric {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#single_instance_assignment: {
                        let field_value = match fields_map.get("singleInstanceAssignment") {
                            Some(value) => value,
                            None => bail!("Missing field 'singleInstanceAssignment' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#target: {
