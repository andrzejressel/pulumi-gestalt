...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RegionNetworkEndpointGroupServerlessDeployment {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RegionNetworkEndpointGroupServerlessDeployment {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#url_mask: {
                        let field_value = match fields_map.get("urlMask") {
                            Some(value) => value,
                            None => bail!("Missing field 'urlMask' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#version: {
