...
pub struct GetInstanceTemplateNetworkInterface {
    ...
    pub r#access_configs: Vec<super::super::types::compute::GetInstanceTemplateNetworkInterfaceAccessConfig>,
    /// An
    /// array of alias IP ranges for this network interface. Can only be specified for network
    /// interfaces on subnet-mode networks. Structure documented below.
    #[builder(into)]
    #[serde(rename = "aliasIpRanges")]
    pub r#alias_ip_ranges: Vec<super::super::types::compute::GetInstanceTemplateNetworkInterfaceAliasIpRange>,
    ...
    pub r#ipv_6_access_configs: Vec<super::super::types::compute::GetInstanceTemplateNetworkInterfaceIpv6AccessConfig>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetInstanceTemplateNetworkInterface {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetInstanceTemplateNetworkInterface {
