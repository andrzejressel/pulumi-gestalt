...
pub struct UrlMapPathMatcherRouteRuleRouteActionWeightedBackendService {
    ...
    pub r#header_action: Option<Box<super::super::types::compute::UrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderAction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for UrlMapPathMatcherRouteRuleRouteActionWeightedBackendService {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for UrlMapPathMatcherRouteRuleRouteActionWeightedBackendService {
