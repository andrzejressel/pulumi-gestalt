...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for UrlMapDefaultCustomErrorResponsePolicyErrorResponseRule {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "match_response_codes".to_string(),
            ...
            map.insert(
                "override_response_code".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for UrlMapDefaultCustomErrorResponsePolicyErrorResponseRule {
