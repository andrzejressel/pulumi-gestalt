...
pub struct FirewallPolicyWithRulesRuleMatchLayer4Config {
    /// (Output)
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FirewallPolicyWithRulesRuleMatchLayer4Config {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FirewallPolicyWithRulesRuleMatchLayer4Config {
