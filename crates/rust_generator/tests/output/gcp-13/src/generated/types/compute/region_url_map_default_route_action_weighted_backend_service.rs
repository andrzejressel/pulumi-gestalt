...
pub struct RegionUrlMapDefaultRouteActionWeightedBackendService {
    ...
    pub r#header_action: Option<Box<super::super::types::compute::RegionUrlMapDefaultRouteActionWeightedBackendServiceHeaderAction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RegionUrlMapDefaultRouteActionWeightedBackendService {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RegionUrlMapDefaultRouteActionWeightedBackendService {
