...
pub struct BackendServiceCircuitBreakers {
    ...
    pub r#connect_timeout: Option<Box<super::super::types::compute::BackendServiceCircuitBreakersConnectTimeout>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BackendServiceCircuitBreakers {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "max_requests_per_connection".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BackendServiceCircuitBreakers {
