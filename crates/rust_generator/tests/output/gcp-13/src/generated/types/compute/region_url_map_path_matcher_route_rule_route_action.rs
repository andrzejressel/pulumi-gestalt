...
pub struct RegionUrlMapPathMatcherRouteRuleRouteAction {
    /// The specification for allowing client side cross-origin requests. Please see W3C
    /// Recommendation for Cross Origin Resource Sharing
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "corsPolicy")]
    pub r#cors_policy: Option<Box<super::super::types::compute::RegionUrlMapPathMatcherRouteRuleRouteActionCorsPolicy>>,
    ...
    pub r#fault_injection_policy: Option<Box<super::super::types::compute::RegionUrlMapPathMatcherRouteRuleRouteActionFaultInjectionPolicy>>,
    ...
    pub r#request_mirror_policy: Option<Box<super::super::types::compute::RegionUrlMapPathMatcherRouteRuleRouteActionRequestMirrorPolicy>>,
    /// Specifies the retry policy associated with this route.
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "retryPolicy")]
    pub r#retry_policy: Option<Box<super::super::types::compute::RegionUrlMapPathMatcherRouteRuleRouteActionRetryPolicy>>,
    ...
    pub r#timeout: Option<Box<super::super::types::compute::RegionUrlMapPathMatcherRouteRuleRouteActionTimeout>>,
    /// The spec to modify the URL of the request, prior to forwarding the request to
    /// the matched service
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "urlRewrite")]
    pub r#url_rewrite: Option<Box<super::super::types::compute::RegionUrlMapPathMatcherRouteRuleRouteActionUrlRewrite>>,
    ...
    pub r#weighted_backend_services: Option<Vec<super::super::types::compute::RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendService>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RegionUrlMapPathMatcherRouteRuleRouteAction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RegionUrlMapPathMatcherRouteRuleRouteAction {
