...
pub struct RegionNetworkFirewallPolicyWithRulesRuleMatch {
    ...
    pub r#layer_4_configs: Vec<super::super::types::compute::RegionNetworkFirewallPolicyWithRulesRuleMatchLayer4Config>,
    ...
    pub r#src_secure_tags: Option<Vec<super::super::types::compute::RegionNetworkFirewallPolicyWithRulesRuleMatchSrcSecureTag>>,
    /// Names of Network Threat Intelligence lists.
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RegionNetworkFirewallPolicyWithRulesRuleMatch {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RegionNetworkFirewallPolicyWithRulesRuleMatch {
