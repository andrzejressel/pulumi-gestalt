...
pub struct GetGlobalForwardingRuleServiceDirectoryRegistration {
    ...
    pub r#service_directory_region: String,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetGlobalForwardingRuleServiceDirectoryRegistration {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "service_directory_region".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetGlobalForwardingRuleServiceDirectoryRegistration {
