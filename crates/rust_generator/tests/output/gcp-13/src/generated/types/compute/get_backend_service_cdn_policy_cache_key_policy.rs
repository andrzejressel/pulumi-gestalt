...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetBackendServiceCdnPolicyCacheKeyPolicy {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "include_named_cookies".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "query_string_blacklists".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetBackendServiceCdnPolicyCacheKeyPolicy {
