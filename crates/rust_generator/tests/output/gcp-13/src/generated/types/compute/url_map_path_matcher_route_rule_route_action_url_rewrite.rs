...
pub struct UrlMapPathMatcherRouteRuleRouteActionUrlRewrite {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for UrlMapPathMatcherRouteRuleRouteActionUrlRewrite {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for UrlMapPathMatcherRouteRuleRouteActionUrlRewrite {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#path_template_rewrite: {
                        let field_value = match fields_map.get("pathTemplateRewrite") {
                            Some(value) => value,
                            None => bail!("Missing field 'pathTemplateRewrite' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
