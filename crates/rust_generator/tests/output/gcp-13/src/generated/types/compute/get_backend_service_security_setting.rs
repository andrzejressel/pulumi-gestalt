...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetBackendServiceSecuritySetting {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "aws_v_4_authentications".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetBackendServiceSecuritySetting {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#aws_v_4_authentications: {
                        let field_value = match fields_map.get("aws_v_4_authentications") {
                            Some(value) => value,
                            None => bail!("Missing field 'aws_v_4_authentications' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
