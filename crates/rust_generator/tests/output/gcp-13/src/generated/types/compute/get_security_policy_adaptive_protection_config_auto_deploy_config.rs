...
pub struct GetSecurityPolicyAdaptiveProtectionConfigAutoDeployConfig {
    ...
    pub r#confidence_threshold: f64,
    ...
    pub r#expiration_sec: i32,
    /// Rules are only automatically deployed when the estimated impact to baseline traffic from the suggested mitigation is below this threshold.
    #[builder(into)]
    #[serde(rename = "impactedBaselineThreshold")]
    pub r#impacted_baseline_threshold: f64,
    /// Identifies new attackers only when the load to the backend service that is under attack exceeds this threshold.
    #[builder(into)]
    #[serde(rename = "loadThreshold")]
    pub r#load_threshold: f64,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetSecurityPolicyAdaptiveProtectionConfigAutoDeployConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "impacted_baseline_threshold".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetSecurityPolicyAdaptiveProtectionConfigAutoDeployConfig {
