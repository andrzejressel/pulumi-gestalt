...
pub struct FirewallPolicyWithRulesRuleMatch {
    ...
    pub r#layer_4_configs: Vec<super::super::types::compute::FirewallPolicyWithRulesRuleMatchLayer4Config>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FirewallPolicyWithRulesRuleMatch {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FirewallPolicyWithRulesRuleMatch {
