...
pub struct RegionNetworkFirewallPolicyRuleMatch {
    ...
    pub r#layer_4_configs: Vec<super::super::types::compute::RegionNetworkFirewallPolicyRuleMatchLayer4Config>,
    ...
    pub r#src_secure_tags: Option<Vec<super::super::types::compute::RegionNetworkFirewallPolicyRuleMatchSrcSecureTag>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RegionNetworkFirewallPolicyRuleMatch {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RegionNetworkFirewallPolicyRuleMatch {
