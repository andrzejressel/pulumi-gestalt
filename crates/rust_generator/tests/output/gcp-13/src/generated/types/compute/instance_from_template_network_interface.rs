...
pub struct InstanceFromTemplateNetworkInterface {
    /// Access configurations, i.e. IPs via which this instance can be accessed via the Internet.
    #[builder(into)]
    #[serde(rename = "accessConfigs")]
    pub r#access_configs: Option<Vec<super::super::types::compute::InstanceFromTemplateNetworkInterfaceAccessConfig>>,
    /// An array of alias IP ranges for this network interface.
    #[builder(into)]
    #[serde(rename = "aliasIpRanges")]
    pub r#alias_ip_ranges: Option<Vec<super::super::types::compute::InstanceFromTemplateNetworkInterfaceAliasIpRange>>,
    ...
    pub r#ipv_6_access_configs: Option<Vec<super::super::types::compute::InstanceFromTemplateNetworkInterfaceIpv6AccessConfig>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for InstanceFromTemplateNetworkInterface {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for InstanceFromTemplateNetworkInterface {
