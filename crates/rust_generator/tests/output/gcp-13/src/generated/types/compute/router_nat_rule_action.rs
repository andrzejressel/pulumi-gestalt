...
pub struct RouterNatRuleAction {
    ...
    pub r#source_nat_active_ips: Option<Vec<String>>,
    /// A list of URLs of the subnetworks used as source ranges for this NAT Rule.
    /// These subnetworks must have purpose set to PRIVATE_NAT.
    /// This field is used for private NAT.
    #[builder(into)]
    #[serde(rename = "sourceNatActiveRanges")]
    pub r#source_nat_active_ranges: Option<Vec<String>>,
    ...
    pub r#source_nat_drain_ips: Option<Vec<String>>,
    /// A list of URLs of subnetworks representing source ranges to be drained.
    /// This is only supported on patch/update, and these subnetworks must have previously been used as active ranges in this NAT Rule.
    /// This field is used for private NAT.
    #[builder(into)]
    #[serde(rename = "sourceNatDrainRanges")]
    pub r#source_nat_drain_ranges: Option<Vec<String>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RouterNatRuleAction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RouterNatRuleAction {
