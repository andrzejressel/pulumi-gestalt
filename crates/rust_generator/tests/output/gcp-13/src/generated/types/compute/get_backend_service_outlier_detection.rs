...
pub struct GetBackendServiceOutlierDetection {
    ...
    pub r#success_rate_minimum_hosts: i32,
    ...
    pub r#success_rate_request_volume: i32,
    ...
    pub r#success_rate_stdev_factor: i32,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetBackendServiceOutlierDetection {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetBackendServiceOutlierDetection {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#base_ejection_times: {
                        let field_value = match fields_map.get("base_ejection_times") {
                            Some(value) => value,
                            None => bail!("Missing field 'base_ejection_times' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
