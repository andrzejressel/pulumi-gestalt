            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#base_ejection_times: {
                        let field_value = match fields_map.get("baseEjectionTimes") {
                            Some(value) => value,
                            None => bail!("Missing field 'baseEjectionTimes' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
