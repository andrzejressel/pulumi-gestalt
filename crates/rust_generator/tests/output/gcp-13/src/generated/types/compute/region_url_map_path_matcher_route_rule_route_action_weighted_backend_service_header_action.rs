...
pub struct RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderAction {
    ...
    pub r#request_headers_to_adds: Option<Vec<super::super::types::compute::RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderActionRequestHeadersToAdd>>,
    ...
    pub r#response_headers_to_adds: Option<Vec<super::super::types::compute::RegionUrlMapPathMatcherRouteRuleRouteActionWeightedBackendServiceHeaderActionResponseHeadersToAdd>>,
