...
pub struct InstanceTemplateScheduling {
    ...
    pub r#local_ssd_recovery_timeouts: Option<Vec<super::super::types::compute::InstanceTemplateSchedulingLocalSsdRecoveryTimeout>>,
    ...
    pub r#node_affinities: Option<Vec<super::super::types::compute::InstanceTemplateSchedulingNodeAffinity>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for InstanceTemplateScheduling {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for InstanceTemplateScheduling {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#max_run_duration: {
                        let field_value = match fields_map.get("maxRunDuration") {
                            Some(value) => value,
                            None => bail!("Missing field 'maxRunDuration' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#min_node_cpus: {
                    ...
                    r#on_instance_stop_action: {
                        let field_value = match fields_map.get("onInstanceStopAction") {
                            Some(value) => value,
                            None => bail!("Missing field 'onInstanceStopAction' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#preemptible: {
