...
pub struct RegionNetworkFirewallPolicyWithRulesRule {
    ...
    /// Structure is documented below.
    #[builder(into)]
    pub r#target_secure_tags: Option<Vec<super::super::types::compute::RegionNetworkFirewallPolicyWithRulesRuleTargetSecureTag>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RegionNetworkFirewallPolicyWithRulesRule {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RegionNetworkFirewallPolicyWithRulesRule {
