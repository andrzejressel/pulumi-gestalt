...
pub struct RegionInstanceGroupManagerStandbyPolicy {
    ...
    pub r#initial_delay_sec: Option<i32>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RegionInstanceGroupManagerStandbyPolicy {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RegionInstanceGroupManagerStandbyPolicy {
