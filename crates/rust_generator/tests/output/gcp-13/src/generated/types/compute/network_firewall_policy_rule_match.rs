...
pub struct NetworkFirewallPolicyRuleMatch {
    ...
    pub r#layer_4_configs: Vec<super::super::types::compute::NetworkFirewallPolicyRuleMatchLayer4Config>,
    ...
    pub r#src_secure_tags: Option<Vec<super::super::types::compute::NetworkFirewallPolicyRuleMatchSrcSecureTag>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for NetworkFirewallPolicyRuleMatch {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for NetworkFirewallPolicyRuleMatch {
