...
pub struct RegionUrlMapPathMatcherPathRuleRouteAction {
    ...
    pub r#weighted_backend_services: Option<Vec<super::super::types::compute::RegionUrlMapPathMatcherPathRuleRouteActionWeightedBackendService>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RegionUrlMapPathMatcherPathRuleRouteAction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RegionUrlMapPathMatcherPathRuleRouteAction {
