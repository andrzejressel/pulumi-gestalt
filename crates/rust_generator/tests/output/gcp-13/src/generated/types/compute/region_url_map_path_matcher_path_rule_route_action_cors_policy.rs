...
pub struct RegionUrlMapPathMatcherPathRuleRouteActionCorsPolicy {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RegionUrlMapPathMatcherPathRuleRouteActionCorsPolicy {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "allow_origin_regexes".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RegionUrlMapPathMatcherPathRuleRouteActionCorsPolicy {
