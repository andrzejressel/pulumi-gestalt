...
pub struct RegionPerInstanceConfigPreservedStateInternalIp {
    ...
    pub r#ip_address: Option<Box<super::super::types::compute::RegionPerInstanceConfigPreservedStateInternalIpIpAddress>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RegionPerInstanceConfigPreservedStateInternalIp {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RegionPerInstanceConfigPreservedStateInternalIp {
