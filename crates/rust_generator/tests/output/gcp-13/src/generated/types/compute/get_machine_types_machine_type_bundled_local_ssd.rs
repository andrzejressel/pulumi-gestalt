...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetMachineTypesMachineTypeBundledLocalSsd {
    fn to_pulumi_value(
        &self,
        ...
        async move {
            ...
            let field_futures: Vec<ToPulumiObjectFieldFuture<'_>> = vec![
                to_pulumi_object_field(
                    "default_interface",
                    &self.r#default_interface,
                ),
                to_pulumi_object_field(
                    "partition_count",
                    &self.r#partition_count,
                ),
            ];
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetMachineTypesMachineTypeBundledLocalSsd {
