...
pub struct BackendServiceCdnPolicy {
    ...
    pub r#bypass_cache_on_request_headers: Option<Vec<super::super::types::compute::BackendServiceCdnPolicyBypassCacheOnRequestHeader>>,
    ...
    pub r#negative_caching_policies: Option<Vec<super::super::types::compute::BackendServiceCdnPolicyNegativeCachingPolicy>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BackendServiceCdnPolicy {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BackendServiceCdnPolicy {
