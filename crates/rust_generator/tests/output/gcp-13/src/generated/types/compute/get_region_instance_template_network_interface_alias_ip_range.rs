...
pub struct GetRegionInstanceTemplateNetworkInterfaceAliasIpRange {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetRegionInstanceTemplateNetworkInterfaceAliasIpRange {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "subnetwork_range_name".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetRegionInstanceTemplateNetworkInterfaceAliasIpRange {
