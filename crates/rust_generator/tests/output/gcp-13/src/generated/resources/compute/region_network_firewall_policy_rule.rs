...
pub mod region_network_firewall_policy_rule {
    ...
    pub struct RegionNetworkFirewallPolicyRuleArgs {
        ...
        #[builder(into, default)]
        pub security_profile_group: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub target_secure_tags: pulumi_gestalt_rust::Input<
            Option<
                Vec<
        ...
        #[builder(into, default)]
        pub tls_inspect: pulumi_gestalt_rust::Input<Option<bool>>,
    }
    #[allow(dead_code)]
    ...
    fn __create(
        ...
        let target_secure_tags_binding = args.target_secure_tags.get_output(ctx);
