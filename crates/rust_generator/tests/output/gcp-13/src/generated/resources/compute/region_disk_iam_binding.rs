...
pub mod region_disk_iam_binding {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct RegionDiskIamBindingArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::compute::RegionDiskIamBindingCondition>,
        >,
    ...
    #[allow(dead_code)]
    pub struct RegionDiskIamBindingResult {
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:compute/regionDiskIamBinding:RegionDiskIamBinding".into(),
            name: name.to_string(),
