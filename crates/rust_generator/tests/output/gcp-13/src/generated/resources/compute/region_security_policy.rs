...
pub mod region_security_policy {
    ...
    fn __create(
        ...
        let ddos_protection_config_binding = args.ddos_protection_config.get_output(ctx);
        ...
        let user_defined_fields_binding = args.user_defined_fields.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &ddos_protection_config_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
        ...
        RegionSecurityPolicyResult {
            ...
            self_link_with_policy_id: o.get_field("selfLinkWithPolicyId"),
            type_: o.get_field("type"),
            user_defined_fields: o.get_field("userDefinedFields"),
        }
    }
}
