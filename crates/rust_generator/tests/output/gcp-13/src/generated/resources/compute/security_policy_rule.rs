...
pub mod security_policy_rule {
    ...
    pub struct SecurityPolicyRuleArgs {
        ...
        /// Structure is documented below.
        #[builder(into, default)]
        pub redirect_options: pulumi_gestalt_rust::Input<
    ...
    fn __create(
        ...
        let preconfigured_waf_config_binding = args
            ...
            .get_output(ctx);
        let preview_binding = args.preview.get_output(ctx);
        let priority_binding = args.priority.get_output(ctx);
        let project_binding = args.project.get_output(ctx);
        let rate_limit_options_binding = args.rate_limit_options.get_output(ctx);
        let redirect_options_binding = args.redirect_options.get_output(ctx);
