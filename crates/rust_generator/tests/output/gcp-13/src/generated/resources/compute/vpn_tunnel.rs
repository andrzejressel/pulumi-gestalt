...
pub mod vpn_tunnel {
    ...
    pub struct VPNTunnelArgs {
        ...
        #[builder(into, default)]
        pub ike_version: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub peer_gcp_gateway: pulumi_gestalt_rust::Input<Option<String>>,
        /// IP address of the peer VPN gateway. Only IPv4 is supported.
        #[builder(into, default)]
        pub peer_ip: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        /// associated.
        #[builder(into, default)]
        pub target_vpn_gateway: pulumi_gestalt_rust::Input<Option<String>>,
        /// URL of the VPN gateway with which this VPN tunnel is associated.
        /// This must be used if a High Availability VPN gateway resource is created.
        /// This field must reference a `gcp.compute.HaVpnGateway` resource.
        #[builder(into, default)]
        pub vpn_gateway: pulumi_gestalt_rust::Input<Option<String>>,
        /// The interface ID of the VPN gateway with which this VPN tunnel is associated.
        #[builder(into, default)]
        pub vpn_gateway_interface: pulumi_gestalt_rust::Input<Option<i32>>,
    }
    #[allow(dead_code)]
