...
pub mod machine_image_iam_member {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct MachineImageIamMemberArgs {
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::Input<
            Option<super::super::types::compute::MachineImageIamMemberCondition>,
        >,
        /// Used to find the parent resource to bind the IAM policy to
        #[builder(into)]
        pub machine_image: pulumi_gestalt_rust::Input<String>,
    ...
    fn __create(
        ...
        let machine_image_binding = args.machine_image.get_output(ctx);
        let member_binding = args.member.get_output(ctx);
        let project_binding = args.project.get_output(ctx);
        let role_binding = args.role.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:compute/machineImageIamMember:MachineImageIamMember".into(),
            name: name.to_string(),
