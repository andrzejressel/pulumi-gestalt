...
pub mod interconnect {
    ...
    pub struct InterconnectArgs {
        ...
        #[builder(into, default)]
        pub customer_name: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        /// - - -
        #[builder(into)]
        pub interconnect_type: pulumi_gestalt_rust::Input<String>,
        ...
        #[builder(into)]
        pub link_type: pulumi_gestalt_rust::Input<String>,
        ...
        /// federation.
        #[builder(into, default)]
        pub noc_contact_email: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub remote_location: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub requested_features: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        /// Target number of physical links in the link bundle, as requested by the customer.
        #[builder(into)]
        pub requested_link_count: pulumi_gestalt_rust::Input<i32>,
    }
    #[allow(dead_code)]
