...
pub mod region_commitment {
    ...
    fn __create(
        ...
        let existing_reservations_binding = args.existing_reservations.get_output(ctx);
        let license_resource_binding = args.license_resource.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &existing_reservations_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "licenseResource".into(),
                    value: &license_resource_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
