...
pub mod interconnect_attachment {
    ...
    fn __create(
        ...
        let candidate_subnets_binding = args.candidate_subnets.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let edge_availability_domain_binding = args
            .edge_availability_domain
            .get_output(ctx);
        let encryption_binding = args.encryption.get_output(ctx);
        let interconnect_binding = args.interconnect.get_output(ctx);
        ...
        let subnet_length_binding = args.subnet_length.get_output(ctx);
        let type__binding = args.type_.get_output(ctx);
        let vlan_tag8021q_binding = args.vlan_tag8021q.get_output(ctx);
