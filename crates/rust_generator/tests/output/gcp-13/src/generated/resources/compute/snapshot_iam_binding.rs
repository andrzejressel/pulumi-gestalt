...
pub mod snapshot_iam_binding {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct SnapshotIamBindingArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::compute::SnapshotIamBindingCondition>,
        >,
    ...
    #[allow(dead_code)]
    pub struct SnapshotIamBindingResult {
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:compute/snapshotIamBinding:SnapshotIamBinding".into(),
            name: name.to_string(),
