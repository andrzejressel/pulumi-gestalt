...
pub mod url_map {
    ...
    fn __create(
        ...
        let default_custom_error_response_policy_binding = args
            .default_custom_error_response_policy
            .get_output(ctx);
        let default_route_action_binding = args.default_route_action.get_output(ctx);
        let default_service_binding = args.default_service.get_output(ctx);
        let default_url_redirect_binding = args.default_url_redirect.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let header_action_binding = args.header_action.get_output(ctx);
        let host_rules_binding = args.host_rules.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let path_matchers_binding = args.path_matchers.get_output(ctx);
        let project_binding = args.project.get_output(ctx);
        let tests_binding = args.tests.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &default_custom_error_response_policy_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
