...
pub mod public_delegated_prefix {
    ...
    fn __create(
        ...
        let is_live_migration_binding = args.is_live_migration.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let parent_prefix_binding = args.parent_prefix.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &is_live_migration_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &parent_prefix_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "project".into(),
