...
pub mod firewall {
    ...
    pub struct FirewallArgs {
        ...
        pub allows: pulumi_gestalt_rust::Input<
        ...
        /// Structure is documented below.
        #[builder(into, default)]
        pub denies: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub destination_ranges: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        ...
        #[builder(into, default)]
        pub source_ranges: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        ...
        /// one of `source_ranges`, `source_tags` or `source_service_accounts` is required.
        #[builder(into, default)]
        pub source_tags: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        ...
        #[builder(into, default)]
        pub target_tags: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
    }
    #[allow(dead_code)]
    ...
    fn __create(
        ...
        let allows_binding = args.allows.get_output(ctx);
        let denies_binding = args.denies.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let destination_ranges_binding = args.destination_ranges.get_output(ctx);
        ...
        let source_ranges_binding = args.source_ranges.get_output(ctx);
        let source_service_accounts_binding = args
            .source_service_accounts
            .get_output(ctx);
        let source_tags_binding = args.source_tags.get_output(ctx);
        let target_service_accounts_binding = args
            .target_service_accounts
            .get_output(ctx);
        let target_tags_binding = args.target_tags.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "allows".into(),
                    value: &allows_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "denies".into(),
                    value: &denies_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &destination_ranges_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "direction".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &source_ranges_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "sourceServiceAccounts".into(),
                    value: &source_service_accounts_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "sourceTags".into(),
                    value: &source_tags_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &target_tags_binding.drop_type(),
                },
            ],
            options,
        };
