...
pub mod subnetwork {
    ...
    pub struct SubnetworkArgs {
        ...
        #[builder(into, default)]
        pub external_ipv6_prefix: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub ipv6_access_type: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub reserved_internal_range: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        /// Structure is documented below.
        #[builder(into, default)]
        pub secondary_ip_ranges: pulumi_gestalt_rust::Input<
    ...
    fn __create(
        ...
        let external_ipv6_prefix_binding = args.external_ipv6_prefix.get_output(ctx);
        let ip_cidr_range_binding = args.ip_cidr_range.get_output(ctx);
        let ipv6_access_type_binding = args.ipv6_access_type.get_output(ctx);
        ...
        let secondary_ip_ranges_binding = args.secondary_ip_ranges.get_output(ctx);
        let send_secondary_ip_range_if_empty_binding = args
            .send_secondary_ip_range_if_empty
            .get_output(ctx);
        let stack_type_binding = args.stack_type.get_output(ctx);
