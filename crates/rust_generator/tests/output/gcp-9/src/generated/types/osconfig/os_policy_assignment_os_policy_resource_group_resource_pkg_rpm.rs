...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpm {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for OsPolicyAssignmentOsPolicyResourceGroupResourcePkgRpm {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#pull_deps: {
                        let field_value = match fields_map.get("pullDeps") {
                            Some(value) => value,
                            None => bail!("Missing field 'pullDeps' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
