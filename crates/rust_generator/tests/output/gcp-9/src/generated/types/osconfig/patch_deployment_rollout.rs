...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PatchDeploymentRollout {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PatchDeploymentRollout {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#disruption_budget: {
                        let field_value = match fields_map.get("disruptionBudget") {
                            Some(value) => value,
                            None => bail!("Missing field 'disruptionBudget' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
