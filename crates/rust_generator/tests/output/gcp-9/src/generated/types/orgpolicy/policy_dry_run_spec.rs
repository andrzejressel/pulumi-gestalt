...
pub struct PolicyDryRunSpec {
    ...
    #[builder(into)]
    #[serde(rename = "reset")]
    pub r#reset: Option<bool>,
    /// In policies for boolean constraints, the following requirements apply: - There must be one and only one policy rule where condition is unset. - Boolean policy rules with conditions must set `enforced` to the opposite of the policy rule without a condition. - During policy evaluation, policy rules with conditions that are true for a target resource take precedence.
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "rules")]
    pub r#rules: Option<Vec<super::super::types::orgpolicy::PolicyDryRunSpecRule>>,
    /// (Output)
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PolicyDryRunSpec {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PolicyDryRunSpec {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#reset: {
                        let field_value = match fields_map.get("reset") {
                            Some(value) => value,
                            None => bail!("Missing field 'reset' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#rules: {
