...
pub struct GetCloudVmClusterProperty {
    /// OCI Cluster name.
    #[builder(into)]
    ...
    pub r#diagnostics_data_collection_options: Vec<super::super::types::oracledatabase::GetCloudVmClusterPropertyDiagnosticsDataCollectionOption>,
    ...
    pub r#time_zones: Vec<super::super::types::oracledatabase::GetCloudVmClusterPropertyTimeZone>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetCloudVmClusterProperty {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetCloudVmClusterProperty {
