...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ApiKeyRestrictions {
    ...
    > {
        async move {
            ...
            map.insert(
                "android_key_restrictions".to_string(),
            ...
            map.insert(
                "browser_key_restrictions".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "ios_key_restrictions".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "server_key_restrictions".to_string(),
                ToPulumiValue::to_pulumi_value(
