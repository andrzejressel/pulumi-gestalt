...
pub struct PatchDeploymentPatchConfigPreStepLinuxExecStepConfig {
    ...
    pub r#gcs_object: Option<Box<super::super::types::osconfig::PatchDeploymentPatchConfigPreStepLinuxExecStepConfigGcsObject>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PatchDeploymentPatchConfigPreStepLinuxExecStepConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PatchDeploymentPatchConfigPreStepLinuxExecStepConfig {
