...
pub struct GetCloudExadataInfrastructureProperty {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetCloudExadataInfrastructureProperty {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "activated_storage_count".to_string(),
            ...
            map.insert(
                "additional_storage_count".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "available_storage_size_gb".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "monthly_db_server_version".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "monthly_storage_server_version".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "next_maintenance_run_id".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "next_maintenance_run_time".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "next_security_maintenance_run_time".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "storage_server_version".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "total_storage_size_gb".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetCloudExadataInfrastructureProperty {
