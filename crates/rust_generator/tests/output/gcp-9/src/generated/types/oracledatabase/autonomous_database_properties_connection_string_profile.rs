...
pub struct AutonomousDatabasePropertiesConnectionStringProfile {
    ...
    pub r#host_format: Option<String>,
    ...
    pub r#session_mode: Option<String>,
    ...
    pub r#syntax_format: Option<String>,
    ...
    pub r#tls_authentication: Option<String>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AutonomousDatabasePropertiesConnectionStringProfile {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AutonomousDatabasePropertiesConnectionStringProfile {
