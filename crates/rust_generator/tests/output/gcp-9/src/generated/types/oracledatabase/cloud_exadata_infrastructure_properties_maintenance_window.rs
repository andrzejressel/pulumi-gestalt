...
pub struct CloudExadataInfrastructurePropertiesMaintenanceWindow {
    ...
    pub r#custom_action_timeout_mins: Option<i32>,
    ...
    pub r#hours_of_days: Option<Vec<i32>>,
    ...
    pub r#is_custom_action_timeout_enabled: Option<bool>,
    /// Lead time window allows user to set a lead time to prepare for a down time.
    /// The lead time is in weeks and valid value is between 1 to 4.
    #[builder(into)]
    #[serde(rename = "leadTimeWeek")]
    pub r#lead_time_week: Option<i32>,
    ...
    pub r#patching_mode: Option<String>,
    ...
    pub r#weeks_of_months: Option<Vec<i32>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CloudExadataInfrastructurePropertiesMaintenanceWindow {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CloudExadataInfrastructurePropertiesMaintenanceWindow {
