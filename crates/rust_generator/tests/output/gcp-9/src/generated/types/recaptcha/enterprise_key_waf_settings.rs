...
pub struct EnterpriseKeyWafSettings {
    ...
    pub r#waf_feature: String,
    /// The WAF service that uses this key. Possible values: CA, FASTLY
    #[builder(into)]
    #[serde(rename = "wafService")]
    pub r#waf_service: String,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EnterpriseKeyWafSettings {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for EnterpriseKeyWafSettings {
