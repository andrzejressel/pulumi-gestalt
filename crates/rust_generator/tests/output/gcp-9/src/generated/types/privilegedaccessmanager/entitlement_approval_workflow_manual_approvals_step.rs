...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EntitlementApprovalWorkflowManualApprovalsStep {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for EntitlementApprovalWorkflowManualApprovalsStep {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#approver_email_recipients: {
                        let field_value = match fields_map.get("approverEmailRecipients") {
                            Some(value) => value,
                            None => bail!("Missing field 'approverEmailRecipients' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#approvers: {
