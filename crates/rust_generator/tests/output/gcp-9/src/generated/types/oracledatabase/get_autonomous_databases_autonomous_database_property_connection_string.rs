...
pub struct GetAutonomousDatabasesAutonomousDatabasePropertyConnectionString {
    /// A list of all connection strings that can be used to connect to the
    /// Autonomous Database.
    #[builder(into)]
    pub r#all_connection_strings: Vec<super::super::types::oracledatabase::GetAutonomousDatabasesAutonomousDatabasePropertyConnectionStringAllConnectionString>,
    ...
    #[builder(into)]
    pub r#profiles: Vec<super::super::types::oracledatabase::GetAutonomousDatabasesAutonomousDatabasePropertyConnectionStringProfile>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetAutonomousDatabasesAutonomousDatabasePropertyConnectionString {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetAutonomousDatabasesAutonomousDatabasePropertyConnectionString {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#all_connection_strings: {
                        let field_value = match fields_map.get("allConnectionStrings") {
                            Some(value) => value,
                            None => bail!("Missing field 'allConnectionStrings' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
