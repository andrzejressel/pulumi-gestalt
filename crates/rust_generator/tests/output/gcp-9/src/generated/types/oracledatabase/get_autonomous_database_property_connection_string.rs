...
pub struct GetAutonomousDatabasePropertyConnectionString {
    ...
    pub r#all_connection_strings: Vec<super::super::types::oracledatabase::GetAutonomousDatabasePropertyConnectionStringAllConnectionString>,
    ...
    pub r#profiles: Vec<super::super::types::oracledatabase::GetAutonomousDatabasePropertyConnectionStringProfile>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetAutonomousDatabasePropertyConnectionString {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetAutonomousDatabasePropertyConnectionString {
