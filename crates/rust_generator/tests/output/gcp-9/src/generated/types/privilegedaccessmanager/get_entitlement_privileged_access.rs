...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetEntitlementPrivilegedAccess {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "gcp_iam_accesses".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#gcp_iam_accesses,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetEntitlementPrivilegedAccess {
