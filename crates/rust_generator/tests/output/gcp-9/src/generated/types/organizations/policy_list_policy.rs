...
pub struct PolicyListPolicy {
    /// or `deny` - (Optional) One or the other must be set.
    #[builder(into)]
    #[serde(rename = "allow")]
    pub r#allow: Option<Box<super::super::types::organizations::PolicyListPolicyAllow>>,
    /// One or the other must be set.
    #[builder(into)]
    #[serde(rename = "deny")]
    pub r#deny: Option<Box<super::super::types::organizations::PolicyListPolicyDeny>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PolicyListPolicy {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PolicyListPolicy {
