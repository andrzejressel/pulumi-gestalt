...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetEntitlementApprovalWorkflow {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetEntitlementApprovalWorkflow {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#manual_approvals: {
                        let field_value = match fields_map.get("manualApprovals") {
                            Some(value) => value,
                            None => bail!("Missing field 'manualApprovals' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
