...
pub mod entitlement {
    ...
    fn __create(
        ...
        let additional_notification_targets_binding = args
            .additional_notification_targets
            .get_output(ctx);
        let approval_workflow_binding = args.approval_workflow.get_output(ctx);
        let eligible_users_binding = args.eligible_users.get_output(ctx);
        let entitlement_id_binding = args.entitlement_id.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let max_request_duration_binding = args.max_request_duration.get_output(ctx);
        let parent_binding = args.parent.get_output(ctx);
        let privileged_access_binding = args.privileged_access.get_output(ctx);
