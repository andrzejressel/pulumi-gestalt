...
pub mod patch_deployment {
    ...
    fn __create(
        ...
        let instance_filter_binding = args.instance_filter.get_output(ctx);
        let one_time_schedule_binding = args.one_time_schedule.get_output(ctx);
        let patch_config_binding = args.patch_config.get_output(ctx);
        let patch_deployment_id_binding = args.patch_deployment_id.get_output(ctx);
        let project_binding = args.project.get_output(ctx);
        let recurring_schedule_binding = args.recurring_schedule.get_output(ctx);
        let rollout_binding = args.rollout.get_output(ctx);
