...
pub mod schema_iam_binding {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct SchemaIamBindingArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::pubsub::SchemaIamBindingCondition>,
        >,
    ...
    #[allow(dead_code)]
    pub struct SchemaIamBindingResult {
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:pubsub/schemaIamBinding:SchemaIamBinding".into(),
            name: name.to_string(),
