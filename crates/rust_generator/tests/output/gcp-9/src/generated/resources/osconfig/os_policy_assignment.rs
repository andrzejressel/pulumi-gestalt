...
pub mod os_policy_assignment {
    ...
    fn __create(
        ...
        let os_policies_binding = args.os_policies.get_output(ctx);
        let project_binding = args.project.get_output(ctx);
        let rollout_binding = args.rollout.get_output(ctx);
        let skip_await_rollout_binding = args.skip_await_rollout.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &os_policies_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "project".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &skip_await_rollout_binding.drop_type(),
                },
            ],
            options,
        };
