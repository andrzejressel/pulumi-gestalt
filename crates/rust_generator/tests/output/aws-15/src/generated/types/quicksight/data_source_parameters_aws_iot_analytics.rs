    ...
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#data_set_name: {
                        let field_value = match fields_map.get("dataSetName") {
                            Some(value) => value,
                            None => bail!("Missing field 'dataSetName' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
