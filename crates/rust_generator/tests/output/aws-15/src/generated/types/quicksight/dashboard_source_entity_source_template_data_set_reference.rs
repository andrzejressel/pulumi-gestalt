...
pub struct DashboardSourceEntitySourceTemplateDataSetReference {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DashboardSourceEntitySourceTemplateDataSetReference {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("data_set_placeholder".to_string(), self.r#data_set_placeholder.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DashboardSourceEntitySourceTemplateDataSetReference {
