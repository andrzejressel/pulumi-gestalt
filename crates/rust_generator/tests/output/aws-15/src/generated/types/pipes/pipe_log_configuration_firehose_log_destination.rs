...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PipeLogConfigurationFirehoseLogDestination {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "delivery_stream_arn".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#delivery_stream_arn,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PipeLogConfigurationFirehoseLogDestination {
