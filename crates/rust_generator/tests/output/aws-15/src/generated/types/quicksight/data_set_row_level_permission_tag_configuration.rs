...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DataSetRowLevelPermissionTagConfiguration {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("tag_rules".to_string(), self.r#tag_rules.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DataSetRowLevelPermissionTagConfiguration {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#tag_rules: {
                        ...
                        <Vec<super::super::types::quicksight::DataSetRowLevelPermissionTagConfigurationTagRule> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
