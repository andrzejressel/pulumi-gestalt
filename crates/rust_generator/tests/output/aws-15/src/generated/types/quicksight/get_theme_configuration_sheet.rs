...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetThemeConfigurationSheet {
    ...
    > {
        async move {
            ...
            map.insert("tile_layouts".to_string(), self.r#tile_layouts.to_pulumi_value().await);
            map.insert("tiles".to_string(), self.r#tiles.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#tile_layouts: {
                        ...
                        <Vec<super::super::types::quicksight::GetThemeConfigurationSheetTileLayout> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#tiles: {
                        ...
                        <Vec<super::super::types::quicksight::GetThemeConfigurationSheetTile> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
