...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AppCampaignHook {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("lambda_function_name".to_string(), self.r#lambda_function_name.to_pulumi_value().await);
            map.insert("mode".to_string(), self.r#mode.to_pulumi_value().await);
            map.insert("web_url".to_string(), self.r#web_url.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AppCampaignHook {
