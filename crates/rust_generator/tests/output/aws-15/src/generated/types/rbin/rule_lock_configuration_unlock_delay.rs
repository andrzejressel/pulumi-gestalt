...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RuleLockConfigurationUnlockDelay {
    ...
    > {
        async move {
            ...
            map.insert("unlock_delay_unit".to_string(), self.r#unlock_delay_unit.to_pulumi_value().await);
            map.insert("unlock_delay_value".to_string(), self.r#unlock_delay_value.to_pulumi_value().await);
