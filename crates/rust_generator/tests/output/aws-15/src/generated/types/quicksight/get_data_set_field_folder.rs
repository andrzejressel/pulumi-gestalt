...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetDataSetFieldFolder {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("field_folders_id".to_string(), self.r#field_folders_id.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetDataSetFieldFolder {
