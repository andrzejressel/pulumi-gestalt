...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PipeTargetParametersEcsTaskParametersCapacityProviderStrategy {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("base".to_string(), self.r#base.to_pulumi_value().await);
            map.insert("capacity_provider".to_string(), self.r#capacity_provider.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PipeTargetParametersEcsTaskParametersCapacityProviderStrategy {
