            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#date_time_parameters: {
                        ...
                        <Option<Vec<super::super::types::quicksight::DashboardParametersDateTimeParameter>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#decimal_parameters: {
                        ...
                        <Option<Vec<super::super::types::quicksight::DashboardParametersDecimalParameter>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#integer_parameters: {
                        ...
                        <Option<Vec<super::super::types::quicksight::DashboardParametersIntegerParameter>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#string_parameters: {
                        ...
                        <Option<Vec<super::super::types::quicksight::DashboardParametersStringParameter>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
