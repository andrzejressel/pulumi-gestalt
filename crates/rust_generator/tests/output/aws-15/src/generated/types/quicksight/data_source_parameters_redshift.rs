...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DataSourceParametersRedshift {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("cluster_id".to_string(), self.r#cluster_id.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DataSourceParametersRedshift {
