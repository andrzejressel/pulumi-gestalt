...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TemplatePermission {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for TemplatePermission {
