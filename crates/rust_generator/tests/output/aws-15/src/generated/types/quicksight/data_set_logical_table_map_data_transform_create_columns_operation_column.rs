...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DataSetLogicalTableMapDataTransformCreateColumnsOperationColumn {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("column_id".to_string(), self.r#column_id.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DataSetLogicalTableMapDataTransformCreateColumnsOperationColumn {
