...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DataSetPhysicalTableMapCustomSql {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("sql_query".to_string(), self.r#sql_query.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DataSetPhysicalTableMapCustomSql {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#columns: {
                        ...
                        <Option<Vec<super::super::types::quicksight::DataSetPhysicalTableMapCustomSqlColumn>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#data_source_arn: {
