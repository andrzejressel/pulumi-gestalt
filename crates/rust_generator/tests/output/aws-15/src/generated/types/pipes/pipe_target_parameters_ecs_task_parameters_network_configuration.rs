            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#aws_vpc_configuration: {
                        let field_value = match fields_map.get("awsVpcConfiguration") {
                            Some(value) => value,
                            None => bail!("Missing field 'awsVpcConfiguration' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
