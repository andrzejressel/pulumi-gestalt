...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RuleResourceTag {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("resource_tag_key".to_string(), self.r#resource_tag_key.to_pulumi_value().await);
            map.insert("resource_tag_value".to_string(), self.r#resource_tag_value.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RuleResourceTag {
