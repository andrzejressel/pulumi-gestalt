...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PipeSourceParametersKinesisStreamParameters {
    ...
    > {
        async move {
            ...
            map.insert("maximum_record_age_in_seconds".to_string(), self.r#maximum_record_age_in_seconds.to_pulumi_value().await);
            map.insert("maximum_retry_attempts".to_string(), self.r#maximum_retry_attempts.to_pulumi_value().await);
            map.insert("on_partial_batch_item_failure".to_string(), self.r#on_partial_batch_item_failure.to_pulumi_value().await);
            map.insert("parallelization_factor".to_string(), self.r#parallelization_factor.to_pulumi_value().await);
            map.insert("starting_position".to_string(), self.r#starting_position.to_pulumi_value().await);
            map.insert("starting_position_timestamp".to_string(), self.r#starting_position_timestamp.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#dead_letter_config: {
                        ...
                        <Option<Box<super::super::types::pipes::PipeSourceParametersKinesisStreamParametersDeadLetterConfig>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
