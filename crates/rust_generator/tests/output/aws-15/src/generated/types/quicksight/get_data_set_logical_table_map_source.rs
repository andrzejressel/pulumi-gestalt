...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetDataSetLogicalTableMapSource {
    ...
    > {
        async move {
            ...
            map.insert("join_instructions".to_string(), self.r#join_instructions.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#join_instructions: {
                        ...
                        <Vec<super::super::types::quicksight::GetDataSetLogicalTableMapSourceJoinInstruction> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#physical_table_id: {
