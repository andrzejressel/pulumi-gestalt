...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TemplateSourceEntity {
    ...
    > {
        async move {
            ...
            map.insert("source_analysis".to_string(), self.r#source_analysis.to_pulumi_value().await);
            map.insert("source_template".to_string(), self.r#source_template.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#source_analysis: {
                        ...
                        <Option<Box<super::super::types::quicksight::TemplateSourceEntitySourceAnalysis>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#source_template: {
                        ...
                        <Option<Box<super::super::types::quicksight::TemplateSourceEntitySourceTemplate>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
