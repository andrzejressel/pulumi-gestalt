...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RefreshScheduleSchedule {
    ...
    > {
        async move {
            ...
            map.insert("refresh_type".to_string(), self.r#refresh_type.to_pulumi_value().await);
            map.insert("schedule_frequency".to_string(), self.r#schedule_frequency.to_pulumi_value().await);
            map.insert("start_after_date_time".to_string(), self.r#start_after_date_time.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#schedule_frequency: {
                        ...
                        <Option<Box<super::super::types::quicksight::RefreshScheduleScheduleScheduleFrequency>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
