...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PipeTargetParameters {
    ...
    > {
        async move {
            ...
            map.insert("batch_job_parameters".to_string(), self.r#batch_job_parameters.to_pulumi_value().await);
            map.insert("cloudwatch_logs_parameters".to_string(), self.r#cloudwatch_logs_parameters.to_pulumi_value().await);
            map.insert("ecs_task_parameters".to_string(), self.r#ecs_task_parameters.to_pulumi_value().await);
            map.insert("eventbridge_event_bus_parameters".to_string(), self.r#eventbridge_event_bus_parameters.to_pulumi_value().await);
            map.insert("http_parameters".to_string(), self.r#http_parameters.to_pulumi_value().await);
            ...
            map.insert("lambda_function_parameters".to_string(), self.r#lambda_function_parameters.to_pulumi_value().await);
            map.insert("redshift_data_parameters".to_string(), self.r#redshift_data_parameters.to_pulumi_value().await);
            ...
            map.insert("step_function_state_machine_parameters".to_string(), self.r#step_function_state_machine_parameters.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#batch_job_parameters: {
                        ...
                        <Option<Box<super::super::types::pipes::PipeTargetParametersBatchJobParameters>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#cloudwatch_logs_parameters: {
                        ...
                        <Option<Box<super::super::types::pipes::PipeTargetParametersCloudwatchLogsParameters>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#ecs_task_parameters: {
                        ...
                        <Option<Box<super::super::types::pipes::PipeTargetParametersEcsTaskParameters>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#eventbridge_event_bus_parameters: {
                        ...
                        <Option<Box<super::super::types::pipes::PipeTargetParametersEventbridgeEventBusParameters>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#http_parameters: {
                        ...
                        <Option<Box<super::super::types::pipes::PipeTargetParametersHttpParameters>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#input_template: {
                    ...
                    r#kinesis_stream_parameters: {
                        ...
                        <Option<Box<super::super::types::pipes::PipeTargetParametersKinesisStreamParameters>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#lambda_function_parameters: {
                        ...
                        <Option<Box<super::super::types::pipes::PipeTargetParametersLambdaFunctionParameters>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#redshift_data_parameters: {
                        ...
                        <Option<Box<super::super::types::pipes::PipeTargetParametersRedshiftDataParameters>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#sagemaker_pipeline_parameters: {
                        ...
                        <Option<Box<super::super::types::pipes::PipeTargetParametersSagemakerPipelineParameters>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#sqs_queue_parameters: {
                        ...
                        <Option<Box<super::super::types::pipes::PipeTargetParametersSqsQueueParameters>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#step_function_state_machine_parameters: {
                        ...
                        <Option<Box<super::super::types::pipes::PipeTargetParametersStepFunctionStateMachineParameters>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
