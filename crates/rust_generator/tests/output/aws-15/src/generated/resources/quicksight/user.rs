...
pub mod user {
    ...
    pub struct UserArgs {
        ...
        #[builder(into, default)]
        pub iam_arn: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub session_name: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into)]
        pub user_role: pulumi_gestalt_rust::Input<String>,
    }
    #[allow(dead_code)]
