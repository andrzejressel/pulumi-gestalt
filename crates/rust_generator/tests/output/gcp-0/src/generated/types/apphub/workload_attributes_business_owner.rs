...
pub struct WorkloadAttributesBusinessOwner {
    /// Contact's name.
    #[builder(into)]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WorkloadAttributesBusinessOwner {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WorkloadAttributesBusinessOwner {
