...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetDiscoveredServiceServiceProperty {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetDiscoveredServiceServiceProperty {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#gcp_project: {
                        let field_value = match fields_map.get("gcpProject") {
                            Some(value) => value,
                            None => bail!("Missing field 'gcpProject' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
