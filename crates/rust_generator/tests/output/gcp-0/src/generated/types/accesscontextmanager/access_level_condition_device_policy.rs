...
pub struct AccessLevelConditionDevicePolicy {
    ...
    pub r#os_constraints: Option<Vec<super::super::types::accesscontextmanager::AccessLevelConditionDevicePolicyOsConstraint>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AccessLevelConditionDevicePolicy {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AccessLevelConditionDevicePolicy {
