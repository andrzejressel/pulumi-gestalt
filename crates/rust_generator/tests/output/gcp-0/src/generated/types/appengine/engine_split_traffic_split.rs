...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EngineSplitTrafficSplit {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for EngineSplitTrafficSplit {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#allocations: {
                        let field_value = match fields_map.get("allocations") {
                            Some(value) => value,
                            None => bail!("Missing field 'allocations' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
