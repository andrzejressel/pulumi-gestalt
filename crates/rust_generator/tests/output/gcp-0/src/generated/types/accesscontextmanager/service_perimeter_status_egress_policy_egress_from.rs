...
pub struct ServicePerimeterStatusEgressPolicyEgressFrom {
    ...
    pub r#sources: Option<Vec<super::super::types::accesscontextmanager::ServicePerimeterStatusEgressPolicyEgressFromSource>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ServicePerimeterStatusEgressPolicyEgressFrom {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ServicePerimeterStatusEgressPolicyEgressFrom {
