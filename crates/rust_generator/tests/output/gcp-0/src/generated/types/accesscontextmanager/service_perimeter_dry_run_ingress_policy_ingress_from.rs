...
pub struct ServicePerimeterDryRunIngressPolicyIngressFrom {
    ...
    pub r#sources: Option<Vec<super::super::types::accesscontextmanager::ServicePerimeterDryRunIngressPolicyIngressFromSource>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ServicePerimeterDryRunIngressPolicyIngressFrom {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ServicePerimeterDryRunIngressPolicyIngressFrom {
