...
pub struct ServicePerimeterStatusIngressPolicyIngressFrom {
    ...
    pub r#sources: Option<Vec<super::super::types::accesscontextmanager::ServicePerimeterStatusIngressPolicyIngressFromSource>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ServicePerimeterStatusIngressPolicyIngressFrom {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ServicePerimeterStatusIngressPolicyIngressFrom {
