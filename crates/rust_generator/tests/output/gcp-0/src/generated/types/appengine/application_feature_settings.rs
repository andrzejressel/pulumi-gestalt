...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ApplicationFeatureSettings {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "split_health_checks".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#split_health_checks,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ApplicationFeatureSettings {
