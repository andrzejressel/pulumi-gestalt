...
pub mod gateway_iam_member {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct GatewayIamMemberArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::Input<
            Option<super::super::types::apigateway::GatewayIamMemberCondition>,
        >,
        #[builder(into)]
        pub gateway: pulumi_gestalt_rust::Input<String>,
    ...
    #[allow(dead_code)]
    pub struct GatewayIamMemberResult {
    ...
    fn __create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:apigateway/gatewayIamMember:GatewayIamMember".into(),
            name: name.to_string(),
