...
pub mod access_policy_iam_member {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct AccessPolicyIamMemberArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<
                super::super::types::accesscontextmanager::AccessPolicyIamMemberCondition,
            >,
        >,
    ...
    #[allow(dead_code)]
    pub struct AccessPolicyIamMemberResult {
    ...
    ) -> AccessPolicyIamMemberResult {
        let condition_binding = args.condition.get_output(context);
        let member_binding = args.member.get_output(context);
        let name_binding = args.name.get_output(context);
        let role_binding = args.role.get_output(context);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:accesscontextmanager/accessPolicyIamMember:AccessPolicyIamMember"
                .into(),
            name: name.to_string(),
