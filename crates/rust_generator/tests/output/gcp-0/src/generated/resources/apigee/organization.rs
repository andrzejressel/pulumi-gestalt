...
pub mod organization {
    ...
    pub struct OrganizationArgs {
        ...
        pub analytics_region: pulumi_gestalt_rust::Input<Option<String>>,
        /// Cloud KMS key name used for encrypting API consumer data.
        #[builder(into, default)]
        pub api_consumer_data_encryption_key_name: pulumi_gestalt_rust::Input<
            Option<String>,
        >,
        ...
        #[builder(into, default)]
        pub control_plane_encryption_key_name: pulumi_gestalt_rust::Input<
            Option<String>,
        >,
        ...
        #[builder(into, default)]
        pub disable_vpc_peering: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub retention: pulumi_gestalt_rust::Input<Option<String>>,
        /// Cloud KMS key name used for encrypting the data that is stored and replicated across runtime instances.
        /// Update is not allowed after the organization is created.
        /// If not specified, a Google-Managed encryption key will be used.
        /// Valid only when `RuntimeType` is CLOUD. For example: `projects/foo/locations/us/keyRings/bar/cryptoKeys/baz`.
        #[builder(into, default)]
        pub runtime_database_encryption_key_name: pulumi_gestalt_rust::Input<
            Option<String>,
        >,
        ...
        #[builder(into, default)]
        pub runtime_type: pulumi_gestalt_rust::Input<Option<String>>,
    }
    #[allow(dead_code)]
