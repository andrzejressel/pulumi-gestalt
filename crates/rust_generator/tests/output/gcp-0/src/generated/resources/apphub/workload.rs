...
pub mod workload {
    ...
    pub struct WorkloadArgs {
        ...
        #[builder(into)]
        pub discovered_workload: pulumi_gestalt_rust::Input<String>,
        ...
        /// - - -
        #[builder(into)]
        pub workload_id: pulumi_gestalt_rust::Input<String>,
    }
    #[allow(dead_code)]
    ...
    fn __create(
        ...
        let discovered_workload_binding = args.discovered_workload.get_output(ctx);
        let display_name_binding = args.display_name.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let project_binding = args.project.get_output(ctx);
        let workload_id_binding = args.workload_id.get_output(ctx);
