...
pub mod kubernetes_cluster_node_pool {
    ...
    pub struct KubernetesClusterNodePoolArgs {
        ...
        #[builder(into, default)]
        pub gpu_instance: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub host_encryption_enabled: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub host_group_id: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub kubelet_disk_type: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub linux_os_config: pulumi_gestalt_rust::Input<
            Option<
                super::super::types::containerservice::KubernetesClusterNodePoolLinuxOsConfig,
            >,
        >,
        #[builder(into, default)]
        pub max_count: pulumi_gestalt_rust::Input<Option<i32>>,
        /// The maximum number of pods that can run on each agent. Changing this forces a new resource to be created.
        #[builder(into, default)]
        pub max_pods: pulumi_gestalt_rust::Input<Option<i32>>,
        #[builder(into, default)]
        pub min_count: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub node_network_profile: pulumi_gestalt_rust::Input<
            Option<
        ...
        #[builder(into, default)]
        pub node_public_ip_prefix_id: pulumi_gestalt_rust::Input<Option<String>>,
        /// A list of Kubernetes taints which should be applied to nodes in the agent pool (e.g `key=value:NoSchedule`).
        #[builder(into, default)]
        pub node_taints: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        ...
        #[builder(into, default)]
        pub orchestrator_version: pulumi_gestalt_rust::Input<Option<String>>,
        /// The Agent Operating System disk size in GB. Changing this forces a new resource to be created.
        #[builder(into, default)]
        pub os_disk_size_gb: pulumi_gestalt_rust::Input<Option<i32>>,
        /// The type of disk which should be used for the Operating System. Possible values are `Ephemeral` and `Managed`. Defaults to `Managed`. Changing this forces a new resource to be created.
        #[builder(into, default)]
        pub os_disk_type: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub os_sku: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub pod_subnet_id: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub spot_max_price: pulumi_gestalt_rust::Input<Option<f64>>,
        ...
        #[builder(into, default)]
        pub ultra_ssd_enabled: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub vnet_subnet_id: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub workload_runtime: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &gpu_instance_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "hostEncryptionEnabled".into(),
                    value: &host_encryption_enabled_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &kubelet_disk_type_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &linux_os_config_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "maxCount".into(),
                    value: &max_count_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "maxPods".into(),
                    value: &max_pods_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "minCount".into(),
                    value: &min_count_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "mode".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &node_labels_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "nodeNetworkProfile".into(),
                    value: &node_network_profile_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &node_public_ip_prefix_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "nodeTaints".into(),
                    value: &node_taints_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "orchestratorVersion".into(),
                    value: &orchestrator_version_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "osDiskSizeGb".into(),
                    value: &os_disk_size_gb_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "osDiskType".into(),
                    value: &os_disk_type_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "osSku".into(),
                    value: &os_sku_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "osType".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &pod_subnet_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "priority".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &scale_down_mode_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &spot_max_price_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "tags".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &ultra_ssd_enabled_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "upgradeSettings".into(),
                    value: &upgrade_settings_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "vmSize".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &vnet_subnet_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "windowsProfile".into(),
                    value: &windows_profile_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "workloadRuntime".into(),
                    value: &workload_runtime_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "zones".into(),
