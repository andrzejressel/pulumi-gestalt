...
pub mod sql_container {
    ...
    fn __create(
        ...
        let indexing_policy_binding = args.indexing_policy.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let partition_key_kind_binding = args.partition_key_kind.get_output(ctx);
        let partition_key_paths_binding = args.partition_key_paths.get_output(ctx);
