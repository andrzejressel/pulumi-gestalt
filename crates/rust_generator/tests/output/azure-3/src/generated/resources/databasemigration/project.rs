...
pub mod project {
    ...
    pub struct ProjectArgs {
        ...
        #[builder(into)]
        pub source_platform: pulumi_gestalt_rust::Input<String>,
        ...
        #[builder(into)]
        pub target_platform: pulumi_gestalt_rust::Input<String>,
    }
    #[allow(dead_code)]
    ...
    fn __create(
        ...
        let source_platform_binding = args.source_platform.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let target_platform_binding = args.target_platform.get_output(ctx);
