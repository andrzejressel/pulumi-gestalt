...
pub mod job {
    ...
    fn __create(
        ...
        let container_app_environment_id_binding = args
            ...
            .get_output(ctx);
        let event_trigger_config_binding = args.event_trigger_config.get_output(ctx);
        let identity_binding = args.identity.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let manual_trigger_config_binding = args.manual_trigger_config.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let registries_binding = args.registries.get_output(ctx);
        let replica_retry_limit_binding = args.replica_retry_limit.get_output(ctx);
