...
pub mod prefix {
    ...
    pub struct PrefixArgs {
        ...
        pub commissioning_enabled: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub roa_validity_end_date: pulumi_gestalt_rust::Input<Option<String>>,
    ...
    fn __create(
        ...
        let commissioning_enabled_binding = args.commissioning_enabled.get_output(ctx);
        ...
        let roa_validity_end_date_binding = args.roa_validity_end_date.get_output(ctx);
