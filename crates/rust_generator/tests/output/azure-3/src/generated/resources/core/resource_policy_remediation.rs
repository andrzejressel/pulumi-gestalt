...
pub mod resource_policy_remediation {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct ResourcePolicyRemediationArgs {
    ...
    #[allow(dead_code)]
    pub struct ResourcePolicyRemediationResult {
    ...
    pub fn create(
        ...
        ResourcePolicyRemediationResult {
            ...
            resource_discovery_mode: o.get_field("resourceDiscoveryMode"),
