...
pub mod grafana {
    ...
    fn __create(
        ...
        let api_key_enabled_binding = args.api_key_enabled.get_output(ctx);
        ...
        let deterministic_outbound_ip_enabled_binding = args
            ...
            .get_output(ctx);
        let grafana_major_version_binding = args.grafana_major_version.get_output(ctx);
        ...
        let smtp_binding = args.smtp.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &api_key_enabled_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "autoGeneratedDomainNameLabelScope".into(),
                    value: &auto_generated_domain_name_label_scope_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "azureMonitorWorkspaceIntegrations".into(),
                    value: &azure_monitor_workspace_integrations_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "deterministicOutboundIpEnabled".into(),
                    value: &deterministic_outbound_ip_enabled_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "grafanaMajorVersion".into(),
                    value: &grafana_major_version_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "identity".into(),
