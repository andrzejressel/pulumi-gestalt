...
pub mod mongo_collection {
    ...
    fn __create(
        ...
        let default_ttl_seconds_binding = args.default_ttl_seconds.get_output(ctx);
        let indices_binding = args.indices.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let resource_group_name_binding = args.resource_group_name.get_output(ctx);
        let shard_key_binding = args.shard_key.get_output(ctx);
