...
pub mod mongo_cluster {
    ...
    pub struct MongoClusterArgs {
        ...
        #[builder(into, default)]
        pub administrator_username: pulumi_gestalt_rust::Input<Option<String>>,
        /// The compute tier to assign to the MongoDB Cluster. Possible values are `Free`, `M25`, `M30`, `M40`, `M50`, `M60` and `M80`.
        #[builder(into, default)]
        pub compute_tier: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub high_availability_mode: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub preview_features: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        ...
        #[builder(into, default)]
        pub storage_size_in_gb: pulumi_gestalt_rust::Input<Option<i32>>,
