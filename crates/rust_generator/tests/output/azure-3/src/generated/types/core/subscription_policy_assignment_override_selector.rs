...
pub struct SubscriptionPolicyAssignmentOverrideSelector {
    #[builder(into)]
    #[serde(rename = "ins")]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for SubscriptionPolicyAssignmentOverrideSelector {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for SubscriptionPolicyAssignmentOverrideSelector {
