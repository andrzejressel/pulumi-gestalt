...
pub struct KubernetesClusterNodePoolWindowsProfile {
    ...
    pub r#outbound_nat_enabled: Option<bool>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for KubernetesClusterNodePoolWindowsProfile {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "outbound_nat_enabled".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for KubernetesClusterNodePoolWindowsProfile {
