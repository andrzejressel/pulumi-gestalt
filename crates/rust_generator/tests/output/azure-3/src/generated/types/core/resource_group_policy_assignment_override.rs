...
pub struct ResourceGroupPolicyAssignmentOverride {
    ...
    pub r#selectors: Option<Vec<super::super::types::core::ResourceGroupPolicyAssignmentOverrideSelector>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ResourceGroupPolicyAssignmentOverride {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ResourceGroupPolicyAssignmentOverride {
