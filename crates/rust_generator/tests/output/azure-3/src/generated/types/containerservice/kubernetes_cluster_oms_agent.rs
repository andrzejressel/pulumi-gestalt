...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for KubernetesClusterOmsAgent {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "msi_auth_for_monitoring_enabled".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "oms_agent_identities".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for KubernetesClusterOmsAgent {
