...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for MongoCollectionSystemIndex {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for MongoCollectionSystemIndex {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#unique: {
                        let field_value = match fields_map.get("unique") {
                            Some(value) => value,
                            None => bail!("Missing field 'unique' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
