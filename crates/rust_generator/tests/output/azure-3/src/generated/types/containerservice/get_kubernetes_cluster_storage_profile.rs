...
pub struct GetKubernetesClusterStorageProfile {
    ...
    pub r#blob_driver_enabled: bool,
    /// Is the Disk CSI driver enabled?
    #[builder(into)]
    #[serde(rename = "diskDriverEnabled")]
    pub r#disk_driver_enabled: bool,
    /// Is the File CSI driver enabled?
    #[builder(into)]
    #[serde(rename = "fileDriverEnabled")]
    pub r#file_driver_enabled: bool,
    /// Is the Snapshot Controller enabled?
    #[builder(into)]
    #[serde(rename = "snapshotControllerEnabled")]
    pub r#snapshot_controller_enabled: bool,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetKubernetesClusterStorageProfile {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetKubernetesClusterStorageProfile {
