...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RegistryTaskRegistryCredential {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RegistryTaskRegistryCredential {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#customs: {
                        let field_value = match fields_map.get("customs") {
                            Some(value) => value,
                            None => bail!("Missing field 'customs' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
