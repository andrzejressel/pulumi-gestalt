...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for KubernetesClusterMaintenanceWindow {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for KubernetesClusterMaintenanceWindow {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#alloweds: {
                        let field_value = match fields_map.get("alloweds") {
                            Some(value) => value,
                            None => bail!("Missing field 'alloweds' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
