...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GremlinGraphConflictResolutionPolicy {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "conflict_resolution_path".to_string(),
            ...
            map.insert(
                "conflict_resolution_procedure".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GremlinGraphConflictResolutionPolicy {
