...
pub struct ResourceDeploymentScriptPowerShellContainer {
    ...
    pub r#container_group_name: Option<String>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ResourceDeploymentScriptPowerShellContainer {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "container_group_name".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#container_group_name,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ResourceDeploymentScriptPowerShellContainer {
