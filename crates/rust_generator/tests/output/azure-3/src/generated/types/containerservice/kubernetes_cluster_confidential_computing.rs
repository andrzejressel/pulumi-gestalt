...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for KubernetesClusterConfidentialComputing {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "sgx_quote_helper_enabled".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#sgx_quote_helper_enabled,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for KubernetesClusterConfidentialComputing {
