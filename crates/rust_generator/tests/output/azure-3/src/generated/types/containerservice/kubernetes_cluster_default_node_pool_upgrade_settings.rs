...
pub struct KubernetesClusterDefaultNodePoolUpgradeSettings {
    ...
    pub r#drain_timeout_in_minutes: Option<i32>,
    ...
    pub r#node_soak_duration_in_minutes: Option<i32>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for KubernetesClusterDefaultNodePoolUpgradeSettings {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for KubernetesClusterDefaultNodePoolUpgradeSettings {
