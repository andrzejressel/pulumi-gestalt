...
pub struct AppTemplateTcpScaleRule {
    ...
    pub r#authentications: Option<Vec<super::super::types::containerapp::AppTemplateTcpScaleRuleAuthentication>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AppTemplateTcpScaleRule {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AppTemplateTcpScaleRule {
