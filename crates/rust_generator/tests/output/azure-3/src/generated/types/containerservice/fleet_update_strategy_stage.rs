...
pub struct FleetUpdateStrategyStage {
    ...
    #[builder(into)]
    #[serde(rename = "groups")]
    pub r#groups: Vec<super::super::types::containerservice::FleetUpdateStrategyStageGroup>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FleetUpdateStrategyStage {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "after_stage_wait_in_seconds".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FleetUpdateStrategyStage {
