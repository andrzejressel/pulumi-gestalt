...
pub struct AppTemplateAzureQueueScaleRule {
    ...
    pub r#authentications: Vec<super::super::types::containerapp::AppTemplateAzureQueueScaleRuleAuthentication>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AppTemplateAzureQueueScaleRule {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AppTemplateAzureQueueScaleRule {
