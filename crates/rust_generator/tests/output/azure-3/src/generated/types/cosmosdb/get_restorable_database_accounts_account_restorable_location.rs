...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetRestorableDatabaseAccountsAccountRestorableLocation {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "regional_database_account_instance_id".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#regional_database_account_instance_id,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetRestorableDatabaseAccountsAccountRestorableLocation {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#regional_database_account_instance_id: {
                        let field_value = match fields_map.get("regional_database_account_instance_id") {
                            Some(value) => value,
                            None => bail!("Missing field 'regional_database_account_instance_id' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
