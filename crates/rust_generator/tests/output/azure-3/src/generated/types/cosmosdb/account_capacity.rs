...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AccountCapacity {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "total_throughput_limit".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AccountCapacity {
