...
pub struct GetAppTemplateTcpScaleRule {
    ...
    pub r#authentications: Vec<super::super::types::containerapp::GetAppTemplateTcpScaleRuleAuthentication>,
    #[builder(into)]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetAppTemplateTcpScaleRule {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetAppTemplateTcpScaleRule {
