...
pub struct ResourceGroupPolicyAssignmentOverrideSelector {
    #[builder(into)]
    #[serde(rename = "ins")]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ResourceGroupPolicyAssignmentOverrideSelector {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ResourceGroupPolicyAssignmentOverrideSelector {
