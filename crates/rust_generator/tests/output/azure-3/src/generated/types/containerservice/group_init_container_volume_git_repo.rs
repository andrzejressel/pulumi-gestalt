...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GroupInitContainerVolumeGitRepo {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GroupInitContainerVolumeGitRepo {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#directory: {
                        let field_value = match fields_map.get("directory") {
                            Some(value) => value,
                            None => bail!("Missing field 'directory' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
