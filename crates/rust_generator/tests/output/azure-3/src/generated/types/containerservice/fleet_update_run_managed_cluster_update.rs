            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#node_image_selection: {
                        let field_value = match fields_map.get("nodeImageSelection") {
                            Some(value) => value,
                            None => bail!("Missing field 'nodeImageSelection' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
