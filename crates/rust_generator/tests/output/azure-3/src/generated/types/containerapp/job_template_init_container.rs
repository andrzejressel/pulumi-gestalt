...
pub struct JobTemplateInitContainer {
    ...
    #[builder(into)]
    #[serde(rename = "envs")]
    pub r#envs: Option<Vec<super::super::types::containerapp::JobTemplateInitContainerEnv>>,
    ...
    pub r#volume_mounts: Option<Vec<super::super::types::containerapp::JobTemplateInitContainerVolumeMount>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for JobTemplateInitContainer {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for JobTemplateInitContainer {
