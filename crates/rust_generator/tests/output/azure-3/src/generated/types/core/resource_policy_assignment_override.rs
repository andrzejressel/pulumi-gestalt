...
pub struct ResourcePolicyAssignmentOverride {
    ...
    pub r#selectors: Option<Vec<super::super::types::core::ResourcePolicyAssignmentOverrideSelector>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ResourcePolicyAssignmentOverride {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ResourcePolicyAssignmentOverride {
