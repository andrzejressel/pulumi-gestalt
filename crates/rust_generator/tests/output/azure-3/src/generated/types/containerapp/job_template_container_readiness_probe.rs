...
pub struct JobTemplateContainerReadinessProbe {
    ...
    pub r#headers: Option<Vec<super::super::types::containerapp::JobTemplateContainerReadinessProbeHeader>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for JobTemplateContainerReadinessProbe {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "success_count_threshold".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for JobTemplateContainerReadinessProbe {
