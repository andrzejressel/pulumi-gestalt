...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetAppIngressCustomDomain {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "certificate_binding_type".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#certificate_binding_type,
                )
                .await,
            );
            map.insert(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetAppIngressCustomDomain {
