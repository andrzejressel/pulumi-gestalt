...
pub struct GetAppTemplateContainerStartupProbe {
    ...
    pub r#headers: Vec<super::super::types::containerapp::GetAppTemplateContainerStartupProbeHeader>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetAppTemplateContainerStartupProbe {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetAppTemplateContainerStartupProbe {
