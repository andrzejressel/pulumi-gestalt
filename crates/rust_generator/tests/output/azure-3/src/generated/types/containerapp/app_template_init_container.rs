...
pub struct AppTemplateInitContainer {
    ...
    #[builder(into)]
    #[serde(rename = "envs")]
    pub r#envs: Option<Vec<super::super::types::containerapp::AppTemplateInitContainerEnv>>,
    ...
    pub r#volume_mounts: Option<Vec<super::super::types::containerapp::AppTemplateInitContainerVolumeMount>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AppTemplateInitContainer {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AppTemplateInitContainer {
