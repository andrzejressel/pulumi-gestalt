            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#client_certificate_base_64: {
                        let field_value = match fields_map.get("clientCertificateBase64") {
                            Some(value) => value,
                            None => bail!("Missing field 'clientCertificateBase64' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#client_certificate_password: {
                        let field_value = match fields_map.get("clientCertificatePassword") {
                            Some(value) => value,
                            None => bail!("Missing field 'clientCertificatePassword' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#client_certificate_send_chain: {
                        let field_value = match fields_map.get("clientCertificateSendChain") {
                            Some(value) => value,
                            None => bail!("Missing field 'clientCertificateSendChain' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#client_id: {
