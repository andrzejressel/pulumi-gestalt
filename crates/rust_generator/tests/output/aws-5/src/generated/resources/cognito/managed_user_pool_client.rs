...
pub mod managed_user_pool_client {
    ...
    pub struct ManagedUserPoolClientArgs {
        ...
        pub access_token_validity: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub allowed_oauth_flows: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        ...
        #[builder(into, default)]
        pub allowed_oauth_flows_user_pool_client: pulumi_gestalt_rust::Input<
            Option<bool>,
        >,
        ...
        #[builder(into, default)]
        pub auth_session_validity: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub callback_urls: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        /// Default redirect URI and must be included in the list of callback URLs.
        #[builder(into, default)]
        pub default_redirect_uri: pulumi_gestalt_rust::Input<Option<String>>,
        /// Enables the propagation of additional user context data.
        #[builder(into, default)]
        pub enable_propagate_additional_user_context_data: pulumi_gestalt_rust::Input<
            Option<bool>,
        >,
        /// Enables or disables token revocation.
        #[builder(into, default)]
        pub enable_token_revocation: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub explicit_auth_flows: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        /// Time limit, between 5 minutes and 1 day, after which the ID token is no longer valid and cannot be used. By default, the unit is hours. The unit can be overridden by a value in `token_validity_units.id_token`.
        #[builder(into, default)]
        pub id_token_validity: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub logout_urls: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        /// Regular expression that matches the name of the desired User Pool Client. It must only match one User Pool Client.
        #[builder(into, default)]
        pub name_pattern: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub refresh_token_validity: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub supported_identity_providers: pulumi_gestalt_rust::Input<
            Option<Vec<String>>,
        >,
        /// Configuration block for representing the validity times in units. See details below. Detailed below.
        #[builder(into, default)]
        pub token_validity_units: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub write_attributes: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
    }
    #[allow(dead_code)]
    ...
    fn __create(
        ...
        let name_pattern_binding = args.name_pattern.get_output(ctx);
