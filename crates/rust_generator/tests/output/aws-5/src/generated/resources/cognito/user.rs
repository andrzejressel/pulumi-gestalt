...
pub mod user {
    ...
    pub struct UserArgs {
        ...
        #[builder(into, default)]
        pub client_metadata: pulumi_gestalt_rust::Input<
            Option<std::collections::HashMap<String, String>>,
        >,
        ...
        #[builder(into, default)]
        pub force_alias_creation: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub message_action: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub temporary_password: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub validation_data: pulumi_gestalt_rust::Input<
            Option<std::collections::HashMap<String, String>>,
        >,
    }
    #[allow(dead_code)]
    ...
    fn __create(
        ...
        let client_metadata_binding = args.client_metadata.get_output(ctx);
        let desired_delivery_mediums_binding = args
            .desired_delivery_mediums
            .get_output(ctx);
        let enabled_binding = args.enabled.get_output(ctx);
        let force_alias_creation_binding = args.force_alias_creation.get_output(ctx);
        let message_action_binding = args.message_action.get_output(ctx);
        let password_binding = args.password.get_output(ctx);
        let temporary_password_binding = args.temporary_password.get_output(ctx);
        let user_pool_id_binding = args.user_pool_id.get_output(ctx);
        let username_binding = args.username.get_output(ctx);
        let validation_data_binding = args.validation_data.get_output(ctx);
