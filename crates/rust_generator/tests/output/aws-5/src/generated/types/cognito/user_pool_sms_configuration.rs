...
pub struct UserPoolSmsConfiguration {
    ...
    pub r#sns_region: Option<String>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for UserPoolSmsConfiguration {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("sns_caller_arn".to_string(), self.r#sns_caller_arn.to_pulumi_value().await);
            map.insert("sns_region".to_string(), self.r#sns_region.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for UserPoolSmsConfiguration {
