            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#level_fives: {
                        ...
                        <Vec<super::super::types::connect::GetUserHierarchyGroupHierarchyPathLevelFife> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#level_fours: {
                        ...
                        <Vec<super::super::types::connect::GetUserHierarchyGroupHierarchyPathLevelFour> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#level_ones: {
                        ...
                        <Vec<super::super::types::connect::GetUserHierarchyGroupHierarchyPathLevelOne> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#level_threes: {
                        ...
                        <Vec<super::super::types::connect::GetUserHierarchyGroupHierarchyPathLevelThree> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#level_twos: {
                        ...
                        <Vec<super::super::types::connect::GetUserHierarchyGroupHierarchyPathLevelTwo> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
