...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CustomActionTypeOutputArtifactDetails {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("maximum_count".to_string(), self.r#maximum_count.to_pulumi_value().await);
            map.insert("minimum_count".to_string(), self.r#minimum_count.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CustomActionTypeOutputArtifactDetails {
