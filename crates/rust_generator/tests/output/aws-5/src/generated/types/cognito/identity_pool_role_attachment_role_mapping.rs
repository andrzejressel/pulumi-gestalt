...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for IdentityPoolRoleAttachmentRoleMapping {
    ...
    > {
        async move {
            ...
            map.insert("ambiguous_role_resolution".to_string(), self.r#ambiguous_role_resolution.to_pulumi_value().await);
            map.insert("identity_provider".to_string(), self.r#identity_provider.to_pulumi_value().await);
            map.insert("mapping_rules".to_string(), self.r#mapping_rules.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#mapping_rules: {
                        ...
                        <Option<Vec<super::super::types::cognito::IdentityPoolRoleAttachmentRoleMappingMappingRule>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#type_: {
