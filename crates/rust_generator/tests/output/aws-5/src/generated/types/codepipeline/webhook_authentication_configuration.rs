...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WebhookAuthenticationConfiguration {
    ...
    > {
        async move {
            ...
            map.insert("allowed_ip_range".to_string(), self.r#allowed_ip_range.to_pulumi_value().await);
            map.insert("secret_token".to_string(), self.r#secret_token.to_pulumi_value().await);
