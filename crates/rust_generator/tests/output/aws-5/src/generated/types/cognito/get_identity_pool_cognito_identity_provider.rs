...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetIdentityPoolCognitoIdentityProvider {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetIdentityPoolCognitoIdentityProvider {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#server_side_token_check: {
                        let field_value = match fields_map.get("serverSideTokenCheck") {
                            Some(value) => value,
                            None => bail!("Missing field 'serverSideTokenCheck' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
