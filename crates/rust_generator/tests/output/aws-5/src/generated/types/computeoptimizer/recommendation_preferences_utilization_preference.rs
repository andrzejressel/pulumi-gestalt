...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RecommendationPreferencesUtilizationPreference {
    ...
    > {
        async move {
            ...
            map.insert("metric_parameters".to_string(), self.r#metric_parameters.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#metric_parameters: {
                        ...
                        <Option<Box<super::super::types::computeoptimizer::RecommendationPreferencesUtilizationPreferenceMetricParameters>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
