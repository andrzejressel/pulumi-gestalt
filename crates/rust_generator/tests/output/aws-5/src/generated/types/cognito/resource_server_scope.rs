...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ResourceServerScope {
    ...
    > {
        async move {
            ...
            map.insert("scope_description".to_string(), self.r#scope_description.to_pulumi_value().await);
            map.insert("scope_name".to_string(), self.r#scope_name.to_pulumi_value().await);
