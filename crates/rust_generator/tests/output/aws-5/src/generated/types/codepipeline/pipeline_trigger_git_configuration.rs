...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PipelineTriggerGitConfiguration {
    ...
    > {
        async move {
            ...
            map.insert("pull_requests".to_string(), self.r#pull_requests.to_pulumi_value().await);
            map.insert("pushes".to_string(), self.r#pushes.to_pulumi_value().await);
            map.insert("source_action_name".to_string(), self.r#source_action_name.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#pull_requests: {
                        ...
                        <Option<Vec<super::super::types::codepipeline::PipelineTriggerGitConfigurationPullRequest>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#pushes: {
                        ...
                        <Option<Vec<super::super::types::codepipeline::PipelineTriggerGitConfigurationPush>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
