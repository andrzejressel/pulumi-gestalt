...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for HostVpcConfiguration {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("tls_certificate".to_string(), self.r#tls_certificate.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for HostVpcConfiguration {
        ...
        match value.content {
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#tls_certificate: {
                        let field_value = match fields_map.get("tls_certificate") {
                            Some(value) => value,
                            None => bail!("Missing field 'tls_certificate' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
