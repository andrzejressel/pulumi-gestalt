...
pub struct GetUserPoolClientTokenValidityUnit {
    ...
    pub r#id_token: String,
    /// (Optional) Time unit in for the value in `refresh_token_validity`, defaults to `days`.
    #[builder(into)]
    #[serde(rename = "refreshToken")]
    pub r#refresh_token: String,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetUserPoolClientTokenValidityUnit {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetUserPoolClientTokenValidityUnit {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#id_token: {
                        let field_value = match fields_map.get("idToken") {
                            Some(value) => value,
                            None => bail!("Missing field 'idToken' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#refresh_token: {
