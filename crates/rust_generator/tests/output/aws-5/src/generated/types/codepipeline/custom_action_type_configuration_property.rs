...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CustomActionTypeConfigurationProperty {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("queryable".to_string(), self.r#queryable.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CustomActionTypeConfigurationProperty {
        ...
        match value.content {
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#queryable: {
                        let field_value = match fields_map.get("queryable") {
                            Some(value) => value,
                            None => bail!("Missing field 'queryable' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
