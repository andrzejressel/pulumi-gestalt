...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DocumentClassifierOutputDataConfig {
    fn to_pulumi_value(
        &self,
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#output_s_3_uri: {
                        let field_value = match fields_map.get("outputS3Uri") {
                            Some(value) => value,
                            None => bail!("Missing field 'outputS3Uri' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#s_3_uri: {
