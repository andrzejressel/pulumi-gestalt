...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for HoursOfOperationConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("end_time".to_string(), self.r#end_time.to_pulumi_value().await);
            map.insert("start_time".to_string(), self.r#start_time.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for HoursOfOperationConfig {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#end_time: {
                        ...
                        <Box<super::super::types::connect::HoursOfOperationConfigEndTime> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#start_time: {
                        ...
                        <Box<super::super::types::connect::HoursOfOperationConfigStartTime> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
