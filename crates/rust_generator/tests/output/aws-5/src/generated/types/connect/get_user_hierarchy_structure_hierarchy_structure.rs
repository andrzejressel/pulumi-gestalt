...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetUserHierarchyStructureHierarchyStructure {
    ...
    > {
        async move {
            ...
            map.insert("level_fives".to_string(), self.r#level_fives.to_pulumi_value().await);
            map.insert("level_fours".to_string(), self.r#level_fours.to_pulumi_value().await);
            map.insert("level_ones".to_string(), self.r#level_ones.to_pulumi_value().await);
            map.insert("level_threes".to_string(), self.r#level_threes.to_pulumi_value().await);
            map.insert("level_twos".to_string(), self.r#level_twos.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#level_fives: {
                        ...
                        <Vec<super::super::types::connect::GetUserHierarchyStructureHierarchyStructureLevelFife> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#level_fours: {
                        ...
                        <Vec<super::super::types::connect::GetUserHierarchyStructureHierarchyStructureLevelFour> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#level_ones: {
                        ...
                        <Vec<super::super::types::connect::GetUserHierarchyStructureHierarchyStructureLevelOne> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#level_threes: {
                        ...
                        <Vec<super::super::types::connect::GetUserHierarchyStructureHierarchyStructureLevelThree> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#level_twos: {
                        ...
                        <Vec<super::super::types::connect::GetUserHierarchyStructureHierarchyStructureLevelTwo> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
