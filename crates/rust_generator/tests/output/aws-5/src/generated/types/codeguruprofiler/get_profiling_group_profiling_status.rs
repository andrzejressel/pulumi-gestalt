...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetProfilingGroupProfilingStatus {
    ...
    > {
        async move {
            ...
            map.insert("latest_agent_orchestrated_at".to_string(), self.r#latest_agent_orchestrated_at.to_pulumi_value().await);
            map.insert("latest_agent_profile_reported_at".to_string(), self.r#latest_agent_profile_reported_at.to_pulumi_value().await);
            map.insert("latest_aggregated_profiles".to_string(), self.r#latest_aggregated_profiles.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#latest_aggregated_profiles: {
                        ...
                        <Vec<super::super::types::codeguruprofiler::GetProfilingGroupProfilingStatusLatestAggregatedProfile> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
