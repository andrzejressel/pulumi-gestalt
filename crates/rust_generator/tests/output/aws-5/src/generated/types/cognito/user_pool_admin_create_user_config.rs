...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for UserPoolAdminCreateUserConfig {
    ...
    > {
        async move {
            ...
            map.insert("invite_message_template".to_string(), self.r#invite_message_template.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#invite_message_template: {
                        ...
                        <Option<Box<super::super::types::cognito::UserPoolAdminCreateUserConfigInviteMessageTemplate>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
