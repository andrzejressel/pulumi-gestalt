...
pub mod get_vocabulary {
    ...
    pub struct GetVocabularyArgs {
        ...
        #[builder(into, default)]
        pub vocabulary_id: pulumi_gestalt_rust::Input<Option<String>>,
    }
    #[allow(dead_code)]
    ...
    pub fn invoke(
        ...
        let vocabulary_id_binding = args.vocabulary_id.get_output(ctx);
        let request = pulumi_gestalt_rust::InvokeResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &vocabulary_id_binding.drop_type(),
                },
            ],
        };
