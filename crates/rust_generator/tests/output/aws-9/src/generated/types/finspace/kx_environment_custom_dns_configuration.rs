...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for KxEnvironmentCustomDnsConfiguration {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "custom_dns_server_ip".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#custom_dns_server_ip,
                )
                .await,
            );
            map.insert(
                "custom_dns_server_name".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#custom_dns_server_name,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for KxEnvironmentCustomDnsConfiguration {
