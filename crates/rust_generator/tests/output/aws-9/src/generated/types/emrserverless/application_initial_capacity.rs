...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ApplicationInitialCapacity {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "initial_capacity_config".to_string(),
            ...
            map.insert(
                "initial_capacity_type".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ApplicationInitialCapacity {
