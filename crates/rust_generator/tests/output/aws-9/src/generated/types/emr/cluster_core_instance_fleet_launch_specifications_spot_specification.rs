...
pub struct ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification {
    ...
    pub r#timeout_duration_minutes: i32,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "timeout_duration_minutes".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification {
