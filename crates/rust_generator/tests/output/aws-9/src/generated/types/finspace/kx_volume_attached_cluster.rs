...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for KxVolumeAttachedCluster {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for KxVolumeAttachedCluster {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#cluster_status: {
                        let field_value = match fields_map.get("cluster_status") {
                            Some(value) => value,
                            None => bail!("Missing field 'cluster_status' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#cluster_type: {
