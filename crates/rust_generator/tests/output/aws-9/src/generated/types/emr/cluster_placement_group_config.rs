            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#placement_strategy: {
                        let field_value = match fields_map.get("placementStrategy") {
                            Some(value) => value,
                            None => bail!("Missing field 'placementStrategy' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
