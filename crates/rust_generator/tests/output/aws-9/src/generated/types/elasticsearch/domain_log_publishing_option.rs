...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DomainLogPublishingOption {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "cloudwatch_log_group_arn".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#cloudwatch_log_group_arn,
                )
                .await,
            );
            map.insert(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DomainLogPublishingOption {
