...
pub struct GetDomainAutoTuneOptionMaintenanceSchedule {
    ...
    #[builder(into)]
    pub r#durations: Vec<super::super::types::elasticsearch::GetDomainAutoTuneOptionMaintenanceScheduleDuration>,
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#cron_expression_for_recurrence: {
                        let field_value = match fields_map.get("cronExpressionForRecurrence") {
                            Some(value) => value,
                            None => bail!("Missing field 'cronExpressionForRecurrence' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                    ...
                    r#start_at: {
                        let field_value = match fields_map.get("startAt") {
                            Some(value) => value,
                            None => bail!("Missing field 'startAt' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
