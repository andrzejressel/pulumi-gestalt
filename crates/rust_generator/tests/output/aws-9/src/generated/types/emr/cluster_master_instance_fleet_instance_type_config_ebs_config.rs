...
pub struct ClusterMasterInstanceFleetInstanceTypeConfigEbsConfig {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClusterMasterInstanceFleetInstanceTypeConfigEbsConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ClusterMasterInstanceFleetInstanceTypeConfigEbsConfig {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#volumes_per_instance: {
                        let field_value = match fields_map.get("volumesPerInstance") {
                            Some(value) => value,
                            None => bail!("Missing field 'volumesPerInstance' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
