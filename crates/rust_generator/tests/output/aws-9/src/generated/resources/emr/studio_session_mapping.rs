...
pub mod studio_session_mapping {
    ...
    fn __create(
        ...
        let identity_name_binding = args.identity_name.get_output(ctx);
        let identity_type_binding = args.identity_type.get_output(ctx);
        let session_policy_arn_binding = args.session_policy_arn.get_output(ctx);
        let studio_id_binding = args.studio_id.get_output(ctx);
