...
pub mod load_balancer_policy {
    ...
    fn __create(
        ...
        let load_balancer_name_binding = args.load_balancer_name.get_output(ctx);
        let policy_attributes_binding = args.policy_attributes.get_output(ctx);
        let policy_name_binding = args.policy_name.get_output(ctx);
        let policy_type_name_binding = args.policy_type_name.get_output(ctx);
