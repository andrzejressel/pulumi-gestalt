...
pub mod studio {
    ...
    pub struct StudioArgs {
        ...
        #[builder(into)]
        pub default_s3_location: pulumi_gestalt_rust::Input<String>,
        ...
        #[builder(into)]
        pub engine_security_group_id: pulumi_gestalt_rust::Input<String>,
        ...
        #[builder(into, default)]
        pub user_role: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into)]
        pub workspace_security_group_id: pulumi_gestalt_rust::Input<String>,
    }
    #[allow(dead_code)]
