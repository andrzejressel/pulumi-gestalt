...
pub mod preset {
    ...
    fn __create(
        ...
        let audio_binding = args.audio.get_output(ctx);
        let audio_codec_options_binding = args.audio_codec_options.get_output(ctx);
        let container_binding = args.container.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let thumbnails_binding = args.thumbnails.get_output(ctx);
        let type__binding = args.type_.get_output(ctx);
        let video_binding = args.video.get_output(ctx);
        let video_codec_options_binding = args.video_codec_options.get_output(ctx);
        let video_watermarks_binding = args.video_watermarks.get_output(ctx);
