...
pub struct ProductLineResponse {
    ...
    pub r#products: Vec<super::types::ProductResponse>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ProductLineResponse {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ProductLineResponse {
