...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ProductFamilyResponse {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "availability_information".to_string(),
            ...
            map.insert(
                "filterable_properties".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "product_lines".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#product_lines,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ProductFamilyResponse {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#product_lines: {
                        let field_value = match fields_map.get("product_lines") {
                            Some(value) => value,
                            None => bail!("Missing field 'product_lines' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
