...
pub mod s_3_location {
    ...
    fn __create(
        ...
        let s3_bucket_arn_binding = args.s3_bucket_arn.get_output(ctx);
        let s3_config_binding = args.s3_config.get_output(ctx);
        let s3_storage_class_binding = args.s3_storage_class.get_output(ctx);
