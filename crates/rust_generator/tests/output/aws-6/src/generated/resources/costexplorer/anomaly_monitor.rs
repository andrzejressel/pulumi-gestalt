...
pub mod anomaly_monitor {
    ...
    fn __create(
        ...
        let monitor_dimension_binding = args.monitor_dimension.get_output(ctx);
        let monitor_specification_binding = args.monitor_specification.get_output(ctx);
        let monitor_type_binding = args.monitor_type.get_output(ctx);
