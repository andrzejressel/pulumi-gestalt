...
pub mod pipeline_definition {
    ...
    fn __create(
        ...
        let parameter_objects_binding = args.parameter_objects.get_output(ctx);
        let parameter_values_binding = args.parameter_values.get_output(ctx);
        let pipeline_id_binding = args.pipeline_id.get_output(ctx);
        let pipeline_objects_binding = args.pipeline_objects.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &parameter_objects_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
