...
pub mod cost_category {
    ...
    fn __create(
        ...
        let default_value_binding = args.default_value.get_output(ctx);
        let effective_start_binding = args.effective_start.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let rule_version_binding = args.rule_version.get_output(ctx);
        let rules_binding = args.rules.get_output(ctx);
        let split_charge_rules_binding = args.split_charge_rules.get_output(ctx);
