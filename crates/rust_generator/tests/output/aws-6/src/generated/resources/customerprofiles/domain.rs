...
pub mod domain {
    ...
    fn __create(
        ...
        let dead_letter_queue_url_binding = args.dead_letter_queue_url.get_output(ctx);
        let default_encryption_key_binding = args.default_encryption_key.get_output(ctx);
        let default_expiration_days_binding = args
            .default_expiration_days
            .get_output(ctx);
        let domain_name_binding = args.domain_name.get_output(ctx);
        let matching_binding = args.matching.get_output(ctx);
        let rule_based_matching_binding = args.rule_based_matching.get_output(ctx);
