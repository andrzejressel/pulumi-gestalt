...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CostCategoryRuleRuleNot {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CostCategoryRuleRuleNot {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#ands: {
                        ...
                        <Option<Vec<super::super::types::costexplorer::CostCategoryRuleRuleNotAnd>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#cost_category: {
                        ...
                        <Option<Box<super::super::types::costexplorer::CostCategoryRuleRuleNotCostCategory>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#dimension: {
                        ...
                        <Option<Box<super::super::types::costexplorer::CostCategoryRuleRuleNotDimension>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#not: {
                        ...
                        <Option<Box<super::super::types::costexplorer::CostCategoryRuleRuleNotNot>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#ors: {
                        ...
                        <Option<Vec<super::super::types::costexplorer::CostCategoryRuleRuleNotOr>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#tags: {
                        ...
                        <Option<Box<super::super::types::costexplorer::CostCategoryRuleRuleNotTags>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
