...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetCostCategoryRuleRuleNot {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetCostCategoryRuleRuleNot {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#ands: {
                        ...
                        <Vec<super::super::types::costexplorer::GetCostCategoryRuleRuleNotAnd> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#cost_categories: {
                        ...
                        <Vec<super::super::types::costexplorer::GetCostCategoryRuleRuleNotCostCategory> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#dimensions: {
                        ...
                        <Vec<super::super::types::costexplorer::GetCostCategoryRuleRuleNotDimension> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#nots: {
                        ...
                        <Vec<super::super::types::costexplorer::GetCostCategoryRuleRuleNotNot> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#ors: {
                        ...
                        <Vec<super::super::types::costexplorer::GetCostCategoryRuleRuleNotOr> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#tags: {
                        ...
                        <Vec<super::super::types::costexplorer::GetCostCategoryRuleRuleNotTag> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
