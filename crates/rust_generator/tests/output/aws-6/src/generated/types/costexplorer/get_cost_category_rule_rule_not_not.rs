...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetCostCategoryRuleRuleNotNot {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetCostCategoryRuleRuleNotNot {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#cost_categories: {
                        ...
                        <Vec<super::super::types::costexplorer::GetCostCategoryRuleRuleNotNotCostCategory> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#dimensions: {
                        ...
                        <Vec<super::super::types::costexplorer::GetCostCategoryRuleRuleNotNotDimension> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#tags: {
                        ...
                        <Vec<super::super::types::costexplorer::GetCostCategoryRuleRuleNotNotTag> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
