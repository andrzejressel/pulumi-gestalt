...
pub struct GetCostCategoryRuleRuleOrDimension {
    /// Key for the tag.
    #[builder(into)]
    #[serde(rename = "key")]
    pub r#key: String,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetCostCategoryRuleRuleOrDimension {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetCostCategoryRuleRuleOrDimension {
