            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#ands: {
                        ...
                        <Option<Vec<super::super::types::costexplorer::AnomalySubscriptionThresholdExpressionAnd>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#cost_category: {
                        ...
                        <Option<Box<super::super::types::costexplorer::AnomalySubscriptionThresholdExpressionCostCategory>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#dimension: {
                        ...
                        <Option<Box<super::super::types::costexplorer::AnomalySubscriptionThresholdExpressionDimension>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#not: {
                        ...
                        <Option<Box<super::super::types::costexplorer::AnomalySubscriptionThresholdExpressionNot>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#ors: {
                        ...
                        <Option<Vec<super::super::types::costexplorer::AnomalySubscriptionThresholdExpressionOr>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#tags: {
                        ...
                        <Option<Box<super::super::types::costexplorer::AnomalySubscriptionThresholdExpressionTags>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
