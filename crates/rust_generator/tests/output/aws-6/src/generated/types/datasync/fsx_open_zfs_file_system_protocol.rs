...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FsxOpenZfsFileSystemProtocol {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FsxOpenZfsFileSystemProtocol {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#nfs: {
                        ...
                        <Box<super::super::types::datasync::FsxOpenZfsFileSystemProtocolNfs> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
