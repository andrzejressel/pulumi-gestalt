...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetCostCategoryRuleRuleOrAnd {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetCostCategoryRuleRuleOrAnd {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#cost_categories: {
                        ...
                        <Vec<super::super::types::costexplorer::GetCostCategoryRuleRuleOrAndCostCategory> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#dimensions: {
                        ...
                        <Vec<super::super::types::costexplorer::GetCostCategoryRuleRuleOrAndDimension> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#tags: {
                        ...
                        <Vec<super::super::types::costexplorer::GetCostCategoryRuleRuleOrAndTag> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
