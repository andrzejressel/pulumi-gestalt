...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for LocationFsxOntapFileSystemProtocolNfs {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for LocationFsxOntapFileSystemProtocolNfs {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#mount_options: {
                        ...
                        <Box<super::super::types::datasync::LocationFsxOntapFileSystemProtocolNfsMountOptions> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
