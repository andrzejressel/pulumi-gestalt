...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CostCategoryRuleRuleNotOr {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CostCategoryRuleRuleNotOr {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#cost_category: {
                        ...
                        <Option<Box<super::super::types::costexplorer::CostCategoryRuleRuleNotOrCostCategory>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#dimension: {
                        ...
                        <Option<Box<super::super::types::costexplorer::CostCategoryRuleRuleNotOrDimension>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#tags: {
                        ...
                        <Option<Box<super::super::types::costexplorer::CostCategoryRuleRuleNotOrTags>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
