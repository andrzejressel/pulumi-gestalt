...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DomainMatchingAutoMergingConsolidation {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "matching_attributes_lists".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#matching_attributes_lists,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DomainMatchingAutoMergingConsolidation {
