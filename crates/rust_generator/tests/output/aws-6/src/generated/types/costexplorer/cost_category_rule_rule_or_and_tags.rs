...
pub struct CostCategoryRuleRuleOrAndTags {
    /// Key for the tag.
    #[builder(into)]
    #[serde(rename = "key")]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CostCategoryRuleRuleOrAndTags {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CostCategoryRuleRuleOrAndTags {
