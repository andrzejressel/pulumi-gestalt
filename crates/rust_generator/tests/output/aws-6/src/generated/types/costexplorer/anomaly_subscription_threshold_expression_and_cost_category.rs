...
pub struct AnomalySubscriptionThresholdExpressionAndCostCategory {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AnomalySubscriptionThresholdExpressionAndCostCategory {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("match_options".to_string(), self.r#match_options.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AnomalySubscriptionThresholdExpressionAndCostCategory {
