...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CostCategoryRuleRuleAnd {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CostCategoryRuleRuleAnd {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#ands: {
                        ...
                        <Option<Vec<super::super::types::costexplorer::CostCategoryRuleRuleAndAnd>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#cost_category: {
                        ...
                        <Option<Box<super::super::types::costexplorer::CostCategoryRuleRuleAndCostCategory>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#dimension: {
                        ...
                        <Option<Box<super::super::types::costexplorer::CostCategoryRuleRuleAndDimension>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#not: {
                        ...
                        <Option<Box<super::super::types::costexplorer::CostCategoryRuleRuleAndNot>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#ors: {
                        ...
                        <Option<Vec<super::super::types::costexplorer::CostCategoryRuleRuleAndOr>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#tags: {
                        ...
                        <Option<Box<super::super::types::costexplorer::CostCategoryRuleRuleAndTags>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
