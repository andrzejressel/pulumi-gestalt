...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetPipelineDefinitionParameterObject {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetPipelineDefinitionParameterObject {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#attributes: {
                        ...
                        <Vec<super::super::types::datapipeline::GetPipelineDefinitionParameterObjectAttribute> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#id: {
