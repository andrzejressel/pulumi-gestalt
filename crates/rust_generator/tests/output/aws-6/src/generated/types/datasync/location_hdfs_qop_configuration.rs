...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for LocationHdfsQopConfiguration {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("data_transfer_protection".to_string(), self.r#data_transfer_protection.to_pulumi_value().await);
            map.insert("rpc_protection".to_string(), self.r#rpc_protection.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for LocationHdfsQopConfiguration {
