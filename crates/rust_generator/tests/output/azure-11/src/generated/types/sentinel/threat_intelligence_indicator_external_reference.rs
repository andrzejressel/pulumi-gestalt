...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ThreatIntelligenceIndicatorExternalReference {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ThreatIntelligenceIndicatorExternalReference {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#hashes: {
                        let field_value = match fields_map.get("hashes") {
                            Some(value) => value,
                            None => bail!("Missing field 'hashes' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#id: {
