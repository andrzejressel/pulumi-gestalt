...
pub struct AlertRuleScheduledEntityMapping {
    ...
    pub r#field_mappings: Vec<super::super::types::sentinel::AlertRuleScheduledEntityMappingFieldMapping>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AlertRuleScheduledEntityMapping {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AlertRuleScheduledEntityMapping {
