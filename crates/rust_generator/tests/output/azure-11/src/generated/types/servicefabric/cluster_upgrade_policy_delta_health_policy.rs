...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClusterUpgradePolicyDeltaHealthPolicy {
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "max_delta_unhealthy_applications_percent".to_string(),
            ...
            map.insert(
                "max_delta_unhealthy_nodes_percent".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "max_upgrade_domain_delta_unhealthy_nodes_percent".to_string(),
                ToPulumiValue::to_pulumi_value(
