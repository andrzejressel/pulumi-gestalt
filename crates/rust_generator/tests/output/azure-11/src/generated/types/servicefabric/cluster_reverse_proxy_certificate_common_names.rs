...
pub struct ClusterReverseProxyCertificateCommonNames {
    ...
    pub r#common_names: Vec<super::super::types::servicefabric::ClusterReverseProxyCertificateCommonNamesCommonName>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClusterReverseProxyCertificateCommonNames {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ClusterReverseProxyCertificateCommonNames {
