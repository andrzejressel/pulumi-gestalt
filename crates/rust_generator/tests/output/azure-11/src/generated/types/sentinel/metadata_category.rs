...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for MetadataCategory {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for MetadataCategory {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#verticals: {
                        let field_value = match fields_map.get("verticals") {
                            Some(value) => value,
                            None => bail!("Missing field 'verticals' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
