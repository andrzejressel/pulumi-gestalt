...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClusterReverseProxyCertificate {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "thumbprint_secondary".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ClusterReverseProxyCertificate {
