...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AssessmentStatus {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AssessmentStatus {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#cause: {
                        let field_value = match fields_map.get("cause") {
                            Some(value) => value,
                            None => bail!("Missing field 'cause' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
