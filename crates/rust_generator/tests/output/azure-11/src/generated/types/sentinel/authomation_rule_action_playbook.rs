...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AuthomationRuleActionPlaybook {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AuthomationRuleActionPlaybook {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#logic_app_id: {
                        let field_value = match fields_map.get("logicAppId") {
                            Some(value) => value,
                            None => bail!("Missing field 'logicAppId' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
