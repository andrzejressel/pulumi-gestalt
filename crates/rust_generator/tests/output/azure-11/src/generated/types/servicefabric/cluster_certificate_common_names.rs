...
pub struct ClusterCertificateCommonNames {
    ...
    pub r#common_names: Vec<super::super::types::servicefabric::ClusterCertificateCommonNamesCommonName>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClusterCertificateCommonNames {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ClusterCertificateCommonNames {
