...
pub mod metadata {
    ...
    fn __create(
        ...
        let author_binding = args.author.get_output(ctx);
        let category_binding = args.category.get_output(ctx);
        let content_id_binding = args.content_id.get_output(ctx);
        let content_schema_version_binding = args.content_schema_version.get_output(ctx);
        let custom_version_binding = args.custom_version.get_output(ctx);
        let dependency_binding = args.dependency.get_output(ctx);
        let first_publish_date_binding = args.first_publish_date.get_output(ctx);
        let icon_id_binding = args.icon_id.get_output(ctx);
        let kind_binding = args.kind.get_output(ctx);
        let last_publish_date_binding = args.last_publish_date.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let parent_id_binding = args.parent_id.get_output(ctx);
        let preview_images_binding = args.preview_images.get_output(ctx);
        let preview_images_darks_binding = args.preview_images_darks.get_output(ctx);
        let providers_binding = args.providers.get_output(ctx);
        let source_binding = args.source.get_output(ctx);
        let support_binding = args.support.get_output(ctx);
