...
pub mod cluster {
    ...
    fn __create(
        ...
        let api_server_profile_binding = args.api_server_profile.get_output(ctx);
        let cluster_profile_binding = args.cluster_profile.get_output(ctx);
        let ingress_profile_binding = args.ingress_profile.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let main_profile_binding = args.main_profile.get_output(ctx);
        ...
        let worker_profile_binding = args.worker_profile.get_output(ctx);
