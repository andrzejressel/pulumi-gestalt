...
pub mod managed_cluster {
    ...
    fn __create(
        ...
        let backup_service_enabled_binding = args.backup_service_enabled.get_output(ctx);
        let client_connection_port_binding = args.client_connection_port.get_output(ctx);
        let custom_fabric_settings_binding = args.custom_fabric_settings.get_output(ctx);
        let dns_name_binding = args.dns_name.get_output(ctx);
        let dns_service_enabled_binding = args.dns_service_enabled.get_output(ctx);
        let http_gateway_port_binding = args.http_gateway_port.get_output(ctx);
        let lb_rules_binding = args.lb_rules.get_output(ctx);
        ...
        let upgrade_wave_binding = args.upgrade_wave.get_output(ctx);
