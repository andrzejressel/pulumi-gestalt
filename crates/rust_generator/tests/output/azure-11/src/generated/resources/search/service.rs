...
pub mod service {
    ...
    fn __create(
        ...
        let allowed_ips_binding = args.allowed_ips.get_output(ctx);
        ...
        let customer_managed_key_enforcement_enabled_binding = args
            ...
            .get_output(ctx);
        let hosting_mode_binding = args.hosting_mode.get_output(ctx);
        ...
        let semantic_search_sku_binding = args.semantic_search_sku.get_output(ctx);
