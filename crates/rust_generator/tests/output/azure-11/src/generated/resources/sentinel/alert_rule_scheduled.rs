...
pub mod alert_rule_scheduled {
    ...
    pub struct AlertRuleScheduledArgs {
        ...
        #[builder(into, default)]
        pub query_frequency: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub query_period: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub trigger_operator: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub trigger_threshold: pulumi_gestalt_rust::Input<Option<i32>>,
    }
    #[allow(dead_code)]
    ...
    fn __create(
        ...
        let alert_rule_template_version_binding = args
            ...
            .get_output(ctx);
        let custom_details_binding = args.custom_details.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let display_name_binding = args.display_name.get_output(ctx);
        let enabled_binding = args.enabled.get_output(ctx);
        let entity_mappings_binding = args.entity_mappings.get_output(ctx);
        let event_grouping_binding = args.event_grouping.get_output(ctx);
        let incident_binding = args.incident.get_output(ctx);
        let log_analytics_workspace_id_binding = args
            .log_analytics_workspace_id
            .get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let query_binding = args.query.get_output(ctx);
        let query_frequency_binding = args.query_frequency.get_output(ctx);
        let query_period_binding = args.query_period.get_output(ctx);
        let sentinel_entity_mappings_binding = args
            .sentinel_entity_mappings
            .get_output(ctx);
        let severity_binding = args.severity.get_output(ctx);
        let suppression_duration_binding = args.suppression_duration.get_output(ctx);
        let suppression_enabled_binding = args.suppression_enabled.get_output(ctx);
        let tactics_binding = args.tactics.get_output(ctx);
        let techniques_binding = args.techniques.get_output(ctx);
        let trigger_operator_binding = args.trigger_operator.get_output(ctx);
        let trigger_threshold_binding = args.trigger_threshold.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &query_frequency_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "queryPeriod".into(),
                    value: &query_period_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &trigger_operator_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
