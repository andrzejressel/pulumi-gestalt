...
///             .build_struct(),
///     );
///     let exampleDataConnectorOffice365Project = data_connector_office_365_project::create(
///         "exampleDataConnectorOffice365Project",
///         DataConnectorOffice365ProjectArgs::builder()
...
pub mod data_connector_office_365_project {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct DataConnectorOffice365ProjectArgs {
    ...
    #[allow(dead_code)]
    pub struct DataConnectorOffice365ProjectResult {
