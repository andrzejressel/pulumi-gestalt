...
pub mod cache {
    ...
    fn __create(
        ...
        let non_ssl_port_enabled_binding = args.non_ssl_port_enabled.get_output(ctx);
        let patch_schedules_binding = args.patch_schedules.get_output(ctx);
        ...
        let public_network_access_enabled_binding = args
            ...
            .get_output(ctx);
        let redis_configuration_binding = args.redis_configuration.get_output(ctx);
        let redis_version_binding = args.redis_version.get_output(ctx);
        let replicas_per_master_binding = args.replicas_per_master.get_output(ctx);
        let replicas_per_primary_binding = args.replicas_per_primary.get_output(ctx);
        ...
        let tenant_settings_binding = args.tenant_settings.get_output(ctx);
