...
///             .build_struct(),
///     );
///     let exampleDataConnectorDynamics365 = data_connector_dynamics_365::create(
///         "exampleDataConnectorDynamics365",
///         DataConnectorDynamics365Args::builder()
...
pub mod data_connector_dynamics_365 {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct DataConnectorDynamics365Args {
    ...
    #[allow(dead_code)]
    pub struct DataConnectorDynamics365Result {
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "azure:sentinel/dataConnectorDynamics365:DataConnectorDynamics365"
                .into(),
            name: name.to_string(),
