...
///             .build_struct(),
///     );
///     let exampleDataConnectorOfficeAtp = data_connector_office_atp::create(
///         "exampleDataConnectorOfficeAtp",
///         DataConnectorOfficeAtpArgs::builder()
...
pub mod data_connector_office_atp {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct DataConnectorOfficeAtpArgs {
    ...
    #[allow(dead_code)]
    pub struct DataConnectorOfficeAtpResult {
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "azure:sentinel/dataConnectorOfficeAtp:DataConnectorOfficeAtp".into(),
            name: name.to_string(),
