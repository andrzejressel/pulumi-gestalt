...
pub mod automation_rule {
    ...
    pub struct AutomationRuleArgs {
        ...
        pub action_playbooks: pulumi_gestalt_rust::InputOrOutput<
            Option<Vec<super::super::types::sentinel::AutomationRuleActionPlaybook>>,
        >,
    ...
    fn __create(
        ...
        let action_incidents_binding = args.action_incidents.get_output(ctx);
        let action_playbooks_binding = args.action_playbooks.get_output(ctx);
        let condition_json_binding = args.condition_json.get_output(ctx);
        let display_name_binding = args.display_name.get_output(ctx);
        let enabled_binding = args.enabled.get_output(ctx);
        let expiration_binding = args.expiration.get_output(ctx);
        let log_analytics_workspace_id_binding = args
            .log_analytics_workspace_id
            .get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let order_binding = args.order.get_output(ctx);
        let triggers_on_binding = args.triggers_on.get_output(ctx);
        let triggers_when_binding = args.triggers_when.get_output(ctx);
