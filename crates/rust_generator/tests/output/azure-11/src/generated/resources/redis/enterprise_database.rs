...
pub mod enterprise_database {
    ...
    pub struct EnterpriseDatabaseArgs {
        ...
        #[builder(into, default)]
        pub linked_database_group_nickname: pulumi_gestalt_rust::Input<Option<String>>,
    ...
    fn __create(
        ...
        let client_protocol_binding = args.client_protocol.get_output(ctx);
        let cluster_id_binding = args.cluster_id.get_output(ctx);
        let clustering_policy_binding = args.clustering_policy.get_output(ctx);
        ...
        let linked_database_group_nickname_binding = args
            ...
            .get_output(ctx);
        let linked_database_ids_binding = args.linked_database_ids.get_output(ctx);
        let modules_binding = args.modules.get_output(ctx);
