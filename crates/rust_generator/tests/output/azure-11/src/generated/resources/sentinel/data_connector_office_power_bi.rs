...
///             .build_struct(),
///     );
///     let exampleDataConnectorOfficePowerBi = data_connector_office_power_bi::create(
///         "exampleDataConnectorOfficePowerBi",
///         DataConnectorOfficePowerBiArgs::builder()
...
pub mod data_connector_office_power_bi {
    ...
    #[allow(dead_code)]
    pub struct DataConnectorOfficePowerBiArgs {
