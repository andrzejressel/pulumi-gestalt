...
pub mod cluster {
    ...
    fn __create(
        ...
        let add_on_features_binding = args.add_on_features.get_output(ctx);
        let azure_active_directory_binding = args.azure_active_directory.get_output(ctx);
        ...
        let client_certificate_thumbprints_binding = args
            ...
            .get_output(ctx);
        let cluster_code_version_binding = args.cluster_code_version.get_output(ctx);
        let diagnostics_config_binding = args.diagnostics_config.get_output(ctx);
        let fabric_settings_binding = args.fabric_settings.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let management_endpoint_binding = args.management_endpoint.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let node_types_binding = args.node_types.get_output(ctx);
        let reliability_level_binding = args.reliability_level.get_output(ctx);
