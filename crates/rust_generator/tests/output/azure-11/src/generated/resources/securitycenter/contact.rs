...
pub mod contact {
    ...
    fn __create(
        ...
        let alert_notifications_binding = args.alert_notifications.get_output(ctx);
        let alerts_to_admins_binding = args.alerts_to_admins.get_output(ctx);
        let email_binding = args.email.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let phone_binding = args.phone.get_output(ctx);
