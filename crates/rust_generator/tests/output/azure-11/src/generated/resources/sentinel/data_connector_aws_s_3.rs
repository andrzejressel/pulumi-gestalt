...
pub mod data_connector_aws_s_3 {
    ...
    fn __create(
        ...
        let aws_role_arn_binding = args.aws_role_arn.get_output(ctx);
        let destination_table_binding = args.destination_table.get_output(ctx);
        let log_analytics_workspace_id_binding = args
            .log_analytics_workspace_id
            .get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let sqs_urls_binding = args.sqs_urls.get_output(ctx);
