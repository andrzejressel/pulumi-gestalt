...
pub mod subscription_rule {
    ...
    fn __create(
        ...
        let correlation_filter_binding = args.correlation_filter.get_output(ctx);
        let filter_type_binding = args.filter_type.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let sql_filter_binding = args.sql_filter.get_output(ctx);
