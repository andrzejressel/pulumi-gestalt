...
pub struct GetLinuxWebAppSiteConfigIpRestriction {
    ...
    #[builder(into)]
    pub r#headers: Vec<super::super::types::appservice::GetLinuxWebAppSiteConfigIpRestrictionHeader>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetLinuxWebAppSiteConfigIpRestriction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetLinuxWebAppSiteConfigIpRestriction {
