...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for SourceControlGithubActionConfigurationCodeConfiguration {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for SourceControlGithubActionConfigurationCodeConfiguration {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#runtime_stack: {
                        let field_value = match fields_map.get("runtimeStack") {
                            Some(value) => value,
                            None => bail!("Missing field 'runtimeStack' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
