...
pub struct ApiOperationResponseRepresentation {
    ...
    pub r#examples: Option<Vec<super::super::types::apimanagement::ApiOperationResponseRepresentationExample>>,
    ...
    pub r#form_parameters: Option<Vec<super::super::types::apimanagement::ApiOperationResponseRepresentationFormParameter>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ApiOperationResponseRepresentation {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ApiOperationResponseRepresentation {
