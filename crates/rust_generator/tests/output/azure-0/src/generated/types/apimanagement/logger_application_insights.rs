...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for LoggerApplicationInsights {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for LoggerApplicationInsights {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#instrumentation_key: {
                        let field_value = match fields_map.get("instrumentation_key") {
                            Some(value) => value,
                            None => bail!("Missing field 'instrumentation_key' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
