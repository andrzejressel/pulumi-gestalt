...
pub struct AppServiceSiteConfigIpRestriction {
    /// Does this restriction `Allow` or `Deny` access for this IP range. Defaults to `Allow`.
    #[builder(into)]
    pub r#action: Option<String>,
    /// The `headers` block for this specific `ip_restriction` as defined below.
    #[builder(into)]
    pub r#headers: Option<Box<super::super::types::appservice::AppServiceSiteConfigIpRestrictionHeaders>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AppServiceSiteConfigIpRestriction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AppServiceSiteConfigIpRestriction {
