...
pub struct LinuxWebAppSlotSiteConfigScmIpRestriction {
    ...
    #[builder(into)]
    pub r#headers: Option<Box<super::super::types::appservice::LinuxWebAppSlotSiteConfigScmIpRestrictionHeaders>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for LinuxWebAppSlotSiteConfigScmIpRestriction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for LinuxWebAppSlotSiteConfigScmIpRestriction {
