...
pub struct WindowsWebAppAuthSettings {
    ...
    pub r#active_directory: Box<Option<super::super::types::appservice::WindowsWebAppAuthSettingsActiveDirectory>>,
    ...
    pub r#facebook: Box<Option<super::super::types::appservice::WindowsWebAppAuthSettingsFacebook>>,
    /// A `github` block as defined below.
    #[builder(into)]
    #[serde(rename = "github")]
    pub r#github: Box<Option<super::super::types::appservice::WindowsWebAppAuthSettingsGithub>>,
    /// A `google` block as defined below.
    #[builder(into)]
    #[serde(rename = "google")]
    pub r#google: Box<Option<super::super::types::appservice::WindowsWebAppAuthSettingsGoogle>>,
    ...
    pub r#microsoft: Box<Option<super::super::types::appservice::WindowsWebAppAuthSettingsMicrosoft>>,
    ...
    pub r#twitter: Box<Option<super::super::types::appservice::WindowsWebAppAuthSettingsTwitter>>,
