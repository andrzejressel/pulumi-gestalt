...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for SpringCloudGatewayClientAuthorization {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "certificate_ids".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#certificate_ids,
                )
                .await,
            );
            map.insert(
                "verification_enabled".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#verification_enabled,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for SpringCloudGatewayClientAuthorization {
