...
pub struct LinuxFunctionAppSlotSiteConfigIpRestriction {
    ...
    pub r#headers: Option<Box<super::super::types::appservice::LinuxFunctionAppSlotSiteConfigIpRestrictionHeaders>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for LinuxFunctionAppSlotSiteConfigIpRestriction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for LinuxFunctionAppSlotSiteConfigIpRestriction {
