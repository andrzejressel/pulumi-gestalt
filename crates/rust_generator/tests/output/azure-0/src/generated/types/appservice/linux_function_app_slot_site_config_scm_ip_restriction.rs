...
pub struct LinuxFunctionAppSlotSiteConfigScmIpRestriction {
    ...
    #[builder(into)]
    pub r#headers: Option<Box<super::super::types::appservice::LinuxFunctionAppSlotSiteConfigScmIpRestrictionHeaders>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for LinuxFunctionAppSlotSiteConfigScmIpRestriction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for LinuxFunctionAppSlotSiteConfigScmIpRestriction {
