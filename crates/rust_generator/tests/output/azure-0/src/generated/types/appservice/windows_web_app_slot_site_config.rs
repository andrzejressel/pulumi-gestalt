...
pub struct WindowsWebAppSlotSiteConfig {
    ...
    #[builder(into)]
    pub r#handler_mappings: Option<Vec<super::super::types::appservice::WindowsWebAppSlotSiteConfigHandlerMapping>>,
    ...
    #[builder(into)]
    pub r#ip_restrictions: Option<Vec<super::super::types::appservice::WindowsWebAppSlotSiteConfigIpRestriction>>,
    ...
    #[builder(into)]
    pub r#scm_ip_restrictions: Option<Vec<super::super::types::appservice::WindowsWebAppSlotSiteConfigScmIpRestriction>>,
    ...
    #[builder(into)]
    pub r#virtual_applications: Option<Vec<super::super::types::appservice::WindowsWebAppSlotSiteConfigVirtualApplication>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WindowsWebAppSlotSiteConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WindowsWebAppSlotSiteConfig {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#handler_mappings: {
                        let field_value = match fields_map.get("handlerMappings") {
                            Some(value) => value,
                            None => bail!("Missing field 'handlerMappings' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    ...
                    r#virtual_applications: {
                        let field_value = match fields_map.get("virtualApplications") {
                            Some(value) => value,
                            None => bail!("Missing field 'virtualApplications' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
