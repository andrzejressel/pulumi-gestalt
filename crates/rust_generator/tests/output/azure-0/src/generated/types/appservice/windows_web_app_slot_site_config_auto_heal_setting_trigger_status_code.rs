...
pub struct WindowsWebAppSlotSiteConfigAutoHealSettingTriggerStatusCode {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WindowsWebAppSlotSiteConfigAutoHealSettingTriggerStatusCode {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WindowsWebAppSlotSiteConfigAutoHealSettingTriggerStatusCode {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#status_code_range: {
                        let field_value = match fields_map.get("statusCodeRange") {
                            Some(value) => value,
                            None => bail!("Missing field 'statusCodeRange' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#sub_status: {
                    ...
                    r#win_32_status_code: {
                        let field_value = match fields_map.get("win32StatusCode") {
                            Some(value) => value,
                            None => bail!("Missing field 'win32StatusCode' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
