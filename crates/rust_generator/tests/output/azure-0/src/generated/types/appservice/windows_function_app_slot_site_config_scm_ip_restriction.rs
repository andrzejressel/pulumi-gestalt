...
pub struct WindowsFunctionAppSlotSiteConfigScmIpRestriction {
    ...
    pub r#headers: Option<Box<super::super::types::appservice::WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WindowsFunctionAppSlotSiteConfigScmIpRestriction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WindowsFunctionAppSlotSiteConfigScmIpRestriction {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#service_tag: {
                        let field_value = match fields_map.get("serviceTag") {
                            Some(value) => value,
                            None => bail!("Missing field 'serviceTag' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#virtual_network_subnet_id: {
                        let field_value = match fields_map.get("virtualNetworkSubnetId") {
                            Some(value) => value,
                            None => bail!("Missing field 'virtualNetworkSubnetId' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
