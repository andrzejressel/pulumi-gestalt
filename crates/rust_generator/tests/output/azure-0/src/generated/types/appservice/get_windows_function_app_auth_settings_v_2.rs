...
pub struct GetWindowsFunctionAppAuthSettingsV2 {
    /// An `active_directory_v2` block as defined below.
    #[builder(into)]
    #[serde(rename = "activeDirectoryV2s")]
    pub r#active_directory_v_2_s: Vec<super::super::types::appservice::GetWindowsFunctionAppAuthSettingsV2ActiveDirectoryV2>,
    /// An `apple_v2` block as defined below.
    #[builder(into)]
    #[serde(rename = "appleV2s")]
    pub r#apple_v_2_s: Vec<super::super::types::appservice::GetWindowsFunctionAppAuthSettingsV2AppleV2>,
    ...
    pub r#azure_static_web_app_v_2_s: Vec<super::super::types::appservice::GetWindowsFunctionAppAuthSettingsV2AzureStaticWebAppV2>,
    ...
    pub r#custom_oidc_v_2_s: Vec<super::super::types::appservice::GetWindowsFunctionAppAuthSettingsV2CustomOidcV2>,
    ...
    pub r#facebook_v_2_s: Vec<super::super::types::appservice::GetWindowsFunctionAppAuthSettingsV2FacebookV2>,
    ...
    pub r#github_v_2_s: Vec<super::super::types::appservice::GetWindowsFunctionAppAuthSettingsV2GithubV2>,
    /// A `google_v2` block as defined below.
    #[builder(into)]
    #[serde(rename = "googleV2s")]
    pub r#google_v_2_s: Vec<super::super::types::appservice::GetWindowsFunctionAppAuthSettingsV2GoogleV2>,
    ...
    #[builder(into)]
    #[serde(rename = "logins")]
    pub r#logins: Vec<super::super::types::appservice::GetWindowsFunctionAppAuthSettingsV2Login>,
    /// A `microsoft_v2` block as defined below.
    #[builder(into)]
    #[serde(rename = "microsoftV2s")]
    pub r#microsoft_v_2_s: Vec<super::super::types::appservice::GetWindowsFunctionAppAuthSettingsV2MicrosoftV2>,
    ...
    pub r#twitter_v_2_s: Vec<super::super::types::appservice::GetWindowsFunctionAppAuthSettingsV2TwitterV2>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetWindowsFunctionAppAuthSettingsV2 {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetWindowsFunctionAppAuthSettingsV2 {
