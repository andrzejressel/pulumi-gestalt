...
pub struct GetFunctionAppSiteConfig {
    ...
    pub r#ip_restrictions: Vec<super::super::types::appservice::GetFunctionAppSiteConfigIpRestriction>,
    ...
    pub r#scm_ip_restrictions: Vec<super::super::types::appservice::GetFunctionAppSiteConfigScmIpRestriction>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetFunctionAppSiteConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetFunctionAppSiteConfig {
