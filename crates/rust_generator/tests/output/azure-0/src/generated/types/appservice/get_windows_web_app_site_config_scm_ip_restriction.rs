...
pub struct GetWindowsWebAppSiteConfigScmIpRestriction {
    ...
    #[builder(into)]
    pub r#headers: Vec<super::super::types::appservice::GetWindowsWebAppSiteConfigScmIpRestrictionHeader>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetWindowsWebAppSiteConfigScmIpRestriction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetWindowsWebAppSiteConfigScmIpRestriction {
