...
pub struct AppServiceLogs {
    ...
    pub r#application_logs: Box<Option<super::super::types::appservice::AppServiceLogsApplicationLogs>>,
    ...
    pub r#http_logs: Box<Option<super::super::types::appservice::AppServiceLogsHttpLogs>>,
}
