...
pub struct GetLinuxFunctionAppBackup {
    ...
    pub r#schedules: Vec<super::super::types::appservice::GetLinuxFunctionAppBackupSchedule>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetLinuxFunctionAppBackup {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetLinuxFunctionAppBackup {
