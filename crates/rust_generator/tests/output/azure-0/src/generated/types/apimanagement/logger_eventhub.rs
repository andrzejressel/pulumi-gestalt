...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for LoggerEventhub {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "user_assigned_identity_client_id".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for LoggerEventhub {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#user_assigned_identity_client_id: {
                        let field_value = match fields_map.get("user_assigned_identity_client_id") {
                            Some(value) => value,
                            None => bail!("Missing field 'user_assigned_identity_client_id' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
