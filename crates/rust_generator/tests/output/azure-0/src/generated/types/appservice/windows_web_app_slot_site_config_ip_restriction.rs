...
pub struct WindowsWebAppSlotSiteConfigIpRestriction {
    ...
    pub r#headers: Option<Box<super::super::types::appservice::WindowsWebAppSlotSiteConfigIpRestrictionHeaders>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WindowsWebAppSlotSiteConfigIpRestriction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WindowsWebAppSlotSiteConfigIpRestriction {
