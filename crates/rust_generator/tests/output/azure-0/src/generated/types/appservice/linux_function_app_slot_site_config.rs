...
pub struct LinuxFunctionAppSlotSiteConfig {
    ...
    pub r#ip_restrictions: Option<Vec<super::super::types::appservice::LinuxFunctionAppSlotSiteConfigIpRestriction>>,
    ...
    pub r#scm_ip_restrictions: Option<Vec<super::super::types::appservice::LinuxFunctionAppSlotSiteConfigScmIpRestriction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for LinuxFunctionAppSlotSiteConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for LinuxFunctionAppSlotSiteConfig {
