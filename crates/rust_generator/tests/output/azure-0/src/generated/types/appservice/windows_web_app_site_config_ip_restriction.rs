...
pub struct WindowsWebAppSiteConfigIpRestriction {
    ...
    pub r#headers: Option<Box<super::super::types::appservice::WindowsWebAppSiteConfigIpRestrictionHeaders>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WindowsWebAppSiteConfigIpRestriction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WindowsWebAppSiteConfigIpRestriction {
