...
pub struct GetWindowsWebAppSiteConfigAutoHealSettingAction {
    ...
    pub r#custom_actions: Vec<super::super::types::appservice::GetWindowsWebAppSiteConfigAutoHealSettingActionCustomAction>,
    ...
    pub r#minimum_process_execution_time: String,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetWindowsWebAppSiteConfigAutoHealSettingAction {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "minimum_process_execution_time".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetWindowsWebAppSiteConfigAutoHealSettingAction {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#minimum_process_execution_time: {
                        let field_value = match fields_map.get("minimum_process_execution_time") {
                            Some(value) => value,
                            None => bail!("Missing field 'minimum_process_execution_time' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
