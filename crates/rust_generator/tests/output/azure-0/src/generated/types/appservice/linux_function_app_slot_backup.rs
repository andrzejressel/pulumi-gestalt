...
pub struct LinuxFunctionAppSlotBackup {
    ...
    pub r#schedule: Box<super::super::types::appservice::LinuxFunctionAppSlotBackupSchedule>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for LinuxFunctionAppSlotBackup {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for LinuxFunctionAppSlotBackup {
