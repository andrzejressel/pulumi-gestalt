...
pub struct SlotAuthSettings {
    ...
    pub r#active_directory: Box<Option<super::super::types::appservice::SlotAuthSettingsActiveDirectory>>,
    ...
    pub r#facebook: Box<Option<super::super::types::appservice::SlotAuthSettingsFacebook>>,
    /// A `google` block as defined below.
    #[builder(into)]
    #[serde(rename = "google")]
    pub r#google: Box<Option<super::super::types::appservice::SlotAuthSettingsGoogle>>,
    ...
    pub r#microsoft: Box<Option<super::super::types::appservice::SlotAuthSettingsMicrosoft>>,
    ...
    pub r#twitter: Box<Option<super::super::types::appservice::SlotAuthSettingsTwitter>>,
