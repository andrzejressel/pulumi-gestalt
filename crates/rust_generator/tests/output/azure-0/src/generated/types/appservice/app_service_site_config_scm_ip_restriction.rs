...
pub struct AppServiceSiteConfigScmIpRestriction {
    ...
    pub r#headers: Option<Box<super::super::types::appservice::AppServiceSiteConfigScmIpRestrictionHeaders>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AppServiceSiteConfigScmIpRestriction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AppServiceSiteConfigScmIpRestriction {
