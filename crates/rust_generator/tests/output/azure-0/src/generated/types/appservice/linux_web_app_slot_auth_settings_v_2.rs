...
pub struct LinuxWebAppSlotAuthSettingsV2 {
    /// An `active_directory_v2` block as defined below.
    #[builder(into)]
    #[serde(rename = "activeDirectoryV2")]
    pub r#active_directory_v_2: Option<Box<super::super::types::appservice::LinuxWebAppSlotAuthSettingsV2ActiveDirectoryV2>>,
    /// An `apple_v2` block as defined below.
    #[builder(into)]
    #[serde(rename = "appleV2")]
    pub r#apple_v_2: Option<Box<super::super::types::appservice::LinuxWebAppSlotAuthSettingsV2AppleV2>>,
    ...
    pub r#azure_static_web_app_v_2: Option<Box<super::super::types::appservice::LinuxWebAppSlotAuthSettingsV2AzureStaticWebAppV2>>,
    ...
    pub r#custom_oidc_v_2_s: Option<Vec<super::super::types::appservice::LinuxWebAppSlotAuthSettingsV2CustomOidcV2>>,
    ...
    pub r#facebook_v_2: Option<Box<super::super::types::appservice::LinuxWebAppSlotAuthSettingsV2FacebookV2>>,
    ...
    pub r#github_v_2: Option<Box<super::super::types::appservice::LinuxWebAppSlotAuthSettingsV2GithubV2>>,
    /// A `google_v2` block as defined below.
    #[builder(into)]
    #[serde(rename = "googleV2")]
    pub r#google_v_2: Option<Box<super::super::types::appservice::LinuxWebAppSlotAuthSettingsV2GoogleV2>>,
    ...
    #[builder(into)]
    #[serde(rename = "login")]
    pub r#login: Box<super::super::types::appservice::LinuxWebAppSlotAuthSettingsV2Login>,
    /// A `microsoft_v2` block as defined below.
    #[builder(into)]
    #[serde(rename = "microsoftV2")]
    pub r#microsoft_v_2: Option<Box<super::super::types::appservice::LinuxWebAppSlotAuthSettingsV2MicrosoftV2>>,
    ...
    pub r#twitter_v_2: Option<Box<super::super::types::appservice::LinuxWebAppSlotAuthSettingsV2TwitterV2>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for LinuxWebAppSlotAuthSettingsV2 {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for LinuxWebAppSlotAuthSettingsV2 {
