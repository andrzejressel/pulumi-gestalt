...
pub struct LinuxWebAppSiteConfigIpRestriction {
    ...
    #[builder(into)]
    pub r#headers: Option<Box<super::super::types::appservice::LinuxWebAppSiteConfigIpRestrictionHeaders>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for LinuxWebAppSiteConfigIpRestriction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for LinuxWebAppSiteConfigIpRestriction {
