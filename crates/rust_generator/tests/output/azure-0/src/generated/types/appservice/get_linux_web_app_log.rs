...
pub struct GetLinuxWebAppLog {
    ...
    pub r#application_logs: Vec<super::super::types::appservice::GetLinuxWebAppLogApplicationLog>,
    ...
    pub r#http_logs: Vec<super::super::types::appservice::GetLinuxWebAppLogHttpLog>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetLinuxWebAppLog {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetLinuxWebAppLog {
