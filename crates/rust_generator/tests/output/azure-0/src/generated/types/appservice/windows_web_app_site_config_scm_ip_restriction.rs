...
pub struct WindowsWebAppSiteConfigScmIpRestriction {
    ...
    pub r#headers: Option<Box<super::super::types::appservice::WindowsWebAppSiteConfigScmIpRestrictionHeaders>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WindowsWebAppSiteConfigScmIpRestriction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WindowsWebAppSiteConfigScmIpRestriction {
