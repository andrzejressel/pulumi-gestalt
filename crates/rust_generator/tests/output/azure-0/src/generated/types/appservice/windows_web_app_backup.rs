...
pub struct WindowsWebAppBackup {
    ...
    pub r#schedule: Box<super::super::types::appservice::WindowsWebAppBackupSchedule>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WindowsWebAppBackup {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WindowsWebAppBackup {
