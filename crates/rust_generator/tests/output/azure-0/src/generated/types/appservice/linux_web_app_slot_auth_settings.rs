...
pub struct LinuxWebAppSlotAuthSettings {
    /// An `active_directory` block as defined above.
    #[builder(into)]
    #[serde(rename = "activeDirectory")]
    pub r#active_directory: Option<Box<super::super::types::appservice::LinuxWebAppSlotAuthSettingsActiveDirectory>>,
    ...
    pub r#facebook: Option<Box<super::super::types::appservice::LinuxWebAppSlotAuthSettingsFacebook>>,
    /// A `github` block as defined below.
    #[builder(into)]
    #[serde(rename = "github")]
    pub r#github: Option<Box<super::super::types::appservice::LinuxWebAppSlotAuthSettingsGithub>>,
    /// A `google` block as defined below.
    #[builder(into)]
    #[serde(rename = "google")]
    pub r#google: Option<Box<super::super::types::appservice::LinuxWebAppSlotAuthSettingsGoogle>>,
    ...
    pub r#microsoft: Option<Box<super::super::types::appservice::LinuxWebAppSlotAuthSettingsMicrosoft>>,
    ...
    pub r#twitter: Option<Box<super::super::types::appservice::LinuxWebAppSlotAuthSettingsTwitter>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for LinuxWebAppSlotAuthSettings {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for LinuxWebAppSlotAuthSettings {
