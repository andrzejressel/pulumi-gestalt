...
pub struct LinuxWebAppSlotAuthSettings {
    ...
    pub r#active_directory: Box<Option<super::super::types::appservice::LinuxWebAppSlotAuthSettingsActiveDirectory>>,
    ...
    pub r#facebook: Box<Option<super::super::types::appservice::LinuxWebAppSlotAuthSettingsFacebook>>,
    /// A `github` block as defined below.
    #[builder(into)]
    #[serde(rename = "github")]
    pub r#github: Box<Option<super::super::types::appservice::LinuxWebAppSlotAuthSettingsGithub>>,
    /// A `google` block as defined below.
    #[builder(into)]
    #[serde(rename = "google")]
    pub r#google: Box<Option<super::super::types::appservice::LinuxWebAppSlotAuthSettingsGoogle>>,
    ...
    pub r#microsoft: Box<Option<super::super::types::appservice::LinuxWebAppSlotAuthSettingsMicrosoft>>,
    ...
    pub r#twitter: Box<Option<super::super::types::appservice::LinuxWebAppSlotAuthSettingsTwitter>>,
