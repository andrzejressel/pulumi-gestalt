...
pub struct AppServiceAuthSettings {
    ...
    pub r#facebook: Option<Box<super::super::types::appservice::AppServiceAuthSettingsFacebook>>,
    /// A `google` block as defined below.
    #[builder(into)]
    #[serde(rename = "google")]
    pub r#google: Option<Box<super::super::types::appservice::AppServiceAuthSettingsGoogle>>,
    ...
    pub r#microsoft: Option<Box<super::super::types::appservice::AppServiceAuthSettingsMicrosoft>>,
    ...
    pub r#twitter: Option<Box<super::super::types::appservice::AppServiceAuthSettingsTwitter>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AppServiceAuthSettings {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AppServiceAuthSettings {
