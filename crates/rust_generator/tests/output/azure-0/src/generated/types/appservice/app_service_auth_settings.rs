...
pub struct AppServiceAuthSettings {
    ...
    pub r#active_directory: Box<Option<super::super::types::appservice::AppServiceAuthSettingsActiveDirectory>>,
    ...
    pub r#facebook: Box<Option<super::super::types::appservice::AppServiceAuthSettingsFacebook>>,
    /// A `google` block as defined below.
    #[builder(into)]
    #[serde(rename = "google")]
    pub r#google: Box<Option<super::super::types::appservice::AppServiceAuthSettingsGoogle>>,
    ...
    pub r#microsoft: Box<Option<super::super::types::appservice::AppServiceAuthSettingsMicrosoft>>,
    ...
    pub r#twitter: Box<Option<super::super::types::appservice::AppServiceAuthSettingsTwitter>>,
