...
pub struct FunctionAppSiteConfigIpRestriction {
    ...
    #[builder(into)]
    pub r#headers: Option<Box<super::super::types::appservice::FunctionAppSiteConfigIpRestrictionHeaders>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FunctionAppSiteConfigIpRestriction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FunctionAppSiteConfigIpRestriction {
