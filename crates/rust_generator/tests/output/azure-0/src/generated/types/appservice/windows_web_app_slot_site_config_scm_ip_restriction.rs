...
pub struct WindowsWebAppSlotSiteConfigScmIpRestriction {
    ...
    pub r#headers: Option<Box<super::super::types::appservice::WindowsWebAppSlotSiteConfigScmIpRestrictionHeaders>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WindowsWebAppSlotSiteConfigScmIpRestriction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WindowsWebAppSlotSiteConfigScmIpRestriction {
