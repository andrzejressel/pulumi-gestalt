...
pub struct WindowsFunctionAppSiteConfigScmIpRestriction {
    ...
    pub r#headers: Option<Box<super::super::types::appservice::WindowsFunctionAppSiteConfigScmIpRestrictionHeaders>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WindowsFunctionAppSiteConfigScmIpRestriction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WindowsFunctionAppSiteConfigScmIpRestriction {
