...
pub struct WindowsWebAppAuthSettingsV2 {
    ...
    pub r#active_directory_v_2: Box<Option<super::super::types::appservice::WindowsWebAppAuthSettingsV2ActiveDirectoryV2>>,
    /// An `apple_v2` block as defined below.
    #[builder(into)]
    #[serde(rename = "appleV2")]
    pub r#apple_v_2: Box<Option<super::super::types::appservice::WindowsWebAppAuthSettingsV2AppleV2>>,
    ...
    pub r#azure_static_web_app_v_2: Box<Option<super::super::types::appservice::WindowsWebAppAuthSettingsV2AzureStaticWebAppV2>>,
    ...
    pub r#facebook_v_2: Box<Option<super::super::types::appservice::WindowsWebAppAuthSettingsV2FacebookV2>>,
    ...
    pub r#github_v_2: Box<Option<super::super::types::appservice::WindowsWebAppAuthSettingsV2GithubV2>>,
    /// A `google_v2` block as defined below.
    #[builder(into)]
    #[serde(rename = "googleV2")]
    pub r#google_v_2: Box<Option<super::super::types::appservice::WindowsWebAppAuthSettingsV2GoogleV2>>,
    ...
    pub r#microsoft_v_2: Box<Option<super::super::types::appservice::WindowsWebAppAuthSettingsV2MicrosoftV2>>,
    ...
    pub r#twitter_v_2: Box<Option<super::super::types::appservice::WindowsWebAppAuthSettingsV2TwitterV2>>,
