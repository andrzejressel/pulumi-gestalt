...
pub struct LinuxWebAppSlotSiteConfigIpRestriction {
    ...
    #[builder(into)]
    pub r#headers: Option<Box<super::super::types::appservice::LinuxWebAppSlotSiteConfigIpRestrictionHeaders>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for LinuxWebAppSlotSiteConfigIpRestriction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for LinuxWebAppSlotSiteConfigIpRestriction {
