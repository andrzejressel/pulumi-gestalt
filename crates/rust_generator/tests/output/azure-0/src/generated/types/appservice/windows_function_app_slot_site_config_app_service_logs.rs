...
pub struct WindowsFunctionAppSlotSiteConfigAppServiceLogs {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WindowsFunctionAppSlotSiteConfigAppServiceLogs {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WindowsFunctionAppSlotSiteConfigAppServiceLogs {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#disk_quota_mb: {
                        let field_value = match fields_map.get("diskQuotaMb") {
                            Some(value) => value,
                            None => bail!("Missing field 'diskQuotaMb' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
