...
pub struct ApiOperationResponseRepresentationFormParameter {
    ...
    pub r#examples: Option<Vec<super::super::types::apimanagement::ApiOperationResponseRepresentationFormParameterExample>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ApiOperationResponseRepresentationFormParameter {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ApiOperationResponseRepresentationFormParameter {
