...
pub struct LinuxFunctionAppBackup {
    ...
    pub r#schedule: Box<super::super::types::appservice::LinuxFunctionAppBackupSchedule>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for LinuxFunctionAppBackup {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for LinuxFunctionAppBackup {
