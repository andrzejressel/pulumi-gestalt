...
pub struct GetWindowsFunctionAppSiteConfigScmIpRestriction {
    ...
    #[builder(into)]
    pub r#headers: Vec<super::super::types::appservice::GetWindowsFunctionAppSiteConfigScmIpRestrictionHeader>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetWindowsFunctionAppSiteConfigScmIpRestriction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetWindowsFunctionAppSiteConfigScmIpRestriction {
