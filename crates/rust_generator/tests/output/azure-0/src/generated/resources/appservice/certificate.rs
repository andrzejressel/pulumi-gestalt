...
pub mod certificate {
    ...
    fn __create(
        ...
        let key_vault_secret_id_binding = args.key_vault_secret_id.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let password_binding = args.password.get_output(ctx);
        let pfx_blob_binding = args.pfx_blob.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "pfxBlob".into(),
                    value: &pfx_blob_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
