...
pub mod spring_cloud_app_dynamics_application_performance_monitoring {
    ...
    fn __create(
        ...
        let agent_account_access_key_binding = args
            ...
            .get_output(ctx);
        let agent_account_name_binding = args.agent_account_name.get_output(ctx);
        let agent_application_name_binding = args.agent_application_name.get_output(ctx);
        let agent_node_name_binding = args.agent_node_name.get_output(ctx);
        let agent_tier_name_binding = args.agent_tier_name.get_output(ctx);
        let agent_unique_host_id_binding = args.agent_unique_host_id.get_output(ctx);
        let controller_host_name_binding = args.controller_host_name.get_output(ctx);
        let controller_port_binding = args.controller_port.get_output(ctx);
        let controller_ssl_enabled_binding = args.controller_ssl_enabled.get_output(ctx);
