...
pub mod logger {
    ...
    fn __create(
        ...
        let application_insights_binding = args.application_insights.get_output(ctx);
        let buffered_binding = args.buffered.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let eventhub_binding = args.eventhub.get_output(ctx);
