...
pub mod standard_web_test {
    ...
    fn __create(
        ...
        let retry_enabled_binding = args.retry_enabled.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let timeout_binding = args.timeout.get_output(ctx);
        let validation_rules_binding = args.validation_rules.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "request".into(),
                    value: &request_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
