...
pub mod plan {
    ...
    fn __create(
        ...
        let app_service_environment_id_binding = args
            ...
            .get_output(ctx);
        let is_xenon_binding = args.is_xenon.get_output(ctx);
        ...
        let per_site_scaling_binding = args.per_site_scaling.get_output(ctx);
        let reserved_binding = args.reserved.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "isXenon".into(),
                    value: &is_xenon_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "kind".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &per_site_scaling_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "reserved".into(),
                    value: &reserved_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
