...
pub mod api_version_set {
    ...
    fn __create(
        ...
        let version_header_name_binding = args.version_header_name.get_output(ctx);
        let version_query_name_binding = args.version_query_name.get_output(ctx);
        let versioning_scheme_binding = args.versioning_scheme.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &version_header_name_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "versionQueryName".into(),
                    value: &version_query_name_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "versioningScheme".into(),
                    value: &versioning_scheme_binding.drop_type(),
                },
            ],
            options,
        };
