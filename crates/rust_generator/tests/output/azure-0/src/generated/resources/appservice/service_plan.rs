...
pub mod service_plan {
    ...
    pub struct ServicePlanArgs {
        ...
        #[builder(into, default)]
        pub per_site_scaling_enabled: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub worker_count: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub zone_balancing_enabled: pulumi_gestalt_rust::Input<Option<bool>>,
    }
    #[allow(dead_code)]
    ...
    fn __create(
        ...
        let worker_count_binding = args.worker_count.get_output(ctx);
        let zone_balancing_enabled_binding = args.zone_balancing_enabled.get_output(ctx);
