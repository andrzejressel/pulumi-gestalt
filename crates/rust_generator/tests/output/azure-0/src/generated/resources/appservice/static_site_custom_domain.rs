...
pub mod static_site_custom_domain {
    ...
    fn __create(
        ...
        let static_site_id_binding = args.static_site_id.get_output(ctx);
        let validation_type_binding = args.validation_type.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &static_site_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
