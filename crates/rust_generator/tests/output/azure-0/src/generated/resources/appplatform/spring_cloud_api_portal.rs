...
pub mod spring_cloud_api_portal {
    ...
    fn __create(
        ...
        let api_try_out_enabled_binding = args.api_try_out_enabled.get_output(ctx);
        let gateway_ids_binding = args.gateway_ids.get_output(ctx);
        let https_only_enabled_binding = args.https_only_enabled.get_output(ctx);
