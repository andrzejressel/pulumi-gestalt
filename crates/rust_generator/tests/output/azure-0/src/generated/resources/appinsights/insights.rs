...
pub mod insights {
    ...
    pub struct InsightsArgs {
        ...
        #[builder(into)]
        pub application_type: pulumi_gestalt_rust::Input<String>,
        /// Specifies the Application Insights component daily data volume cap in GB. Defaults to `100`.
        #[builder(into, default)]
        pub daily_data_cap_in_gb: pulumi_gestalt_rust::Input<Option<f64>>,
        /// Specifies if a notification email will be sent when the daily data volume cap is met. Defaults to `false`.
        #[builder(into, default)]
        pub daily_data_cap_notifications_disabled: pulumi_gestalt_rust::Input<
            Option<bool>,
        >,
        /// By default the real client IP is masked as `0.0.0.0` in the logs. Use this argument to disable masking and log the real client IP. Defaults to `false`.
        #[builder(into, default)]
        pub disable_ip_masking: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub force_customer_storage_for_profiler: pulumi_gestalt_rust::Input<
            Option<bool>,
        >,
