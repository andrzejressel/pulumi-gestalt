...
pub struct BillingAccountBucketConfigCmekSettings {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BillingAccountBucketConfigCmekSettings {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BillingAccountBucketConfigCmekSettings {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#kms_key_version_name: {
                        let field_value = match fields_map.get("kmsKeyVersionName") {
                            Some(value) => value,
                            None => bail!("Missing field 'kmsKeyVersionName' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#name: {
