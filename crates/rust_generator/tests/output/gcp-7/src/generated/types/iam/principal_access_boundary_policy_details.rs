            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#enforcement_version: {
                        let field_value = match fields_map.get("enforcementVersion") {
                            Some(value) => value,
                            None => bail!("Missing field 'enforcementVersion' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
