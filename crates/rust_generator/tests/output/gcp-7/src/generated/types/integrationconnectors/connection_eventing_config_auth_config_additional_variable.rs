...
pub struct ConnectionEventingConfigAuthConfigAdditionalVariable {
    ...
    pub r#encryption_key_value: Option<Box<super::super::types::integrationconnectors::ConnectionEventingConfigAuthConfigAdditionalVariableEncryptionKeyValue>>,
    ...
    pub r#secret_value: Option<Box<super::super::types::integrationconnectors::ConnectionEventingConfigAuthConfigAdditionalVariableSecretValue>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ConnectionEventingConfigAuthConfigAdditionalVariable {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ConnectionEventingConfigAuthConfigAdditionalVariable {
