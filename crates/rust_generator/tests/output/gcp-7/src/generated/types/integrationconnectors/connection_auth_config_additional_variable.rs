...
pub struct ConnectionAuthConfigAdditionalVariable {
    ...
    pub r#encryption_key_value: Option<Box<super::super::types::integrationconnectors::ConnectionAuthConfigAdditionalVariableEncryptionKeyValue>>,
    ...
    pub r#secret_value: Option<Box<super::super::types::integrationconnectors::ConnectionAuthConfigAdditionalVariableSecretValue>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ConnectionAuthConfigAdditionalVariable {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ConnectionAuthConfigAdditionalVariable {
