...
pub struct ConnectionEventingConfigAdditionalVariable {
    ...
    pub r#encryption_key_value: Option<Box<super::super::types::integrationconnectors::ConnectionEventingConfigAdditionalVariableEncryptionKeyValue>>,
    ...
    pub r#secret_value: Option<Box<super::super::types::integrationconnectors::ConnectionEventingConfigAdditionalVariableSecretValue>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ConnectionEventingConfigAdditionalVariable {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ConnectionEventingConfigAdditionalVariable {
