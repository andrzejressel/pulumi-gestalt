...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ConfigMfaProviderConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "totp_provider_config".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ConfigMfaProviderConfig {
