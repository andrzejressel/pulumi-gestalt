            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#disable_programmatic_signin: {
                        let field_value = match fields_map.get("disableProgrammaticSignin") {
                            Some(value) => value,
                            None => bail!("Missing field 'disableProgrammaticSignin' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
