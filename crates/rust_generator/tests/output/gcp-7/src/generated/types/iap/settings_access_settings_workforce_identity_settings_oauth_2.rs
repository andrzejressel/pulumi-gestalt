            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#client_secret_sha_256: {
                        let field_value = match fields_map.get("clientSecretSha256") {
                            Some(value) => value,
                            None => bail!("Missing field 'clientSecretSha256' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
