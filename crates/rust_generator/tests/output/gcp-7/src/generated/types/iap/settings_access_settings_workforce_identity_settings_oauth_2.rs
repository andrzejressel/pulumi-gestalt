...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for SettingsAccessSettingsWorkforceIdentitySettingsOauth2 {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "client_secret_sha_256".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#client_secret_sha_256,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for SettingsAccessSettingsWorkforceIdentitySettingsOauth2 {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#client_secret_sha_256: {
                        let field_value = match fields_map.get("client_secret_sha_256") {
                            Some(value) => value,
                            None => bail!("Missing field 'client_secret_sha_256' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
