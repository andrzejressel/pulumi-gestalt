...
pub mod web_region_backend_service_iam_member {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct WebRegionBackendServiceIamMemberArgs {
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::Input<
            Option<super::super::types::iap::WebRegionBackendServiceIamMemberCondition>,
        >,
        ...
        #[builder(into)]
        pub web_region_backend_service: pulumi_gestalt_rust::Input<String>,
    }
    #[allow(dead_code)]
    pub struct WebRegionBackendServiceIamMemberResult {
