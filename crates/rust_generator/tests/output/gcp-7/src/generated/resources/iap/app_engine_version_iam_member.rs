...
pub mod app_engine_version_iam_member {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct AppEngineVersionIamMemberArgs {
        ...
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::iap::AppEngineVersionIamMemberCondition>,
        >,
    ...
    #[allow(dead_code)]
    pub struct AppEngineVersionIamMemberResult {
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:iap/appEngineVersionIamMember:AppEngineVersionIamMember".into(),
            name: name.to_string(),
