...
pub mod cluster {
    ...
    fn __create(
        ...
        let capacity_config_binding = args.capacity_config.get_output(ctx);
        let cluster_id_binding = args.cluster_id.get_output(ctx);
        let gcp_config_binding = args.gcp_config.get_output(ctx);
        let labels_binding = args.labels.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let project_binding = args.project.get_output(ctx);
        let rebalance_config_binding = args.rebalance_config.get_output(ctx);
