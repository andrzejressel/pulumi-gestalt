...
pub mod web_backend_service_iam_binding {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct WebBackendServiceIamBindingArgs {
        /// An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
        /// Structure is documented below.
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::Input<
            Option<super::super::types::iap::WebBackendServiceIamBindingCondition>,
        >,
        ...
        #[builder(into)]
        pub web_backend_service: pulumi_gestalt_rust::Input<String>,
    }
    #[allow(dead_code)]
    pub struct WebBackendServiceIamBindingResult {
    ...
    ) -> WebBackendServiceIamBindingResult {
    ...
    fn __create(
        ...
        let web_backend_service_binding = args.web_backend_service.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:iap/webBackendServiceIamBinding:WebBackendServiceIamBinding"
                .into(),
            name: name.to_string(),
