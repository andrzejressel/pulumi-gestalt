...
pub mod web_type_app_enging_iam_binding {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct WebTypeAppEngingIamBindingArgs {
        ...
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::iap::WebTypeAppEngingIamBindingCondition>,
        >,
    ...
    #[allow(dead_code)]
    pub struct WebTypeAppEngingIamBindingResult {
