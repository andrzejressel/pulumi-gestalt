...
pub mod key_handle {
    ...
    fn __create(
        ...
        let resource_type_selector_binding = args.resource_type_selector.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &resource_type_selector_binding.drop_type(),
                },
            ],
            options,
        };
        ...
        KeyHandleResult {
            ...
            resource_type_selector: o.get_field("resourceTypeSelector"),
        }
    }
}
