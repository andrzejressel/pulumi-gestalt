...
pub mod pipeline {
    ...
    fn __create(
        ...
        let buffer_options_binding = args.buffer_options.get_output(ctx);
        ...
        let max_units_binding = args.max_units.get_output(ctx);
        let min_units_binding = args.min_units.get_output(ctx);
