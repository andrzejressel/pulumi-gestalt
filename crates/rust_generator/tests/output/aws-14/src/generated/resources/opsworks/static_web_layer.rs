...
///     let web = static_web_layer::create(
///         "web",
///         StaticWebLayerArgs::builder().stack_id("${main.id}").build_struct(),
///     );
/// }
/// ```
///
...
pub mod static_web_layer {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct StaticWebLayerArgs {
        ...
        pub ebs_volumes: pulumi_gestalt_rust::InputOrOutput<
            Option<Vec<super::super::types::opsworks::StaticWebLayerEbsVolume>>,
        >,
        ...
        pub load_based_auto_scaling: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::opsworks::StaticWebLayerLoadBasedAutoScaling>,
        >,
    ...
    pub struct StaticWebLayerResult {
        ...
        pub ebs_volumes: pulumi_gestalt_rust::Output<
            Vec<super::super::types::opsworks::StaticWebLayerEbsVolume>,
        >,
        /// Name of an Elastic Load Balancer to attach to this layer
        ...
        pub load_based_auto_scaling: pulumi_gestalt_rust::Output<
            super::super::types::opsworks::StaticWebLayerLoadBasedAutoScaling,
        >,
        /// A human-readable name for the layer.
