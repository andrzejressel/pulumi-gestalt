...
pub mod connection {
    ...
    fn __create(
        ...
        let connected_device_id_binding = args.connected_device_id.get_output(ctx);
        let connected_link_id_binding = args.connected_link_id.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &connected_device_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "connectedLinkId".into(),
                    value: &connected_link_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
