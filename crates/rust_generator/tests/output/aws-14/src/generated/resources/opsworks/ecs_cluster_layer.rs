...
///     let example = ecs_cluster_layer::create(
///         "example",
///         EcsClusterLayerArgs::builder()
///             .ecs_cluster_arn("${exampleAwsEcsCluster.arn}")
///             .stack_id("${exampleAwsOpsworksStack.id}")
///             .build_struct(),
///     );
/// }
/// ```
#[allow(clippy::doc_lazy_continuation, clippy::tabs_in_doc_comments, clippy::should_implement_trait)]
pub mod ecs_cluster_layer {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct EcsClusterLayerArgs {
        ...
        pub cloudwatch_configuration: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::opsworks::EcsClusterLayerCloudwatchConfiguration>,
        >,
        #[builder(into, default)]
        ...
        pub ebs_volumes: pulumi_gestalt_rust::InputOrOutput<
            Option<Vec<super::super::types::opsworks::EcsClusterLayerEbsVolume>>,
        >,
        /// The ECS Cluster ARN of the layer.
        #[builder(into)]
        pub ecs_cluster_arn: pulumi_gestalt_rust::InputOrOutput<String>,
        ...
        pub load_based_auto_scaling: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::opsworks::EcsClusterLayerLoadBasedAutoScaling>,
        >,
    ...
    pub struct EcsClusterLayerResult {
        ...
        pub ebs_volumes: pulumi_gestalt_rust::Output<
            Vec<super::super::types::opsworks::EcsClusterLayerEbsVolume>,
        >,
        /// The ECS Cluster ARN of the layer.
        ...
        pub load_based_auto_scaling: pulumi_gestalt_rust::Output<
            super::super::types::opsworks::EcsClusterLayerLoadBasedAutoScaling,
        >,
        /// A human-readable name for the layer.
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "aws:opsworks/ecsClusterLayer:EcsClusterLayer".into(),
            name: name.to_string(),
