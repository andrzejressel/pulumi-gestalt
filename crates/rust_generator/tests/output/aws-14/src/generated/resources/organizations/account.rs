...
pub mod account {
    ...
    pub struct AccountArgs {
        ...
        pub close_on_deletion: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub create_govcloud: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub parent_id: pulumi_gestalt_rust::Input<Option<String>>,
    ...
    fn __create(
        ...
        let close_on_deletion_binding = args.close_on_deletion.get_output(ctx);
        let create_govcloud_binding = args.create_govcloud.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &close_on_deletion_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "createGovcloud".into(),
                    value: &create_govcloud_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "email".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &iam_user_access_to_billing_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
