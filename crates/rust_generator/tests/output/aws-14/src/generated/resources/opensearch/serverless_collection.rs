...
pub mod serverless_collection {
    ...
    pub struct ServerlessCollectionArgs {
        ...
        #[builder(into, default)]
        pub standby_replicas: pulumi_gestalt_rust::Input<Option<String>>,
    ...
    fn __create(
        ...
        let standby_replicas_binding = args.standby_replicas.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &standby_replicas_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "tags".into(),
