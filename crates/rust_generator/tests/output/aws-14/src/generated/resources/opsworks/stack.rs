...
pub mod stack {
    ...
    fn __create(
        ...
        let berkshelf_version_binding = args.berkshelf_version.get_output(ctx);
        let color_binding = args.color.get_output(ctx);
        ...
        let default_instance_profile_arn_binding = args
            ...
            .get_output(ctx);
        let default_os_binding = args.default_os.get_output(ctx);
        let default_root_device_type_binding = args
            .default_root_device_type
            .get_output(ctx);
        let default_ssh_key_name_binding = args.default_ssh_key_name.get_output(ctx);
        let default_subnet_id_binding = args.default_subnet_id.get_output(ctx);
        let hostname_theme_binding = args.hostname_theme.get_output(ctx);
        let manage_berkshelf_binding = args.manage_berkshelf.get_output(ctx);
        ...
        let use_custom_cookbooks_binding = args.use_custom_cookbooks.get_output(ctx);
