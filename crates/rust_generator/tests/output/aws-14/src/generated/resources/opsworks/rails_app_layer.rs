...
pub mod rails_app_layer {
    ...
    pub struct RailsAppLayerArgs {
        ...
        #[builder(into, default)]
        pub bundler_version: pulumi_gestalt_rust::Input<Option<String>>,
        #[builder(into, default)]
        ...
        #[builder(into, default)]
        pub manage_bundler: pulumi_gestalt_rust::Input<Option<bool>>,
        /// A human-readable name for the layer.
        #[builder(into, default)]
        pub name: pulumi_gestalt_rust::Input<Option<String>>,
        /// The version of Passenger to use. Defaults to "4.0.46".
        #[builder(into, default)]
        pub passenger_version: pulumi_gestalt_rust::Input<Option<String>>,
        /// The version of Ruby to use. Defaults to "2.0.0".
        #[builder(into, default)]
        pub ruby_version: pulumi_gestalt_rust::Input<Option<String>>,
        /// The version of RubyGems to use. Defaults to "2.2.2".
        #[builder(into, default)]
        pub rubygems_version: pulumi_gestalt_rust::Input<Option<String>>,
