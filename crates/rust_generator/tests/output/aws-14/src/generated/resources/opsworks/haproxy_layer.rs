...
///     let lb = haproxy_layer::create(
///         "lb",
///         HaproxyLayerArgs::builder()
///             .stack_id("${main.id}")
...
pub mod haproxy_layer {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct HaproxyLayerArgs {
        ...
        pub cloudwatch_configuration: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::opsworks::HaproxyLayerCloudwatchConfiguration>,
        >,
        #[builder(into, default)]
        ...
        pub ebs_volumes: pulumi_gestalt_rust::InputOrOutput<
            Option<Vec<super::super::types::opsworks::HaproxyLayerEbsVolume>>,
        >,
        ...
        #[builder(into, default)]
        pub healthcheck_method: pulumi_gestalt_rust::InputOrOutput<Option<String>>,
        /// URL path to use for instance healthchecks. Defaults to "/".
        #[builder(into, default)]
        pub healthcheck_url: pulumi_gestalt_rust::InputOrOutput<Option<String>>,
        ...
        pub load_based_auto_scaling: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::opsworks::HaproxyLayerLoadBasedAutoScaling>,
        >,
        ...
        #[builder(into, default)]
        pub stats_enabled: pulumi_gestalt_rust::InputOrOutput<Option<bool>>,
        /// The password to use for HAProxy stats.
        #[builder(into)]
        pub stats_password: pulumi_gestalt_rust::InputOrOutput<String>,
        /// The HAProxy stats URL. Defaults to "/haproxy?stats".
        #[builder(into, default)]
        pub stats_url: pulumi_gestalt_rust::InputOrOutput<Option<String>>,
        /// The username for HAProxy stats. Defaults to "opsworks".
        #[builder(into, default)]
        pub stats_user: pulumi_gestalt_rust::InputOrOutput<Option<String>>,
    ...
    pub struct HaproxyLayerResult {
        ...
        pub ebs_volumes: pulumi_gestalt_rust::Output<
            Vec<super::super::types::opsworks::HaproxyLayerEbsVolume>,
        >,
        /// Name of an Elastic Load Balancer to attach to this layer
        pub elastic_load_balancer: pulumi_gestalt_rust::Output<Option<String>>,
        /// HTTP method to use for instance healthchecks. Defaults to "OPTIONS".
        pub healthcheck_method: pulumi_gestalt_rust::Output<Option<String>>,
        /// URL path to use for instance healthchecks. Defaults to "/".
        pub healthcheck_url: pulumi_gestalt_rust::Output<Option<String>>,
        /// Whether to install OS and package updates on each instance when it boots.
        ...
        pub load_based_auto_scaling: pulumi_gestalt_rust::Output<
            super::super::types::opsworks::HaproxyLayerLoadBasedAutoScaling,
        >,
        /// A human-readable name for the layer.
        ...
        /// Whether to enable HAProxy stats.
        pub stats_enabled: pulumi_gestalt_rust::Output<Option<bool>>,
        /// The password to use for HAProxy stats.
        pub stats_password: pulumi_gestalt_rust::Output<String>,
        /// The HAProxy stats URL. Defaults to "/haproxy?stats".
        pub stats_url: pulumi_gestalt_rust::Output<Option<String>>,
        /// The username for HAProxy stats. Defaults to "opsworks".
        pub stats_user: pulumi_gestalt_rust::Output<Option<String>>,
        /// Names of a set of system packages to install on the layer's instances.
    ...
    pub fn create(
        ...
        let elastic_load_balancer_binding = args
            ...
            .get_output(context);
        let healthcheck_method_binding = args.healthcheck_method.get_output(context);
        let healthcheck_url_binding = args.healthcheck_url.get_output(context);
        ...
        let stats_enabled_binding = args.stats_enabled.get_output(context);
        let stats_password_binding = args.stats_password.get_output(context);
        let stats_url_binding = args.stats_url.get_output(context);
        let stats_user_binding = args.stats_user.get_output(context);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "healthcheckMethod".into(),
                    value: &healthcheck_method_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "healthcheckUrl".into(),
                    value: &healthcheck_url_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "statsEnabled".into(),
                    value: &stats_enabled_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "statsPassword".into(),
                    value: &stats_password_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "statsUrl".into(),
                    value: &stats_url_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "statsUser".into(),
                    value: &stats_user_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
        ...
        HaproxyLayerResult {
            ...
            healthcheck_method: o.get_field("healthcheckMethod"),
            healthcheck_url: o.get_field("healthcheckUrl"),
            ...
            stats_enabled: o.get_field("statsEnabled"),
            stats_password: o.get_field("statsPassword"),
            stats_url: o.get_field("statsUrl"),
            stats_user: o.get_field("statsUser"),
