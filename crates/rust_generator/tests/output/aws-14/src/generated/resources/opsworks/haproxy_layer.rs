...
pub mod haproxy_layer {
    ...
    fn __create(
        ...
        let healthcheck_method_binding = args.healthcheck_method.get_output(ctx);
        let healthcheck_url_binding = args.healthcheck_url.get_output(ctx);
        ...
        let stats_enabled_binding = args.stats_enabled.get_output(ctx);
        let stats_password_binding = args.stats_password.get_output(ctx);
        let stats_url_binding = args.stats_url.get_output(ctx);
        let stats_user_binding = args.stats_user.get_output(ctx);
