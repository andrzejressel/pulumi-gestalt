...
///     let cache = memcached_layer::create(
///         "cache",
///         MemcachedLayerArgs::builder().stack_id("${main.id}").build_struct(),
///     );
/// }
/// ```
#[allow(
...
pub mod memcached_layer {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct MemcachedLayerArgs {
        /// Amount of memory to allocate for the cache on each instance, in megabytes. Defaults to 512MB.
        #[builder(into, default)]
        pub allocated_memory: pulumi_gestalt_rust::InputOrOutput<Option<i32>>,
        ...
        pub cloudwatch_configuration: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::opsworks::MemcachedLayerCloudwatchConfiguration>,
        >,
        #[builder(into, default)]
        ...
        pub ebs_volumes: pulumi_gestalt_rust::InputOrOutput<
            Option<Vec<super::super::types::opsworks::MemcachedLayerEbsVolume>>,
        >,
        ...
        pub load_based_auto_scaling: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::opsworks::MemcachedLayerLoadBasedAutoScaling>,
        >,
    ...
    #[allow(dead_code)]
    pub struct MemcachedLayerResult {
        ...
        pub ebs_volumes: pulumi_gestalt_rust::Output<
            Vec<super::super::types::opsworks::MemcachedLayerEbsVolume>,
        >,
        /// Name of an Elastic Load Balancer to attach to this layer
        ...
        pub load_based_auto_scaling: pulumi_gestalt_rust::Output<
            super::super::types::opsworks::MemcachedLayerLoadBasedAutoScaling,
        >,
        /// A human-readable name for the layer.
    ...
    fn __create(
        ...
        let allocated_memory_binding = args.allocated_memory.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "aws:opsworks/memcachedLayer:MemcachedLayer".into(),
            name: name.to_string(),
            version: super::super::get_version(),
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "allocatedMemory".into(),
                    value: &allocated_memory_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
