...
pub mod nodejs_app_layer {
    ...
    pub struct NodejsAppLayerArgs {
        ...
        #[builder(into, default)]
        pub nodejs_version: pulumi_gestalt_rust::InputOrOutput<Option<String>>,
    ...
    pub struct NodejsAppLayerResult {
        ...
        /// The version of NodeJS to use. Defaults to "0.10.38".
        pub nodejs_version: pulumi_gestalt_rust::Output<Option<String>>,
        /// ID of the stack the layer will belong to.
    ...
    pub fn create(
        ...
        let nodejs_version_binding = args.nodejs_version.get_output(context);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &nodejs_version_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "stackId".into(),
        ...
        NodejsAppLayerResult {
            ...
            nodejs_version: o.get_field("nodejsVersion"),
