...
///     let db = mysql_layer::create(
///         "db",
///         MysqlLayerArgs::builder().stack_id("${main.id}").build_struct(),
///     );
/// }
/// ```
#[allow(
...
pub mod mysql_layer {
    ...
    pub struct MysqlLayerArgs {
        ...
        #[builder(into, default)]
        pub root_password_on_all_instances: pulumi_gestalt_rust::Input<Option<bool>>,
    ...
    pub struct MysqlLayerResult {
        ...
        pub ebs_volumes: pulumi_gestalt_rust::Output<
            Vec<super::super::types::opsworks::MysqlLayerEbsVolume>,
        >,
        /// Name of an Elastic Load Balancer to attach to this layer
        ...
        pub load_based_auto_scaling: pulumi_gestalt_rust::Output<
            super::super::types::opsworks::MysqlLayerLoadBasedAutoScaling,
        >,
        /// A human-readable name for the layer.
        ...
        /// Whether to set the root user password to all instances in the stack so they can access the instances in this layer.
        pub root_password_on_all_instances: pulumi_gestalt_rust::Output<Option<bool>>,
        /// ID of the stack the layer will belong to.
    ...
    fn __create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "rootPasswordOnAllInstances".into(),
                    value: &root_password_on_all_instances_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "stackId".into(),
        ...
        MysqlLayerResult {
            ...
            root_password_on_all_instances: o.get_field("rootPasswordOnAllInstances"),
