...
///     let monitor = ganglia_layer::create(
///         "monitor",
///         GangliaLayerArgs::builder()
///             .password("foobarbaz")
///             .stack_id("${main.id}")
///             .build_struct(),
///     );
...
pub mod ganglia_layer {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct GangliaLayerArgs {
        ...
        pub ebs_volumes: pulumi_gestalt_rust::InputOrOutput<
            Option<Vec<super::super::types::opsworks::GangliaLayerEbsVolume>>,
        >,
        ...
        pub load_based_auto_scaling: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::opsworks::GangliaLayerLoadBasedAutoScaling>,
        >,
    ...
    pub struct GangliaLayerResult {
        ...
        pub ebs_volumes: pulumi_gestalt_rust::Output<
            Vec<super::super::types::opsworks::GangliaLayerEbsVolume>,
        >,
        /// Name of an Elastic Load Balancer to attach to this layer
        ...
        pub load_based_auto_scaling: pulumi_gestalt_rust::Output<
            super::super::types::opsworks::GangliaLayerLoadBasedAutoScaling,
        >,
        /// A human-readable name for the layer.
