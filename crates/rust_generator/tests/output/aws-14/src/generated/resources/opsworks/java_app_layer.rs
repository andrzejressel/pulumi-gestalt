...
pub mod java_app_layer {
    ...
    pub struct JavaAppLayerArgs {
        ...
        pub app_server: pulumi_gestalt_rust::Input<Option<String>>,
        /// Version of the selected application container to use. Defaults to "7".
        #[builder(into, default)]
        pub app_server_version: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub jvm_type: pulumi_gestalt_rust::Input<Option<String>>,
        /// Version of JVM to use. Defaults to "7".
        #[builder(into, default)]
        pub jvm_version: pulumi_gestalt_rust::Input<Option<String>>,
        #[builder(into, default)]
    ...
    fn __create(
        ...
        let app_server_version_binding = args.app_server_version.get_output(ctx);
        ...
        let jvm_type_binding = args.jvm_type.get_output(ctx);
        let jvm_version_binding = args.jvm_version.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &app_server_version_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &jvm_options_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "jvmType".into(),
                    value: &jvm_type_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "jvmVersion".into(),
                    value: &jvm_version_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
        ...
        JavaAppLayerResult {
            ...
            jvm_type: o.get_field("jvmType"),
            jvm_version: o.get_field("jvmVersion"),
