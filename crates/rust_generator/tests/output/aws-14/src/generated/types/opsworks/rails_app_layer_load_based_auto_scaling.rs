...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RailsAppLayerLoadBasedAutoScaling {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RailsAppLayerLoadBasedAutoScaling {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#downscaling: {
                        ...
                        <Option<Box<super::super::types::opsworks::RailsAppLayerLoadBasedAutoScalingDownscaling>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#enable: {
                    ...
                    r#upscaling: {
                        ...
                        <Option<Box<super::super::types::opsworks::RailsAppLayerLoadBasedAutoScalingUpscaling>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
