...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FirewallPolicyFirewallPolicyPolicyVariables {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FirewallPolicyFirewallPolicyPolicyVariables {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#rule_variables: {
                        ...
                        <Option<Vec<super::super::types::networkfirewall::FirewallPolicyFirewallPolicyPolicyVariablesRuleVariable>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
