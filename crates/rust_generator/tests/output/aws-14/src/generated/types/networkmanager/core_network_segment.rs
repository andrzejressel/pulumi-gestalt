...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CoreNetworkSegment {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("shared_segments".to_string(), self.r#shared_segments.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CoreNetworkSegment {
