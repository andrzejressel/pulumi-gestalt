...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActions {
    ...
    > {
        async move {
            ...
            map.insert("custom_actions".to_string(), self.r#custom_actions.to_pulumi_value().await);
            map.insert("stateless_rules".to_string(), self.r#stateless_rules.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#custom_actions: {
                        ...
                        <Option<Vec<super::super::types::networkfirewall::RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomAction>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#stateless_rules: {
                        ...
                        <Vec<super::super::types::networkfirewall::RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRule> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
