...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ApplicationEnvironment {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("secure".to_string(), self.r#secure.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ApplicationEnvironment {
