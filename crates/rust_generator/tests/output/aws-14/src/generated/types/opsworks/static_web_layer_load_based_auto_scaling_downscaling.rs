...
pub struct StaticWebLayerLoadBasedAutoScalingDownscaling {
    #[builder(into)]
    #[serde(rename = "alarms")]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for StaticWebLayerLoadBasedAutoScalingDownscaling {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for StaticWebLayerLoadBasedAutoScalingDownscaling {
