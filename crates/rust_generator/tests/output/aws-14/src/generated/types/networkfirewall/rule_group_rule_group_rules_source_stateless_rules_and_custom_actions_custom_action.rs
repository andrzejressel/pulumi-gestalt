            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#action_definition: {
                        ...
                        <Box<super::super::types::networkfirewall::RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomActionActionDefinition> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#action_name: {
