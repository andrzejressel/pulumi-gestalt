...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationCheckCertificateRevocationStatus {
    ...
    > {
        async move {
            ...
            map.insert("revoked_status_action".to_string(), self.r#revoked_status_action.to_pulumi_value().await);
            map.insert("unknown_status_action".to_string(), self.r#unknown_status_action.to_pulumi_value().await);
