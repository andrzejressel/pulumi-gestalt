...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetLinkBandwidth {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("download_speed".to_string(), self.r#download_speed.to_pulumi_value().await);
            map.insert("upload_speed".to_string(), self.r#upload_speed.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetLinkBandwidth {
