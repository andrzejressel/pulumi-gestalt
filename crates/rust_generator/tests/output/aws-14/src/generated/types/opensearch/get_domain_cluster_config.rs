...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetDomainClusterConfig {
    ...
    > {
        async move {
            ...
            map.insert("zone_awareness_configs".to_string(), self.r#zone_awareness_configs.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#cold_storage_options: {
                        ...
                        <Vec<super::super::types::opensearch::GetDomainClusterConfigColdStorageOption> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    ...
                    r#zone_awareness_configs: {
                        ...
                        <Vec<super::super::types::opensearch::GetDomainClusterConfigZoneAwarenessConfig> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
