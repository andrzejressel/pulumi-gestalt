...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FirewallPolicyFirewallPolicy {
    ...
    > {
        async move {
            ...
            map.insert("policy_variables".to_string(), self.r#policy_variables.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#policy_variables: {
                        ...
                        <Option<Box<super::super::types::networkfirewall::FirewallPolicyFirewallPolicyPolicyVariables>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    ...
                    r#stateful_engine_options: {
                        ...
                        <Option<Box<super::super::types::networkfirewall::FirewallPolicyFirewallPolicyStatefulEngineOptions>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#stateful_rule_group_references: {
                        ...
                        <Option<Vec<super::super::types::networkfirewall::FirewallPolicyFirewallPolicyStatefulRuleGroupReference>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#stateless_custom_actions: {
                        ...
                        <Option<Vec<super::super::types::networkfirewall::FirewallPolicyFirewallPolicyStatelessCustomAction>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    ...
                    r#stateless_rule_group_references: {
                        ...
                        <Option<Vec<super::super::types::networkfirewall::FirewallPolicyFirewallPolicyStatelessRuleGroupReference>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
