...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RuleGroupRuleGroupRulesSourceStatefulRuleHeader {
    ...
    > {
        async move {
            ...
            map.insert("destination_port".to_string(), self.r#destination_port.to_pulumi_value().await);
            map.insert("direction".to_string(), self.r#direction.to_pulumi_value().await);
            ...
            map.insert("source_port".to_string(), self.r#source_port.to_pulumi_value().await);
