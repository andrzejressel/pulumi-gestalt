...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for OutboundConnectionConnectionProperties {
    ...
    > {
        async move {
            ...
            map.insert("cross_cluster_search".to_string(), self.r#cross_cluster_search.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#cross_cluster_search: {
                        ...
                        <Option<Box<super::super::types::opensearch::OutboundConnectionConnectionPropertiesCrossClusterSearch>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#endpoint: {
