...
pub struct EnvironmentLoggingConfigurationSchedulerLogs {
    #[builder(into)]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EnvironmentLoggingConfigurationSchedulerLogs {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "cloud_watch_log_group_arn".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for EnvironmentLoggingConfigurationSchedulerLogs {
