...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetDomainAutoTuneOptionMaintenanceSchedule {
    ...
    > {
        async move {
            ...
            map.insert("cron_expression_for_recurrence".to_string(), self.r#cron_expression_for_recurrence.to_pulumi_value().await);
            map.insert("durations".to_string(), self.r#durations.to_pulumi_value().await);
            map.insert("start_at".to_string(), self.r#start_at.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#durations: {
                        ...
                        <Vec<super::super::types::opensearch::GetDomainAutoTuneOptionMaintenanceScheduleDuration> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#start_at: {
