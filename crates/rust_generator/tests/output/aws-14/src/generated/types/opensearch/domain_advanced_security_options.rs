...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DomainAdvancedSecurityOptions {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("anonymous_auth_enabled".to_string(), self.r#anonymous_auth_enabled.to_pulumi_value().await);
            map.insert("enabled".to_string(), self.r#enabled.to_pulumi_value().await);
            map.insert("internal_user_database_enabled".to_string(), self.r#internal_user_database_enabled.to_pulumi_value().await);
            map.insert("master_user_options".to_string(), self.r#master_user_options.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DomainAdvancedSecurityOptions {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#master_user_options: {
                        ...
                        <Option<Box<super::super::types::opensearch::DomainAdvancedSecurityOptionsMasterUserOptions>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
