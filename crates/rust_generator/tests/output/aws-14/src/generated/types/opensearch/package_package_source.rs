...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PackagePackageSource {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("s_3_key".to_string(), self.r#s_3_key.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PackagePackageSource {
