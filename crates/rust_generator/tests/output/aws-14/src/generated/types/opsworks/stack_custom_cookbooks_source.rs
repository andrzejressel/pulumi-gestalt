...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for StackCustomCookbooksSource {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for StackCustomCookbooksSource {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#ssh_key: {
                        let field_value = match fields_map.get("sshKey") {
                            Some(value) => value,
                            None => bail!("Missing field 'sshKey' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#type_: {
