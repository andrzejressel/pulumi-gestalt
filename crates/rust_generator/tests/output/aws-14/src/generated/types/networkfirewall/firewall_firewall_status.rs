...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FirewallFirewallStatus {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FirewallFirewallStatus {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#sync_states: {
                        ...
                        <Option<Vec<super::super::types::networkfirewall::FirewallFirewallStatusSyncState>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
