...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for StaticWebLayerLoadBasedAutoScaling {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for StaticWebLayerLoadBasedAutoScaling {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#downscaling: {
                        ...
                        <Option<Box<super::super::types::opsworks::StaticWebLayerLoadBasedAutoScalingDownscaling>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#enable: {
                    ...
                    r#upscaling: {
                        ...
                        <Option<Box<super::super::types::opsworks::StaticWebLayerLoadBasedAutoScalingUpscaling>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
