...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FirewallPolicyFirewallPolicyStatelessCustomAction {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("action_definition".to_string(), self.r#action_definition.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FirewallPolicyFirewallPolicyStatelessCustomAction {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#action_definition: {
                        ...
                        <Box<super::super::types::networkfirewall::FirewallPolicyFirewallPolicyStatelessCustomActionActionDefinition> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#action_name: {
