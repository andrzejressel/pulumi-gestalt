...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GangliaLayerLoadBasedAutoScaling {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GangliaLayerLoadBasedAutoScaling {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#downscaling: {
                        ...
                        <Option<Box<super::super::types::opsworks::GangliaLayerLoadBasedAutoScalingDownscaling>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#enable: {
                    ...
                    r#upscaling: {
                        ...
                        <Option<Box<super::super::types::opsworks::GangliaLayerLoadBasedAutoScalingUpscaling>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
