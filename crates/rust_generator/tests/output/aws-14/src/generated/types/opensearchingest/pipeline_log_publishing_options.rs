...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PipelineLogPublishingOptions {
    ...
    > {
        async move {
            ...
            map.insert("cloudwatch_log_destination".to_string(), self.r#cloudwatch_log_destination.to_pulumi_value().await);
            map.insert("is_logging_enabled".to_string(), self.r#is_logging_enabled.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#cloudwatch_log_destination: {
                        ...
                        <Option<Box<super::super::types::opensearchingest::PipelineLogPublishingOptionsCloudwatchLogDestination>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
