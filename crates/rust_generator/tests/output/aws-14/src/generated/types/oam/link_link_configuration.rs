            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#log_group_configuration: {
                        let field_value = match fields_map.get("logGroupConfiguration") {
                            Some(value) => value,
                            None => bail!("Missing field 'logGroupConfiguration' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#metric_configuration: {
                        let field_value = match fields_map.get("metricConfiguration") {
                            Some(value) => value,
                            None => bail!("Missing field 'metricConfiguration' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
