...
pub struct HaproxyLayerLoadBasedAutoScaling {
    ...
    pub r#downscaling: Option<Box<super::super::types::opsworks::HaproxyLayerLoadBasedAutoScalingDownscaling>>,
    #[builder(into)]
    #[serde(rename = "enable")]
    pub r#enable: Option<bool>,
    #[builder(into)]
    #[serde(rename = "upscaling")]
    pub r#upscaling: Option<Box<super::super::types::opsworks::HaproxyLayerLoadBasedAutoScalingUpscaling>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for HaproxyLayerLoadBasedAutoScaling {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for HaproxyLayerLoadBasedAutoScaling {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#downscaling: {
                        ...
                        <Option<Box<super::super::types::opsworks::HaproxyLayerLoadBasedAutoScalingDownscaling>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#enable: {
                    ...
                    r#upscaling: {
                        ...
                        <Option<Box<super::super::types::opsworks::HaproxyLayerLoadBasedAutoScalingUpscaling>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
