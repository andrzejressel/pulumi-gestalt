...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetDomainSnapshotOption {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("automated_snapshot_start_hour".to_string(), self.r#automated_snapshot_start_hour.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetDomainSnapshotOption {
