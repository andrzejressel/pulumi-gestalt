...
pub struct EcsClusterLayerCloudwatchConfigurationLogStream {
    #[builder(into)]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EcsClusterLayerCloudwatchConfigurationLogStream {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("batch_count".to_string(), self.r#batch_count.to_pulumi_value().await);
            map.insert("batch_size".to_string(), self.r#batch_size.to_pulumi_value().await);
            map.insert("buffer_duration".to_string(), self.r#buffer_duration.to_pulumi_value().await);
            map.insert("datetime_format".to_string(), self.r#datetime_format.to_pulumi_value().await);
            map.insert("encoding".to_string(), self.r#encoding.to_pulumi_value().await);
            map.insert("file".to_string(), self.r#file.to_pulumi_value().await);
            map.insert("file_fingerprint_lines".to_string(), self.r#file_fingerprint_lines.to_pulumi_value().await);
            map.insert("initial_position".to_string(), self.r#initial_position.to_pulumi_value().await);
            map.insert("log_group_name".to_string(), self.r#log_group_name.to_pulumi_value().await);
            map.insert("multiline_start_pattern".to_string(), self.r#multiline_start_pattern.to_pulumi_value().await);
            map.insert("time_zone".to_string(), self.r#time_zone.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for EcsClusterLayerCloudwatchConfigurationLogStream {
