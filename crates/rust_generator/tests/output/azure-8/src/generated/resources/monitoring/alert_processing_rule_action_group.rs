...
pub mod alert_processing_rule_action_group {
    ...
    pub struct AlertProcessingRuleActionGroupArgs {
        ...
        #[builder(into)]
        pub add_action_group_ids: pulumi_gestalt_rust::Input<Vec<String>>,
    ...
    fn __create(
        ...
        let add_action_group_ids_binding = args.add_action_group_ids.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &add_action_group_ids_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "condition".into(),
