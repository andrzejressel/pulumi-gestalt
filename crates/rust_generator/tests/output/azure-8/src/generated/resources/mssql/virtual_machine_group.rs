...
pub mod virtual_machine_group {
    ...
    fn __create(
        ...
        let sql_image_offer_binding = args.sql_image_offer.get_output(ctx);
        let sql_image_sku_binding = args.sql_image_sku.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let wsfc_domain_profile_binding = args.wsfc_domain_profile.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &sql_image_offer_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "sqlImageSku".into(),
                    value: &sql_image_sku_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "tags".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &wsfc_domain_profile_binding.drop_type(),
                },
            ],
            options,
        };
