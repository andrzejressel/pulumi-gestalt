...
pub mod action_group {
    ...
    fn __create(
        ...
        let arm_role_receivers_binding = args.arm_role_receivers.get_output(ctx);
        ...
        let azure_function_receivers_binding = args
            ...
            .get_output(ctx);
        let email_receivers_binding = args.email_receivers.get_output(ctx);
        let enabled_binding = args.enabled.get_output(ctx);
        let event_hub_receivers_binding = args.event_hub_receivers.get_output(ctx);
        let itsm_receivers_binding = args.itsm_receivers.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let logic_app_receivers_binding = args.logic_app_receivers.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let resource_group_name_binding = args.resource_group_name.get_output(ctx);
        let short_name_binding = args.short_name.get_output(ctx);
        let sms_receivers_binding = args.sms_receivers.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let voice_receivers_binding = args.voice_receivers.get_output(ctx);
        let webhook_receivers_binding = args.webhook_receivers.get_output(ctx);
