...
pub mod managed_instance {
    ...
    pub struct ManagedInstanceArgs {
        ...
        #[builder(into)]
        pub administrator_login: pulumi_gestalt_rust::Input<String>,
        /// The password associated with the `administrator_login` user. Needs to comply with Azure's [Password Policy](https://msdn.microsoft.com/library/ms161959.aspx)
        #[builder(into)]
        pub administrator_login_password: pulumi_gestalt_rust::Input<String>,
        ...
        #[builder(into, default)]
        pub dns_zone_partner_id: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub service_principal_type: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into)]
        pub storage_size_in_gb: pulumi_gestalt_rust::Input<i32>,
        ...
        #[builder(into, default)]
        pub timezone_id: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into)]
        pub vcores: pulumi_gestalt_rust::Input<i32>,
        /// Specifies whether or not the SQL Managed Instance is zone redundant. Defaults to `false`.
        #[builder(into, default)]
        pub zone_redundant_enabled: pulumi_gestalt_rust::Input<Option<bool>>,
    }
    #[allow(dead_code)]
