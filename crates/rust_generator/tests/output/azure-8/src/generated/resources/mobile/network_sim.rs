...
pub mod network_sim {
    ...
    fn __create(
        ...
        let authentication_key_binding = args.authentication_key.get_output(ctx);
        let device_type_binding = args.device_type.get_output(ctx);
        ...
        let operator_key_code_binding = args.operator_key_code.get_output(ctx);
        let sim_policy_id_binding = args.sim_policy_id.get_output(ctx);
