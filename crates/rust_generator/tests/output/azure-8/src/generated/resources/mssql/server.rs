...
pub mod server {
    ...
    pub struct ServerArgs {
        ...
        #[builder(into, default)]
        pub connection_policy: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub outbound_network_restriction_enabled: pulumi_gestalt_rust::Input<
            Option<bool>,
        >,
        ...
        #[builder(into, default)]
        pub primary_user_assigned_identity_id: pulumi_gestalt_rust::Input<
            Option<String>,
        >,
    ...
    fn __create(
        ...
        let administrator_login_password_binding = args
            ...
            .get_output(ctx);
        let azuread_administrator_binding = args.azuread_administrator.get_output(ctx);
        let connection_policy_binding = args.connection_policy.get_output(ctx);
