...
pub mod metric_alert {
    ...
    fn __create(
        ...
        let application_insights_web_test_location_availability_criteria_binding = args
            ...
            .get_output(ctx);
        let auto_mitigate_binding = args.auto_mitigate.get_output(ctx);
        let criterias_binding = args.criterias.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let dynamic_criteria_binding = args.dynamic_criteria.get_output(ctx);
        ...
        let target_resource_location_binding = args
            ...
            .get_output(ctx);
        let target_resource_type_binding = args.target_resource_type.get_output(ctx);
        let window_size_binding = args.window_size.get_output(ctx);
