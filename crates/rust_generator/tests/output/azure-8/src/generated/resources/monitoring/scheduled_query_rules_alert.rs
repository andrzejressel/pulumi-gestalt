...
pub mod scheduled_query_rules_alert {
    ...
    fn __create(
        ...
        let query_type_binding = args.query_type.get_output(ctx);
        let resource_group_name_binding = args.resource_group_name.get_output(ctx);
        let severity_binding = args.severity.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let throttling_binding = args.throttling.get_output(ctx);
        let time_window_binding = args.time_window.get_output(ctx);
        let trigger_binding = args.trigger.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &authorized_resource_ids_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "autoMitigationEnabled".into(),
                    value: &auto_mitigation_enabled_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "queryType".into(),
                    value: &query_type_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &throttling_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "timeWindow".into(),
                    value: &time_window_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "trigger".into(),
