...
pub mod database {
    ...
    pub struct DatabaseArgs {
        ...
        pub auto_pause_delay_in_minutes: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub geo_backup_enabled: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub ledger_enabled: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub max_size_gb: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub min_capacity: pulumi_gestalt_rust::Input<Option<f64>>,
        /// The name of the MS SQL Database. Changing this forces a new resource to be created.
        #[builder(into, default)]
        pub name: pulumi_gestalt_rust::Input<Option<String>>,
        /// The number of readonly secondary replicas associated with the database to which readonly application intent connections may be routed. This property is only settable for Hyperscale edition databases.
        #[builder(into, default)]
        pub read_replica_count: pulumi_gestalt_rust::Input<Option<i32>>,
        /// If enabled, connections that have application intent set to readonly in their connection string may be routed to a readonly secondary replica. This property is only settable for Premium and Business Critical databases.
        #[builder(into, default)]
        pub read_scale: pulumi_gestalt_rust::Input<Option<bool>>,
        /// The ID of the database to be recovered. This property is only applicable when the `create_mode` is `Recovery`.
        #[builder(into, default)]
        pub recover_database_id: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub restore_point_in_time: pulumi_gestalt_rust::Input<Option<String>>,
        /// Specifies the name of the sample schema to apply when creating this database. Possible value is `AdventureWorksLT`.
        #[builder(into, default)]
        pub sample_name: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub secondary_type: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub short_term_retention_policy: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub storage_account_type: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub threat_detection_policy: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub transparent_data_encryption_enabled: pulumi_gestalt_rust::Input<
            Option<bool>,
        >,
        ...
        #[builder(into, default)]
        pub transparent_data_encryption_key_automatic_rotation_enabled: pulumi_gestalt_rust::Input<
            Option<bool>,
        >,
        ...
        #[builder(into, default)]
        pub transparent_data_encryption_key_vault_key_id: pulumi_gestalt_rust::Input<
            Option<String>,
        >,
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &auto_pause_delay_in_minutes_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "collation".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &creation_source_database_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "elasticPoolId".into(),
                    value: &elastic_pool_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &geo_backup_enabled_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "identity".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "import".into(),
                    value: &import_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "ledgerEnabled".into(),
                    value: &ledger_enabled_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &read_replica_count_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "readScale".into(),
                    value: &read_scale_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "recoverDatabaseId".into(),
                    value: &recover_database_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "recoveryPointId".into(),
                    value: &recovery_point_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "restoreDroppedDatabaseId".into(),
                    value: &restore_dropped_database_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "restoreLongTermRetentionBackupId".into(),
                    value: &restore_long_term_retention_backup_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "restorePointInTime".into(),
                    value: &restore_point_in_time_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "sampleName".into(),
                    value: &sample_name_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "secondaryType".into(),
                    value: &secondary_type_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "serverId".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &short_term_retention_policy_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "skuName".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &threat_detection_policy_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "transparentDataEncryptionEnabled".into(),
                    value: &transparent_data_encryption_enabled_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
