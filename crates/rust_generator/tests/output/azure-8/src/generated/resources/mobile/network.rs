...
pub mod network {
    ...
    fn __create(
        ...
        let mobile_country_code_binding = args.mobile_country_code.get_output(ctx);
        let mobile_network_code_binding = args.mobile_network_code.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &mobile_country_code_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "mobileNetworkCode".into(),
                    value: &mobile_network_code_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
