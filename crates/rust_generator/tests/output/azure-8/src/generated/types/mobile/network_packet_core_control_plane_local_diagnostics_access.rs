...
pub struct NetworkPacketCoreControlPlaneLocalDiagnosticsAccess {
    ...
    pub r#https_server_certificate_url: Option<String>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for NetworkPacketCoreControlPlaneLocalDiagnosticsAccess {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "https_server_certificate_url".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for NetworkPacketCoreControlPlaneLocalDiagnosticsAccess {
