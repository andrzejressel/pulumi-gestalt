...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetNetworkServicePccRuleQosPolicy {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "guaranteed_bit_rates".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetNetworkServicePccRuleQosPolicy {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#guaranteed_bit_rates: {
                        let field_value = match fields_map.get("guaranteed_bit_rates") {
                            Some(value) => value,
                            None => bail!("Missing field 'guaranteed_bit_rates' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#maximum_bit_rates: {
                        let field_value = match fields_map.get("maximum_bit_rates") {
                            Some(value) => value,
                            None => bail!("Missing field 'maximum_bit_rates' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
