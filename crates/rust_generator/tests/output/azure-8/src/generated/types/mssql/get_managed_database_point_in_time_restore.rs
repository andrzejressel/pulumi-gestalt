...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetManagedDatabasePointInTimeRestore {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "restore_point_in_time".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetManagedDatabasePointInTimeRestore {
