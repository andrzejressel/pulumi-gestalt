...
pub struct GetDataCollectionRuleDataFlow {
    ...
    pub r#built_in_transform: String,
    ...
    pub r#transform_kql: String,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetDataCollectionRuleDataFlow {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetDataCollectionRuleDataFlow {
