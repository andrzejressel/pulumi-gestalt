...
pub struct GetDataCollectionRuleDataSourceLogFile {
    ...
    #[builder(into)]
    pub r#settings: Vec<super::super::types::monitoring::GetDataCollectionRuleDataSourceLogFileSetting>,
    /// Specifies a list of streams that this data source will be sent to. A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to.
    #[builder(into)]
    pub r#streams: Vec<String>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetDataCollectionRuleDataSourceLogFile {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetDataCollectionRuleDataSourceLogFile {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#file_patterns: {
                        let field_value = match fields_map.get("filePatterns") {
                            Some(value) => value,
                            None => bail!("Missing field 'filePatterns' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
