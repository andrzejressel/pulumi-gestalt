...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetActionGroupWebhookReceiverAadAuth {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "identifier_uri".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#identifier_uri,
                )
                .await,
            );
            map.insert(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetActionGroupWebhookReceiverAadAuth {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#identifier_uri: {
                        let field_value = match fields_map.get("identifier_uri") {
                            Some(value) => value,
                            None => bail!("Missing field 'identifier_uri' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
