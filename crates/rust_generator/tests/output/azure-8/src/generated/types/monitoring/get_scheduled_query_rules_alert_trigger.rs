...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetScheduledQueryRulesAlertTrigger {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "metric_triggers".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#metric_triggers,
                )
                .await,
            );
            map.insert(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetScheduledQueryRulesAlertTrigger {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#metric_triggers: {
                        let field_value = match fields_map.get("metric_triggers") {
                            Some(value) => value,
                            None => bail!("Missing field 'metric_triggers' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
