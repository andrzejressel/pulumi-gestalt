...
pub struct NetworkServiceServiceQosPolicy {
    ...
    pub r#qos_indicator: Option<i32>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for NetworkServiceServiceQosPolicy {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for NetworkServiceServiceQosPolicy {
