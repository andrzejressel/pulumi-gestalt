...
pub struct AlertProcessingRuleSuppressionSchedule {
    ...
    pub r#recurrence: Option<Box<super::super::types::monitoring::AlertProcessingRuleSuppressionScheduleRecurrence>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AlertProcessingRuleSuppressionSchedule {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AlertProcessingRuleSuppressionSchedule {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#effective_from: {
                        let field_value = match fields_map.get("effectiveFrom") {
                            Some(value) => value,
                            None => bail!("Missing field 'effectiveFrom' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#effective_until: {
                        let field_value = match fields_map.get("effectiveUntil") {
                            Some(value) => value,
                            None => bail!("Missing field 'effectiveUntil' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#recurrence: {
