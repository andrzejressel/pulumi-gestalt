...
pub struct DataCollectionRuleDataSourcesIisLog {
    ...
    pub r#log_directories: Option<Vec<String>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DataCollectionRuleDataSourcesIisLog {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "log_directories".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#log_directories,
                )
                .await,
            );
            map.insert(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DataCollectionRuleDataSourcesIisLog {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#log_directories: {
                        let field_value = match fields_map.get("log_directories") {
                            Some(value) => value,
                            None => bail!("Missing field 'log_directories' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
