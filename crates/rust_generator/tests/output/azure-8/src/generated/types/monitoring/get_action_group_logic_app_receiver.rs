...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetActionGroupLogicAppReceiver {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetActionGroupLogicAppReceiver {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#callback_url: {
                        let field_value = match fields_map.get("callback_url") {
                            Some(value) => value,
                            None => bail!("Missing field 'callback_url' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
