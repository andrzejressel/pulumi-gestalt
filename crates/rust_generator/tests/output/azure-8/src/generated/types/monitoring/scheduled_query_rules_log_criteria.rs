...
pub struct ScheduledQueryRulesLogCriteria {
    ...
    pub r#dimensions: Vec<super::super::types::monitoring::ScheduledQueryRulesLogCriteriaDimension>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ScheduledQueryRulesLogCriteria {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ScheduledQueryRulesLogCriteria {
