...
pub struct GetNetworkServiceServiceQosPolicy {
    ...
    pub r#maximum_bit_rates: Vec<super::super::types::mobile::GetNetworkServiceServiceQosPolicyMaximumBitRate>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetNetworkServiceServiceQosPolicy {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetNetworkServiceServiceQosPolicy {
