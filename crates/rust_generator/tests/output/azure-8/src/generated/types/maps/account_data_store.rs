...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AccountDataStore {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AccountDataStore {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#unique_name: {
                        let field_value = match fields_map.get("unique_name") {
                            Some(value) => value,
                            None => bail!("Missing field 'unique_name' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
