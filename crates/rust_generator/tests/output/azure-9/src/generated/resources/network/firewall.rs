...
pub mod firewall {
    ...
    fn __create(
        ...
        let dns_proxy_enabled_binding = args.dns_proxy_enabled.get_output(ctx);
        ...
        let threat_intel_mode_binding = args.threat_intel_mode.get_output(ctx);
        let virtual_hub_binding = args.virtual_hub.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &management_ip_configuration_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &threat_intel_mode_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "virtualHub".into(),
                    value: &virtual_hub_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "zones".into(),
