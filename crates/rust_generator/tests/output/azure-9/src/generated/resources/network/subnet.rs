...
pub mod subnet {
    ...
    pub struct SubnetArgs {
        ...
        #[builder(into, default)]
        pub private_endpoint_network_policies: pulumi_gestalt_rust::Input<
            Option<String>,
        >,
        ...
        #[builder(into, default)]
        pub private_link_service_network_policies_enabled: pulumi_gestalt_rust::Input<
            Option<bool>,
        >,
        ...
        #[builder(into, default)]
        pub service_endpoints: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
    ...
    fn __create(
        ...
        let address_prefixes_binding = args.address_prefixes.get_output(ctx);
        let default_outbound_access_enabled_binding = args
            .default_outbound_access_enabled
            .get_output(ctx);
        let delegations_binding = args.delegations.get_output(ctx);
        ...
        let service_endpoint_policy_ids_binding = args
            ...
            .get_output(ctx);
        let service_endpoints_binding = args.service_endpoints.get_output(ctx);
