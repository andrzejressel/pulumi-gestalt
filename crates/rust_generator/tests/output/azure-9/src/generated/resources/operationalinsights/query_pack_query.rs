...
pub mod query_pack_query {
    ...
    pub struct QueryPackQueryArgs {
        ...
        pub additional_settings_json: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into)]
        pub query_pack_id: pulumi_gestalt_rust::Input<String>,
        ...
        #[builder(into, default)]
        pub resource_types: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        ...
        #[builder(into, default)]
        pub solutions: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
