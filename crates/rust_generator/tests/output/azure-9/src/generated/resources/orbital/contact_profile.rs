...
pub mod contact_profile {
    ...
    fn __create(
        ...
        let auto_tracking_binding = args.auto_tracking.get_output(ctx);
        let event_hub_uri_binding = args.event_hub_uri.get_output(ctx);
        let links_binding = args.links.get_output(ctx);
        ...
        ContactProfileResult {
            ...
            minimum_elevation_degrees: o.get_field("minimumElevationDegrees"),
            minimum_variable_contact_duration: o
                .get_field("minimumVariableContactDuration"),
            name: o.get_field("name"),
            network_configuration_subnet_id: o.get_field("networkConfigurationSubnetId"),
