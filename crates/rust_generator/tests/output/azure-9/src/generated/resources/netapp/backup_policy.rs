...
pub mod backup_policy {
    ...
    fn __create(
        ...
        let daily_backups_to_keep_binding = args.daily_backups_to_keep.get_output(ctx);
        ...
        let weekly_backups_to_keep_binding = args.weekly_backups_to_keep.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &daily_backups_to_keep_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "enabled".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &monthly_backups_to_keep_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
