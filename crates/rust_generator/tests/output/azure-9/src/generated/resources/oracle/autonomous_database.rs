...
pub mod autonomous_database {
    ...
    pub struct AutonomousDatabaseArgs {
        ...
        #[builder(into)]
        pub auto_scaling_enabled: pulumi_gestalt_rust::Input<bool>,
        /// Indicates if auto scaling is enabled for the Autonomous Database storage. The default value is `false`.
        #[builder(into)]
        pub auto_scaling_for_storage_enabled: pulumi_gestalt_rust::Input<bool>,
        /// (Updatable) Retention period, in days, for backups. Changing this forces a new Autonomous Database to be created.
        #[builder(into)]
        pub backup_retention_period_in_days: pulumi_gestalt_rust::Input<i32>,
        ...
        #[builder(into)]
        pub character_set: pulumi_gestalt_rust::Input<String>,
        ...
        #[builder(into)]
        pub compute_count: pulumi_gestalt_rust::Input<f64>,
        ...
        #[builder(into)]
        pub compute_model: pulumi_gestalt_rust::Input<String>,
        ...
        #[builder(into)]
        pub db_workload: pulumi_gestalt_rust::Input<String>,
        ...
        #[builder(into)]
        pub mtls_connection_required: pulumi_gestalt_rust::Input<bool>,
        ...
        #[builder(into)]
        pub national_character_set: pulumi_gestalt_rust::Input<String>,
