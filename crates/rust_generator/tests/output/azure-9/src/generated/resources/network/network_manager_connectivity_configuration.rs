...
pub mod network_manager_connectivity_configuration {
    ...
    fn __create(
        ...
        let applies_to_groups_binding = args.applies_to_groups.get_output(ctx);
        let connectivity_topology_binding = args.connectivity_topology.get_output(ctx);
        let delete_existing_peering_enabled_binding = args
            .delete_existing_peering_enabled
            .get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let global_mesh_enabled_binding = args.global_mesh_enabled.get_output(ctx);
        let hub_binding = args.hub.get_output(ctx);
