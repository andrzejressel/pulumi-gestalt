...
pub mod snapshot_policy {
    ...
    fn __create(
        ...
        let daily_schedule_binding = args.daily_schedule.get_output(ctx);
        let enabled_binding = args.enabled.get_output(ctx);
        let hourly_schedule_binding = args.hourly_schedule.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let monthly_schedule_binding = args.monthly_schedule.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let resource_group_name_binding = args.resource_group_name.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let weekly_schedule_binding = args.weekly_schedule.get_output(ctx);
