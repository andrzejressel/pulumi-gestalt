...
pub mod analytics_solution {
    ...
    fn __create(
        ...
        let solution_name_binding = args.solution_name.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let workspace_name_binding = args.workspace_name.get_output(ctx);
        let workspace_resource_id_binding = args.workspace_resource_id.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &solution_name_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "tags".into(),
