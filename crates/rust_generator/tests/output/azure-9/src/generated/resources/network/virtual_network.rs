...
pub mod virtual_network {
    ...
    fn __create(
        ...
        let address_spaces_binding = args.address_spaces.get_output(ctx);
        let bgp_community_binding = args.bgp_community.get_output(ctx);
        let ddos_protection_plan_binding = args.ddos_protection_plan.get_output(ctx);
