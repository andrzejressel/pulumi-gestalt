...
pub mod collector_policy {
    ...
    fn __create(
        ...
        let ipfx_emission_binding = args.ipfx_emission.get_output(ctx);
        let ipfx_ingestion_binding = args.ipfx_ingestion.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let traffic_collector_id_binding = args.traffic_collector_id.get_output(ctx);
