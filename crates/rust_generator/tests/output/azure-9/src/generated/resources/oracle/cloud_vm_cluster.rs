...
pub mod cloud_vm_cluster {
    ...
    fn __create(
        ...
        let backup_subnet_cidr_binding = args.backup_subnet_cidr.get_output(ctx);
        ...
        let db_node_storage_size_in_gbs_binding = args
            ...
            .get_output(ctx);
        let db_servers_binding = args.db_servers.get_output(ctx);
        let display_name_binding = args.display_name.get_output(ctx);
        let domain_binding = args.domain.get_output(ctx);
        let gi_version_binding = args.gi_version.get_output(ctx);
        let hostname_binding = args.hostname.get_output(ctx);
        let license_model_binding = args.license_model.get_output(ctx);
        let local_backup_enabled_binding = args.local_backup_enabled.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let memory_size_in_gbs_binding = args.memory_size_in_gbs.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let resource_group_name_binding = args.resource_group_name.get_output(ctx);
        let scan_listener_port_tcp_binding = args.scan_listener_port_tcp.get_output(ctx);
        ...
        let sparse_diskgroup_enabled_binding = args
            ...
            .get_output(ctx);
        let ssh_public_keys_binding = args.ssh_public_keys.get_output(ctx);
