...
pub mod network_watcher_flow_log {
    ...
    fn __create(
        ...
        let network_security_group_id_binding = args
            ...
            .get_output(ctx);
        let network_watcher_name_binding = args.network_watcher_name.get_output(ctx);
        ...
        let traffic_analytics_binding = args.traffic_analytics.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &network_watcher_name_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &traffic_analytics_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "version".into(),
