...
pub mod contact {
    ...
    fn __create(
        ...
        let contact_profile_id_binding = args.contact_profile_id.get_output(ctx);
        let ground_station_name_binding = args.ground_station_name.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let reservation_end_time_binding = args.reservation_end_time.get_output(ctx);
        let reservation_start_time_binding = args.reservation_start_time.get_output(ctx);
        let spacecraft_id_binding = args.spacecraft_id.get_output(ctx);
