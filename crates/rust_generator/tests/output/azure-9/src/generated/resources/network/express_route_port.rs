...
pub mod express_route_port {
    ...
    fn __create(
        ...
        let bandwidth_in_gbps_binding = args.bandwidth_in_gbps.get_output(ctx);
        let billing_type_binding = args.billing_type.get_output(ctx);
        let encapsulation_binding = args.encapsulation.get_output(ctx);
        let identity_binding = args.identity.get_output(ctx);
        let link1_binding = args.link1.get_output(ctx);
        let link2_binding = args.link2.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let peering_location_binding = args.peering_location.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &encapsulation_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "identity".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "link1".into(),
                    value: &link1_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "link2".into(),
                    value: &link2_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "location".into(),
