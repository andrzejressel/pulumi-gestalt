...
pub mod configuration {
    ...
    fn __create(
        ...
        let config_files_binding = args.config_files.get_output(ctx);
        let nginx_deployment_id_binding = args.nginx_deployment_id.get_output(ctx);
        let package_data_binding = args.package_data.get_output(ctx);
        let protected_files_binding = args.protected_files.get_output(ctx);
        let root_file_binding = args.root_file.get_output(ctx);
