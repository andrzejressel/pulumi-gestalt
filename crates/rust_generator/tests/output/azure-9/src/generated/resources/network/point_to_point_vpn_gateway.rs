...
pub mod point_to_point_vpn_gateway {
    ...
    pub struct PointToPointVpnGatewayArgs {
        ...
        #[builder(into)]
        pub connection_configurations: pulumi_gestalt_rust::Input<
            Vec<
        ...
        #[builder(into, default)]
        pub routing_preference_internet_enabled: pulumi_gestalt_rust::Input<
            Option<bool>,
        >,
        ...
        #[builder(into)]
        pub scale_unit: pulumi_gestalt_rust::Input<i32>,
