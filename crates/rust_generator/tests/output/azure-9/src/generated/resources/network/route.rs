...
pub mod route {
    ...
    fn __create(
        ...
        let address_prefix_binding = args.address_prefix.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let next_hop_in_ip_address_binding = args.next_hop_in_ip_address.get_output(ctx);
        let next_hop_type_binding = args.next_hop_type.get_output(ctx);
        let resource_group_name_binding = args.resource_group_name.get_output(ctx);
        let route_table_name_binding = args.route_table_name.get_output(ctx);
