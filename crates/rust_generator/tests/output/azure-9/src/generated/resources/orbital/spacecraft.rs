...
pub mod spacecraft {
    ...
    fn __create(
        ...
        let norad_id_binding = args.norad_id.get_output(ctx);
        let resource_group_name_binding = args.resource_group_name.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let title_line_binding = args.title_line.get_output(ctx);
        let two_line_elements_binding = args.two_line_elements.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "noradId".into(),
                    value: &norad_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "titleLine".into(),
                    value: &title_line_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
