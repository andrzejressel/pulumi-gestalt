...
pub mod hub {
    ...
    fn __create(
        ...
        let apns_credential_binding = args.apns_credential.get_output(ctx);
        let browser_credential_binding = args.browser_credential.get_output(ctx);
        let gcm_credential_binding = args.gcm_credential.get_output(ctx);
