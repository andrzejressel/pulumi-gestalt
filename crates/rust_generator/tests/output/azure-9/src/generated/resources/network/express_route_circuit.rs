...
pub mod express_route_circuit {
    ...
    fn __create(
        ...
        let bandwidth_in_mbps_binding = args.bandwidth_in_mbps.get_output(ctx);
        let express_route_port_id_binding = args.express_route_port_id.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let peering_location_binding = args.peering_location.get_output(ctx);
        let resource_group_name_binding = args.resource_group_name.get_output(ctx);
        let service_provider_name_binding = args.service_provider_name.get_output(ctx);
