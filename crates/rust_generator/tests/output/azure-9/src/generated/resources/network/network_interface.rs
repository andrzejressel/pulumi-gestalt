...
pub mod network_interface {
    ...
    fn __create(
        ...
        let accelerated_networking_enabled_binding = args
            ...
            .get_output(ctx);
        let auxiliary_mode_binding = args.auxiliary_mode.get_output(ctx);
        let auxiliary_sku_binding = args.auxiliary_sku.get_output(ctx);
        ...
        let ip_forwarding_enabled_binding = args.ip_forwarding_enabled.get_output(ctx);
