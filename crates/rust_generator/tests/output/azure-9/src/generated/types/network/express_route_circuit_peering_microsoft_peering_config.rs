...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ExpressRouteCircuitPeeringMicrosoftPeeringConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "advertised_communities".to_string(),
            ...
            map.insert(
                "advertised_public_prefixes".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "routing_registry_name".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ExpressRouteCircuitPeeringMicrosoftPeeringConfig {
