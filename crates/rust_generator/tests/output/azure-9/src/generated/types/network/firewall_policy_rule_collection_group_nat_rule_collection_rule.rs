            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#destination_address: {
                        let field_value = match fields_map.get("destination_address") {
                            Some(value) => value,
                            None => bail!("Missing field 'destination_address' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#destination_ports: {
                    ...
                    r#translated_fqdn: {
                        let field_value = match fields_map.get("translated_fqdn") {
                            Some(value) => value,
                            None => bail!("Missing field 'translated_fqdn' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#translated_port: {
