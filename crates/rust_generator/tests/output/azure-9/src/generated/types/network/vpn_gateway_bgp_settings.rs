...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for VpnGatewayBgpSettings {
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "instance_0_bgp_peering_address".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "instance_1_bgp_peering_address".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#instance_0_bgp_peering_address: {
                        let field_value = match fields_map.get("instance_0_bgp_peering_address") {
                            Some(value) => value,
                            None => bail!("Missing field 'instance_0_bgp_peering_address' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#instance_1_bgp_peering_address: {
                        let field_value = match fields_map.get("instance_1_bgp_peering_address") {
                            Some(value) => value,
                            None => bail!("Missing field 'instance_1_bgp_peering_address' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#peer_weight: {
