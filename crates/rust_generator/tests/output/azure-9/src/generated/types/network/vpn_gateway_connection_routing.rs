            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#associated_route_table: {
                        let field_value = match fields_map.get("associatedRouteTable") {
                            Some(value) => value,
                            None => bail!("Missing field 'associatedRouteTable' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
