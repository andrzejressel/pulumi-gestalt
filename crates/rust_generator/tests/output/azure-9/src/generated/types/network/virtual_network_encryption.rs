...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for VirtualNetworkEncryption {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for VirtualNetworkEncryption {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#enforcement: {
                        let field_value = match fields_map.get("enforcement") {
                            Some(value) => value,
                            None => bail!("Missing field 'enforcement' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
