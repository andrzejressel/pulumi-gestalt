...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FirewallPolicyDns {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FirewallPolicyDns {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#proxy_enabled: {
                        let field_value = match fields_map.get("proxyEnabled") {
                            Some(value) => value,
                            None => bail!("Missing field 'proxyEnabled' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
