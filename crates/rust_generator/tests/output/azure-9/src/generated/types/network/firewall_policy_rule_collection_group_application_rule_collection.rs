...
pub struct FirewallPolicyRuleCollectionGroupApplicationRuleCollection {
    ...
    #[builder(into)]
    #[serde(rename = "rules")]
    pub r#rules: Vec<super::super::types::network::FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRule>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FirewallPolicyRuleCollectionGroupApplicationRuleCollection {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FirewallPolicyRuleCollectionGroupApplicationRuleCollection {
