...
pub struct ApplicationGatewayWafConfigurationDisabledRuleGroup {
    ...
    #[builder(into)]
    #[serde(rename = "rules")]
    pub r#rules: Option<Vec<i32>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ApplicationGatewayWafConfigurationDisabledRuleGroup {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ApplicationGatewayWafConfigurationDisabledRuleGroup {
