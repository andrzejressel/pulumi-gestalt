...
pub struct NetworkManagerAdminRuleSource {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for NetworkManagerAdminRuleSource {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "address_prefix_type".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#address_prefix_type,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for NetworkManagerAdminRuleSource {
