...
pub struct ExadataInfrastructureMaintenanceWindow {
    ...
    pub r#lead_time_in_weeks: Option<i32>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ExadataInfrastructureMaintenanceWindow {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ExadataInfrastructureMaintenanceWindow {
