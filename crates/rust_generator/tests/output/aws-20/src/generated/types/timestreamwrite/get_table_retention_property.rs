...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetTableRetentionProperty {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("magnetic_store_retention_period_in_days".to_string(), self.r#magnetic_store_retention_period_in_days.to_pulumi_value().await);
            map.insert("memory_store_retention_period_in_hours".to_string(), self.r#memory_store_retention_period_in_hours.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetTableRetentionProperty {
