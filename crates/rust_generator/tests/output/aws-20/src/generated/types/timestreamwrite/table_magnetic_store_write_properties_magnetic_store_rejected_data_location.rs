...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TableMagneticStoreWritePropertiesMagneticStoreRejectedDataLocation {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for TableMagneticStoreWritePropertiesMagneticStoreRejectedDataLocation {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#s_3_configuration: {
                        ...
                        <Option<Box<super::super::types::timestreamwrite::TableMagneticStoreWritePropertiesMagneticStoreRejectedDataLocationS3Configuration>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
