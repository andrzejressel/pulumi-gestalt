...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DbInstanceLogDeliveryConfiguration {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DbInstanceLogDeliveryConfiguration {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#s_3_configuration: {
                        ...
                        <Option<Box<super::super::types::timestreaminfluxdb::DbInstanceLogDeliveryConfigurationS3Configuration>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
