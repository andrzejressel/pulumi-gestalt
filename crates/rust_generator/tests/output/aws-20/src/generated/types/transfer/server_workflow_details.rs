...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ServerWorkflowDetails {
    ...
    > {
        async move {
            ...
            map.insert("on_partial_upload".to_string(), self.r#on_partial_upload.to_pulumi_value().await);
            map.insert("on_upload".to_string(), self.r#on_upload.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#on_partial_upload: {
                        ...
                        <Option<Box<super::super::types::transfer::ServerWorkflowDetailsOnPartialUpload>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#on_upload: {
                        ...
                        <Option<Box<super::super::types::transfer::ServerWorkflowDetailsOnUpload>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
