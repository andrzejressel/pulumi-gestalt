...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WorkflowStepDecryptStepDetailsDestinationFileLocation {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WorkflowStepDecryptStepDetailsDestinationFileLocation {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#efs_file_location: {
                        ...
                        <Option<Box<super::super::types::transfer::WorkflowStepDecryptStepDetailsDestinationFileLocationEfsFileLocation>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#s_3_file_location: {
                        ...
                        <Option<Box<super::super::types::transfer::WorkflowStepDecryptStepDetailsDestinationFileLocationS3FileLocation>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
