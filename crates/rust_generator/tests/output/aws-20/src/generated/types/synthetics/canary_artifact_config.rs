...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CanaryArtifactConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CanaryArtifactConfig {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#s_3_encryption: {
                        ...
                        <Option<Box<super::super::types::synthetics::CanaryArtifactConfigS3Encryption>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
