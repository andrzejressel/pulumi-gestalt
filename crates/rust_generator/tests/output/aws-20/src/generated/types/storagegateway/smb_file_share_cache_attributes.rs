...
pub struct SmbFileShareCacheAttributes {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for SmbFileShareCacheAttributes {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "cache_stale_timeout_in_seconds".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for SmbFileShareCacheAttributes {
