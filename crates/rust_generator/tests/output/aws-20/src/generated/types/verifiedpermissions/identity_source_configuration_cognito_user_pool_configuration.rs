...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for IdentitySourceConfigurationCognitoUserPoolConfiguration {
    ...
    > {
        async move {
            ...
            map.insert("client_ids".to_string(), self.r#client_ids.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#group_configuration: {
                        ...
                        <Option<Box<super::super::types::verifiedpermissions::IdentitySourceConfigurationCognitoUserPoolConfigurationGroupConfiguration>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#user_pool_arn: {
