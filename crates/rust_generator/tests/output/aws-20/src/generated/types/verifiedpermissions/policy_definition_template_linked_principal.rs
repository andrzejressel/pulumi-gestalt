...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PolicyDefinitionTemplateLinkedPrincipal {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("entity_id".to_string(), self.r#entity_id.to_pulumi_value().await);
            map.insert("entity_type".to_string(), self.r#entity_type.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PolicyDefinitionTemplateLinkedPrincipal {
