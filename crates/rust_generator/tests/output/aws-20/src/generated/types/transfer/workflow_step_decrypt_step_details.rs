...
pub struct WorkflowStepDecryptStepDetails {
    ...
    pub r#destination_file_location: Option<Box<super::super::types::transfer::WorkflowStepDecryptStepDetailsDestinationFileLocation>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WorkflowStepDecryptStepDetails {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WorkflowStepDecryptStepDetails {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#destination_file_location: {
                        ...
                        <Option<Box<super::super::types::transfer::WorkflowStepDecryptStepDetailsDestinationFileLocation>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#name: {
