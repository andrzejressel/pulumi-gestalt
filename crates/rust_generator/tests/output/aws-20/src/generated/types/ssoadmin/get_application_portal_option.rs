...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetApplicationPortalOption {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetApplicationPortalOption {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#sign_in_options: {
                        ...
                        <Option<Vec<super::super::types::ssoadmin::GetApplicationPortalOptionSignInOption>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#visibility: {
