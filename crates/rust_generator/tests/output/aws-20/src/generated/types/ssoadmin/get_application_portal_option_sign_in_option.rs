...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetApplicationPortalOptionSignInOption {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("application_url".to_string(), self.r#application_url.to_pulumi_value().await);
            map.insert("origin".to_string(), self.r#origin.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetApplicationPortalOptionSignInOption {
