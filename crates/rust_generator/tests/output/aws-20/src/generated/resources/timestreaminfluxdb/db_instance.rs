...
pub mod db_instance {
    ...
    pub struct DbInstanceArgs {
        ...
        #[builder(into)]
        pub allocated_storage: pulumi_gestalt_rust::Input<i32>,
        ...
        #[builder(into, default)]
        pub log_delivery_configuration: pulumi_gestalt_rust::Input<
            Option<
        ...
        #[builder(into)]
        pub vpc_security_group_ids: pulumi_gestalt_rust::Input<Vec<String>>,
