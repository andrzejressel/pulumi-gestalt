...
pub mod server {
    ...
    pub struct ServerArgs {
        ...
        #[builder(into, default)]
        pub endpoint_details: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub function: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub host_key: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub identity_provider_type: pulumi_gestalt_rust::Input<Option<String>>,
        /// Amazon Resource Name (ARN) of the IAM role used to authenticate the user account with an `identity_provider_type` of `API_GATEWAY`.
        #[builder(into, default)]
        pub invocation_role: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub s3_storage_options: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub workflow_details: pulumi_gestalt_rust::Input<
