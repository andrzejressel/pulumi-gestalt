...
pub mod profile {
    ...
    fn __create(
        ...
        let as2_id_binding = args.as2_id.get_output(ctx);
        let certificate_ids_binding = args.certificate_ids.get_output(ctx);
        let profile_type_binding = args.profile_type.get_output(ctx);
