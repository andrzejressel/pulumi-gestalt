...
pub mod vocabulary {
    ...
    fn __create(
        ...
        let phrases_binding = args.phrases.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let vocabulary_file_uri_binding = args.vocabulary_file_uri.get_output(ctx);
        let vocabulary_name_binding = args.vocabulary_name.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "phrases".into(),
                    value: &phrases_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "tags".into(),
