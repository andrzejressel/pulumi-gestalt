...
pub mod stored_iscsi_volume {
    ...
    fn __create(
        ...
        let preserve_existing_data_binding = args.preserve_existing_data.get_output(ctx);
        let snapshot_id_binding = args.snapshot_id.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let target_name_binding = args.target_name.get_output(ctx);
