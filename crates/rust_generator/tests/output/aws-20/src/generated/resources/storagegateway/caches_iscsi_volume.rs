...
pub mod caches_iscsi_volume {
    ...
    fn __create(
        ...
        let source_volume_arn_binding = args.source_volume_arn.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let target_name_binding = args.target_name.get_output(ctx);
        let volume_size_in_bytes_binding = args.volume_size_in_bytes.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &source_volume_arn_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "tags".into(),
