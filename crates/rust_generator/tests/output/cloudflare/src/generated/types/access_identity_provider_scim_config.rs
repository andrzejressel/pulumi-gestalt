...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AccessIdentityProviderScimConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "group_member_deprovision".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AccessIdentityProviderScimConfig {
