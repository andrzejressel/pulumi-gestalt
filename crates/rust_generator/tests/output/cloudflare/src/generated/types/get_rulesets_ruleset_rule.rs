...
pub struct GetRulesetsRulesetRule {
    ...
    pub r#action_parameters: Option<Box<super::types::GetRulesetsRulesetRuleActionParameters>>,
    ...
    pub r#exposed_credential_check: Option<Box<super::types::GetRulesetsRulesetRuleExposedCredentialCheck>>,
    ...
    pub r#logging: Option<Box<super::types::GetRulesetsRulesetRuleLogging>>,
    /// List of parameters that configure HTTP rate limiting behaviour.
    #[builder(into)]
    #[serde(rename = "ratelimit")]
    pub r#ratelimit: Option<Box<super::types::GetRulesetsRulesetRuleRatelimit>>,
    /// Rule reference.
    #[builder(into)]
    #[serde(rename = "ref")]
    pub r#ref_: String,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetRulesetsRulesetRule {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetRulesetsRulesetRule {
