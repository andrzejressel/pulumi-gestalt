...
pub struct AccessGroupExclude {
    ...
    pub r#auth_contexts: Option<Vec<super::types::AccessGroupExcludeAuthContext>>,
    ...
    #[builder(into)]
    #[serde(rename = "azures")]
    pub r#azures: Option<Vec<super::types::AccessGroupExcludeAzure>>,
    ...
    pub r#external_evaluation: Option<Box<super::types::AccessGroupExcludeExternalEvaluation>>,
    ...
    pub r#githubs: Option<Vec<super::types::AccessGroupExcludeGithub>>,
    ...
    pub r#gsuites: Option<Vec<super::types::AccessGroupExcludeGsuite>>,
    ...
    #[builder(into)]
    #[serde(rename = "oktas")]
    pub r#oktas: Option<Vec<super::types::AccessGroupExcludeOkta>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into)]
    #[serde(rename = "samls")]
    pub r#samls: Option<Vec<super::types::AccessGroupExcludeSaml>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AccessGroupExclude {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AccessGroupExclude {
