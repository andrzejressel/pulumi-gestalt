...
pub struct ZeroTrustAccessPolicyRequire {
    ...
    pub r#auth_contexts: Option<Vec<super::types::ZeroTrustAccessPolicyRequireAuthContext>>,
    ...
    #[builder(into)]
    #[serde(rename = "azures")]
    pub r#azures: Option<Vec<super::types::ZeroTrustAccessPolicyRequireAzure>>,
    ...
    #[builder(into)]
    #[serde(rename = "externalEvaluations")]
    pub r#external_evaluations: Option<Vec<super::types::ZeroTrustAccessPolicyRequireExternalEvaluation>>,
    ...
    pub r#githubs: Option<Vec<super::types::ZeroTrustAccessPolicyRequireGithub>>,
    ...
    pub r#gsuites: Option<Vec<super::types::ZeroTrustAccessPolicyRequireGsuite>>,
    ...
    #[builder(into)]
    #[serde(rename = "oktas")]
    pub r#oktas: Option<Vec<super::types::ZeroTrustAccessPolicyRequireOkta>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into)]
    #[serde(rename = "samls")]
    pub r#samls: Option<Vec<super::types::ZeroTrustAccessPolicyRequireSaml>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ZeroTrustAccessPolicyRequire {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ZeroTrustAccessPolicyRequire {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#external_evaluations: {
                        let field_value = match fields_map.get("external_evaluations") {
                            Some(value) => value,
                            None => bail!("Missing field 'external_evaluations' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#geos: {
