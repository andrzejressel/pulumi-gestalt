            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#external_evaluations: {
                        let field_value = match fields_map.get("externalEvaluations") {
                            Some(value) => value,
                            None => bail!("Missing field 'externalEvaluations' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#geos: {
