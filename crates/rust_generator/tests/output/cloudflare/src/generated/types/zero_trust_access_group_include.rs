...
pub struct ZeroTrustAccessGroupInclude {
    ...
    pub r#auth_contexts: Option<Vec<super::types::ZeroTrustAccessGroupIncludeAuthContext>>,
    ...
    #[builder(into)]
    #[serde(rename = "azures")]
    pub r#azures: Option<Vec<super::types::ZeroTrustAccessGroupIncludeAzure>>,
    ...
    pub r#external_evaluations: Option<Vec<super::types::ZeroTrustAccessGroupIncludeExternalEvaluation>>,
    ...
    pub r#githubs: Option<Vec<super::types::ZeroTrustAccessGroupIncludeGithub>>,
    ...
    pub r#gsuites: Option<Vec<super::types::ZeroTrustAccessGroupIncludeGsuite>>,
    ...
    #[builder(into)]
    #[serde(rename = "oktas")]
    pub r#oktas: Option<Vec<super::types::ZeroTrustAccessGroupIncludeOkta>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into)]
    #[serde(rename = "samls")]
    pub r#samls: Option<Vec<super::types::ZeroTrustAccessGroupIncludeSaml>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ZeroTrustAccessGroupInclude {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ZeroTrustAccessGroupInclude {
