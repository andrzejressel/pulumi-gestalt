...
pub struct AccessPolicyInclude {
    ...
    pub r#auth_contexts: Option<Vec<super::types::AccessPolicyIncludeAuthContext>>,
    ...
    #[builder(into)]
    #[serde(rename = "azures")]
    pub r#azures: Option<Vec<super::types::AccessPolicyIncludeAzure>>,
    ...
    pub r#external_evaluation: Option<Box<super::types::AccessPolicyIncludeExternalEvaluation>>,
    ...
    pub r#githubs: Option<Vec<super::types::AccessPolicyIncludeGithub>>,
    ...
    pub r#gsuites: Option<Vec<super::types::AccessPolicyIncludeGsuite>>,
    ...
    #[builder(into)]
    #[serde(rename = "oktas")]
    pub r#oktas: Option<Vec<super::types::AccessPolicyIncludeOkta>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into)]
    #[serde(rename = "samls")]
    pub r#samls: Option<Vec<super::types::AccessPolicyIncludeSaml>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AccessPolicyInclude {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AccessPolicyInclude {
