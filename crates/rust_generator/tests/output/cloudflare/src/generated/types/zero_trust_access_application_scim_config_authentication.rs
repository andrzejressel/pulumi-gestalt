...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ZeroTrustAccessApplicationScimConfigAuthentication {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ZeroTrustAccessApplicationScimConfigAuthentication {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#authorization_url: {
                        let field_value = match fields_map.get("authorizationUrl") {
                            Some(value) => value,
                            None => bail!("Missing field 'authorizationUrl' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
