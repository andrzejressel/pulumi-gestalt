...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RateLimitMatchResponse {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RateLimitMatchResponse {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#origin_traffic: {
                        let field_value = match fields_map.get("origin_traffic") {
                            Some(value) => value,
                            None => bail!("Missing field 'origin_traffic' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#statuses: {
