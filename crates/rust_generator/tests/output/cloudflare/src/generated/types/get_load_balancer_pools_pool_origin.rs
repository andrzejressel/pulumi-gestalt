...
pub struct GetLoadBalancerPoolsPoolOrigin {
    ...
    pub r#headers: Option<Vec<super::types::GetLoadBalancerPoolsPoolOriginHeader>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetLoadBalancerPoolsPoolOrigin {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetLoadBalancerPoolsPoolOrigin {
