...
pub struct RulesetRuleActionParameters {
    ...
    #[builder(into)]
    pub r#rules: Option<std::collections::BTreeMap<String, String>>,
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#disable_rum: {
                        let field_value = match fields_map.get("disableRum") {
                            Some(value) => value,
                            None => bail!("Missing field 'disableRum' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#disable_zaraz: {
