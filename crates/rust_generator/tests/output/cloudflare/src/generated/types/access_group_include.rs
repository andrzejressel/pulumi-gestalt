...
pub struct AccessGroupInclude {
    ...
    pub r#auth_contexts: Option<Vec<super::types::AccessGroupIncludeAuthContext>>,
    ...
    #[builder(into)]
    #[serde(rename = "azures")]
    pub r#azures: Option<Vec<super::types::AccessGroupIncludeAzure>>,
    ...
    pub r#githubs: Option<Vec<super::types::AccessGroupIncludeGithub>>,
    ...
    pub r#gsuites: Option<Vec<super::types::AccessGroupIncludeGsuite>>,
    ...
    #[builder(into)]
    #[serde(rename = "oktas")]
    pub r#oktas: Option<Vec<super::types::AccessGroupIncludeOkta>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into)]
    #[serde(rename = "samls")]
    pub r#samls: Option<Vec<super::types::AccessGroupIncludeSaml>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AccessGroupInclude {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AccessGroupInclude {
