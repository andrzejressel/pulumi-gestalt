...
pub struct TunnelConfigConfigIngressRuleOriginRequest {
    ...
    #[builder(into)]
    pub r#access: Option<Box<super::types::TunnelConfigConfigIngressRuleOriginRequestAccess>>,
    /// Runs as jump host.
    #[builder(into)]
    ...
    #[builder(into)]
    pub r#ip_rules: Option<Vec<super::types::TunnelConfigConfigIngressRuleOriginRequestIpRule>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TunnelConfigConfigIngressRuleOriginRequest {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for TunnelConfigConfigIngressRuleOriginRequest {
