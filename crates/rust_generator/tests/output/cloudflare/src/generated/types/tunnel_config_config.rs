...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TunnelConfigConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for TunnelConfigConfig {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#ingress_rules: {
                        let field_value = match fields_map.get("ingressRules") {
                            Some(value) => value,
                            None => bail!("Missing field 'ingressRules' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                    ...
                    r#warp_routing: {
                        let field_value = match fields_map.get("warpRouting") {
                            Some(value) => value,
                            None => bail!("Missing field 'warpRouting' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
