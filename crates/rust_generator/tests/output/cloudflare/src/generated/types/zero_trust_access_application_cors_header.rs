...
pub struct ZeroTrustAccessApplicationCorsHeader {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ZeroTrustAccessApplicationCorsHeader {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ZeroTrustAccessApplicationCorsHeader {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#allow_all_headers: {
                        let field_value = match fields_map.get("allowAllHeaders") {
                            Some(value) => value,
                            None => bail!("Missing field 'allowAllHeaders' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#allow_all_methods: {
                        let field_value = match fields_map.get("allowAllMethods") {
                            Some(value) => value,
                            None => bail!("Missing field 'allowAllMethods' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#allow_all_origins: {
                        let field_value = match fields_map.get("allowAllOrigins") {
                            Some(value) => value,
                            None => bail!("Missing field 'allowAllOrigins' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#allow_credentials: {
