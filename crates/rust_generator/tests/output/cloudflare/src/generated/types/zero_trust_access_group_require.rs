...
pub struct ZeroTrustAccessGroupRequire {
    ...
    pub r#auth_contexts: Option<Vec<super::types::ZeroTrustAccessGroupRequireAuthContext>>,
    ...
    #[builder(into)]
    #[serde(rename = "azures")]
    pub r#azures: Option<Vec<super::types::ZeroTrustAccessGroupRequireAzure>>,
    ...
    pub r#external_evaluations: Option<Vec<super::types::ZeroTrustAccessGroupRequireExternalEvaluation>>,
    ...
    pub r#githubs: Option<Vec<super::types::ZeroTrustAccessGroupRequireGithub>>,
    ...
    pub r#gsuites: Option<Vec<super::types::ZeroTrustAccessGroupRequireGsuite>>,
    ...
    #[builder(into)]
    #[serde(rename = "oktas")]
    pub r#oktas: Option<Vec<super::types::ZeroTrustAccessGroupRequireOkta>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into)]
    #[serde(rename = "samls")]
    pub r#samls: Option<Vec<super::types::ZeroTrustAccessGroupRequireSaml>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ZeroTrustAccessGroupRequire {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ZeroTrustAccessGroupRequire {
