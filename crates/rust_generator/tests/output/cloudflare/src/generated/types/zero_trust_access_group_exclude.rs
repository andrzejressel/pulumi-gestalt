...
pub struct ZeroTrustAccessGroupExclude {
    ...
    pub r#auth_contexts: Option<Vec<super::types::ZeroTrustAccessGroupExcludeAuthContext>>,
    ...
    #[builder(into)]
    #[serde(rename = "azures")]
    pub r#azures: Option<Vec<super::types::ZeroTrustAccessGroupExcludeAzure>>,
    ...
    pub r#external_evaluations: Option<Vec<super::types::ZeroTrustAccessGroupExcludeExternalEvaluation>>,
    ...
    pub r#githubs: Option<Vec<super::types::ZeroTrustAccessGroupExcludeGithub>>,
    ...
    pub r#gsuites: Option<Vec<super::types::ZeroTrustAccessGroupExcludeGsuite>>,
    ...
    #[builder(into)]
    #[serde(rename = "oktas")]
    pub r#oktas: Option<Vec<super::types::ZeroTrustAccessGroupExcludeOkta>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into)]
    #[serde(rename = "samls")]
    pub r#samls: Option<Vec<super::types::ZeroTrustAccessGroupExcludeSaml>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ZeroTrustAccessGroupExclude {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ZeroTrustAccessGroupExclude {
