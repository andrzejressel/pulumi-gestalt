...
pub struct ZeroTrustAccessPolicyExclude {
    ...
    pub r#auth_contexts: Option<Vec<super::types::ZeroTrustAccessPolicyExcludeAuthContext>>,
    ...
    #[builder(into)]
    #[serde(rename = "azures")]
    pub r#azures: Option<Vec<super::types::ZeroTrustAccessPolicyExcludeAzure>>,
    ...
    pub r#external_evaluations: Option<Vec<super::types::ZeroTrustAccessPolicyExcludeExternalEvaluation>>,
    ...
    pub r#githubs: Option<Vec<super::types::ZeroTrustAccessPolicyExcludeGithub>>,
    ...
    pub r#gsuites: Option<Vec<super::types::ZeroTrustAccessPolicyExcludeGsuite>>,
    ...
    #[builder(into)]
    #[serde(rename = "oktas")]
    pub r#oktas: Option<Vec<super::types::ZeroTrustAccessPolicyExcludeOkta>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into)]
    #[serde(rename = "samls")]
    pub r#samls: Option<Vec<super::types::ZeroTrustAccessPolicyExcludeSaml>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ZeroTrustAccessPolicyExclude {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ZeroTrustAccessPolicyExclude {
