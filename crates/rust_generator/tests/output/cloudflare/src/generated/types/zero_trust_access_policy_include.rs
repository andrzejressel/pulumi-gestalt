...
pub struct ZeroTrustAccessPolicyInclude {
    ...
    pub r#auth_contexts: Option<Vec<super::types::ZeroTrustAccessPolicyIncludeAuthContext>>,
    ...
    #[builder(into)]
    #[serde(rename = "azures")]
    pub r#azures: Option<Vec<super::types::ZeroTrustAccessPolicyIncludeAzure>>,
    ...
    pub r#external_evaluations: Option<Vec<super::types::ZeroTrustAccessPolicyIncludeExternalEvaluation>>,
    ...
    pub r#githubs: Option<Vec<super::types::ZeroTrustAccessPolicyIncludeGithub>>,
    ...
    pub r#gsuites: Option<Vec<super::types::ZeroTrustAccessPolicyIncludeGsuite>>,
    ...
    #[builder(into)]
    #[serde(rename = "oktas")]
    pub r#oktas: Option<Vec<super::types::ZeroTrustAccessPolicyIncludeOkta>>,
    /// Matches a SAML group. Requires a SAML identity provider.
    #[builder(into)]
    #[serde(rename = "samls")]
    pub r#samls: Option<Vec<super::types::ZeroTrustAccessPolicyIncludeSaml>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ZeroTrustAccessPolicyInclude {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ZeroTrustAccessPolicyInclude {
