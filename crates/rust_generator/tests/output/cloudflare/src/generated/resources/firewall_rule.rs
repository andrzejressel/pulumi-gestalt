...
pub mod firewall_rule {
    ...
    fn __create(
        ...
        let filter_id_binding = args.filter_id.get_output(ctx);
        let paused_binding = args.paused.get_output(ctx);
        let priority_binding = args.priority.get_output(ctx);
        let products_binding = args.products.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "filterId".into(),
                    value: &filter_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "paused".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "products".into(),
                    value: &products_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "zoneId".into(),
