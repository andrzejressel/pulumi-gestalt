...
pub mod waiting_room_event {
    ...
    fn __create(
        ...
        let disable_session_renewal_binding = args
            ...
            .get_output(ctx);
        let event_end_time_binding = args.event_end_time.get_output(ctx);
        let event_start_time_binding = args.event_start_time.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let new_users_per_minute_binding = args.new_users_per_minute.get_output(ctx);
        let prequeue_start_time_binding = args.prequeue_start_time.get_output(ctx);
        ...
        let shuffle_at_event_start_binding = args.shuffle_at_event_start.get_output(ctx);
        let suspended_binding = args.suspended.get_output(ctx);
        let total_active_users_binding = args.total_active_users.get_output(ctx);
        let waiting_room_id_binding = args.waiting_room_id.get_output(ctx);
