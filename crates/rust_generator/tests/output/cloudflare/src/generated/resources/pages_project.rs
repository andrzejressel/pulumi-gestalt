...
pub mod pages_project {
    ...
    fn __create(
        ...
        let build_config_binding = args.build_config.get_output(ctx);
        let deployment_configs_binding = args.deployment_configs.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let production_branch_binding = args.production_branch.get_output(ctx);
