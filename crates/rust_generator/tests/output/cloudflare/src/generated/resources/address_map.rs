...
pub mod address_map {
    ...
    fn __create(
        ...
        let default_sni_binding = args.default_sni.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let enabled_binding = args.enabled.get_output(ctx);
        let ips_binding = args.ips.get_output(ctx);
        let memberships_binding = args.memberships.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &default_sni_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &memberships_binding.drop_type(),
                },
            ],
            options,
        };
