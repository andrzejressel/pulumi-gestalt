...
pub mod waiting_room {
    ...
    pub struct WaitingRoomArgs {
        ...
        pub additional_routes: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub cookie_suffix: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub json_response_enabled: pulumi_gestalt_rust::Input<Option<bool>>,
        /// A unique name to identify the waiting room. **Modifying this attribute will force creation of a new resource.**
        #[builder(into)]
        pub name: pulumi_gestalt_rust::Input<String>,
        /// The number of new users that will be let into the route every minute.
        #[builder(into)]
        pub new_users_per_minute: pulumi_gestalt_rust::Input<i32>,
        ...
        #[builder(into, default)]
        pub queue_all: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub queueing_status_code: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into)]
        pub total_active_users: pulumi_gestalt_rust::Input<i32>,
    ...
    fn __create(
        ...
        let additional_routes_binding = args.additional_routes.get_output(ctx);
        let cookie_suffix_binding = args.cookie_suffix.get_output(ctx);
        let custom_page_html_binding = args.custom_page_html.get_output(ctx);
        ...
        let json_response_enabled_binding = args.json_response_enabled.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let new_users_per_minute_binding = args.new_users_per_minute.get_output(ctx);
        let path_binding = args.path.get_output(ctx);
        let queue_all_binding = args.queue_all.get_output(ctx);
        let queueing_method_binding = args.queueing_method.get_output(ctx);
        let queueing_status_code_binding = args.queueing_status_code.get_output(ctx);
        let session_duration_binding = args.session_duration.get_output(ctx);
        let suspended_binding = args.suspended.get_output(ctx);
        let total_active_users_binding = args.total_active_users.get_output(ctx);
