...
pub mod logpush_job {
    ...
    fn __create(
        ...
        let destination_conf_binding = args.destination_conf.get_output(ctx);
        ...
        let logpull_options_binding = args.logpull_options.get_output(ctx);
        let max_upload_bytes_binding = args.max_upload_bytes.get_output(ctx);
        let max_upload_interval_seconds_binding = args
            .max_upload_interval_seconds
            .get_output(ctx);
        let max_upload_records_binding = args.max_upload_records.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let output_options_binding = args.output_options.get_output(ctx);
        let ownership_challenge_binding = args.ownership_challenge.get_output(ctx);
