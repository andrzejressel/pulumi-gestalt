...
pub mod notification_policy {
    ...
    pub struct NotificationPolicyArgs {
        ...
        #[builder(into)]
        pub alert_type: pulumi_gestalt_rust::Input<String>,
        /// Description of the notification policy.
        #[builder(into, default)]
        pub description: pulumi_gestalt_rust::Input<Option<String>>,
        /// The email ID to which the notification should be dispatched.
        #[builder(into, default)]
        pub email_integrations: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub pagerduty_integrations: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub webhooks_integrations: pulumi_gestalt_rust::Input<
    ...
    fn __create(
        ...
        let alert_type_binding = args.alert_type.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let email_integrations_binding = args.email_integrations.get_output(ctx);
        let enabled_binding = args.enabled.get_output(ctx);
        let filters_binding = args.filters.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let pagerduty_integrations_binding = args.pagerduty_integrations.get_output(ctx);
        let webhooks_integrations_binding = args.webhooks_integrations.get_output(ctx);
