...
pub mod custom_hostname {
    ...
    fn __create(
        ...
        let custom_metadata_binding = args.custom_metadata.get_output(ctx);
        let custom_origin_server_binding = args.custom_origin_server.get_output(ctx);
        let custom_origin_sni_binding = args.custom_origin_sni.get_output(ctx);
        let hostname_binding = args.hostname.get_output(ctx);
        let ssls_binding = args.ssls.get_output(ctx);
