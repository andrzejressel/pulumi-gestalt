...
pub mod event_subscription {
    ...
    pub struct EventSubscriptionArgs {
        ...
        #[builder(into)]
        pub sns_topic: pulumi_gestalt_rust::Input<String>,
    ...
    fn __create(
        ...
        let sns_topic_binding = args.sns_topic.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "snsTopic".into(),
                    value: &sns_topic_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "sourceIds".into(),
        ...
        EventSubscriptionResult {
            ...
            sns_topic: o.get_field("snsTopic"),
