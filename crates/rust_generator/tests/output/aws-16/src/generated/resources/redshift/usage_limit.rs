...
pub mod usage_limit {
    ...
    pub struct UsageLimitArgs {
        ...
        #[builder(into)]
        pub feature_type: pulumi_gestalt_rust::Input<String>,
        /// The type of limit. Depending on the feature type, this can be based on a time duration or data size. If FeatureType is `spectrum`, then LimitType must be `data-scanned`. If FeatureType is `concurrency-scaling`, then LimitType must be `time`. If FeatureType is `cross-region-datasharing`, then LimitType must be `data-scanned`. Valid values are `data-scanned`, and `time`.
        #[builder(into)]
        pub limit_type: pulumi_gestalt_rust::Input<String>,
    ...
    fn __create(
        ...
        let breach_action_binding = args.breach_action.get_output(ctx);
        let cluster_identifier_binding = args.cluster_identifier.get_output(ctx);
        let feature_type_binding = args.feature_type.get_output(ctx);
        let limit_type_binding = args.limit_type.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &feature_type_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "limitType".into(),
                    value: &limit_type_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "period".into(),
