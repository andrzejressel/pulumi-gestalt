...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetClusterClusterNode {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetClusterClusterNode {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#node_role: {
                        let field_value = match fields_map.get("nodeRole") {
                            Some(value) => value,
                            None => bail!("Missing field 'nodeRole' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
