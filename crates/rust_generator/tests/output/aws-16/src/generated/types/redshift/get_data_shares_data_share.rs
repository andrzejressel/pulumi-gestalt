...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetDataSharesDataShare {
    ...
    > {
        async move {
            ...
            map.insert("data_share_arn".to_string(), self.r#data_share_arn.to_pulumi_value().await);
            map.insert("managed_by".to_string(), self.r#managed_by.to_pulumi_value().await);
            map.insert("producer_arn".to_string(), self.r#producer_arn.to_pulumi_value().await);
