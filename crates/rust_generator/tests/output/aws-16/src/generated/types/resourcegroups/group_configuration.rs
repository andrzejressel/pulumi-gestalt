...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GroupConfiguration {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GroupConfiguration {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#parameters: {
                        ...
                        <Option<Vec<super::super::types::resourcegroups::GroupConfigurationParameter>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#type_: {
