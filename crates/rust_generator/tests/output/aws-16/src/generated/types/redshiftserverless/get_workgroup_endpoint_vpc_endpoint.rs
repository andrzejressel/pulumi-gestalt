...
pub struct GetWorkgroupEndpointVpcEndpoint {
    ...
    pub r#network_interfaces: Vec<super::super::types::redshiftserverless::GetWorkgroupEndpointVpcEndpointNetworkInterface>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetWorkgroupEndpointVpcEndpoint {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetWorkgroupEndpointVpcEndpoint {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#network_interfaces: {
                        ...
                        <Vec<super::super::types::redshiftserverless::GetWorkgroupEndpointVpcEndpointNetworkInterface> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#vpc_endpoint_id: {
