...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetWorkgroupEndpointVpcEndpointNetworkInterface {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("network_interface_id".to_string(), self.r#network_interface_id.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetWorkgroupEndpointVpcEndpointNetworkInterface {
