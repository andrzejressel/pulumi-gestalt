...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ReservedInstanceRecurringCharge {
    ...
    > {
        async move {
            ...
            map.insert("recurring_charge_amount".to_string(), self.r#recurring_charge_amount.to_pulumi_value().await);
            map.insert("recurring_charge_frequency".to_string(), self.r#recurring_charge_frequency.to_pulumi_value().await);
