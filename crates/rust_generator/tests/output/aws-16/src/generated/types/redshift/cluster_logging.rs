...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClusterLogging {
    ...
    > {
        async move {
            ...
            map.insert("log_destination_type".to_string(), self.r#log_destination_type.to_pulumi_value().await);
            map.insert("log_exports".to_string(), self.r#log_exports.to_pulumi_value().await);
