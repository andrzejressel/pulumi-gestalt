...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PipelinePipelineDefinitionS3Location {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("object_key".to_string(), self.r#object_key.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PipelinePipelineDefinitionS3Location {
