...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FlowDefinitionHumanLoopRequestSource {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("aws_managed_human_loop_request_source".to_string(), self.r#aws_managed_human_loop_request_source.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FlowDefinitionHumanLoopRequestSource {
