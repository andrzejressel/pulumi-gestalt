...
pub struct DomainDefaultUserSettingsKernelGatewayAppSettings {
    ...
    pub r#custom_images: Option<Vec<super::super::types::sagemaker::DomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see `default_resource_spec` Block below.
    #[builder(into)]
    #[serde(rename = "defaultResourceSpec")]
    pub r#default_resource_spec: Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpec>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DomainDefaultUserSettingsKernelGatewayAppSettings {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DomainDefaultUserSettingsKernelGatewayAppSettings {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#custom_images: {
                        ...
                        <Option<Vec<super::super::types::sagemaker::DomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#default_resource_spec: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpec>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
