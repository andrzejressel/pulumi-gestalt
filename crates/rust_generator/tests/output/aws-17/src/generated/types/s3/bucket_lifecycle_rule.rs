            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#expiration: {
                        ...
                        <Option<Box<super::super::types::s3::BucketLifecycleRuleExpiration>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#id: {
                    ...
                    r#noncurrent_version_expiration: {
                        ...
                        <Option<Box<super::super::types::s3::BucketLifecycleRuleNoncurrentVersionExpiration>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#noncurrent_version_transitions: {
                        ...
                        <Option<Vec<super::super::types::s3::BucketLifecycleRuleNoncurrentVersionTransition>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#prefix: {
                    ...
                    r#transitions: {
                        ...
                        <Option<Vec<super::super::types::s3::BucketLifecycleRuleTransition>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
