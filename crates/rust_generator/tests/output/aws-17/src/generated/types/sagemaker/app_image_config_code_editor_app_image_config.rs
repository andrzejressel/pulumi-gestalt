            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#container_config: {
                        ...
                        <Option<Box<super::super::types::sagemaker::AppImageConfigCodeEditorAppImageConfigContainerConfig>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#file_system_config: {
                        ...
                        <Option<Box<super::super::types::sagemaker::AppImageConfigCodeEditorAppImageConfigFileSystemConfig>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
