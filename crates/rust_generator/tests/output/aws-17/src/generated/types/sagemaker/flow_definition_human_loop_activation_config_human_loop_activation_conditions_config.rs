            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#human_loop_activation_conditions: {
                        let field_value = match fields_map.get("humanLoopActivationConditions") {
                            Some(value) => value,
                            None => bail!("Missing field 'humanLoopActivationConditions' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
