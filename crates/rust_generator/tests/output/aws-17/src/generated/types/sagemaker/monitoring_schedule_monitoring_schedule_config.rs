...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for MonitoringScheduleMonitoringScheduleConfig {
    ...
    > {
        async move {
            ...
            map.insert("monitoring_job_definition_name".to_string(), self.r#monitoring_job_definition_name.to_pulumi_value().await);
            map.insert("monitoring_type".to_string(), self.r#monitoring_type.to_pulumi_value().await);
            map.insert("schedule_config".to_string(), self.r#schedule_config.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#schedule_config: {
                        ...
                        <Option<Box<super::super::types::sagemaker::MonitoringScheduleMonitoringScheduleConfigScheduleConfig>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
