...
pub struct DomainDefaultUserSettingsJupyterLabAppSettingsEmrSettings {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DomainDefaultUserSettingsJupyterLabAppSettingsEmrSettings {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("assumable_role_arns".to_string(), self.r#assumable_role_arns.to_pulumi_value().await);
            map.insert("execution_role_arns".to_string(), self.r#execution_role_arns.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DomainDefaultUserSettingsJupyterLabAppSettingsEmrSettings {
