...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DataQualityJobDefinitionDataQualityJobOutputConfig {
    ...
    > {
        async move {
            ...
            map.insert("monitoring_outputs".to_string(), self.r#monitoring_outputs.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#monitoring_outputs: {
                        ...
                        <Box<super::super::types::sagemaker::DataQualityJobDefinitionDataQualityJobOutputConfigMonitoringOutputs> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
