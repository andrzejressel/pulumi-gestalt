            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#monitoring_outputs: {
                        let field_value = match fields_map.get("monitoringOutputs") {
                            Some(value) => value,
                            None => bail!("Missing field 'monitoringOutputs' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
