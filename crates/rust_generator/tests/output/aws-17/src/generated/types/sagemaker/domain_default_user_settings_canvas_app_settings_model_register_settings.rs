...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DomainDefaultUserSettingsCanvasAppSettingsModelRegisterSettings {
    fn to_pulumi_value(
        &self,
        ...
        async move {
            ...
            let field_futures: Vec<ToPulumiObjectFieldFuture<'_>> = vec![
                to_pulumi_object_field(
                    ...
                    &self.r#cross_account_model_register_role_arn,
                ),
                to_pulumi_object_field(
                    "status",
                    &self.r#status,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DomainDefaultUserSettingsCanvasAppSettingsModelRegisterSettings {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#cross_account_model_register_role_arn: {
                        let field_value = match fields_map.get("crossAccountModelRegisterRoleArn") {
                            Some(value) => value,
                            None => bail!("Missing field 'crossAccountModelRegisterRoleArn' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
