...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ModelPrimaryContainerImageConfigRepositoryAuthConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "repository_credentials_provider_arn".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ModelPrimaryContainerImageConfigRepositoryAuthConfig {
