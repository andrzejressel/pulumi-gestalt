...
pub struct ModelContainerMultiModelConfig {
    ...
    pub r#model_cache_setting: Option<String>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ModelContainerMultiModelConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("model_cache_setting".to_string(), self.r#model_cache_setting.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ModelContainerMultiModelConfig {
