...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AnalyticsConfigurationStorageClassAnalysis {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AnalyticsConfigurationStorageClassAnalysis {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#data_export: {
                        ...
                        <Box<super::super::types::s3::AnalyticsConfigurationStorageClassAnalysisDataExport> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
