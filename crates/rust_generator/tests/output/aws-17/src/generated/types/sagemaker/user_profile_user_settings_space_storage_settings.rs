...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for UserProfileUserSettingsSpaceStorageSettings {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for UserProfileUserSettingsSpaceStorageSettings {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#default_ebs_storage_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::UserProfileUserSettingsSpaceStorageSettingsDefaultEbsStorageSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
