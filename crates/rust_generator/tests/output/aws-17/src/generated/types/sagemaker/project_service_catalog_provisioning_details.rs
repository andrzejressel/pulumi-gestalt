...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ProjectServiceCatalogProvisioningDetails {
    ...
    > {
        async move {
            ...
            map.insert("provisioning_artifact_id".to_string(), self.r#provisioning_artifact_id.to_pulumi_value().await);
            map.insert("provisioning_parameters".to_string(), self.r#provisioning_parameters.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#provisioning_parameters: {
                        ...
                        <Option<Vec<super::super::types::sagemaker::ProjectServiceCatalogProvisioningDetailsProvisioningParameter>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
