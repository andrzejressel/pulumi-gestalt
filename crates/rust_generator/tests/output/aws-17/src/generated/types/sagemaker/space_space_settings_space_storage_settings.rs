            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#ebs_storage_settings: {
                        let field_value = match fields_map.get("ebsStorageSettings") {
                            Some(value) => value,
                            None => bail!("Missing field 'ebsStorageSettings' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
