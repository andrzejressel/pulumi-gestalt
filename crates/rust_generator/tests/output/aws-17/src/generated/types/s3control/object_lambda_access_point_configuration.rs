...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ObjectLambdaAccessPointConfiguration {
    ...
    > {
        async move {
            ...
            map.insert("allowed_features".to_string(), self.r#allowed_features.to_pulumi_value().await);
            map.insert("cloud_watch_metrics_enabled".to_string(), self.r#cloud_watch_metrics_enabled.to_pulumi_value().await);
            map.insert("supporting_access_point".to_string(), self.r#supporting_access_point.to_pulumi_value().await);
            map.insert("transformation_configurations".to_string(), self.r#transformation_configurations.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#transformation_configurations: {
                        ...
                        <Vec<super::super::types::s3control::ObjectLambdaAccessPointConfigurationTransformationConfiguration> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
