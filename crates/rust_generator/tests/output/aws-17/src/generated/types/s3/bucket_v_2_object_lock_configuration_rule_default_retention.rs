...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BucketV2ObjectLockConfigurationRuleDefaultRetention {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("years".to_string(), self.r#years.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BucketV2ObjectLockConfigurationRuleDefaultRetention {
