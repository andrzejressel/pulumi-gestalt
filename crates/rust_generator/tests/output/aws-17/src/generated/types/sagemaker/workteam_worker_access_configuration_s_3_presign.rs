...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WorkteamWorkerAccessConfigurationS3Presign {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("iam_policy_constraints".to_string(), self.r#iam_policy_constraints.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WorkteamWorkerAccessConfigurationS3Presign {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#iam_policy_constraints: {
                        ...
                        <Option<Box<super::super::types::sagemaker::WorkteamWorkerAccessConfigurationS3PresignIamPolicyConstraints>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
