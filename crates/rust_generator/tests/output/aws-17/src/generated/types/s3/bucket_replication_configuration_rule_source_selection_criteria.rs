...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BucketReplicationConfigurationRuleSourceSelectionCriteria {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BucketReplicationConfigurationRuleSourceSelectionCriteria {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#sse_kms_encrypted_objects: {
                        ...
                        <Option<Box<super::super::types::s3::BucketReplicationConfigurationRuleSourceSelectionCriteriaSseKmsEncryptedObjects>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
