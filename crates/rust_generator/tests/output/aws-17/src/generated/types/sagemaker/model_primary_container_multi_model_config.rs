...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ModelPrimaryContainerMultiModelConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "model_cache_setting".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#model_cache_setting,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ModelPrimaryContainerMultiModelConfig {
