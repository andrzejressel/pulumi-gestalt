...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BucketObjectLockConfigurationV2Rule {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BucketObjectLockConfigurationV2Rule {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#default_retention: {
                        ...
                        <Box<super::super::types::s3::BucketObjectLockConfigurationV2RuleDefaultRetention> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
