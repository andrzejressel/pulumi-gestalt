...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FlowDefinitionHumanLoopActivationConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("human_loop_activation_conditions_config".to_string(), self.r#human_loop_activation_conditions_config.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FlowDefinitionHumanLoopActivationConfig {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#human_loop_activation_conditions_config: {
                        ...
                        <Option<Box<super::super::types::sagemaker::FlowDefinitionHumanLoopActivationConfigHumanLoopActivationConditionsConfig>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
