...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EndpointConfigurationProductionVariantManagedInstanceScaling {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("max_instance_count".to_string(), self.r#max_instance_count.to_pulumi_value().await);
            map.insert("min_instance_count".to_string(), self.r#min_instance_count.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for EndpointConfigurationProductionVariantManagedInstanceScaling {
