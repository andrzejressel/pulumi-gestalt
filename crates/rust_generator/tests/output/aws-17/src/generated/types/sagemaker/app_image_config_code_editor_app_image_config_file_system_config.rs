...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AppImageConfigCodeEditorAppImageConfigFileSystemConfig {
    ...
    > {
        async move {
            ...
            map.insert("default_gid".to_string(), self.r#default_gid.to_pulumi_value().await);
            map.insert("default_uid".to_string(), self.r#default_uid.to_pulumi_value().await);
            map.insert("mount_path".to_string(), self.r#mount_path.to_pulumi_value().await);
