...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BucketV2Logging {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("target_bucket".to_string(), self.r#target_bucket.to_pulumi_value().await);
            map.insert("target_prefix".to_string(), self.r#target_prefix.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BucketV2Logging {
