...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DomainDefaultUserSettings {
    ...
    > {
        async move {
            ...
            map.insert("auto_mount_home_efs".to_string(), self.r#auto_mount_home_efs.to_pulumi_value().await);
            map.insert("canvas_app_settings".to_string(), self.r#canvas_app_settings.to_pulumi_value().await);
            map.insert("code_editor_app_settings".to_string(), self.r#code_editor_app_settings.to_pulumi_value().await);
            ...
            map.insert("default_landing_uri".to_string(), self.r#default_landing_uri.to_pulumi_value().await);
            ...
            map.insert("r_session_app_settings".to_string(), self.r#r_session_app_settings.to_pulumi_value().await);
            map.insert("r_studio_server_pro_app_settings".to_string(), self.r#r_studio_server_pro_app_settings.to_pulumi_value().await);
            map.insert("security_groups".to_string(), self.r#security_groups.to_pulumi_value().await);
            map.insert("sharing_settings".to_string(), self.r#sharing_settings.to_pulumi_value().await);
            map.insert("space_storage_settings".to_string(), self.r#space_storage_settings.to_pulumi_value().await);
            map.insert("studio_web_portal".to_string(), self.r#studio_web_portal.to_pulumi_value().await);
            map.insert("studio_web_portal_settings".to_string(), self.r#studio_web_portal_settings.to_pulumi_value().await);
            map.insert("tensor_board_app_settings".to_string(), self.r#tensor_board_app_settings.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#canvas_app_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsCanvasAppSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#code_editor_app_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsCodeEditorAppSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#custom_file_system_configs: {
                        ...
                        <Option<Vec<super::super::types::sagemaker::DomainDefaultUserSettingsCustomFileSystemConfig>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#custom_posix_user_config: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsCustomPosixUserConfig>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    ...
                    r#jupyter_lab_app_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsJupyterLabAppSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#jupyter_server_app_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsJupyterServerAppSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#kernel_gateway_app_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsKernelGatewayAppSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#r_session_app_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsRSessionAppSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#r_studio_server_pro_app_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsRStudioServerProAppSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#security_groups: {
                    ...
                    r#sharing_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsSharingSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#space_storage_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsSpaceStorageSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#studio_web_portal: {
                    ...
                    r#studio_web_portal_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsStudioWebPortalSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#tensor_board_app_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsTensorBoardAppSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
