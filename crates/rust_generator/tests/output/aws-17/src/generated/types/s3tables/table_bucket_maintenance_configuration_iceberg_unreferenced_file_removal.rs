...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TableBucketMaintenanceConfigurationIcebergUnreferencedFileRemoval {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for TableBucketMaintenanceConfigurationIcebergUnreferencedFileRemoval {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#settings: {
                        ...
                        <Box<super::super::types::s3tables::TableBucketMaintenanceConfigurationIcebergUnreferencedFileRemovalSettings> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#status: {
