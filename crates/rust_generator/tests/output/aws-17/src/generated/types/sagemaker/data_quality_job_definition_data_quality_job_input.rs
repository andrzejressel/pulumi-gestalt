...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DataQualityJobDefinitionDataQualityJobInput {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("batch_transform_input".to_string(), self.r#batch_transform_input.to_pulumi_value().await);
            map.insert("endpoint_input".to_string(), self.r#endpoint_input.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DataQualityJobDefinitionDataQualityJobInput {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#batch_transform_input: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DataQualityJobDefinitionDataQualityJobInputBatchTransformInput>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#endpoint_input: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DataQualityJobDefinitionDataQualityJobInputEndpointInput>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
