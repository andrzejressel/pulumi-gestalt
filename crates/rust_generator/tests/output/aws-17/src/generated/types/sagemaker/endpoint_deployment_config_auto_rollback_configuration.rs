...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EndpointDeploymentConfigAutoRollbackConfiguration {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for EndpointDeploymentConfigAutoRollbackConfiguration {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#alarms: {
                        ...
                        <Option<Vec<super::super::types::sagemaker::EndpointDeploymentConfigAutoRollbackConfigurationAlarm>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
