...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ZoneVpc {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("vpc_region".to_string(), self.r#vpc_region.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ZoneVpc {
