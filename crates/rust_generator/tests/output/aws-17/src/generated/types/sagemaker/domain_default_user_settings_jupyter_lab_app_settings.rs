...
pub struct DomainDefaultUserSettingsJupyterLabAppSettings {
    ...
    pub r#app_lifecycle_management: Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsJupyterLabAppSettingsAppLifecycleManagement>>,
    ...
    pub r#code_repositories: Option<Vec<super::super::types::sagemaker::DomainDefaultUserSettingsJupyterLabAppSettingsCodeRepository>>,
    ...
    pub r#custom_images: Option<Vec<super::super::types::sagemaker::DomainDefaultUserSettingsJupyterLabAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see `default_resource_spec` Block below.
    #[builder(into)]
    #[serde(rename = "defaultResourceSpec")]
    pub r#default_resource_spec: Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsJupyterLabAppSettingsDefaultResourceSpec>>,
    ...
    pub r#emr_settings: Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsJupyterLabAppSettingsEmrSettings>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DomainDefaultUserSettingsJupyterLabAppSettings {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DomainDefaultUserSettingsJupyterLabAppSettings {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#app_lifecycle_management: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsJupyterLabAppSettingsAppLifecycleManagement>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    ...
                    r#code_repositories: {
                        ...
                        <Option<Vec<super::super::types::sagemaker::DomainDefaultUserSettingsJupyterLabAppSettingsCodeRepository>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#custom_images: {
                        ...
                        <Option<Vec<super::super::types::sagemaker::DomainDefaultUserSettingsJupyterLabAppSettingsCustomImage>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#default_resource_spec: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsJupyterLabAppSettingsDefaultResourceSpec>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#emr_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsJupyterLabAppSettingsEmrSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
