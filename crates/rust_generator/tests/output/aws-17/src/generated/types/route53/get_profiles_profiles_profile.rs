...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetProfilesProfilesProfile {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("share_status".to_string(), self.r#share_status.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetProfilesProfilesProfile {
        ...
        match value.content {
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#share_status: {
                        let field_value = match fields_map.get("share_status") {
                            Some(value) => value,
                            None => bail!("Missing field 'share_status' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        <String as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
