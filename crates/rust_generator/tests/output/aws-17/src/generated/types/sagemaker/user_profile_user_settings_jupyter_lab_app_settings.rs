...
pub struct UserProfileUserSettingsJupyterLabAppSettings {
    ...
    pub r#app_lifecycle_management: Option<Box<super::super::types::sagemaker::UserProfileUserSettingsJupyterLabAppSettingsAppLifecycleManagement>>,
    ...
    pub r#code_repositories: Option<Vec<super::super::types::sagemaker::UserProfileUserSettingsJupyterLabAppSettingsCodeRepository>>,
    #[builder(into)]
    #[serde(rename = "customImages")]
    pub r#custom_images: Option<Vec<super::super::types::sagemaker::UserProfileUserSettingsJupyterLabAppSettingsCustomImage>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see Default Resource Spec below.
    #[builder(into)]
    #[serde(rename = "defaultResourceSpec")]
    pub r#default_resource_spec: Option<Box<super::super::types::sagemaker::UserProfileUserSettingsJupyterLabAppSettingsDefaultResourceSpec>>,
    ...
    pub r#emr_settings: Option<Box<super::super::types::sagemaker::UserProfileUserSettingsJupyterLabAppSettingsEmrSettings>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for UserProfileUserSettingsJupyterLabAppSettings {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for UserProfileUserSettingsJupyterLabAppSettings {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#app_lifecycle_management: {
                        ...
                        <Option<Box<super::super::types::sagemaker::UserProfileUserSettingsJupyterLabAppSettingsAppLifecycleManagement>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    ...
                    r#code_repositories: {
                        ...
                        <Option<Vec<super::super::types::sagemaker::UserProfileUserSettingsJupyterLabAppSettingsCodeRepository>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#custom_images: {
                        ...
                        <Option<Vec<super::super::types::sagemaker::UserProfileUserSettingsJupyterLabAppSettingsCustomImage>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#default_resource_spec: {
                        ...
                        <Option<Box<super::super::types::sagemaker::UserProfileUserSettingsJupyterLabAppSettingsDefaultResourceSpec>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#emr_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::UserProfileUserSettingsJupyterLabAppSettingsEmrSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
