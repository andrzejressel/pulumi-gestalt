...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EndpointDeploymentConfig {
    ...
    > {
        async move {
            ...
            map.insert("auto_rollback_configuration".to_string(), self.r#auto_rollback_configuration.to_pulumi_value().await);
            map.insert("blue_green_update_policy".to_string(), self.r#blue_green_update_policy.to_pulumi_value().await);
            map.insert("rolling_update_policy".to_string(), self.r#rolling_update_policy.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#auto_rollback_configuration: {
                        ...
                        <Option<Box<super::super::types::sagemaker::EndpointDeploymentConfigAutoRollbackConfiguration>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#blue_green_update_policy: {
                        ...
                        <Option<Box<super::super::types::sagemaker::EndpointDeploymentConfigBlueGreenUpdatePolicy>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#rolling_update_policy: {
                        ...
                        <Option<Box<super::super::types::sagemaker::EndpointDeploymentConfigRollingUpdatePolicy>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
