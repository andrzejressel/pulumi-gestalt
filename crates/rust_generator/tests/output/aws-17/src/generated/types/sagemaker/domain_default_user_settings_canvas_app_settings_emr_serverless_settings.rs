...
pub struct DomainDefaultUserSettingsCanvasAppSettingsEmrServerlessSettings {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DomainDefaultUserSettingsCanvasAppSettingsEmrServerlessSettings {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DomainDefaultUserSettingsCanvasAppSettingsEmrServerlessSettings {
