...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BucketIntelligentTieringConfigurationTiering {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("access_tier".to_string(), self.r#access_tier.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BucketIntelligentTieringConfigurationTiering {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#access_tier: {
                        let field_value = match fields_map.get("access_tier") {
                            Some(value) => value,
                            None => bail!("Missing field 'access_tier' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
