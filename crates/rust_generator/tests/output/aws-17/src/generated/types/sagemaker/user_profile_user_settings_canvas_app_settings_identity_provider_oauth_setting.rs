...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for UserProfileUserSettingsCanvasAppSettingsIdentityProviderOauthSetting {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("data_source_name".to_string(), self.r#data_source_name.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for UserProfileUserSettingsCanvasAppSettingsIdentityProviderOauthSetting {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#data_source_name: {
                        let field_value = match fields_map.get("data_source_name") {
                            Some(value) => value,
                            None => bail!("Missing field 'data_source_name' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
