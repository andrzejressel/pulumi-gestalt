...
pub struct BucketReplicationConfigRuleDestinationEncryptionConfiguration {
    ...
    pub r#replica_kms_key_id: String,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BucketReplicationConfigRuleDestinationEncryptionConfiguration {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BucketReplicationConfigRuleDestinationEncryptionConfiguration {
