...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TableMaintenanceConfigurationIcebergSnapshotManagement {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for TableMaintenanceConfigurationIcebergSnapshotManagement {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#settings: {
                        ...
                        <Box<super::super::types::s3tables::TableMaintenanceConfigurationIcebergSnapshotManagementSettings> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#status: {
