...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for UserProfileUserSettingsCodeEditorAppSettings {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for UserProfileUserSettingsCodeEditorAppSettings {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#app_lifecycle_management: {
                        ...
                        <Option<Box<super::super::types::sagemaker::UserProfileUserSettingsCodeEditorAppSettingsAppLifecycleManagement>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    ...
                    r#custom_images: {
                        ...
                        <Option<Vec<super::super::types::sagemaker::UserProfileUserSettingsCodeEditorAppSettingsCustomImage>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#default_resource_spec: {
                        ...
                        <Option<Box<super::super::types::sagemaker::UserProfileUserSettingsCodeEditorAppSettingsDefaultResourceSpec>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
