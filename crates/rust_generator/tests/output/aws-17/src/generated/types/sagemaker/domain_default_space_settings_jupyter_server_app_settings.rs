...
pub struct DomainDefaultSpaceSettingsJupyterServerAppSettings {
    ...
    pub r#code_repositories: Option<Vec<super::super::types::sagemaker::DomainDefaultSpaceSettingsJupyterServerAppSettingsCodeRepository>>,
    /// The default instance type and the Amazon Resource Name (ARN) of the SageMaker image created on the instance. see `default_resource_spec` Block below.
    #[builder(into)]
    #[serde(rename = "defaultResourceSpec")]
    pub r#default_resource_spec: Option<Box<super::super::types::sagemaker::DomainDefaultSpaceSettingsJupyterServerAppSettingsDefaultResourceSpec>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DomainDefaultSpaceSettingsJupyterServerAppSettings {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DomainDefaultSpaceSettingsJupyterServerAppSettings {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#code_repositories: {
                        ...
                        <Option<Vec<super::super::types::sagemaker::DomainDefaultSpaceSettingsJupyterServerAppSettingsCodeRepository>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#default_resource_spec: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultSpaceSettingsJupyterServerAppSettingsDefaultResourceSpec>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
