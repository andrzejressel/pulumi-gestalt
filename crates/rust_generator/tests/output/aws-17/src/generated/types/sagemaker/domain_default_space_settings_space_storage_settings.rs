...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DomainDefaultSpaceSettingsSpaceStorageSettings {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DomainDefaultSpaceSettingsSpaceStorageSettings {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#default_ebs_storage_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultSpaceSettingsSpaceStorageSettingsDefaultEbsStorageSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
