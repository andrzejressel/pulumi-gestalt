...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BucketReplicationConfigurationRule {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("delete_marker_replication_status".to_string(), self.r#delete_marker_replication_status.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BucketReplicationConfigurationRule {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#destination: {
                        ...
                        <Box<super::super::types::s3::BucketReplicationConfigurationRuleDestination> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#filter: {
                        ...
                        <Option<Box<super::super::types::s3::BucketReplicationConfigurationRuleFilter>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#id: {
                    ...
                    r#source_selection_criteria: {
                        ...
                        <Option<Box<super::super::types::s3::BucketReplicationConfigurationRuleSourceSelectionCriteria>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#status: {
