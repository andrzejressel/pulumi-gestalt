...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevel {
    ...
    > {
        async move {
            ...
            map.insert("prefix_level".to_string(), self.r#prefix_level.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#activity_metrics: {
                        ...
                        <Option<Box<super::super::types::s3control::StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelActivityMetrics>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#advanced_cost_optimization_metrics: {
                        ...
                        <Option<Box<super::super::types::s3control::StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelAdvancedCostOptimizationMetrics>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#advanced_data_protection_metrics: {
                        ...
                        <Option<Box<super::super::types::s3control::StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelAdvancedDataProtectionMetrics>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#detailed_status_code_metrics: {
                        ...
                        <Option<Box<super::super::types::s3control::StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelDetailedStatusCodeMetrics>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#prefix_level: {
                        ...
                        <Option<Box<super::super::types::s3control::StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevel>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
