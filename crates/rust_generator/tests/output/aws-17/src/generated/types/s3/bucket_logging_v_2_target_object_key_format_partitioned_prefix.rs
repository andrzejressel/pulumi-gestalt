...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BucketLoggingV2TargetObjectKeyFormatPartitionedPrefix {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("partition_date_source".to_string(), self.r#partition_date_source.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BucketLoggingV2TargetObjectKeyFormatPartitionedPrefix {
