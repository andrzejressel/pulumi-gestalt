...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BucketV2ServerSideEncryptionConfigurationRule {
    ...
    > {
        async move {
            ...
            map.insert("apply_server_side_encryption_by_defaults".to_string(), self.r#apply_server_side_encryption_by_defaults.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#apply_server_side_encryption_by_defaults: {
                        ...
                        <Vec<super::super::types::s3::BucketV2ServerSideEncryptionConfigurationRuleApplyServerSideEncryptionByDefault> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
