...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BucketObjectLockConfigurationRule {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BucketObjectLockConfigurationRule {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#default_retention: {
                        ...
                        <Box<super::super::types::s3::BucketObjectLockConfigurationRuleDefaultRetention> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
