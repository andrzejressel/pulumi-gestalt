...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DataQualityJobDefinitionDataQualityBaselineConfig {
    ...
    > {
        async move {
            ...
            map.insert("constraints_resource".to_string(), self.r#constraints_resource.to_pulumi_value().await);
            map.insert("statistics_resource".to_string(), self.r#statistics_resource.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#constraints_resource: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DataQualityJobDefinitionDataQualityBaselineConfigConstraintsResource>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#statistics_resource: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DataQualityJobDefinitionDataQualityBaselineConfigStatisticsResource>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
