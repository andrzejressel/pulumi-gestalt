...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BucketV2ReplicationConfigurationRuleDestination {
    ...
    > {
        async move {
            ...
            map.insert("access_control_translations".to_string(), self.r#access_control_translations.to_pulumi_value().await);
            ...
            map.insert("replication_times".to_string(), self.r#replication_times.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#access_control_translations: {
                        ...
                        <Option<Vec<super::super::types::s3::BucketV2ReplicationConfigurationRuleDestinationAccessControlTranslation>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#account_id: {
                    ...
                    r#metrics: {
                        ...
                        <Option<Vec<super::super::types::s3::BucketV2ReplicationConfigurationRuleDestinationMetric>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    ...
                    r#replication_times: {
                        ...
                        <Option<Vec<super::super::types::s3::BucketV2ReplicationConfigurationRuleDestinationReplicationTime>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#storage_class: {
