...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetTrafficPolicyDocumentRule {
    ...
    > {
        async move {
            ...
            map.insert("geo_proximity_locations".to_string(), self.r#geo_proximity_locations.to_pulumi_value().await);
            map.insert("id".to_string(), self.r#id.to_pulumi_value().await);
            map.insert("items".to_string(), self.r#items.to_pulumi_value().await);
            map.insert("locations".to_string(), self.r#locations.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#geo_proximity_locations: {
                        ...
                        <Option<Vec<super::super::types::route53::GetTrafficPolicyDocumentRuleGeoProximityLocation>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#id: {
                    ...
                    r#items: {
                        ...
                        <Option<Vec<super::super::types::route53::GetTrafficPolicyDocumentRuleItem>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#locations: {
                        ...
                        <Option<Vec<super::super::types::route53::GetTrafficPolicyDocumentRuleLocation>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#primary: {
                        ...
                        <Option<Box<super::super::types::route53::GetTrafficPolicyDocumentRulePrimary>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#regions: {
                        ...
                        <Option<Vec<super::super::types::route53::GetTrafficPolicyDocumentRuleRegion>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#secondary: {
                        ...
                        <Option<Box<super::super::types::route53::GetTrafficPolicyDocumentRuleSecondary>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#type_: {
