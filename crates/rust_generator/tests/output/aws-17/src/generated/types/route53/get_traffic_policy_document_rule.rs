            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#geo_proximity_locations: {
                        let field_value = match fields_map.get("geoProximityLocations") {
                            Some(value) => value,
                            None => bail!("Missing field 'geoProximityLocations' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
