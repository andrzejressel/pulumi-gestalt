...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for UserProfileUserSettingsCustomFileSystemConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("efs_file_system_configs".to_string(), self.r#efs_file_system_configs.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for UserProfileUserSettingsCustomFileSystemConfig {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#efs_file_system_configs: {
                        ...
                        <Option<Vec<super::super::types::sagemaker::UserProfileUserSettingsCustomFileSystemConfigEfsFileSystemConfig>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
