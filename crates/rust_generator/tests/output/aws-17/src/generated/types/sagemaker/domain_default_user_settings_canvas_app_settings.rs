            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#direct_deploy_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsCanvasAppSettingsDirectDeploySettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#emr_serverless_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsCanvasAppSettingsEmrServerlessSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#generative_ai_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsCanvasAppSettingsGenerativeAiSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#identity_provider_oauth_settings: {
                        ...
                        <Option<Vec<super::super::types::sagemaker::DomainDefaultUserSettingsCanvasAppSettingsIdentityProviderOauthSetting>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#kendra_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsCanvasAppSettingsKendraSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#model_register_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsCanvasAppSettingsModelRegisterSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#time_series_forecasting_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsCanvasAppSettingsTimeSeriesForecastingSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#workspace_settings: {
                        ...
                        <Option<Box<super::super::types::sagemaker::DomainDefaultUserSettingsCanvasAppSettingsWorkspaceSettings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
