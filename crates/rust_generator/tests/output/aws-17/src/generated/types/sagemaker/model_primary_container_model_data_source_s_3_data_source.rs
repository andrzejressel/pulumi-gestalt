...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ModelPrimaryContainerModelDataSourceS3DataSource {
    ...
    > {
        async move {
            ...
            map.insert("compression_type".to_string(), self.r#compression_type.to_pulumi_value().await);
            map.insert("model_access_config".to_string(), self.r#model_access_config.to_pulumi_value().await);
            map.insert("s_3_data_type".to_string(), self.r#s_3_data_type.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#model_access_config: {
                        ...
                        <Option<Box<super::super::types::sagemaker::ModelPrimaryContainerModelDataSourceS3DataSourceModelAccessConfig>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#s_3_data_type: {
