...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for SpaceSpaceSettingsKernelGatewayAppSettings {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for SpaceSpaceSettingsKernelGatewayAppSettings {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#custom_images: {
                        ...
                        <Option<Vec<super::super::types::sagemaker::SpaceSpaceSettingsKernelGatewayAppSettingsCustomImage>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#default_resource_spec: {
                        ...
                        <Box<super::super::types::sagemaker::SpaceSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
