...
pub mod object_copy {
    ...
    fn __create(
        ...
        let copy_if_match_binding = args.copy_if_match.get_output(ctx);
        let copy_if_modified_since_binding = args.copy_if_modified_since.get_output(ctx);
        let copy_if_none_match_binding = args.copy_if_none_match.get_output(ctx);
        let copy_if_unmodified_since_binding = args
            .copy_if_unmodified_since
            .get_output(ctx);
        let customer_algorithm_binding = args.customer_algorithm.get_output(ctx);
        let customer_key_binding = args.customer_key.get_output(ctx);
        let customer_key_md5_binding = args.customer_key_md5.get_output(ctx);
        ...
        let expected_source_bucket_owner_binding = args
            ...
            .get_output(ctx);
        let expires_binding = args.expires.get_output(ctx);
        ...
        let kms_encryption_context_binding = args.kms_encryption_context.get_output(ctx);
        let kms_key_id_binding = args.kms_key_id.get_output(ctx);
        let metadata_binding = args.metadata.get_output(ctx);
        let metadata_directive_binding = args.metadata_directive.get_output(ctx);
        ...
        let source_customer_algorithm_binding = args
            ...
            .get_output(ctx);
        let source_customer_key_binding = args.source_customer_key.get_output(ctx);
        ...
        let tagging_directive_binding = args.tagging_directive.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &checksum_algorithm_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &copy_if_match_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "copyIfModifiedSince".into(),
                    value: &copy_if_modified_since_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "copyIfNoneMatch".into(),
                    value: &copy_if_none_match_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "copyIfUnmodifiedSince".into(),
                    value: &copy_if_unmodified_since_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "customerAlgorithm".into(),
                    value: &customer_algorithm_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "customerKey".into(),
                    value: &customer_key_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "customerKeyMd5".into(),
                    value: &customer_key_md5_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &expected_source_bucket_owner_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "expires".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &kms_encryption_context_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "kmsKeyId".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &metadata_directive_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &source_customer_algorithm_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "sourceCustomerKey".into(),
                    value: &source_customer_key_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "sourceCustomerKeyMd5".into(),
                    value: &source_customer_key_md5_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &tagging_directive_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "tags".into(),
