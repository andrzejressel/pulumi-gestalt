...
pub mod account_public_access_block {
    ...
    pub struct AccountPublicAccessBlockArgs {
        ...
        #[builder(into, default)]
        pub block_public_acls: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub ignore_public_acls: pulumi_gestalt_rust::Input<Option<bool>>,
        /// Whether Amazon S3 should restrict public bucket policies for buckets in this account. Defaults to `false`. Enabling this setting does not affect previously stored bucket policies, except that public and cross-account access within any public bucket policy, including non-public delegation to specific accounts, is blocked. When set to `true`:
        /// * Only the bucket owner and AWS Services can access buckets with public policies.
        #[builder(into, default)]
        pub restrict_public_buckets: pulumi_gestalt_rust::Input<Option<bool>>,
    }
    #[allow(dead_code)]
