...
pub mod pipeline {
    ...
    fn __create(
        ...
        let parallelism_configuration_binding = args
            ...
            .get_output(ctx);
        let pipeline_definition_binding = args.pipeline_definition.get_output(ctx);
        let pipeline_definition_s3_location_binding = args
            .pipeline_definition_s3_location
            .get_output(ctx);
        let pipeline_description_binding = args.pipeline_description.get_output(ctx);
        let pipeline_display_name_binding = args.pipeline_display_name.get_output(ctx);
