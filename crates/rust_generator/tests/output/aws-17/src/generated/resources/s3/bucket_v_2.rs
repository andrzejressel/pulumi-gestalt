...
pub mod bucket_v_2 {
    ...
    pub struct BucketV2Args {
        ...
        #[builder(into, default)]
        pub object_lock_enabled: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub replication_configurations: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub server_side_encryption_configurations: pulumi_gestalt_rust::Input<
            Option<
        ...
        #[builder(into, default)]
        pub versionings: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub websites: pulumi_gestalt_rust::Input<
    ...
    fn __create(
        ...
        let object_lock_configuration_binding = args
            ...
            .get_output(ctx);
        let object_lock_enabled_binding = args.object_lock_enabled.get_output(ctx);
        ...
        let versionings_binding = args.versionings.get_output(ctx);
        let websites_binding = args.websites.get_output(ctx);
