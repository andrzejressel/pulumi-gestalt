...
pub mod endpoint {
    ...
    fn __create(
        ...
        let deployment_config_binding = args.deployment_config.get_output(ctx);
        let endpoint_config_name_binding = args.endpoint_config_name.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &deployment_config_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "endpointConfigName".into(),
                    value: &endpoint_config_name_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
