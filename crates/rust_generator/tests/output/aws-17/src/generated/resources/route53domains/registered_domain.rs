...
pub mod registered_domain {
    ...
    fn __create(
        ...
        let admin_contact_binding = args.admin_contact.get_output(ctx);
        let admin_privacy_binding = args.admin_privacy.get_output(ctx);
        let auto_renew_binding = args.auto_renew.get_output(ctx);
        let billing_contact_binding = args.billing_contact.get_output(ctx);
        let billing_privacy_binding = args.billing_privacy.get_output(ctx);
        let domain_name_binding = args.domain_name.get_output(ctx);
        let name_servers_binding = args.name_servers.get_output(ctx);
        let registrant_contact_binding = args.registrant_contact.get_output(ctx);
        let registrant_privacy_binding = args.registrant_privacy.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let tech_contact_binding = args.tech_contact.get_output(ctx);
        let tech_privacy_binding = args.tech_privacy.get_output(ctx);
        let transfer_lock_binding = args.transfer_lock.get_output(ctx);
