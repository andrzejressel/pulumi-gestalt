...
pub mod resource_set {
    ...
    pub struct ResourceSetArgs {
        ...
        #[builder(into)]
        pub resource_set_type: pulumi_gestalt_rust::Input<String>,
    ...
    fn __create(
        ...
        let resource_set_name_binding = args.resource_set_name.get_output(ctx);
        let resource_set_type_binding = args.resource_set_type.get_output(ctx);
