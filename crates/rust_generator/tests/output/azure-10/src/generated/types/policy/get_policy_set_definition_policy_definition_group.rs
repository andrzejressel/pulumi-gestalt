...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetPolicySetDefinitionPolicyDefinitionGroup {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "additional_metadata_resource_id".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#additional_metadata_resource_id,
                )
                .await,
            );
            map.insert(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetPolicySetDefinitionPolicyDefinitionGroup {
