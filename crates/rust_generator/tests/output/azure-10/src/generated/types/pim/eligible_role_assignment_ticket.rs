...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EligibleRoleAssignmentTicket {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for EligibleRoleAssignmentTicket {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#system: {
                        let field_value = match fields_map.get("system") {
                            Some(value) => value,
                            None => bail!("Missing field 'system' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
