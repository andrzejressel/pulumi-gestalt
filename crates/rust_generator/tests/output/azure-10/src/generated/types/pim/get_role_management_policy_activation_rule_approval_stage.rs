...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetRoleManagementPolicyActivationRuleApprovalStage {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "primary_approvers".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#primary_approvers,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetRoleManagementPolicyActivationRuleApprovalStage {
