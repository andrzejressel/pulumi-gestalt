...
pub struct LocalRulestackRuleDestination {
    ...
    pub r#local_rulestack_fqdn_list_ids: Option<Vec<String>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for LocalRulestackRuleDestination {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "local_rulestack_fqdn_list_ids".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for LocalRulestackRuleDestination {
