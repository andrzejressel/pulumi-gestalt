...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EndpointPrivateDnsZoneGroup {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "private_dns_zone_ids".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#private_dns_zone_ids,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for EndpointPrivateDnsZoneGroup {
