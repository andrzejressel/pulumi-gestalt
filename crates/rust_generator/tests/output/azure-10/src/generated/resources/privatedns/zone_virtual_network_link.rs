...
pub mod zone_virtual_network_link {
    ...
    pub struct ZoneVirtualNetworkLinkArgs {
        ...
        #[builder(into, default)]
        pub registration_enabled: pulumi_gestalt_rust::Input<Option<bool>>,
    ...
    fn __create(
        ...
        let private_dns_zone_name_binding = args.private_dns_zone_name.get_output(ctx);
        let registration_enabled_binding = args.registration_enabled.get_output(ctx);
