...
pub mod local_rulestack {
    ...
    fn __create(
        ...
        let anti_spyware_profile_binding = args.anti_spyware_profile.get_output(ctx);
        let anti_virus_profile_binding = args.anti_virus_profile.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let dns_subscription_binding = args.dns_subscription.get_output(ctx);
        let file_blocking_profile_binding = args.file_blocking_profile.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let resource_group_name_binding = args.resource_group_name.get_output(ctx);
        let url_filtering_profile_binding = args.url_filtering_profile.get_output(ctx);
        let vulnerability_profile_binding = args.vulnerability_profile.get_output(ctx);
