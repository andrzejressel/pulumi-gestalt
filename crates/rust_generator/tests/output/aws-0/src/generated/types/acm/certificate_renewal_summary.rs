    ...
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#renewal_status: {
                        let field_value = match fields_map.get("renewalStatus") {
                            Some(value) => value,
                            None => bail!("Missing field 'renewalStatus' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#renewal_status_reason: {
                        let field_value = match fields_map.get("renewalStatusReason") {
                            Some(value) => value,
                            None => bail!("Missing field 'renewalStatusReason' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#updated_at: {
