...
pub struct RestApiEndpointConfiguration {
    ...
    pub r#vpc_endpoint_ids: Option<Vec<String>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RestApiEndpointConfiguration {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("vpc_endpoint_ids".to_string(), self.r#vpc_endpoint_ids.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RestApiEndpointConfiguration {
