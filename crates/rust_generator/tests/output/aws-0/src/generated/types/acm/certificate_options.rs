...
pub struct CertificateOptions {
    ...
    pub r#certificate_transparency_logging_preference: Option<String>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CertificateOptions {
    fn to_pulumi_value(
        &self,
        ...
        async move {
            ...
            let field_futures: Vec<ToPulumiObjectFieldFuture<'_>> = vec![
                to_pulumi_object_field(
                    ...
                    &self.r#certificate_transparency_logging_preference,
                ),
            ];
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CertificateOptions {
