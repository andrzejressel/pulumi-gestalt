...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetCertificateAuthorityRevocationConfigurationOcspConfiguration {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("ocsp_custom_cname".to_string(), self.r#ocsp_custom_cname.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetCertificateAuthorityRevocationConfigurationOcspConfiguration {
