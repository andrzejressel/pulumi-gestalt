...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TargetGroupTargetGroupHealth {
    ...
    > {
        async move {
            ...
            map.insert("dns_failover".to_string(), self.r#dns_failover.to_pulumi_value().await);
            map.insert("unhealthy_state_routing".to_string(), self.r#unhealthy_state_routing.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#dns_failover: {
                        ...
                        <Option<Box<super::super::types::alb::TargetGroupTargetGroupHealthDnsFailover>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#unhealthy_state_routing: {
                        ...
                        <Option<Box<super::super::types::alb::TargetGroupTargetGroupHealthUnhealthyStateRouting>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
