            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#authenticate_cognito: {
                        ...
                        <Option<Box<super::super::types::alb::ListenerDefaultActionAuthenticateCognito>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#authenticate_oidc: {
                        ...
                        <Option<Box<super::super::types::alb::ListenerDefaultActionAuthenticateOidc>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#fixed_response: {
                        ...
                        <Option<Box<super::super::types::alb::ListenerDefaultActionFixedResponse>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#forward: {
                        ...
                        <Option<Box<super::super::types::alb::ListenerDefaultActionForward>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#order: {
                    ...
                    r#redirect: {
                        ...
                        <Option<Box<super::super::types::alb::ListenerDefaultActionRedirect>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#target_group_arn: {
