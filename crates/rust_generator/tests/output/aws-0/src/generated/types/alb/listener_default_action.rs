...
pub struct ListenerDefaultAction {
    ...
    pub r#authenticate_cognito: Box<Option<super::super::types::alb::ListenerDefaultActionAuthenticateCognito>>,
    ...
    pub r#authenticate_oidc: Box<Option<super::super::types::alb::ListenerDefaultActionAuthenticateOidc>>,
    /// Information for creating an action that returns a custom HTTP response. Required if `type` is `fixed-response`.
    #[builder(into)]
    #[serde(rename = "fixedResponse")]
    pub r#fixed_response: Box<Option<super::super::types::alb::ListenerDefaultActionFixedResponse>>,
    ...
    pub r#forward: Box<Option<super::super::types::alb::ListenerDefaultActionForward>>,
    ...
    pub r#redirect: Box<Option<super::super::types::alb::ListenerDefaultActionRedirect>>,
