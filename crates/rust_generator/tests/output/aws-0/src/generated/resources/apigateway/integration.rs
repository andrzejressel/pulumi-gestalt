...
pub mod integration {
    ...
    pub struct IntegrationArgs {
        ...
        #[builder(into, default)]
        pub content_handling: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub integration_http_method: pulumi_gestalt_rust::Input<Option<String>>,
    ...
    fn __create(
        ...
        let cache_key_parameters_binding = args.cache_key_parameters.get_output(ctx);
        let cache_namespace_binding = args.cache_namespace.get_output(ctx);
        ...
        let content_handling_binding = args.content_handling.get_output(ctx);
