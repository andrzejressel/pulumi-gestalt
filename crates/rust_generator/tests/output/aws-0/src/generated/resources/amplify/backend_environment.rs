...
pub mod backend_environment {
    ...
    fn __create(
        ...
        let deployment_artifacts_binding = args.deployment_artifacts.get_output(ctx);
        let environment_name_binding = args.environment_name.get_output(ctx);
        let stack_name_binding = args.stack_name.get_output(ctx);
