...
pub mod certificate {
    ...
    fn __create(
        ...
        let api_passthrough_binding = args.api_passthrough.get_output(ctx);
        ...
        let certificate_signing_request_binding = args
            ...
            .get_output(ctx);
        let signing_algorithm_binding = args.signing_algorithm.get_output(ctx);
        let template_arn_binding = args.template_arn.get_output(ctx);
        let validity_binding = args.validity.get_output(ctx);
