...
pub mod rest_api {
    ...
    pub struct RestApiArgs {
        ...
        pub api_key_source: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub binary_media_types: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        ...
        #[builder(into, default)]
        pub minimum_compression_size: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub put_rest_api_mode: pulumi_gestalt_rust::Input<Option<String>>,
