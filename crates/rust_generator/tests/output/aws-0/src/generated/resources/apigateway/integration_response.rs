...
pub mod integration_response {
    ...
    pub struct IntegrationResponseArgs {
        ...
        #[builder(into, default)]
        pub selection_pattern: pulumi_gestalt_rust::Input<Option<String>>,
        /// HTTP status code.
        ///
    ...
    fn __create(
        ...
        let selection_pattern_binding = args.selection_pattern.get_output(ctx);
        let status_code_binding = args.status_code.get_output(ctx);
