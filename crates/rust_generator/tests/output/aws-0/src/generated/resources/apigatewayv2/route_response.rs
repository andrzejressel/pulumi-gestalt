...
pub mod route_response {
    ...
    fn __create(
        ...
        let model_selection_expression_binding = args
            ...
            .get_output(ctx);
        let response_models_binding = args.response_models.get_output(ctx);
        let route_id_binding = args.route_id.get_output(ctx);
        let route_response_key_binding = args.route_response_key.get_output(ctx);
