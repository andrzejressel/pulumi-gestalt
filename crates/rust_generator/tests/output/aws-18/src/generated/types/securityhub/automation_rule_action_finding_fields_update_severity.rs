...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AutomationRuleActionFindingFieldsUpdateSeverity {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("product".to_string(), self.r#product.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AutomationRuleActionFindingFieldsUpdateSeverity {
