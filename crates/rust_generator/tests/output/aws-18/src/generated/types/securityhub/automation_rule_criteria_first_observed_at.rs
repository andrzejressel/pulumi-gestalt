...
pub struct AutomationRuleCriteriaFirstObservedAt {
    /// A configuration block of the date range for the date filter. See date_range below for more details.
    #[builder(into)]
    #[serde(rename = "dateRange")]
    pub r#date_range: Option<Box<super::super::types::securityhub::AutomationRuleCriteriaFirstObservedAtDateRange>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AutomationRuleCriteriaFirstObservedAt {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AutomationRuleCriteriaFirstObservedAt {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#date_range: {
                        ...
                        <Option<Box<super::super::types::securityhub::AutomationRuleCriteriaFirstObservedAtDateRange>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#end: {
