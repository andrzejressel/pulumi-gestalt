    ...
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#organization_arn: {
                        let field_value = match fields_map.get("organizationArn") {
                            Some(value) => value,
                            None => bail!("Missing field 'organizationArn' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
