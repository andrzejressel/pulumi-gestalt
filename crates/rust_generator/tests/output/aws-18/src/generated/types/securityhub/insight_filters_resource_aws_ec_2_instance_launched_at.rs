...
pub struct InsightFiltersResourceAwsEc2InstanceLaunchedAt {
    /// A configuration block of the date range for the date filter. See date_range below for more details.
    #[builder(into)]
    #[serde(rename = "dateRange")]
    pub r#date_range: Option<Box<super::super::types::securityhub::InsightFiltersResourceAwsEc2InstanceLaunchedAtDateRange>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for InsightFiltersResourceAwsEc2InstanceLaunchedAt {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for InsightFiltersResourceAwsEc2InstanceLaunchedAt {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#date_range: {
                        ...
                        <Option<Box<super::super::types::securityhub::InsightFiltersResourceAwsEc2InstanceLaunchedAtDateRange>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#end: {
