...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for InsightFilters {
    ...
    > {
        async move {
            ...
            map.insert("aws_account_ids".to_string(), self.r#aws_account_ids.to_pulumi_value().await);
            map.insert("company_names".to_string(), self.r#company_names.to_pulumi_value().await);
            map.insert("compliance_statuses".to_string(), self.r#compliance_statuses.to_pulumi_value().await);
            map.insert("confidences".to_string(), self.r#confidences.to_pulumi_value().await);
            map.insert("created_ats".to_string(), self.r#created_ats.to_pulumi_value().await);
            map.insert("criticalities".to_string(), self.r#criticalities.to_pulumi_value().await);
            map.insert("descriptions".to_string(), self.r#descriptions.to_pulumi_value().await);
            map.insert("finding_provider_fields_confidences".to_string(), self.r#finding_provider_fields_confidences.to_pulumi_value().await);
            map.insert("finding_provider_fields_criticalities".to_string(), self.r#finding_provider_fields_criticalities.to_pulumi_value().await);
            map.insert("finding_provider_fields_related_findings_ids".to_string(), self.r#finding_provider_fields_related_findings_ids.to_pulumi_value().await);
            map.insert("finding_provider_fields_related_findings_product_arns".to_string(), self.r#finding_provider_fields_related_findings_product_arns.to_pulumi_value().await);
            map.insert("finding_provider_fields_severity_labels".to_string(), self.r#finding_provider_fields_severity_labels.to_pulumi_value().await);
            map.insert("finding_provider_fields_severity_originals".to_string(), self.r#finding_provider_fields_severity_originals.to_pulumi_value().await);
            map.insert("finding_provider_fields_types".to_string(), self.r#finding_provider_fields_types.to_pulumi_value().await);
            map.insert("first_observed_ats".to_string(), self.r#first_observed_ats.to_pulumi_value().await);
            map.insert("generator_ids".to_string(), self.r#generator_ids.to_pulumi_value().await);
            map.insert("ids".to_string(), self.r#ids.to_pulumi_value().await);
            map.insert("keywords".to_string(), self.r#keywords.to_pulumi_value().await);
            map.insert("last_observed_ats".to_string(), self.r#last_observed_ats.to_pulumi_value().await);
            map.insert("malware_names".to_string(), self.r#malware_names.to_pulumi_value().await);
            map.insert("malware_paths".to_string(), self.r#malware_paths.to_pulumi_value().await);
            map.insert("malware_states".to_string(), self.r#malware_states.to_pulumi_value().await);
            map.insert("malware_types".to_string(), self.r#malware_types.to_pulumi_value().await);
            map.insert("network_destination_domains".to_string(), self.r#network_destination_domains.to_pulumi_value().await);
            map.insert("network_destination_ipv_4_s".to_string(), self.r#network_destination_ipv_4_s.to_pulumi_value().await);
            map.insert("network_destination_ipv_6_s".to_string(), self.r#network_destination_ipv_6_s.to_pulumi_value().await);
            map.insert("network_destination_ports".to_string(), self.r#network_destination_ports.to_pulumi_value().await);
            map.insert("network_directions".to_string(), self.r#network_directions.to_pulumi_value().await);
            map.insert("network_protocols".to_string(), self.r#network_protocols.to_pulumi_value().await);
            map.insert("network_source_domains".to_string(), self.r#network_source_domains.to_pulumi_value().await);
            map.insert("network_source_ipv_4_s".to_string(), self.r#network_source_ipv_4_s.to_pulumi_value().await);
            map.insert("network_source_ipv_6_s".to_string(), self.r#network_source_ipv_6_s.to_pulumi_value().await);
            map.insert("network_source_macs".to_string(), self.r#network_source_macs.to_pulumi_value().await);
            map.insert("network_source_ports".to_string(), self.r#network_source_ports.to_pulumi_value().await);
            map.insert("note_texts".to_string(), self.r#note_texts.to_pulumi_value().await);
            map.insert("note_updated_ats".to_string(), self.r#note_updated_ats.to_pulumi_value().await);
            map.insert("note_updated_bies".to_string(), self.r#note_updated_bies.to_pulumi_value().await);
            map.insert("process_launched_ats".to_string(), self.r#process_launched_ats.to_pulumi_value().await);
            map.insert("process_names".to_string(), self.r#process_names.to_pulumi_value().await);
            map.insert("process_parent_pids".to_string(), self.r#process_parent_pids.to_pulumi_value().await);
            map.insert("process_paths".to_string(), self.r#process_paths.to_pulumi_value().await);
            map.insert("process_pids".to_string(), self.r#process_pids.to_pulumi_value().await);
            map.insert("process_terminated_ats".to_string(), self.r#process_terminated_ats.to_pulumi_value().await);
            map.insert("product_arns".to_string(), self.r#product_arns.to_pulumi_value().await);
            map.insert("product_fields".to_string(), self.r#product_fields.to_pulumi_value().await);
            map.insert("product_names".to_string(), self.r#product_names.to_pulumi_value().await);
            map.insert("recommendation_texts".to_string(), self.r#recommendation_texts.to_pulumi_value().await);
            map.insert("record_states".to_string(), self.r#record_states.to_pulumi_value().await);
            map.insert("related_findings_ids".to_string(), self.r#related_findings_ids.to_pulumi_value().await);
            map.insert("related_findings_product_arns".to_string(), self.r#related_findings_product_arns.to_pulumi_value().await);
            map.insert("resource_aws_ec_2_instance_iam_instance_profile_arns".to_string(), self.r#resource_aws_ec_2_instance_iam_instance_profile_arns.to_pulumi_value().await);
            map.insert("resource_aws_ec_2_instance_image_ids".to_string(), self.r#resource_aws_ec_2_instance_image_ids.to_pulumi_value().await);
            map.insert("resource_aws_ec_2_instance_ipv_4_addresses".to_string(), self.r#resource_aws_ec_2_instance_ipv_4_addresses.to_pulumi_value().await);
            map.insert("resource_aws_ec_2_instance_ipv_6_addresses".to_string(), self.r#resource_aws_ec_2_instance_ipv_6_addresses.to_pulumi_value().await);
            map.insert("resource_aws_ec_2_instance_key_names".to_string(), self.r#resource_aws_ec_2_instance_key_names.to_pulumi_value().await);
            map.insert("resource_aws_ec_2_instance_launched_ats".to_string(), self.r#resource_aws_ec_2_instance_launched_ats.to_pulumi_value().await);
            map.insert("resource_aws_ec_2_instance_subnet_ids".to_string(), self.r#resource_aws_ec_2_instance_subnet_ids.to_pulumi_value().await);
            map.insert("resource_aws_ec_2_instance_types".to_string(), self.r#resource_aws_ec_2_instance_types.to_pulumi_value().await);
            map.insert("resource_aws_ec_2_instance_vpc_ids".to_string(), self.r#resource_aws_ec_2_instance_vpc_ids.to_pulumi_value().await);
            map.insert("resource_aws_iam_access_key_created_ats".to_string(), self.r#resource_aws_iam_access_key_created_ats.to_pulumi_value().await);
            map.insert("resource_aws_iam_access_key_statuses".to_string(), self.r#resource_aws_iam_access_key_statuses.to_pulumi_value().await);
            map.insert("resource_aws_iam_access_key_user_names".to_string(), self.r#resource_aws_iam_access_key_user_names.to_pulumi_value().await);
            map.insert("resource_aws_s_3_bucket_owner_ids".to_string(), self.r#resource_aws_s_3_bucket_owner_ids.to_pulumi_value().await);
            map.insert("resource_aws_s_3_bucket_owner_names".to_string(), self.r#resource_aws_s_3_bucket_owner_names.to_pulumi_value().await);
            map.insert("resource_container_image_ids".to_string(), self.r#resource_container_image_ids.to_pulumi_value().await);
            map.insert("resource_container_image_names".to_string(), self.r#resource_container_image_names.to_pulumi_value().await);
            map.insert("resource_container_launched_ats".to_string(), self.r#resource_container_launched_ats.to_pulumi_value().await);
            map.insert("resource_container_names".to_string(), self.r#resource_container_names.to_pulumi_value().await);
            map.insert("resource_details_others".to_string(), self.r#resource_details_others.to_pulumi_value().await);
            map.insert("resource_ids".to_string(), self.r#resource_ids.to_pulumi_value().await);
            map.insert("resource_partitions".to_string(), self.r#resource_partitions.to_pulumi_value().await);
            map.insert("resource_regions".to_string(), self.r#resource_regions.to_pulumi_value().await);
            map.insert("resource_tags".to_string(), self.r#resource_tags.to_pulumi_value().await);
            map.insert("resource_types".to_string(), self.r#resource_types.to_pulumi_value().await);
            map.insert("severity_labels".to_string(), self.r#severity_labels.to_pulumi_value().await);
            map.insert("source_urls".to_string(), self.r#source_urls.to_pulumi_value().await);
            map.insert("threat_intel_indicator_categories".to_string(), self.r#threat_intel_indicator_categories.to_pulumi_value().await);
            map.insert("threat_intel_indicator_last_observed_ats".to_string(), self.r#threat_intel_indicator_last_observed_ats.to_pulumi_value().await);
            map.insert("threat_intel_indicator_source_urls".to_string(), self.r#threat_intel_indicator_source_urls.to_pulumi_value().await);
            map.insert("threat_intel_indicator_sources".to_string(), self.r#threat_intel_indicator_sources.to_pulumi_value().await);
            map.insert("threat_intel_indicator_types".to_string(), self.r#threat_intel_indicator_types.to_pulumi_value().await);
            map.insert("threat_intel_indicator_values".to_string(), self.r#threat_intel_indicator_values.to_pulumi_value().await);
            map.insert("titles".to_string(), self.r#titles.to_pulumi_value().await);
            map.insert("types".to_string(), self.r#types.to_pulumi_value().await);
            map.insert("updated_ats".to_string(), self.r#updated_ats.to_pulumi_value().await);
            map.insert("user_defined_values".to_string(), self.r#user_defined_values.to_pulumi_value().await);
            map.insert("verification_states".to_string(), self.r#verification_states.to_pulumi_value().await);
            map.insert("workflow_statuses".to_string(), self.r#workflow_statuses.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#aws_account_ids: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersAwsAccountId>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#company_names: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersCompanyName>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#compliance_statuses: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersComplianceStatus>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#confidences: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersConfidence>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#created_ats: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersCreatedAt>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#criticalities: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersCriticality>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#descriptions: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersDescription>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#finding_provider_fields_confidences: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersFindingProviderFieldsConfidence>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#finding_provider_fields_criticalities: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersFindingProviderFieldsCriticality>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#finding_provider_fields_related_findings_ids: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersFindingProviderFieldsRelatedFindingsId>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#finding_provider_fields_related_findings_product_arns: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersFindingProviderFieldsRelatedFindingsProductArn>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#finding_provider_fields_severity_labels: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersFindingProviderFieldsSeverityLabel>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#finding_provider_fields_severity_originals: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersFindingProviderFieldsSeverityOriginal>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#finding_provider_fields_types: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersFindingProviderFieldsType>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#first_observed_ats: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersFirstObservedAt>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#generator_ids: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersGeneratorId>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#ids: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersId>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#keywords: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersKeyword>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#last_observed_ats: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersLastObservedAt>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#malware_names: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersMalwareName>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#malware_paths: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersMalwarePath>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#malware_states: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersMalwareState>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#malware_types: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersMalwareType>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#network_destination_domains: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersNetworkDestinationDomain>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#network_destination_ipv_4_s: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersNetworkDestinationIpv4>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#network_destination_ipv_6_s: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersNetworkDestinationIpv6>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#network_destination_ports: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersNetworkDestinationPort>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#network_directions: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersNetworkDirection>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#network_protocols: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersNetworkProtocol>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#network_source_domains: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersNetworkSourceDomain>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#network_source_ipv_4_s: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersNetworkSourceIpv4>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#network_source_ipv_6_s: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersNetworkSourceIpv6>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#network_source_macs: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersNetworkSourceMac>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#network_source_ports: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersNetworkSourcePort>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#note_texts: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersNoteText>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#note_updated_ats: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersNoteUpdatedAt>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#note_updated_bies: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersNoteUpdatedBy>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#process_launched_ats: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersProcessLaunchedAt>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#process_names: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersProcessName>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#process_parent_pids: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersProcessParentPid>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#process_paths: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersProcessPath>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#process_pids: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersProcessPid>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#process_terminated_ats: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersProcessTerminatedAt>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#product_arns: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersProductArn>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#product_fields: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersProductField>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#product_names: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersProductName>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#recommendation_texts: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersRecommendationText>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#record_states: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersRecordState>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#related_findings_ids: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersRelatedFindingsId>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#related_findings_product_arns: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersRelatedFindingsProductArn>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_aws_ec_2_instance_iam_instance_profile_arns: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceAwsEc2InstanceIamInstanceProfileArn>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_aws_ec_2_instance_image_ids: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceAwsEc2InstanceImageId>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_aws_ec_2_instance_ipv_4_addresses: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceAwsEc2InstanceIpv4Address>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_aws_ec_2_instance_ipv_6_addresses: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceAwsEc2InstanceIpv6Address>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_aws_ec_2_instance_key_names: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceAwsEc2InstanceKeyName>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_aws_ec_2_instance_launched_ats: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceAwsEc2InstanceLaunchedAt>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_aws_ec_2_instance_subnet_ids: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceAwsEc2InstanceSubnetId>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_aws_ec_2_instance_types: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceAwsEc2InstanceType>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_aws_ec_2_instance_vpc_ids: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceAwsEc2InstanceVpcId>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_aws_iam_access_key_created_ats: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceAwsIamAccessKeyCreatedAt>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_aws_iam_access_key_statuses: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceAwsIamAccessKeyStatus>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_aws_iam_access_key_user_names: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceAwsIamAccessKeyUserName>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_aws_s_3_bucket_owner_ids: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceAwsS3BucketOwnerId>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_aws_s_3_bucket_owner_names: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceAwsS3BucketOwnerName>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_container_image_ids: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceContainerImageId>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_container_image_names: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceContainerImageName>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_container_launched_ats: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceContainerLaunchedAt>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_container_names: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceContainerName>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_details_others: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceDetailsOther>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_ids: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceId>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_partitions: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourcePartition>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_regions: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceRegion>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_tags: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceTag>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#resource_types: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersResourceType>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#severity_labels: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersSeverityLabel>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#source_urls: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersSourceUrl>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#threat_intel_indicator_categories: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersThreatIntelIndicatorCategory>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#threat_intel_indicator_last_observed_ats: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersThreatIntelIndicatorLastObservedAt>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#threat_intel_indicator_source_urls: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersThreatIntelIndicatorSourceUrl>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#threat_intel_indicator_sources: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersThreatIntelIndicatorSource>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#threat_intel_indicator_types: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersThreatIntelIndicatorType>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#threat_intel_indicator_values: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersThreatIntelIndicatorValue>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#titles: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersTitle>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#types: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersType>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#updated_ats: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersUpdatedAt>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#user_defined_values: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersUserDefinedValue>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#verification_states: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersVerificationState>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#workflow_statuses: {
                        ...
                        <Option<Vec<super::super::types::securityhub::InsightFiltersWorkflowStatus>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
