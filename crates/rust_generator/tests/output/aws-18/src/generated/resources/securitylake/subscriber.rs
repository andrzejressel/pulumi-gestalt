...
pub mod subscriber {
    ...
    fn __create(
        ...
        let subscriber_description_binding = args.subscriber_description.get_output(ctx);
        let subscriber_identity_binding = args.subscriber_identity.get_output(ctx);
        let subscriber_name_binding = args.subscriber_name.get_output(ctx);
