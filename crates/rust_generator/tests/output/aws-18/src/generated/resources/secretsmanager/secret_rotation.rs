...
pub mod secret_rotation {
    ...
    pub struct SecretRotationArgs {
        ...
        pub rotate_immediately: pulumi_gestalt_rust::Input<Option<bool>>,
        /// Specifies the ARN of the Lambda function that can rotate the secret. Must be supplied if the secret is not managed by AWS.
        #[builder(into, default)]
        pub rotation_lambda_arn: pulumi_gestalt_rust::Input<Option<String>>,
        /// A structure that defines the rotation configuration for this secret. Defined below.
        #[builder(into)]
        pub rotation_rules: pulumi_gestalt_rust::Input<
    ...
    fn __create(
        ...
        let rotate_immediately_binding = args.rotate_immediately.get_output(ctx);
        let rotation_lambda_arn_binding = args.rotation_lambda_arn.get_output(ctx);
        let rotation_rules_binding = args.rotation_rules.get_output(ctx);
