...
pub mod standards_control {
    ...
    pub struct StandardsControlArgs {
        ...
        #[builder(into)]
        pub control_status: pulumi_gestalt_rust::Input<String>,
        ...
        pub disabled_reason: pulumi_gestalt_rust::Input<Option<String>>,
        /// The standards control ARN. See the AWS documentation for how to list existing controls using [`get-enabled-standards`](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/get-enabled-standards.html) and [`describe-standards-controls`](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/describe-standards-controls.html).
        #[builder(into)]
        pub standards_control_arn: pulumi_gestalt_rust::Input<String>,
    }
    #[allow(dead_code)]
    ...
    fn __create(
        ...
        let control_status_binding = args.control_status.get_output(ctx);
        let disabled_reason_binding = args.disabled_reason.get_output(ctx);
        let standards_control_arn_binding = args.standards_control_arn.get_output(ctx);
