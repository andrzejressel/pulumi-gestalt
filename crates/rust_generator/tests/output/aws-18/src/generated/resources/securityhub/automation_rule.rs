...
pub mod automation_rule {
    ...
    fn __create(
        ...
        let criteria_binding = args.criteria.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let is_terminal_binding = args.is_terminal.get_output(ctx);
        let rule_name_binding = args.rule_name.get_output(ctx);
        let rule_order_binding = args.rule_order.get_output(ctx);
        let rule_status_binding = args.rule_status.get_output(ctx);
