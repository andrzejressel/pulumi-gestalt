...
pub mod remediation_configuration {
    ...
    fn __create(
        ...
        let automatic_binding = args.automatic.get_output(ctx);
        let config_rule_name_binding = args.config_rule_name.get_output(ctx);
        let execution_controls_binding = args.execution_controls.get_output(ctx);
        ...
        let retry_attempt_seconds_binding = args.retry_attempt_seconds.get_output(ctx);
