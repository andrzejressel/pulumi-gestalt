...
pub mod stack_set_instance {
    ...
    pub struct StackSetInstanceArgs {
        ...
        #[builder(into, default)]
        pub retain_stack: pulumi_gestalt_rust::Input<Option<bool>>,
    ...
    fn __create(
        ...
        let deployment_targets_binding = args.deployment_targets.get_output(ctx);
        let operation_preferences_binding = args.operation_preferences.get_output(ctx);
        let parameter_overrides_binding = args.parameter_overrides.get_output(ctx);
        let region_binding = args.region.get_output(ctx);
        let retain_stack_binding = args.retain_stack.get_output(ctx);
        ...
        StackSetInstanceResult {
            ...
            organizational_unit_id: o.get_field("organizationalUnitId"),
            parameter_overrides: o.get_field("parameterOverrides"),
            region: o.get_field("region"),
            retain_stack: o.get_field("retainStack"),
