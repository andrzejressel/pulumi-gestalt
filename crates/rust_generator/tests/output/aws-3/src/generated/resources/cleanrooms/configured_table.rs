...
pub mod configured_table {
    ...
    fn __create(
        ...
        let allowed_columns_binding = args.allowed_columns.get_output(ctx);
        let analysis_method_binding = args.analysis_method.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let table_reference_binding = args.table_reference.get_output(ctx);
