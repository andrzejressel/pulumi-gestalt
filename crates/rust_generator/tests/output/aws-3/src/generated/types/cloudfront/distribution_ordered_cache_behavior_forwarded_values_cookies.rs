...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DistributionOrderedCacheBehaviorForwardedValuesCookies {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DistributionOrderedCacheBehaviorForwardedValuesCookies {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#whitelisted_names: {
                        let field_value = match fields_map.get("whitelistedNames") {
                            Some(value) => value,
                            None => bail!("Missing field 'whitelistedNames' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
