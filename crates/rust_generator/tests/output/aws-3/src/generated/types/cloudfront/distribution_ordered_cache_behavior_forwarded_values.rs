...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DistributionOrderedCacheBehaviorForwardedValues {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("query_string_cache_keys".to_string(), self.r#query_string_cache_keys.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DistributionOrderedCacheBehaviorForwardedValues {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#cookies: {
                        ...
                        <Box<super::super::types::cloudfront::DistributionOrderedCacheBehaviorForwardedValuesCookies> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#headers: {
