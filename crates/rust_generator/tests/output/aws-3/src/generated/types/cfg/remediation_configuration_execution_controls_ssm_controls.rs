...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RemediationConfigurationExecutionControlsSsmControls {
    ...
    > {
        async move {
            ...
            map.insert("concurrent_execution_rate_percentage".to_string(), self.r#concurrent_execution_rate_percentage.to_pulumi_value().await);
            map.insert("error_percentage".to_string(), self.r#error_percentage.to_pulumi_value().await);
