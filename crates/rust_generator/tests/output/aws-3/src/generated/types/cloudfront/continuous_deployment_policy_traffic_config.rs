...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ContinuousDeploymentPolicyTrafficConfig {
    ...
    > {
        async move {
            ...
            map.insert("single_header_config".to_string(), self.r#single_header_config.to_pulumi_value().await);
            map.insert("single_weight_config".to_string(), self.r#single_weight_config.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#single_header_config: {
                        ...
                        <Option<Box<super::super::types::cloudfront::ContinuousDeploymentPolicyTrafficConfigSingleHeaderConfig>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#single_weight_config: {
                        ...
                        <Option<Box<super::super::types::cloudfront::ContinuousDeploymentPolicyTrafficConfigSingleWeightConfig>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#type_: {
