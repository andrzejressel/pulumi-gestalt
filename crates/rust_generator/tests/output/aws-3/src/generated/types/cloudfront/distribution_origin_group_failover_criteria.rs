...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DistributionOriginGroupFailoverCriteria {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("status_codes".to_string(), self.r#status_codes.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DistributionOriginGroupFailoverCriteria {
