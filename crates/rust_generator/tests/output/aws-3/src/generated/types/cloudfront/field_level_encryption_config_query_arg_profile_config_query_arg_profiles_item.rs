...
pub struct FieldLevelEncryptionConfigQueryArgProfileConfigQueryArgProfilesItem {
    ...
    pub r#profile_id: String,
    /// Query argument for field-level encryption query argument-profile mapping.
    #[builder(into)]
    #[serde(rename = "queryArg")]
    pub r#query_arg: String,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FieldLevelEncryptionConfigQueryArgProfileConfigQueryArgProfilesItem {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FieldLevelEncryptionConfigQueryArgProfileConfigQueryArgProfilesItem {
