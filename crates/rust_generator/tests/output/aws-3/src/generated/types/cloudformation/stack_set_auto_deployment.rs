...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for StackSetAutoDeployment {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("retain_stacks_on_account_removal".to_string(), self.r#retain_stacks_on_account_removal.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for StackSetAutoDeployment {
