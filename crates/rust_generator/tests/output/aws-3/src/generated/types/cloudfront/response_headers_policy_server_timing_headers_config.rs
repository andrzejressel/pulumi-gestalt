...
pub struct ResponseHeadersPolicyServerTimingHeadersConfig {
    ...
    pub r#sampling_rate: f64,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ResponseHeadersPolicyServerTimingHeadersConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("sampling_rate".to_string(), self.r#sampling_rate.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ResponseHeadersPolicyServerTimingHeadersConfig {
