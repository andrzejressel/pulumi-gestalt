...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CloudFormationTypeLoggingConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("log_role_arn".to_string(), self.r#log_role_arn.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CloudFormationTypeLoggingConfig {
