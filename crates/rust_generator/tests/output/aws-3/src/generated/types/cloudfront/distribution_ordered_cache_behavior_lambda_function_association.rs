...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DistributionOrderedCacheBehaviorLambdaFunctionAssociation {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("event_type".to_string(), self.r#event_type.to_pulumi_value().await);
            map.insert("include_body".to_string(), self.r#include_body.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DistributionOrderedCacheBehaviorLambdaFunctionAssociation {
