...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for OriginRequestPolicyHeadersConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for OriginRequestPolicyHeadersConfig {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#headers: {
                        ...
                        <Option<Box<super::super::types::cloudfront::OriginRequestPolicyHeadersConfigHeaders>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
