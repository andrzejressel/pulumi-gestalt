...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BudgetActionDefinitionSsmActionDefinition {
    ...
    > {
        async move {
            ...
            map.insert("action_sub_type".to_string(), self.r#action_sub_type.to_pulumi_value().await);
            map.insert("instance_ids".to_string(), self.r#instance_ids.to_pulumi_value().await);
