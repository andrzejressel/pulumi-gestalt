...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for MediaInsightsPipelineConfigurationElementVoiceAnalyticsProcessorConfiguration {
    ...
    > {
        async move {
            ...
            map.insert("speaker_search_status".to_string(), self.r#speaker_search_status.to_pulumi_value().await);
            map.insert("voice_tone_analysis_status".to_string(), self.r#voice_tone_analysis_status.to_pulumi_value().await);
