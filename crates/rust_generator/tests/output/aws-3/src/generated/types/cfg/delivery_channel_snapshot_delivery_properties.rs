            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#delivery_frequency: {
                        let field_value = match fields_map.get("deliveryFrequency") {
                            Some(value) => value,
                            None => bail!("Missing field 'deliveryFrequency' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
