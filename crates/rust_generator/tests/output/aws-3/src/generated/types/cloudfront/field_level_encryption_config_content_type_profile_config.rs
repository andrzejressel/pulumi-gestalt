...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FieldLevelEncryptionConfigContentTypeProfileConfig {
    ...
    > {
        async move {
            ...
            map.insert("content_type_profiles".to_string(), self.r#content_type_profiles.to_pulumi_value().await);
            map.insert("forward_when_content_type_is_unknown".to_string(), self.r#forward_when_content_type_is_unknown.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#content_type_profiles: {
                        ...
                        <Box<super::super::types::cloudfront::FieldLevelEncryptionConfigContentTypeProfileConfigContentTypeProfiles> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
