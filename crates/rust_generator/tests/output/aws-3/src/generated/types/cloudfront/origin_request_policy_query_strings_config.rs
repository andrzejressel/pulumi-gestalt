...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for OriginRequestPolicyQueryStringsConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for OriginRequestPolicyQueryStringsConfig {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#query_strings: {
                        ...
                        <Option<Box<super::super::types::cloudfront::OriginRequestPolicyQueryStringsConfigQueryStrings>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
