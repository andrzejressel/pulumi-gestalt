...
pub mod cluster {
    ...
    fn __create(
        ...
        let allowed_fqdns_binding = args.allowed_fqdns.get_output(ctx);
        let allowed_ip_ranges_binding = args.allowed_ip_ranges.get_output(ctx);
        let auto_stop_enabled_binding = args.auto_stop_enabled.get_output(ctx);
        ...
        let language_extensions_binding = args.language_extensions.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let optimized_auto_scale_binding = args.optimized_auto_scale.get_output(ctx);
        let outbound_network_access_restricted_binding = args
            .outbound_network_access_restricted
            .get_output(ctx);
        let public_ip_type_binding = args.public_ip_type.get_output(ctx);
        let public_network_access_enabled_binding = args
            .public_network_access_enabled
            .get_output(ctx);
        let purge_enabled_binding = args.purge_enabled.get_output(ctx);
