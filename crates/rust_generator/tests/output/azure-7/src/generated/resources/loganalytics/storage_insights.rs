...
pub mod storage_insights {
    ...
    fn __create(
        ...
        let blob_container_names_binding = args.blob_container_names.get_output(ctx);
        ...
        let table_names_binding = args.table_names.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &blob_container_names_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
