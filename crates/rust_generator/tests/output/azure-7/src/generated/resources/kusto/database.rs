...
pub mod database {
    ...
    pub struct DatabaseArgs {
        ...
        pub hot_cache_period: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub soft_delete_period: pulumi_gestalt_rust::Input<Option<String>>,
    }
    #[allow(dead_code)]
    ...
    fn __create(
        ...
        let hot_cache_period_binding = args.hot_cache_period.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let resource_group_name_binding = args.resource_group_name.get_output(ctx);
        let soft_delete_period_binding = args.soft_delete_period.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &hot_cache_period_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "location".into(),
