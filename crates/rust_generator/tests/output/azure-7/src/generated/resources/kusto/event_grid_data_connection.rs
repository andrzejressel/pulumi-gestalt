...
pub mod event_grid_data_connection {
    ...
    fn __create(
        ...
        let eventgrid_resource_id_binding = args.eventgrid_resource_id.get_output(ctx);
        let eventhub_consumer_group_name_binding = args
            .eventhub_consumer_group_name
            .get_output(ctx);
        let eventhub_id_binding = args.eventhub_id.get_output(ctx);
        ...
        let skip_first_record_binding = args.skip_first_record.get_output(ctx);
