...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ConfigurationInstallPatchesWindow {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "kb_numbers_to_excludes".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "kb_numbers_to_includes".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ConfigurationInstallPatchesWindow {
