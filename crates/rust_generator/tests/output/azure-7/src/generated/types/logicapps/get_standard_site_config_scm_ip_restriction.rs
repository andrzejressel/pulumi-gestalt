...
pub struct GetStandardSiteConfigScmIpRestriction {
    ...
    #[builder(into)]
    pub r#headers: Box<super::super::types::logicapps::GetStandardSiteConfigScmIpRestrictionHeaders>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetStandardSiteConfigScmIpRestriction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetStandardSiteConfigScmIpRestriction {
