...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for IntegrationAccountBatchConfigurationReleaseCriteria {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for IntegrationAccountBatchConfigurationReleaseCriteria {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#message_count: {
                        let field_value = match fields_map.get("message_count") {
                            Some(value) => value,
                            None => bail!("Missing field 'message_count' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#recurrence: {
