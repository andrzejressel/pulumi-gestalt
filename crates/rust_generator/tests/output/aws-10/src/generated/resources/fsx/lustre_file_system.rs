...
pub mod lustre_file_system {
    ...
    pub struct LustreFileSystemArgs {
        ...
        pub auto_import_policy: pulumi_gestalt_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub drive_cache_type: pulumi_gestalt_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub efa_enabled: pulumi_gestalt_rust::InputOrOutput<Option<bool>>,
        /// S3 URI (with optional prefix) where the root of your Amazon FSx file system is exported. Can only be specified with `import_path` argument and the path must use the same Amazon S3 bucket as specified in `import_path`. Set equal to `import_path` to overwrite files on export. Defaults to `s3://{IMPORT BUCKET}/FSxLustre{CREATION TIMESTAMP}`. Only supported on `PERSISTENT_1` deployment types.
        #[builder(into, default)]
        pub export_path: pulumi_gestalt_rust::InputOrOutput<Option<String>>,
        /// Sets the Lustre version for the file system that you're creating. Valid values are 2.10 for `SCRATCH_1`, `SCRATCH_2` and `PERSISTENT_1` deployment types. Valid values for 2.12 include all deployment types.
        #[builder(into, default)]
        pub file_system_type_version: pulumi_gestalt_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub import_path: pulumi_gestalt_rust::InputOrOutput<Option<String>>,
        ...
        #[builder(into, default)]
        pub metadata_configuration: pulumi_gestalt_rust::InputOrOutput<
        ...
        #[builder(into, default)]
        pub per_unit_storage_throughput: pulumi_gestalt_rust::InputOrOutput<Option<i32>>,
        ...
        #[builder(into, default)]
        pub root_squash_configuration: pulumi_gestalt_rust::InputOrOutput<
        ...
        #[builder(into)]
        pub subnet_ids: pulumi_gestalt_rust::InputOrOutput<String>,
    ...
    pub struct LustreFileSystemResult {
        ...
        /// How Amazon FSx keeps your file and directory listings up to date as you add or modify objects in your linked S3 bucket. see [Auto Import Data Repo](https://docs.aws.amazon.com/fsx/latest/LustreGuide/autoimport-data-repo.html) for more details. Only supported on `PERSISTENT_1` deployment types.
        pub auto_import_policy: pulumi_gestalt_rust::Output<String>,
        /// The number of days to retain automatic backups. Setting this to 0 disables automatic backups. You can retain automatic backups for a maximum of 90 days. only valid for `PERSISTENT_1` and `PERSISTENT_2` deployment_type.
        ...
        /// The type of drive cache used by `PERSISTENT_1` filesystems that are provisioned with `HDD` storage_type. Required for `HDD` storage_type, set to either `READ` or `NONE`.
        pub drive_cache_type: pulumi_gestalt_rust::Output<Option<String>>,
        /// Adds support for Elastic Fabric Adapter (EFA) and GPUDirect Storage (GDS) to Lustre. This must be set at creation. If set this cannot be changed and this prevents changes to `per_unit_storage_throughput`. This is only supported when deployment_type is set to `PERSISTENT_2`, `metadata_configuration` is used, and an EFA-enabled security group is attached.
        pub efa_enabled: pulumi_gestalt_rust::Output<bool>,
        /// S3 URI (with optional prefix) where the root of your Amazon FSx file system is exported. Can only be specified with `import_path` argument and the path must use the same Amazon S3 bucket as specified in `import_path`. Set equal to `import_path` to overwrite files on export. Defaults to `s3://{IMPORT BUCKET}/FSxLustre{CREATION TIMESTAMP}`. Only supported on `PERSISTENT_1` deployment types.
        pub export_path: pulumi_gestalt_rust::Output<String>,
        /// Sets the Lustre version for the file system that you're creating. Valid values are 2.10 for `SCRATCH_1`, `SCRATCH_2` and `PERSISTENT_1` deployment types. Valid values for 2.12 include all deployment types.
        pub file_system_type_version: pulumi_gestalt_rust::Output<String>,
        /// A map of tags to apply to the file system's final backup.
        ///
        /// **Note:** If the filesystem uses a Scratch deployment type, final backup during delete will always be skipped and this argument will not be used even when set.
        ...
        >,
        /// S3 URI (with optional prefix) that you're using as the data repository for your FSx for Lustre file system. For example, `s3://example-bucket/optional-prefix/`. Only supported on `PERSISTENT_1` deployment types.
        pub import_path: pulumi_gestalt_rust::Output<Option<String>>,
        /// For files imported from a data repository, this value determines the stripe count and maximum amount of data per file (in MiB) stored on a single physical disk. Can only be specified with `import_path` argument. Defaults to `1024`. Minimum of `1` and maximum of `512000`. Only supported on `PERSISTENT_1` deployment types.
        ...
        >,
        /// The Lustre metadata configuration used when creating an Amazon FSx for Lustre file system. This can be used to specify a user provisioned metadata scale. This is only supported when `deployment_type` is set to `PERSISTENT_2`. See `metadata_configuration` Block for details.
        pub metadata_configuration: pulumi_gestalt_rust::Output<
            super::super::types::fsx::LustreFileSystemMetadataConfiguration,
        >,
        /// The value to be used when mounting the filesystem.
        pub mount_name: pulumi_gestalt_rust::Output<String>,
        ...
        /// Describes the amount of read and write throughput for each 1 tebibyte of storage, in MB/s/TiB, required for the `PERSISTENT_1` and `PERSISTENT_2` deployment_type. Valid values for `PERSISTENT_1` deployment_type and `SSD` storage_type are 50, 100, 200. Valid values for `PERSISTENT_1` deployment_type and `HDD` storage_type are 12, 40. Valid values for `PERSISTENT_2` deployment_type and ` SSD` storage_type are 125, 250, 500, 1000.
        pub per_unit_storage_throughput: pulumi_gestalt_rust::Output<Option<i32>>,
        /// The Lustre root squash configuration used when creating an Amazon FSx for Lustre file system. When enabled, root squash restricts root-level access from clients that try to access your file system as a root user. See `root_squash_configuration` Block for details.
        pub root_squash_configuration: pulumi_gestalt_rust::Output<
            Option<super::super::types::fsx::LustreFileSystemRootSquashConfiguration>,
        >,
        /// A list of IDs for the security groups that apply to the specified network interfaces created for file system access. These security groups will apply to all network interfaces.
        ...
        ///
        /// The following arguments are optional:
        pub subnet_ids: pulumi_gestalt_rust::Output<String>,
        /// A map of tags to assign to the file system. .If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
    ...
    fn __create(
        ...
        let auto_import_policy_binding = args.auto_import_policy.get_output(ctx);
        ...
        let drive_cache_type_binding = args.drive_cache_type.get_output(ctx);
        let efa_enabled_binding = args.efa_enabled.get_output(ctx);
        let export_path_binding = args.export_path.get_output(ctx);
        let file_system_type_version_binding = args
            .file_system_type_version
            .get_output(ctx);
        let final_backup_tags_binding = args.final_backup_tags.get_output(ctx);
        let import_path_binding = args.import_path.get_output(ctx);
        ...
        let metadata_configuration_binding = args.metadata_configuration.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &auto_import_policy_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &drive_cache_type_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "efaEnabled".into(),
                    value: &efa_enabled_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "exportPath".into(),
                    value: &export_path_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "fileSystemTypeVersion".into(),
                    value: &file_system_type_version_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &import_path_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "importedFileChunkSize".into(),
                    value: &imported_file_chunk_size_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "kmsKeyId".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &log_configuration_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "metadataConfiguration".into(),
                    value: &metadata_configuration_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "perUnitStorageThroughput".into(),
                    value: &per_unit_storage_throughput_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "rootSquashConfiguration".into(),
                    value: &root_squash_configuration_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
        ...
        LustreFileSystemResult {
            ...
            drive_cache_type: o.get_field("driveCacheType"),
            efa_enabled: o.get_field("efaEnabled"),
            export_path: o.get_field("exportPath"),
            file_system_type_version: o.get_field("fileSystemTypeVersion"),
            final_backup_tags: o.get_field("finalBackupTags"),
            import_path: o.get_field("importPath"),
            imported_file_chunk_size: o.get_field("importedFileChunkSize"),
            kms_key_id: o.get_field("kmsKeyId"),
            log_configuration: o.get_field("logConfiguration"),
            metadata_configuration: o.get_field("metadataConfiguration"),
            mount_name: o.get_field("mountName"),
            network_interface_ids: o.get_field("networkInterfaceIds"),
            owner_id: o.get_field("ownerId"),
            per_unit_storage_throughput: o.get_field("perUnitStorageThroughput"),
            root_squash_configuration: o.get_field("rootSquashConfiguration"),
