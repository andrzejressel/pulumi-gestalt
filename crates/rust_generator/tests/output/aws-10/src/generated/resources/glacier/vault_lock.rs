...
pub mod vault_lock {
    ...
    pub struct VaultLockArgs {
        ...
        #[builder(into)]
        pub complete_lock: pulumi_gestalt_rust::Input<bool>,
        /// Allow this provider to ignore the error returned when attempting to delete the Glacier Lock Policy. This can be used to delete or recreate the Glacier Vault via this provider, for example, if the Glacier Vault Lock policy permits that action. This should only be used in conjunction with `complete_lock` being set to `true`.
        #[builder(into, default)]
        pub ignore_deletion_error: pulumi_gestalt_rust::Input<Option<bool>>,
    ...
    fn __create(
        ...
        let complete_lock_binding = args.complete_lock.get_output(ctx);
        let ignore_deletion_error_binding = args.ignore_deletion_error.get_output(ctx);
