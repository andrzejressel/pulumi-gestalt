...
pub mod data_repository_association {
    ...
    pub struct DataRepositoryAssociationArgs {
        ...
        #[builder(into, default)]
        pub delete_data_in_filesystem: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into)]
        pub file_system_path: pulumi_gestalt_rust::Input<String>,
    ...
    fn __create(
        ...
        let batch_import_meta_data_on_create_binding = args
            ...
            .get_output(ctx);
        let data_repository_path_binding = args.data_repository_path.get_output(ctx);
        ...
        let file_system_path_binding = args.file_system_path.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &batch_import_meta_data_on_create_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "dataRepositoryPath".into(),
                    value: &data_repository_path_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "deleteDataInFilesystem".into(),
                    value: &delete_data_in_filesystem_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &file_system_path_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
