...
pub mod user_defined_function {
    ...
    fn __create(
        ...
        let class_name_binding = args.class_name.get_output(ctx);
        let database_name_binding = args.database_name.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let owner_name_binding = args.owner_name.get_output(ctx);
        let owner_type_binding = args.owner_type.get_output(ctx);
        let resource_uris_binding = args.resource_uris.get_output(ctx);
