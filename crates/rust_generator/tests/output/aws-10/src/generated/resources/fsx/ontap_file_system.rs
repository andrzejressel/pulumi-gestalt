...
pub mod ontap_file_system {
    ...
    pub struct OntapFileSystemArgs {
        ...
        #[builder(into, default)]
        pub ha_pairs: pulumi_gestalt_rust::Input<Option<i32>>,
        /// ARN for the KMS Key to encrypt the file system at rest, Defaults to an AWS managed KMS Key.
        #[builder(into, default)]
        pub kms_key_id: pulumi_gestalt_rust::Input<Option<String>>,
        /// The ID for a subnet. A subnet is a range of IP addresses in your virtual private cloud (VPC).
        #[builder(into)]
        pub preferred_subnet_id: pulumi_gestalt_rust::Input<String>,
    ...
    fn __create(
        ...
        let endpoint_ip_address_range_binding = args
            ...
            .get_output(ctx);
        let fsx_admin_password_binding = args.fsx_admin_password.get_output(ctx);
        let ha_pairs_binding = args.ha_pairs.get_output(ctx);
