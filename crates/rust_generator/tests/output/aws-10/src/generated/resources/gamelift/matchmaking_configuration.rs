...
pub mod matchmaking_configuration {
    ...
    pub struct MatchmakingConfigurationArgs {
        ...
        pub acceptance_required: pulumi_gestalt_rust::Input<Option<bool>>,
        /// The length of time (in seconds) to wait for players to accept a proposed match, if acceptance is required.
        #[builder(into, default)]
        pub acceptance_timeout_seconds: pulumi_gestalt_rust::Input<Option<i32>>,
        /// The number of player slots in a match to keep open for future players.
        #[builder(into, default)]
        pub additional_player_count: pulumi_gestalt_rust::Input<Option<i32>>,
        /// The method used to backfill game sessions that are created with this matchmaking configuration.
        #[builder(into, default)]
        pub backfill_mode: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub flex_match_mode: pulumi_gestalt_rust::Input<Option<String>>,
        /// One or more custom game properties. See below.
        #[builder(into, default)]
        pub game_properties: pulumi_gestalt_rust::Input<
            Option<
        ...
        #[builder(into)]
        pub request_timeout_seconds: pulumi_gestalt_rust::Input<i32>,
