...
pub mod listener {
    ...
    fn __create(
        ...
        let accelerator_arn_binding = args.accelerator_arn.get_output(ctx);
        let client_affinity_binding = args.client_affinity.get_output(ctx);
        let port_ranges_binding = args.port_ranges.get_output(ctx);
