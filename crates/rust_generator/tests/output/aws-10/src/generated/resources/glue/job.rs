...
pub mod job {
    ...
    pub struct JobArgs {
        ...
        #[builder(into, default)]
        pub execution_class: pulumi_gestalt_rust::Input<Option<String>>,
        /// Execution property of the job. Defined below.
        #[builder(into, default)]
        pub execution_property: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub job_run_queuing_enabled: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub max_capacity: pulumi_gestalt_rust::Input<Option<f64>>,
        ...
        #[builder(into, default)]
        pub notification_property: pulumi_gestalt_rust::Input<
    ...
    fn __create(
        ...
        let connections_binding = args.connections.get_output(ctx);
        let default_arguments_binding = args.default_arguments.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let execution_class_binding = args.execution_class.get_output(ctx);
        let execution_property_binding = args.execution_property.get_output(ctx);
        ...
        let max_retries_binding = args.max_retries.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let non_overridable_arguments_binding = args
            .non_overridable_arguments
            .get_output(ctx);
        let notification_property_binding = args.notification_property.get_output(ctx);
