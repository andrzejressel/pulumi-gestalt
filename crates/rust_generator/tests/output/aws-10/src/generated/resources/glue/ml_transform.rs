...
pub mod ml_transform {
    ...
    pub struct MLTransformArgs {
        ...
        #[builder(into)]
        pub input_record_tables: pulumi_gestalt_rust::Input<
    ...
    fn __create(
        ...
        let input_record_tables_binding = args.input_record_tables.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &input_record_tables_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
