...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CrawlerRecrawlPolicy {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("recrawl_behavior".to_string(), self.r#recrawl_behavior.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CrawlerRecrawlPolicy {
