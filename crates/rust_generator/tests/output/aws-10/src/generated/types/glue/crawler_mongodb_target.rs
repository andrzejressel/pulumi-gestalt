...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CrawlerMongodbTarget {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("scan_all".to_string(), self.r#scan_all.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CrawlerMongodbTarget {
