...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetDataCatalogEncryptionSettingsDataCatalogEncryptionSettingConnectionPasswordEncryption {
    ...
    > {
        async move {
            ...
            map.insert("aws_kms_key_id".to_string(), self.r#aws_kms_key_id.to_pulumi_value().await);
            map.insert("return_connection_password_encrypted".to_string(), self.r#return_connection_password_encrypted.to_pulumi_value().await);
