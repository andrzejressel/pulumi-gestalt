...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetGroupAlternateIdentifier {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetGroupAlternateIdentifier {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#external_id: {
                        ...
                        <Option<Box<super::super::types::identitystore::GetGroupAlternateIdentifierExternalId>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#unique_attribute: {
                        ...
                        <Option<Box<super::super::types::identitystore::GetGroupAlternateIdentifierUniqueAttribute>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
