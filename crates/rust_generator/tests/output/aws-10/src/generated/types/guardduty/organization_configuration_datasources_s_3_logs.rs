...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for OrganizationConfigurationDatasourcesS3Logs {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("auto_enable".to_string(), self.r#auto_enable.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for OrganizationConfigurationDatasourcesS3Logs {
