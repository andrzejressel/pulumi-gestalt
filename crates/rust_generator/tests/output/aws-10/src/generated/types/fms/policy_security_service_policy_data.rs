...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PolicySecurityServicePolicyData {
    ...
    > {
        async move {
            ...
            map.insert("managed_service_data".to_string(), self.r#managed_service_data.to_pulumi_value().await);
            map.insert("policy_option".to_string(), self.r#policy_option.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#policy_option: {
                        ...
                        <Option<Box<super::super::types::fms::PolicySecurityServicePolicyDataPolicyOption>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#type_: {
