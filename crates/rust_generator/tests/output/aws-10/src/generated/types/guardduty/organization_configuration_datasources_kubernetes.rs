...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for OrganizationConfigurationDatasourcesKubernetes {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for OrganizationConfigurationDatasourcesKubernetes {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#audit_logs: {
                        ...
                        <Box<super::super::types::guardduty::OrganizationConfigurationDatasourcesKubernetesAuditLogs> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
