...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DataCatalogEncryptionSettingsDataCatalogEncryptionSettings {
    ...
    > {
        async move {
            ...
            map.insert("connection_password_encryption".to_string(), self.r#connection_password_encryption.to_pulumi_value().await);
            map.insert("encryption_at_rest".to_string(), self.r#encryption_at_rest.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#connection_password_encryption: {
                        ...
                        <Box<super::super::types::glue::DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsConnectionPasswordEncryption> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#encryption_at_rest: {
                        ...
                        <Box<super::super::types::glue::DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsEncryptionAtRest> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
