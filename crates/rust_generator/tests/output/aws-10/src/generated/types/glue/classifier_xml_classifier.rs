...
pub struct ClassifierXmlClassifier {
    ...
    #[builder(into)]
    #[serde(rename = "rowTag")]
    pub r#row_tag: String,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClassifierXmlClassifier {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ClassifierXmlClassifier {
