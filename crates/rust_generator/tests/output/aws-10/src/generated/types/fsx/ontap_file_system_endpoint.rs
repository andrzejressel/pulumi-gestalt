...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for OntapFileSystemEndpoint {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for OntapFileSystemEndpoint {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#interclusters: {
                        ...
                        <Option<Vec<super::super::types::fsx::OntapFileSystemEndpointIntercluster>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#managements: {
                        ...
                        <Option<Vec<super::super::types::fsx::OntapFileSystemEndpointManagement>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
