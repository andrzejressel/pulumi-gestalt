...
pub struct CatalogTableStorageDescriptorSerDeInfo {
    /// Name of the SerDe.
    #[builder(into)]
    #[serde(rename = "name")]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CatalogTableStorageDescriptorSerDeInfo {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "serialization_library".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#serialization_library,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CatalogTableStorageDescriptorSerDeInfo {
