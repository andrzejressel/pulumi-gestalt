...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetCustomRoutingAcceleratorAttribute {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("flow_logs_enabled".to_string(), self.r#flow_logs_enabled.to_pulumi_value().await);
            map.insert("flow_logs_s_3_bucket".to_string(), self.r#flow_logs_s_3_bucket.to_pulumi_value().await);
            map.insert("flow_logs_s_3_prefix".to_string(), self.r#flow_logs_s_3_prefix.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetCustomRoutingAcceleratorAttribute {
