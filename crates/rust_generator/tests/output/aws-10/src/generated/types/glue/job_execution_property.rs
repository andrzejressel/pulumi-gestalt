...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for JobExecutionProperty {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "max_concurrent_runs".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#max_concurrent_runs,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for JobExecutionProperty {
