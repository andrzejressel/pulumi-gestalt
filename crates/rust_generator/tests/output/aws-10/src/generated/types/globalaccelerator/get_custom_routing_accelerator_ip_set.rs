...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetCustomRoutingAcceleratorIpSet {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("ip_family".to_string(), self.r#ip_family.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetCustomRoutingAcceleratorIpSet {
