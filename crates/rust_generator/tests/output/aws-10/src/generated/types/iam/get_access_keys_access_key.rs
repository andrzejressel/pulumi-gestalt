...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetAccessKeysAccessKey {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("access_key_id".to_string(), self.r#access_key_id.to_pulumi_value().await);
            map.insert("create_date".to_string(), self.r#create_date.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetAccessKeysAccessKey {
