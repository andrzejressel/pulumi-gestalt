...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetScriptDagEdge {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("target_parameter".to_string(), self.r#target_parameter.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetScriptDagEdge {
        ...
        match value.content {
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#target_parameter: {
                        let field_value = match fields_map.get("target_parameter") {
                            Some(value) => value,
                            None => bail!("Missing field 'target_parameter' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
