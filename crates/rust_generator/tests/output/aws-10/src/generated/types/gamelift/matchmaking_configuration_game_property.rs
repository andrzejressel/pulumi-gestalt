...
pub struct MatchmakingConfigurationGameProperty {
    /// A game property key
    #[builder(into)]
    #[serde(rename = "key")]
    pub r#key: String,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for MatchmakingConfigurationGameProperty {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for MatchmakingConfigurationGameProperty {
