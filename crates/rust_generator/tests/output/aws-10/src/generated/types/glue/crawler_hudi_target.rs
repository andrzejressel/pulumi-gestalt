            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#maximum_traversal_depth: {
                        let field_value = match fields_map.get("maximumTraversalDepth") {
                            Some(value) => value,
                            None => bail!("Missing field 'maximumTraversalDepth' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#paths: {
