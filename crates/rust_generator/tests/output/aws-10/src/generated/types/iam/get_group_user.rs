...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetGroupUser {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("user_name".to_string(), self.r#user_name.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetGroupUser {
