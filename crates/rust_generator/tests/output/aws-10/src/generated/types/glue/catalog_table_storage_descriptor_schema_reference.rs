...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CatalogTableStorageDescriptorSchemaReference {
    ...
    > {
        async move {
            ...
            map.insert("schema_id".to_string(), self.r#schema_id.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#schema_id: {
                        ...
                        <Option<Box<super::super::types::glue::CatalogTableStorageDescriptorSchemaReferenceSchemaId>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#schema_version_id: {
