...
pub mod group {
    ...
    pub struct GroupArgs {
        ...
        pub availability_zone_distribution: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub capacity_rebalance: pulumi_gestalt_rust::Input<Option<bool>>,
        /// Reserved.
        #[builder(into, default)]
        pub context: pulumi_gestalt_rust::Input<Option<String>>,
        /// Amount of time, in seconds, after a scaling activity completes before another scaling activity can start.
        #[builder(into, default)]
        pub default_cooldown: pulumi_gestalt_rust::Input<Option<i32>>,
        /// Amount of time, in seconds, until a newly launched instance can contribute to the Amazon CloudWatch metrics. This delay lets an instance finish initializing before Amazon EC2 Auto Scaling aggregates instance metrics, resulting in more reliable usage data. Set this value equal to the amount of time that it takes for resource consumption to become stable after an instance reaches the InService state. (See [Set the default instance warmup for an Auto Scaling group](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-default-instance-warmup.html))
        #[builder(into, default)]
        pub default_instance_warmup: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub desired_capacity_type: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub enabled_metrics: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        ...
        #[builder(into, default)]
        pub force_delete_warm_pool: pulumi_gestalt_rust::Input<Option<bool>>,
        /// Time (in seconds) after instance comes into service before checking health.
        #[builder(into, default)]
        pub health_check_grace_period: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub initial_lifecycle_hooks: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub instance_maintenance_policy: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub instance_refresh: pulumi_gestalt_rust::Input<
            Option<super::super::types::autoscaling::GroupInstanceRefresh>,
        >,
        /// Name of the launch configuration to use.
        #[builder(into, default)]
        pub launch_configuration: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub max_instance_lifetime: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub metrics_granularity: pulumi_gestalt_rust::Input<Option<String>>,
        /// Setting this causes Pulumi to wait for
        /// this number of instances from this Auto Scaling Group to show up healthy in the
        /// ELB only on creation. Updates will not wait on ELB instance number changes.
        /// (See also Waiting for Capacity below.)
        #[builder(into, default)]
        pub min_elb_capacity: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub mixed_instances_policy: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub placement_group: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub protect_from_scale_in: pulumi_gestalt_rust::Input<Option<bool>>,
        /// ARN of the service-linked role that the ASG will use to call other AWS services
        #[builder(into, default)]
        pub service_linked_role_arn: pulumi_gestalt_rust::Input<Option<String>>,
        /// List of processes to suspend for the Auto Scaling Group. The allowed values are `Launch`, `Terminate`, `HealthCheck`, `ReplaceUnhealthy`, `AZRebalance`, `AlarmNotification`, `ScheduledActions`, `AddToLoadBalancer`, `InstanceRefresh`.
        /// Note that if you suspend either the `Launch` or `Terminate` process types, it can prevent your Auto Scaling Group from functioning properly.
        #[builder(into, default)]
        pub suspended_processes: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        ...
        /// (See also Waiting for Capacity below.)
        #[builder(into, default)]
        pub wait_for_elb_capacity: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub warm_pool: pulumi_gestalt_rust::Input<
