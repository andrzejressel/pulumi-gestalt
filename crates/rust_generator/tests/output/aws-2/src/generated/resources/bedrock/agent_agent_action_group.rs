...
pub mod agent_agent_action_group {
    ...
    fn __create(
        ...
        let action_group_executor_binding = args.action_group_executor.get_output(ctx);
        let action_group_name_binding = args.action_group_name.get_output(ctx);
        let action_group_state_binding = args.action_group_state.get_output(ctx);
        let agent_id_binding = args.agent_id.get_output(ctx);
        let agent_version_binding = args.agent_version.get_output(ctx);
        let api_schema_binding = args.api_schema.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let function_schema_binding = args.function_schema.get_output(ctx);
