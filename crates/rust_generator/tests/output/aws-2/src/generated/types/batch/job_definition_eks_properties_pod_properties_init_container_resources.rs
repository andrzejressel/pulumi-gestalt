...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for JobDefinitionEksPropertiesPodPropertiesInitContainerResources {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("limits".to_string(), self.r#limits.to_pulumi_value().await);
            map.insert("requests".to_string(), self.r#requests.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for JobDefinitionEksPropertiesPodPropertiesInitContainerResources {
