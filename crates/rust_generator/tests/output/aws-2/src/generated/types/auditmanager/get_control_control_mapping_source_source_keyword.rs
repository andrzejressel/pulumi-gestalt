...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetControlControlMappingSourceSourceKeyword {
    ...
    > {
        async move {
            ...
            map.insert("keyword_input_type".to_string(), self.r#keyword_input_type.to_pulumi_value().await);
            map.insert("keyword_value".to_string(), self.r#keyword_value.to_pulumi_value().await);
