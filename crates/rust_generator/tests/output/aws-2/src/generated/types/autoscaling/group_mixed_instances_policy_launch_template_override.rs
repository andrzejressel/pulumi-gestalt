            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#instance_requirements: {
                        ...
                        <Option<Box<super::super::types::autoscaling::GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirements>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#instance_type: {
                    ...
                    r#launch_template_specification: {
                        ...
                        <Option<Box<super::super::types::autoscaling::GroupMixedInstancesPolicyLaunchTemplateOverrideLaunchTemplateSpecification>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#weighted_capacity: {
