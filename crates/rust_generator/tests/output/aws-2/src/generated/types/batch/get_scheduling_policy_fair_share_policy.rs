...
pub struct GetSchedulingPolicyFairSharePolicy {
    ...
    pub r#compute_reservation: i32,
    #[builder(into)]
    #[serde(rename = "shareDecaySeconds")]
    pub r#share_decay_seconds: i32,
    ...
    pub r#share_distributions: Vec<super::super::types::batch::GetSchedulingPolicyFairSharePolicyShareDistribution>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetSchedulingPolicyFairSharePolicy {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetSchedulingPolicyFairSharePolicy {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#share_distributions: {
                        ...
                        <Vec<super::super::types::batch::GetSchedulingPolicyFairSharePolicyShareDistribution> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
