...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WorkgroupConfigurationEngineVersion {
    ...
    > {
        async move {
            ...
            map.insert("effective_engine_version".to_string(), self.r#effective_engine_version.to_pulumi_value().await);
            map.insert("selected_engine_version".to_string(), self.r#selected_engine_version.to_pulumi_value().await);
