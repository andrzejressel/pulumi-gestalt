...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AssessmentScope {
    ...
    > {
        async move {
            ...
            map.insert("aws_accounts".to_string(), self.r#aws_accounts.to_pulumi_value().await);
            map.insert("aws_services".to_string(), self.r#aws_services.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#aws_accounts: {
                        ...
                        <Option<Vec<super::super::types::auditmanager::AssessmentScopeAwsAccount>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#aws_services: {
                        ...
                        <Option<Vec<super::super::types::auditmanager::AssessmentScopeAwsService>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
