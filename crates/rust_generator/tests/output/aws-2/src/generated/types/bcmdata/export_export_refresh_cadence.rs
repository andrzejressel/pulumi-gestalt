...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ExportExportRefreshCadence {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("frequency".to_string(), self.r#frequency.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ExportExportRefreshCadence {
