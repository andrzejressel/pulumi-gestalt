            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#compute_environment: {
                        let field_value = match fields_map.get("computeEnvironment") {
                            Some(value) => value,
                            None => bail!("Missing field 'computeEnvironment' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
