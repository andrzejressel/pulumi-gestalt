...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DatabaseEncryptionConfiguration {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("kms_key".to_string(), self.r#kms_key.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DatabaseEncryptionConfiguration {
