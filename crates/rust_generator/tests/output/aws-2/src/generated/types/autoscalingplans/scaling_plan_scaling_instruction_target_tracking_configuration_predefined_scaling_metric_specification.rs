            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#predefined_scaling_metric_type: {
                        let field_value = match fields_map.get("predefinedScalingMetricType") {
                            Some(value) => value,
                            None => bail!("Missing field 'predefinedScalingMetricType' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
