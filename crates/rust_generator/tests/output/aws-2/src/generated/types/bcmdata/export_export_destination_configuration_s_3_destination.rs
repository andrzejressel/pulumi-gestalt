...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ExportExportDestinationConfigurationS3Destination {
    ...
    > {
        async move {
            ...
            map.insert("s_3_output_configurations".to_string(), self.r#s_3_output_configurations.to_pulumi_value().await);
            map.insert("s_3_prefix".to_string(), self.r#s_3_prefix.to_pulumi_value().await);
            map.insert("s_3_region".to_string(), self.r#s_3_region.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#s_3_output_configurations: {
                        ...
                        <Option<Vec<super::super::types::bcmdata::ExportExportDestinationConfigurationS3DestinationS3OutputConfiguration>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#s_3_prefix: {
