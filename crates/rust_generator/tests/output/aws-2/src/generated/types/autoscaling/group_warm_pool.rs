...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GroupWarmPool {
    ...
    > {
        async move {
            ...
            map.insert("instance_reuse_policy".to_string(), self.r#instance_reuse_policy.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#instance_reuse_policy: {
                        ...
                        <Option<Box<super::super::types::autoscaling::GroupWarmPoolInstanceReusePolicy>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
