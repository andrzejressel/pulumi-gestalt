...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ProviderIgnoreTags {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("key_prefixes".to_string(), self.r#key_prefixes.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ProviderIgnoreTags {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#key_prefixes: {
                        let field_value = match fields_map.get("key_prefixes") {
                            Some(value) => value,
                            None => bail!("Missing field 'key_prefixes' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
