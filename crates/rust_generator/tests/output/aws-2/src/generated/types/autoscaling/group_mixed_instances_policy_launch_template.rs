...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GroupMixedInstancesPolicyLaunchTemplate {
    ...
    > {
        async move {
            ...
            map.insert("launch_template_specification".to_string(), self.r#launch_template_specification.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#launch_template_specification: {
                        ...
                        <Box<super::super::types::autoscaling::GroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#overrides: {
                        ...
                        <Option<Vec<super::super::types::autoscaling::GroupMixedInstancesPolicyLaunchTemplateOverride>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
