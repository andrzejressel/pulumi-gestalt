            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#efs_volume_configurations: {
                        let field_value = match fields_map.get("efsVolumeConfigurations") {
                            Some(value) => value,
                            None => bail!("Missing field 'efsVolumeConfigurations' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
