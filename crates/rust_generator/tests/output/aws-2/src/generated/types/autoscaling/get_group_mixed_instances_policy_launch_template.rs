...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetGroupMixedInstancesPolicyLaunchTemplate {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetGroupMixedInstancesPolicyLaunchTemplate {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#launch_template_specifications: {
                        ...
                        <Vec<super::super::types::autoscaling::GetGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#overrides: {
                        ...
                        <Vec<super::super::types::autoscaling::GetGroupMixedInstancesPolicyLaunchTemplateOverride> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
