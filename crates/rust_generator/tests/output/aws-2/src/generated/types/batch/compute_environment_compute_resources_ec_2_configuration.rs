...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ComputeEnvironmentComputeResourcesEc2Configuration {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ComputeEnvironmentComputeResourcesEc2Configuration {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#image_id_override: {
                        let field_value = match fields_map.get("image_id_override") {
                            Some(value) => value,
                            None => bail!("Missing field 'image_id_override' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
