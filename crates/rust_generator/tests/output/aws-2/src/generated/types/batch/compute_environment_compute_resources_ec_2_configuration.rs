...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ComputeEnvironmentComputeResourcesEc2Configuration {
    ...
    > {
        async move {
            ...
            map.insert("image_id_override".to_string(), self.r#image_id_override.to_pulumi_value().await);
            map.insert("image_type".to_string(), self.r#image_type.to_pulumi_value().await);
