...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ScalingPlanScalingInstructionTargetTrackingConfiguration {
    ...
    > {
        async move {
            ...
            map.insert("scale_in_cooldown".to_string(), self.r#scale_in_cooldown.to_pulumi_value().await);
            map.insert("scale_out_cooldown".to_string(), self.r#scale_out_cooldown.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#customized_scaling_metric_specification: {
                        ...
                        <Option<Box<super::super::types::autoscalingplans::ScalingPlanScalingInstructionTargetTrackingConfigurationCustomizedScalingMetricSpecification>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#disable_scale_in: {
                    ...
                    r#predefined_scaling_metric_specification: {
                        ...
                        <Option<Box<super::super::types::autoscalingplans::ScalingPlanScalingInstructionTargetTrackingConfigurationPredefinedScalingMetricSpecification>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#scale_in_cooldown: {
