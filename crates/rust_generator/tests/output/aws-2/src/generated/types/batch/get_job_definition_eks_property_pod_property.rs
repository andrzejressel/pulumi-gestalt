...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetJobDefinitionEksPropertyPodProperty {
    ...
    > {
        async move {
            ...
            map.insert("metadatas".to_string(), self.r#metadatas.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#containers: {
                        ...
                        <Vec<super::super::types::batch::GetJobDefinitionEksPropertyPodPropertyContainer> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#dns_policy: {
                    ...
                    r#image_pull_secrets: {
                        ...
                        <Vec<super::super::types::batch::GetJobDefinitionEksPropertyPodPropertyImagePullSecret> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#init_containers: {
                        ...
                        <Vec<super::super::types::batch::GetJobDefinitionEksPropertyPodPropertyInitContainer> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#metadatas: {
                        ...
                        <Vec<super::super::types::batch::GetJobDefinitionEksPropertyPodPropertyMetadata> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    ...
                    r#volumes: {
                        ...
                        <Vec<super::super::types::batch::GetJobDefinitionEksPropertyPodPropertyVolume> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
