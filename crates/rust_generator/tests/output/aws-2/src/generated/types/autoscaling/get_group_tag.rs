...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetGroupTag {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("propagate_at_launch".to_string(), self.r#propagate_at_launch.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetGroupTag {
