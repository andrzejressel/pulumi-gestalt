...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AgentKnowledgeBaseStorageConfigurationRdsConfiguration {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AgentKnowledgeBaseStorageConfigurationRdsConfiguration {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#credentials_secret_arn: {
                        let field_value = match fields_map.get("credentialsSecretArn") {
                            Some(value) => value,
                            None => bail!("Missing field 'credentialsSecretArn' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                    ...
                    r#field_mapping: {
                        let field_value = match fields_map.get("fieldMapping") {
                            Some(value) => value,
                            None => bail!("Missing field 'fieldMapping' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#resource_arn: {
