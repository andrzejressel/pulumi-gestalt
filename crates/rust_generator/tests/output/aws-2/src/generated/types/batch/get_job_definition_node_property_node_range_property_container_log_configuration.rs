...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetJobDefinitionNodePropertyNodeRangePropertyContainerLogConfiguration {
    ...
    > {
        async move {
            ...
            map.insert("log_driver".to_string(), self.r#log_driver.to_pulumi_value().await);
            map.insert("options".to_string(), self.r#options.to_pulumi_value().await);
            map.insert("secret_options".to_string(), self.r#secret_options.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#secret_options: {
                        ...
                        <Vec<super::super::types::batch::GetJobDefinitionNodePropertyNodeRangePropertyContainerLogConfigurationSecretOption> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
