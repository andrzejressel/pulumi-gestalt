...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FrameworkControlScope {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FrameworkControlScope {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#compliance_resource_ids: {
                        let field_value = match fields_map.get("complianceResourceIds") {
                            Some(value) => value,
                            None => bail!("Missing field 'complianceResourceIds' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
