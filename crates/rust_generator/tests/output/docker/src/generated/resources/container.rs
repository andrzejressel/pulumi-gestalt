...
pub mod container {
    ...
    pub struct ContainerArgs {
        ...
        pub attach: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub cgroupns_mode: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub command: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        /// The total number of milliseconds to wait for the container to reach status 'running'
        #[builder(into, default)]
        pub container_read_refresh_timeout_milliseconds: pulumi_gestalt_rust::Input<
            Option<i32>,
        >,
        /// A comma-separated list or hyphen-separated range of CPUs a container can use, e.g. `0-1`.
        #[builder(into, default)]
        pub cpu_set: pulumi_gestalt_rust::Input<Option<String>>,
        /// CPU shares (relative weight) for the container.
        #[builder(into, default)]
        pub cpu_shares: pulumi_gestalt_rust::Input<Option<i32>>,
        /// If defined will attempt to stop the container before destroying. Container will be destroyed after `n` seconds or on successful stop.
        #[builder(into, default)]
        pub destroy_grace_seconds: pulumi_gestalt_rust::Input<Option<i32>>,
        /// Bind devices to the container.
        #[builder(into, default)]
        pub devices: pulumi_gestalt_rust::Input<
            Option<Vec<super::types::ContainerDevice>>,
        >,
        /// DNS servers to use.
        #[builder(into, default)]
        pub dns: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        /// DNS options used by the DNS provider(s), see `resolv.conf` documentation for valid list of options.
        #[builder(into, default)]
        pub dns_opts: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        /// DNS search domains that are used when bare unqualified hostnames are used inside of the container.
        #[builder(into, default)]
        pub dns_searches: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        /// Domain name of the container.
        #[builder(into, default)]
        pub domainname: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub entrypoints: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        /// Environment variables to set in the form of `KEY=VALUE`, e.g. `DEBUG=0`
        #[builder(into, default)]
        pub envs: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        /// GPU devices to add to the container. Currently, only the value `all` is supported. Passing any other value will result in unexpected behavior.
        #[builder(into, default)]
        pub gpus: pulumi_gestalt_rust::Input<Option<String>>,
        /// Additional groups for the container user
        #[builder(into, default)]
        pub group_adds: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        /// A test to perform to check that the container is healthy
        #[builder(into, default)]
        pub healthcheck: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub init: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub log_driver: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub logs: pulumi_gestalt_rust::Input<Option<bool>>,
        /// The maximum amount of times to an attempt a restart when `restart` is set to 'on-failure'.
        #[builder(into, default)]
        pub max_retry_count: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub memory_swap: pulumi_gestalt_rust::Input<Option<i32>>,
        /// Specification for mounts to be added to containers created as part of the service.
        #[builder(into, default)]
        pub mounts: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub must_run: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub networks_advanced: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub publish_all_ports: pulumi_gestalt_rust::Input<Option<bool>>,
        /// Whether the mount should be read-only.
        #[builder(into, default)]
        pub read_only: pulumi_gestalt_rust::Input<Option<bool>>,
        /// If `true`, it will remove anonymous volumes associated with the container. Defaults to `true`.
        #[builder(into, default)]
        pub remove_volumes: pulumi_gestalt_rust::Input<Option<bool>>,
        /// The restart policy for the container. Must be one of 'no', 'on-failure', 'always', 'unless-stopped'. Defaults to `no`.
        #[builder(into, default)]
        pub restart: pulumi_gestalt_rust::Input<Option<String>>,
        /// If `true`, then the container will be automatically removed when it exits. Defaults to `false`.
        #[builder(into, default)]
        pub rm: pulumi_gestalt_rust::Input<Option<bool>>,
        /// Runtime to use for the container.
        #[builder(into, default)]
        pub runtime: pulumi_gestalt_rust::Input<Option<String>>,
        /// List of string values to customize labels for MLS systems, such as SELinux. See https://docs.docker.com/engine/reference/run/#security-configuration.
        #[builder(into, default)]
        pub security_opts: pulumi_gestalt_rust::Input<Option<Vec<String>>>,
        /// Size of `/dev/shm` in MBs.
        #[builder(into, default)]
        pub shm_size: pulumi_gestalt_rust::Input<Option<i32>>,
        /// If `true`, then the Docker container will be started after creation. If `false`, then the container is only created. Defaults to `true`.
        #[builder(into, default)]
        pub start: pulumi_gestalt_rust::Input<Option<bool>>,
        /// If `true`, keep STDIN open even if not attached (`docker run -i`). Defaults to `false`.
        #[builder(into, default)]
        pub stdin_open: pulumi_gestalt_rust::Input<Option<bool>>,
        /// Signal to stop a container (default `SIGTERM`).
        #[builder(into, default)]
        pub stop_signal: pulumi_gestalt_rust::Input<Option<String>>,
        /// Timeout (in seconds) to stop a container.
        #[builder(into, default)]
        pub stop_timeout: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub tty: pulumi_gestalt_rust::Input<Option<bool>>,
        /// Ulimit options to add.
        #[builder(into, default)]
        pub ulimits: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub uploads: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub userns_mode: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub wait: pulumi_gestalt_rust::Input<Option<bool>>,
        /// The timeout in seconds to wait the container to be healthy after creation. Defaults to `60`.
        #[builder(into, default)]
        pub wait_timeout: pulumi_gestalt_rust::Input<Option<i32>>,
        /// The working directory for commands to run in.
        #[builder(into, default)]
        pub working_dir: pulumi_gestalt_rust::Input<Option<String>>,
    }
    #[allow(dead_code)]
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "attach".into(),
                    value: &attach_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &cgroupns_mode_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "command".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "cpuSet".into(),
                    value: &cpu_set_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "cpuShares".into(),
                    value: &cpu_shares_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "destroyGraceSeconds".into(),
                    value: &destroy_grace_seconds_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "devices".into(),
                    value: &devices_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "dns".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "dnsOpts".into(),
                    value: &dns_opts_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "dnsSearches".into(),
                    value: &dns_searches_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "domainname".into(),
                    value: &domainname_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "entrypoints".into(),
                    value: &entrypoints_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "envs".into(),
                    value: &envs_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "gpus".into(),
                    value: &gpus_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "groupAdds".into(),
                    value: &group_adds_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "healthcheck".into(),
                    value: &healthcheck_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "hostname".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "logDriver".into(),
                    value: &log_driver_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "logOpts".into(),
                    value: &log_opts_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "logs".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &max_retry_count_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "memory".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &memory_swap_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "mounts".into(),
                    value: &mounts_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "mustRun".into(),
                    value: &must_run_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &networks_advanced_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "pidMode".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &privileged_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "publishAllPorts".into(),
                    value: &publish_all_ports_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "readOnly".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &remove_volumes_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "restart".into(),
                    value: &restart_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "rm".into(),
                    value: &rm_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "runtime".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &security_opts_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "shmSize".into(),
                    value: &shm_size_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "start".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "stdinOpen".into(),
                    value: &stdin_open_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "stopSignal".into(),
                    value: &stop_signal_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "stopTimeout".into(),
                    value: &stop_timeout_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "storageOpts".into(),
                    value: &storage_opts_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "sysctls".into(),
                    value: &sysctls_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "tmpfs".into(),
                    value: &tmpfs_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "tty".into(),
                    value: &tty_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "ulimits".into(),
                    value: &ulimits_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "uploads".into(),
                    value: &uploads_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "user".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &userns_mode_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "volumes".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "wait".into(),
                    value: &wait_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "waitTimeout".into(),
                    value: &wait_timeout_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "workingDir".into(),
                    value: &working_dir_binding.drop_type(),
                },
            ],
            options,
        };
