...
pub mod service {
    ...
    fn __create(
        ...
        let auth_binding = args.auth.get_output(ctx);
        let converge_config_binding = args.converge_config.get_output(ctx);
        let endpoint_spec_binding = args.endpoint_spec.get_output(ctx);
        let labels_binding = args.labels.get_output(ctx);
        let mode_binding = args.mode.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let rollback_config_binding = args.rollback_config.get_output(ctx);
        let task_spec_binding = args.task_spec.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "auth".into(),
                    value: &auth_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "convergeConfig".into(),
                    value: &converge_config_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "endpointSpec".into(),
                    value: &endpoint_spec_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "labels".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &rollback_config_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "taskSpec".into(),
                    value: &task_spec_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "updateConfig".into(),
                    value: &update_config_binding.drop_type(),
                },
            ],
            options,
        };
