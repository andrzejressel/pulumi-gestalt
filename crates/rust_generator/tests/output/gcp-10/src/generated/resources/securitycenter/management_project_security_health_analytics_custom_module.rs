...
///     let example = management_project_security_health_analytics_custom_module::create(
///         "example",
///         ManagementProjectSecurityHealthAnalyticsCustomModuleArgs::builder()
///             .custom_config(
///                 ManagementProjectSecurityHealthAnalyticsCustomModuleCustomConfig::builder()
///                     .description(
///                         "The rotation period of the identified cryptokey resource exceeds 30 days.",
///                     )
///                     .predicate(
///                         ManagementProjectSecurityHealthAnalyticsCustomModuleCustomConfigPredicate::builder()
///                             .expression(
...
///                     .resourceSelector(
///                         ManagementProjectSecurityHealthAnalyticsCustomModuleCustomConfigResourceSelector::builder()
...
///                 ManagementProjectSecurityHealthAnalyticsCustomModuleCustomConfig::builder()
///                     .customOutput(
///                         ManagementProjectSecurityHealthAnalyticsCustomModuleCustomConfigCustomOutput::builder()
///                             .properties(
///                                 vec![
///                                     ManagementProjectSecurityHealthAnalyticsCustomModuleCustomConfigCustomOutputProperty::builder()
///                                     .name("duration")
///                                     .valueExpression(ManagementProjectSecurityHealthAnalyticsCustomModuleCustomConfigCustomOutputPropertyValueExpression::builder()
...
pub mod management_project_security_health_analytics_custom_module {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct ManagementProjectSecurityHealthAnalyticsCustomModuleArgs {
        /// The user specified custom configuration for the module.
        /// Structure is documented below.
        #[builder(into, default)]
        pub custom_config: pulumi_gestalt_rust::InputOrOutput<
            Option<
                super::super::types::securitycenter::ManagementProjectSecurityHealthAnalyticsCustomModuleCustomConfig,
            >,
        >,
    ...
    #[allow(dead_code)]
    pub struct ManagementProjectSecurityHealthAnalyticsCustomModuleResult {
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:securitycenter/managementProjectSecurityHealthAnalyticsCustomModule:ManagementProjectSecurityHealthAnalyticsCustomModule"
                .into(),
            name: name.to_string(),
