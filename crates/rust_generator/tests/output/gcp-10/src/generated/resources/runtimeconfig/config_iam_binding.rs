...
pub mod config_iam_binding {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct ConfigIamBindingArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::runtimeconfig::ConfigIamBindingCondition>,
        >,
    ...
    #[allow(dead_code)]
    pub struct ConfigIamBindingResult {
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:runtimeconfig/configIamBinding:ConfigIamBinding".into(),
            name: name.to_string(),
