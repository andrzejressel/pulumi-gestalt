...
pub mod posture_deployment {
    ...
    fn __create(
        ...
        let posture_deployment_id_binding = args.posture_deployment_id.get_output(ctx);
        let posture_id_binding = args.posture_id.get_output(ctx);
        let posture_revision_id_binding = args.posture_revision_id.get_output(ctx);
        let target_resource_binding = args.target_resource.get_output(ctx);
