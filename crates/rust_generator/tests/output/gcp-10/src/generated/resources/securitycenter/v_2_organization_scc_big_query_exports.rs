...
pub mod v_2_organization_scc_big_query_exports {
    ...
    #[allow(dead_code)]
    pub struct V2OrganizationSccBigQueryExportsArgs {
    ...
    #[allow(dead_code)]
    pub struct V2OrganizationSccBigQueryExportsResult {
    ...
    fn __create(
        ...
        let big_query_export_id_binding = args.big_query_export_id.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:securitycenter/v2OrganizationSccBigQueryExports:V2OrganizationSccBigQueryExports"
                .into(),
            name: name.to_string(),
