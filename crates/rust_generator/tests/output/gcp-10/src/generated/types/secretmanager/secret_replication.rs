...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for SecretReplication {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for SecretReplication {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#auto: {
                        let field_value = match fields_map.get("auto") {
                            Some(value) => value,
                            None => bail!("Missing field 'auto' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
