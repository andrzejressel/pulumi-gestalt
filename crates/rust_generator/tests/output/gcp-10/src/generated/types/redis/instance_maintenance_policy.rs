...
pub struct InstanceMaintenancePolicy {
    ...
    pub r#weekly_maintenance_windows: Option<Vec<super::super::types::redis::InstanceMaintenancePolicyWeeklyMaintenanceWindow>>,
}
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for InstanceMaintenancePolicy {
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "weekly_maintenance_windows".to_string(),
                ToPulumiValue::to_pulumi_value(
