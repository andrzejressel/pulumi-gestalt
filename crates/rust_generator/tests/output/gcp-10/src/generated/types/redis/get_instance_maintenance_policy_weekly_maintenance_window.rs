...
pub struct GetInstanceMaintenancePolicyWeeklyMaintenanceWindow {
    ...
    pub r#start_times: Vec<super::super::types::redis::GetInstanceMaintenancePolicyWeeklyMaintenanceWindowStartTime>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetInstanceMaintenancePolicyWeeklyMaintenanceWindow {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetInstanceMaintenancePolicyWeeklyMaintenanceWindow {
