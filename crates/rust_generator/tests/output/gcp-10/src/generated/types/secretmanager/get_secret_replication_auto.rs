...
pub struct GetSecretReplicationAuto {
    ...
    pub r#customer_managed_encryptions: Vec<super::super::types::secretmanager::GetSecretReplicationAutoCustomerManagedEncryption>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetSecretReplicationAuto {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetSecretReplicationAuto {
