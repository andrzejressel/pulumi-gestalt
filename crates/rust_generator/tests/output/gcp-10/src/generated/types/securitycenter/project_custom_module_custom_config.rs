...
pub struct ProjectCustomModuleCustomConfig {
    ...
    pub r#predicate: Box<super::super::types::securitycenter::ProjectCustomModuleCustomConfigPredicate>,
    ...
    pub r#resource_selector: Box<super::super::types::securitycenter::ProjectCustomModuleCustomConfigResourceSelector>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ProjectCustomModuleCustomConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ProjectCustomModuleCustomConfig {
