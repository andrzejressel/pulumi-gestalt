...
pub struct V2OrganizationSourceIamBindingCondition {
    #[builder(into)]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for V2OrganizationSourceIamBindingCondition {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for V2OrganizationSourceIamBindingCondition {
