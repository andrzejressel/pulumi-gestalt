...
pub struct OrganizationCustomModuleCustomConfig {
    ...
    pub r#predicate: Box<super::super::types::securitycenter::OrganizationCustomModuleCustomConfigPredicate>,
    ...
    pub r#resource_selector: Box<super::super::types::securitycenter::OrganizationCustomModuleCustomConfigResourceSelector>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for OrganizationCustomModuleCustomConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for OrganizationCustomModuleCustomConfig {
