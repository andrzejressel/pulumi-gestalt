...
pub mod taxonomy_iam_binding {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct TaxonomyIamBindingArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::datacatalog::TaxonomyIamBindingCondition>,
        >,
    ...
    #[allow(dead_code)]
    pub struct TaxonomyIamBindingResult {
    ...
    fn __create(
        ...
        let taxonomy_binding = args.taxonomy.get_output(ctx);
