...
pub mod note {
    ...
    fn __create(
        ...
        let attestation_authority_binding = args.attestation_authority.get_output(ctx);
        ...
        let related_note_names_binding = args.related_note_names.get_output(ctx);
        let related_urls_binding = args.related_urls.get_output(ctx);
