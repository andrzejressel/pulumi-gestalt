...
pub mod metastore_service_iam_binding {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct MetastoreServiceIamBindingArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::dataproc::MetastoreServiceIamBindingCondition>,
        >,
    ...
    #[allow(dead_code)]
    pub struct MetastoreServiceIamBindingResult {
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:dataproc/metastoreServiceIamBinding:MetastoreServiceIamBinding"
                .into(),
            name: name.to_string(),
