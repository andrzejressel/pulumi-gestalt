...
pub mod entry {
    ...
    pub struct EntryArgs {
        ...
        #[builder(into)]
        pub entry_group: pulumi_gestalt_rust::Input<String>,
        /// The id of the entry to create.
        ///
        ///
        /// - - -
        #[builder(into)]
        pub entry_id: pulumi_gestalt_rust::Input<String>,
        /// Specification that applies to a Cloud Storage fileset. This is only valid on entries of type FILESET.
        /// Structure is documented below.
        #[builder(into, default)]
        pub gcs_fileset_spec: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub linked_resource: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub user_specified_system: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub user_specified_type: pulumi_gestalt_rust::Input<Option<String>>,
    }
    #[allow(dead_code)]
