...
pub mod datascan {
    ...
    fn __create(
        ...
        let data_profile_spec_binding = args.data_profile_spec.get_output(ctx);
        let data_quality_spec_binding = args.data_quality_spec.get_output(ctx);
        let data_scan_id_binding = args.data_scan_id.get_output(ctx);
