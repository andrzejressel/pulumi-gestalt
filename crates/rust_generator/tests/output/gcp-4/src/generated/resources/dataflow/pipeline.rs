...
pub mod pipeline {
    ...
    pub struct PipelineArgs {
        ...
        #[builder(into, default)]
        pub pipeline_sources: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub schedule_info: pulumi_gestalt_rust::Input<
        ...
        /// Structure is documented below.
        #[builder(into, default)]
        pub workload: pulumi_gestalt_rust::Input<
    ...
    fn __create(
        ...
        let pipeline_sources_binding = args.pipeline_sources.get_output(ctx);
        let project_binding = args.project.get_output(ctx);
        let region_binding = args.region.get_output(ctx);
        let schedule_info_binding = args.schedule_info.get_output(ctx);
        ...
        let workload_binding = args.workload.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &pipeline_sources_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "project".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &schedule_info_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "schedulerServiceAccountEmail".into(),
                    value: &scheduler_service_account_email_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "state".into(),
