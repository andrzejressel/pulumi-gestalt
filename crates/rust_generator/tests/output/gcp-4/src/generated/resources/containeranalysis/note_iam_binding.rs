...
pub mod note_iam_binding {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct NoteIamBindingArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::Input<
            Option<super::super::types::containeranalysis::NoteIamBindingCondition>,
        >,
        ...
        #[builder(into)]
        pub note: pulumi_gestalt_rust::Input<String>,
    ...
    #[allow(dead_code)]
    pub struct NoteIamBindingResult {
    ...
    fn __create(
        ...
        let note_binding = args.note.get_output(ctx);
        let project_binding = args.project.get_output(ctx);
        let role_binding = args.role.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:containeranalysis/noteIamBinding:NoteIamBinding".into(),
            name: name.to_string(),
