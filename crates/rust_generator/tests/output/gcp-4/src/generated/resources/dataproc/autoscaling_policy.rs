...
pub mod autoscaling_policy {
    ...
    fn __create(
        ...
        let basic_algorithm_binding = args.basic_algorithm.get_output(ctx);
        ...
        let secondary_worker_config_binding = args
            ...
            .get_output(ctx);
        let worker_config_binding = args.worker_config.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &basic_algorithm_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "location".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &secondary_worker_config_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "workerConfig".into(),
                    value: &worker_config_binding.drop_type(),
                },
            ],
            options,
        };
