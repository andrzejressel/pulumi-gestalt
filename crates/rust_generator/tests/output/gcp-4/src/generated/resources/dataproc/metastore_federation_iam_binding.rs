...
pub mod metastore_federation_iam_binding {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct MetastoreFederationIamBindingArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::dataproc::MetastoreFederationIamBindingCondition>,
        >,
        #[builder(into)]
    ...
    #[allow(dead_code)]
    pub struct MetastoreFederationIamBindingResult {
    ...
    fn __create(
        ...
        let federation_id_binding = args.federation_id.get_output(ctx);
