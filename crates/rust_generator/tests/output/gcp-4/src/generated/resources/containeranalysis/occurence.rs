...
pub mod occurence {
    ...
    fn __create(
        ...
        let attestation_binding = args.attestation.get_output(ctx);
        let note_name_binding = args.note_name.get_output(ctx);
        let project_binding = args.project.get_output(ctx);
        let remediation_binding = args.remediation.get_output(ctx);
        let resource_uri_binding = args.resource_uri.get_output(ctx);
