...
pub mod aspect_type {
    ...
    pub struct AspectTypeArgs {
        ...
        pub aspect_type_id: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub metadata_template: pulumi_gestalt_rust::Input<Option<String>>,
    ...
    fn __create(
        ...
        let aspect_type_id_binding = args.aspect_type_id.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let display_name_binding = args.display_name.get_output(ctx);
        let labels_binding = args.labels.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let metadata_template_binding = args.metadata_template.get_output(ctx);
