...
pub mod connection_profile {
    ...
    fn __create(
        ...
        let bigquery_profile_binding = args.bigquery_profile.get_output(ctx);
        ...
        let forward_ssh_connectivity_binding = args
            ...
            .get_output(ctx);
        let gcs_profile_binding = args.gcs_profile.get_output(ctx);
        let labels_binding = args.labels.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let mysql_profile_binding = args.mysql_profile.get_output(ctx);
        let oracle_profile_binding = args.oracle_profile.get_output(ctx);
        let postgresql_profile_binding = args.postgresql_profile.get_output(ctx);
        let private_connectivity_binding = args.private_connectivity.get_output(ctx);
        let project_binding = args.project.get_output(ctx);
        let sql_server_profile_binding = args.sql_server_profile.get_output(ctx);
