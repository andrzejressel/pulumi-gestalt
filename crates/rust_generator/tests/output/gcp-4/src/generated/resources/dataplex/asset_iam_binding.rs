...
pub mod asset_iam_binding {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct AssetIamBindingArgs {
        /// Used to find the parent resource to bind the IAM policy to
        #[builder(into)]
        pub asset: pulumi_gestalt_rust::Input<String>,
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::Input<
            Option<super::super::types::dataplex::AssetIamBindingCondition>,
        >,
        #[builder(into)]
    ...
    #[allow(dead_code)]
    pub struct AssetIamBindingResult {
    ...
    fn __create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:dataplex/assetIamBinding:AssetIamBinding".into(),
            name: name.to_string(),
            version: super::super::get_version(),
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "asset".into(),
                    value: &asset_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "condition".into(),
