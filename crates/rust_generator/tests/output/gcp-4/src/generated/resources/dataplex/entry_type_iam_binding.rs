...
pub mod entry_type_iam_binding {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct EntryTypeIamBindingArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::Input<
            Option<super::super::types::dataplex::EntryTypeIamBindingCondition>,
        >,
        #[builder(into)]
        pub entry_type_id: pulumi_gestalt_rust::Input<String>,
    ...
    #[allow(dead_code)]
    pub struct EntryTypeIamBindingResult {
    ...
    fn __create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:dataplex/entryTypeIamBinding:EntryTypeIamBinding".into(),
            name: name.to_string(),
