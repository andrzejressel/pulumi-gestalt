            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#cloud_storage_resource_reference: {
                        let field_value = match fields_map.get("cloudStorageResourceReference") {
                            Some(value) => value,
                            None => bail!("Missing field 'cloudStorageResourceReference' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
