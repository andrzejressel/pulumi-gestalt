...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetMetastoreServiceScheduledBackup {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetMetastoreServiceScheduledBackup {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#backup_location: {
                        let field_value = match fields_map.get("backupLocation") {
                            Some(value) => value,
                            None => bail!("Missing field 'backupLocation' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
