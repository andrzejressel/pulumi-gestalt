...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ConnectionProfileOracleProfile {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ConnectionProfileOracleProfile {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#connection_attributes: {
                        let field_value = match fields_map.get("connectionAttributes") {
                            Some(value) => value,
                            None => bail!("Missing field 'connectionAttributes' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
