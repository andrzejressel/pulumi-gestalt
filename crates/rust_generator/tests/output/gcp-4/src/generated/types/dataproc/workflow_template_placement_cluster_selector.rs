...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WorkflowTemplatePlacementClusterSelector {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WorkflowTemplatePlacementClusterSelector {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#cluster_labels: {
                        let field_value = match fields_map.get("cluster_labels") {
                            Some(value) => value,
                            None => bail!("Missing field 'cluster_labels' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
