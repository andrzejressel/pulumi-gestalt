...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PreventionDiscoveryConfigTargetBigQueryTarget {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PreventionDiscoveryConfigTargetBigQueryTarget {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#cadence: {
                        let field_value = match fields_map.get("cadence") {
                            Some(value) => value,
                            None => bail!("Missing field 'cadence' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
