...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for MetastoreServiceHiveMetastoreConfigKerberosConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for MetastoreServiceHiveMetastoreConfigKerberosConfig {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#keytab: {
                        let field_value = match fields_map.get("keytab") {
                            Some(value) => value,
                            None => bail!("Missing field 'keytab' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
