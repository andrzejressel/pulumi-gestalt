...
pub struct StreamBackfillAllOracleExcludedObjectsOracleSchemaOracleTableOracleColumn {
    /// Column name.
    #[builder(into)]
    #[serde(rename = "column")]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for StreamBackfillAllOracleExcludedObjectsOracleSchemaOracleTableOracleColumn {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for StreamBackfillAllOracleExcludedObjectsOracleSchemaOracleTableOracleColumn {
