...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetMetastoreServiceScalingConfigAutoscalingConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "autoscaling_enabled".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#autoscaling_enabled,
                )
                .await,
            );
            map.insert(
                "limit_configs".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#limit_configs,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetMetastoreServiceScalingConfigAutoscalingConfig {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#limit_configs: {
                        let field_value = match fields_map.get("limit_configs") {
                            Some(value) => value,
                            None => bail!("Missing field 'limit_configs' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
