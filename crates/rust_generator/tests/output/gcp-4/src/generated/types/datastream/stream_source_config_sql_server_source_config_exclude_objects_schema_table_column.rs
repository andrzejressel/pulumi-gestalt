...
pub struct StreamSourceConfigSqlServerSourceConfigExcludeObjectsSchemaTableColumn {
    /// Column name.
    #[builder(into)]
    #[serde(rename = "column")]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for StreamSourceConfigSqlServerSourceConfigExcludeObjectsSchemaTableColumn {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for StreamSourceConfigSqlServerSourceConfigExcludeObjectsSchemaTableColumn {
