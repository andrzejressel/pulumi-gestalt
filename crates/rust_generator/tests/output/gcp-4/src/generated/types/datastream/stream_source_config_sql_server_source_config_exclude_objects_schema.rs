...
pub struct StreamSourceConfigSqlServerSourceConfigExcludeObjectsSchema {
    /// Schema name.
    #[builder(into)]
    #[serde(rename = "schema")]
    pub r#schema: String,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for StreamSourceConfigSqlServerSourceConfigExcludeObjectsSchema {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for StreamSourceConfigSqlServerSourceConfigExcludeObjectsSchema {
