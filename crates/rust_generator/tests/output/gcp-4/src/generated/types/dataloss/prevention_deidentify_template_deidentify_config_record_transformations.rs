...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PreventionDeidentifyTemplateDeidentifyConfigRecordTransformations {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "field_transformations".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#field_transformations,
                )
                .await,
            );
            map.insert(
                "record_suppressions".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#record_suppressions,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PreventionDeidentifyTemplateDeidentifyConfigRecordTransformations {
