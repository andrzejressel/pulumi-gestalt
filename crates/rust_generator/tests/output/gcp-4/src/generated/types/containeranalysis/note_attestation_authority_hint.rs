...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for NoteAttestationAuthorityHint {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "human_readable_name".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#human_readable_name,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for NoteAttestationAuthorityHint {
