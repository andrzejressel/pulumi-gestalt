...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for JobScheduling {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "max_failures_per_hour".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for JobScheduling {
