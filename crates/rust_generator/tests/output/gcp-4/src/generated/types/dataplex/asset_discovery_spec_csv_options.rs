...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AssetDiscoverySpecCsvOptions {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "disable_type_inference".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AssetDiscoverySpecCsvOptions {
