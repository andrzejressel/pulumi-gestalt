...
pub struct GetMetastoreServiceScalingConfig {
    ...
    pub r#autoscaling_configs: Vec<super::super::types::dataproc::GetMetastoreServiceScalingConfigAutoscalingConfig>,
    /// Metastore instance sizes. Possible values: ["EXTRA_SMALL", "SMALL", "MEDIUM", "LARGE", "EXTRA_LARGE"]
    #[builder(into)]
    #[serde(rename = "instanceSize")]
    pub r#instance_size: String,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetMetastoreServiceScalingConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetMetastoreServiceScalingConfig {
