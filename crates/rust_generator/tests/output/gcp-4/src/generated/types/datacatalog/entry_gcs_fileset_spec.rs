            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#sample_gcs_file_specs: {
                        let field_value = match fields_map.get("sampleGcsFileSpecs") {
                            Some(value) => value,
                            None => bail!("Missing field 'sampleGcsFileSpecs' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
