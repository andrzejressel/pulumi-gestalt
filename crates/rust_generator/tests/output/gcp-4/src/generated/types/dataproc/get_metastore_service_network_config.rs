...
pub struct GetMetastoreServiceNetworkConfig {
    ...
    pub r#consumers: Vec<super::super::types::dataproc::GetMetastoreServiceNetworkConfigConsumer>,
    /// Enables custom routes to be imported and exported for the Dataproc Metastore service's peered VPC network.
    #[builder(into)]
    #[serde(rename = "customRoutesEnabled")]
    pub r#custom_routes_enabled: bool,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetMetastoreServiceNetworkConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetMetastoreServiceNetworkConfig {
