...
pub struct StreamBackfillAllSqlServerExcludedObjectsSchemaTable {
    ...
    pub r#columns: Option<Vec<super::super::types::datastream::StreamBackfillAllSqlServerExcludedObjectsSchemaTableColumn>>,
    /// Table name.
    #[builder(into)]
    #[serde(rename = "table")]
    pub r#table: String,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for StreamBackfillAllSqlServerExcludedObjectsSchemaTable {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for StreamBackfillAllSqlServerExcludedObjectsSchemaTable {
