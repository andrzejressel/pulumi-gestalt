...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PreventionJobTriggerInspectJobInspectConfigRuleSetRule {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "exclusion_rule".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#exclusion_rule,
                )
                .await,
            );
            map.insert(
                "hotword_rule".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#hotword_rule,
                )
                .await,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PreventionJobTriggerInspectJobInspectConfigRuleSetRule {
