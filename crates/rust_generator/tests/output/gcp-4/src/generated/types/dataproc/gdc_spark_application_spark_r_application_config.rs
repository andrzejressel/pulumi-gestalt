...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GdcSparkApplicationSparkRApplicationConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "main_r_file_uri".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#main_r_file_uri,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GdcSparkApplicationSparkRApplicationConfig {
