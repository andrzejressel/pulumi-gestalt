...
pub struct PreventionJobTriggerInspectJobStorageConfigHybridOptionsTableOptions {
    ...
    pub r#identifying_fields: Option<Vec<super::super::types::dataloss::PreventionJobTriggerInspectJobStorageConfigHybridOptionsTableOptionsIdentifyingField>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PreventionJobTriggerInspectJobStorageConfigHybridOptionsTableOptions {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PreventionJobTriggerInspectJobStorageConfigHybridOptionsTableOptions {
