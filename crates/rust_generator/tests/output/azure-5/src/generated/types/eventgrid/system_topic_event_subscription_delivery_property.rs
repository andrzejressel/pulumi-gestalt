...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for SystemTopicEventSubscriptionDeliveryProperty {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for SystemTopicEventSubscriptionDeliveryProperty {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#source_field: {
                        let field_value = match fields_map.get("source_field") {
                            Some(value) => value,
                            None => bail!("Missing field 'source_field' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#type_: {
