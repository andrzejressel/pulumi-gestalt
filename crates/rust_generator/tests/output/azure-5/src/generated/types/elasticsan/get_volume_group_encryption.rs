...
pub struct GetVolumeGroupEncryption {
    ...
    pub r#current_versioned_key_expiration_timestamp: String,
    /// The ID of the current versioned Key Vault Key in use.
    #[builder(into)]
    #[serde(rename = "currentVersionedKeyId")]
    pub r#current_versioned_key_id: String,
    ...
    pub r#last_key_rotation_timestamp: String,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetVolumeGroupEncryption {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetVolumeGroupEncryption {
