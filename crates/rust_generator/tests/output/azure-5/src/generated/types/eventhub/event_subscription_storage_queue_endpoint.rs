...
pub struct EventSubscriptionStorageQueueEndpoint {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EventSubscriptionStorageQueueEndpoint {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "queue_message_time_to_live_in_seconds".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for EventSubscriptionStorageQueueEndpoint {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#queue_message_time_to_live_in_seconds: {
                        let field_value = match fields_map.get("queue_message_time_to_live_in_seconds") {
                            Some(value) => value,
                            None => bail!("Missing field 'queue_message_time_to_live_in_seconds' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
