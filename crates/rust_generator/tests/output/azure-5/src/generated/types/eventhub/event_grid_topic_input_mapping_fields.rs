...
pub struct EventGridTopicInputMappingFields {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EventGridTopicInputMappingFields {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for EventGridTopicInputMappingFields {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#data_version: {
                        let field_value = match fields_map.get("dataVersion") {
                            Some(value) => value,
                            None => bail!("Missing field 'dataVersion' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#event_time: {
                        let field_value = match fields_map.get("eventTime") {
                            Some(value) => value,
                            None => bail!("Missing field 'eventTime' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#event_type: {
