...
pub mod elastic_san {
    ...
    fn __create(
        ...
        let base_size_in_tib_binding = args.base_size_in_tib.get_output(ctx);
        let extended_size_in_tib_binding = args.extended_size_in_tib.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &base_size_in_tib_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "extendedSizeInTib".into(),
                    value: &extended_size_in_tib_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "location".into(),
