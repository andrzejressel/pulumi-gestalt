...
pub mod domain {
    ...
    fn __create(
        ...
        let inbound_ip_rules_binding = args.inbound_ip_rules.get_output(ctx);
        let input_mapping_default_values_binding = args
            .input_mapping_default_values
            .get_output(ctx);
        let input_mapping_fields_binding = args.input_mapping_fields.get_output(ctx);
        let input_schema_binding = args.input_schema.get_output(ctx);
