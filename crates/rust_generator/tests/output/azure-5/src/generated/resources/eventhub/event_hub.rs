...
pub mod event_hub {
    ...
    fn __create(
        ...
        let capture_description_binding = args.capture_description.get_output(ctx);
        let message_retention_binding = args.message_retention.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &capture_description_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "messageRetention".into(),
                    value: &message_retention_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
