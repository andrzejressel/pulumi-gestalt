...
pub mod system_topic {
    ...
    pub struct SystemTopicArgs {
        ...
        #[builder(into)]
        pub source_arm_resource_id: pulumi_gestalt_rust::Input<String>,
        #[builder(into, default)]
        ...
        #[builder(into)]
        pub topic_type: pulumi_gestalt_rust::Input<String>,
    }
    #[allow(dead_code)]
    ...
    fn __create(
        ...
        let source_arm_resource_id_binding = args.source_arm_resource_id.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let topic_type_binding = args.topic_type.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &source_arm_resource_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "tags".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "topicType".into(),
                    value: &topic_type_binding.drop_type(),
                },
            ],
            options,
        };
