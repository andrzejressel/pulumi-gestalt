...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EventEndpointRoutingConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("failover_config".to_string(), self.r#failover_config.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for EventEndpointRoutingConfig {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#failover_config: {
                        ...
                        <Box<super::super::types::cloudwatch::EventEndpointRoutingConfigFailoverConfig> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
