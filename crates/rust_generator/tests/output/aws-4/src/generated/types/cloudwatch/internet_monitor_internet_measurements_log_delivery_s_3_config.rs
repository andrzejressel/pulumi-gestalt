            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#log_delivery_status: {
                        let field_value = match fields_map.get("logDeliveryStatus") {
                            Some(value) => value,
                            None => bail!("Missing field 'logDeliveryStatus' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
