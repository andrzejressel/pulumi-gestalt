...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ProjectSecondarySourceBuildStatusConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("context".to_string(), self.r#context.to_pulumi_value().await);
            map.insert("target_url".to_string(), self.r#target_url.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ProjectSecondarySourceBuildStatusConfig {
