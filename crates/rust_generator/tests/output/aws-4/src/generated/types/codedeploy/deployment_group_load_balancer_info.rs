...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DeploymentGroupLoadBalancerInfo {
    ...
    > {
        async move {
            ...
            map.insert("elb_infos".to_string(), self.r#elb_infos.to_pulumi_value().await);
            map.insert("target_group_infos".to_string(), self.r#target_group_infos.to_pulumi_value().await);
            map.insert("target_group_pair_info".to_string(), self.r#target_group_pair_info.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#elb_infos: {
                        ...
                        <Option<Vec<super::super::types::codedeploy::DeploymentGroupLoadBalancerInfoElbInfo>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#target_group_infos: {
                        ...
                        <Option<Vec<super::super::types::codedeploy::DeploymentGroupLoadBalancerInfoTargetGroupInfo>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#target_group_pair_info: {
                        ...
                        <Option<Box<super::super::types::codedeploy::DeploymentGroupLoadBalancerInfoTargetGroupPairInfo>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
