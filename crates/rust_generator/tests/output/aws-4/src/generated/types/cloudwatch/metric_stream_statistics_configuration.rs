...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for MetricStreamStatisticsConfiguration {
    ...
    > {
        async move {
            ...
            map.insert("additional_statistics".to_string(), self.r#additional_statistics.to_pulumi_value().await);
            map.insert("include_metrics".to_string(), self.r#include_metrics.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#include_metrics: {
                        ...
                        <Vec<super::super::types::cloudwatch::MetricStreamStatisticsConfigurationIncludeMetric> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
