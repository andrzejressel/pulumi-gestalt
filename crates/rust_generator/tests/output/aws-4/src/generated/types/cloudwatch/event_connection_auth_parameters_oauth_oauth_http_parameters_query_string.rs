...
pub struct EventConnectionAuthParametersOauthOauthHttpParametersQueryString {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EventConnectionAuthParametersOauthOauthHttpParametersQueryString {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("is_value_secret".to_string(), self.r#is_value_secret.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for EventConnectionAuthParametersOauthOauthHttpParametersQueryString {
