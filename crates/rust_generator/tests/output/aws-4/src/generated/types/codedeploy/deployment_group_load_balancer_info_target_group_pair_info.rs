...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DeploymentGroupLoadBalancerInfoTargetGroupPairInfo {
    ...
    > {
        async move {
            ...
            map.insert("prod_traffic_route".to_string(), self.r#prod_traffic_route.to_pulumi_value().await);
            map.insert("target_groups".to_string(), self.r#target_groups.to_pulumi_value().await);
            map.insert("test_traffic_route".to_string(), self.r#test_traffic_route.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#prod_traffic_route: {
                        ...
                        <Box<super::super::types::codedeploy::DeploymentGroupLoadBalancerInfoTargetGroupPairInfoProdTrafficRoute> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#target_groups: {
                        ...
                        <Vec<super::super::types::codedeploy::DeploymentGroupLoadBalancerInfoTargetGroupPairInfoTargetGroup> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#test_traffic_route: {
                        ...
                        <Option<Box<super::super::types::codedeploy::DeploymentGroupLoadBalancerInfoTargetGroupPairInfoTestTrafficRoute>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
