            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#cloudwatch_logs: {
                        ...
                        <Option<Box<super::super::types::cloudwatch::GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationCloudwatchLogs>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#firehose: {
                        ...
                        <Option<Box<super::super::types::cloudwatch::GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationFirehose>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#s_3: {
                        ...
                        <Option<Box<super::super::types::cloudwatch::GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationS3>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
