...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EventTargetAppsyncTarget {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("graphql_operation".to_string(), self.r#graphql_operation.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for EventTargetAppsyncTarget {
