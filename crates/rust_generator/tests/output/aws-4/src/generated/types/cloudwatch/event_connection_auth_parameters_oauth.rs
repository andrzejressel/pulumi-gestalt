...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EventConnectionAuthParametersOauth {
    ...
    > {
        async move {
            ...
            map.insert("client_parameters".to_string(), self.r#client_parameters.to_pulumi_value().await);
            map.insert("http_method".to_string(), self.r#http_method.to_pulumi_value().await);
            map.insert("oauth_http_parameters".to_string(), self.r#oauth_http_parameters.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#client_parameters: {
                        ...
                        <Option<Box<super::super::types::cloudwatch::EventConnectionAuthParametersOauthClientParameters>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#http_method: {
                    ...
                    r#oauth_http_parameters: {
                        ...
                        <Box<super::super::types::cloudwatch::EventConnectionAuthParametersOauthOauthHttpParameters> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
