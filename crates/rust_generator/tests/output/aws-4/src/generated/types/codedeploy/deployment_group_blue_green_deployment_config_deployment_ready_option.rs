...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DeploymentGroupBlueGreenDeploymentConfigDeploymentReadyOption {
    ...
    > {
        async move {
            ...
            map.insert("action_on_timeout".to_string(), self.r#action_on_timeout.to_pulumi_value().await);
            map.insert("wait_time_in_minutes".to_string(), self.r#wait_time_in_minutes.to_pulumi_value().await);
