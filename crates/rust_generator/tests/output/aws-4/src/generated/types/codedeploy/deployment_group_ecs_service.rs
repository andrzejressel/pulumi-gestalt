...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DeploymentGroupEcsService {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("cluster_name".to_string(), self.r#cluster_name.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DeploymentGroupEcsService {
