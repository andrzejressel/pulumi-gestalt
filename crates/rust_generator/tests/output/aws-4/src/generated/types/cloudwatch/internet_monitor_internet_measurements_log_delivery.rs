...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for InternetMonitorInternetMeasurementsLogDelivery {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for InternetMonitorInternetMeasurementsLogDelivery {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#s_3_config: {
                        ...
                        <Option<Box<super::super::types::cloudwatch::InternetMonitorInternetMeasurementsLogDeliveryS3Config>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
