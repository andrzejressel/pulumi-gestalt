...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ProjectEnvironmentRegistryCredential {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("credential".to_string(), self.r#credential.to_pulumi_value().await);
            map.insert("credential_provider".to_string(), self.r#credential_provider.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ProjectEnvironmentRegistryCredential {
