...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EventTargetEcsTarget {
    ...
    > {
        async move {
            ...
            map.insert("ordered_placement_strategies".to_string(), self.r#ordered_placement_strategies.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#capacity_provider_strategies: {
                        ...
                        <Option<Vec<super::super::types::cloudwatch::EventTargetEcsTargetCapacityProviderStrategy>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    ...
                    r#network_configuration: {
                        ...
                        <Option<Box<super::super::types::cloudwatch::EventTargetEcsTargetNetworkConfiguration>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#ordered_placement_strategies: {
                        ...
                        <Option<Vec<super::super::types::cloudwatch::EventTargetEcsTargetOrderedPlacementStrategy>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#placement_constraints: {
                        ...
                        <Option<Vec<super::super::types::cloudwatch::EventTargetEcsTargetPlacementConstraint>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#platform_version: {
