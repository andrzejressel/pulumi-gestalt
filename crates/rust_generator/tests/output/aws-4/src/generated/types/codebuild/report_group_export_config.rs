...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ReportGroupExportConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ReportGroupExportConfig {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#s_3_destination: {
                        ...
                        <Option<Box<super::super::types::codebuild::ReportGroupExportConfigS3Destination>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#type_: {
