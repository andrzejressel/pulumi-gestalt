...
pub mod report_group {
    ...
    fn __create(
        ...
        let delete_reports_binding = args.delete_reports.get_output(ctx);
        let export_config_binding = args.export_config.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &delete_reports_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "exportConfig".into(),
                    value: &export_config_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
