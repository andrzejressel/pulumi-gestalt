...
pub mod event_api_destination {
    ...
    pub struct EventApiDestinationArgs {
        ...
        #[builder(into)]
        pub connection_arn: pulumi_gestalt_rust::Input<String>,
    ...
    fn __create(
        ...
        let connection_arn_binding = args.connection_arn.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let http_method_binding = args.http_method.get_output(ctx);
        let invocation_endpoint_binding = args.invocation_endpoint.get_output(ctx);
