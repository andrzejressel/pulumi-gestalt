...
pub mod repository {
    ...
    fn __create(
        ...
        let external_connections_binding = args.external_connections.get_output(ctx);
        let repository_binding = args.repository.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let upstreams_binding = args.upstreams.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &external_connections_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "upstreams".into(),
                    value: &upstreams_binding.drop_type(),
                },
            ],
            options,
        };
