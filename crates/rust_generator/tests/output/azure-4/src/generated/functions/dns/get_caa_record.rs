...
pub mod get_caa_record {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct GetCaaRecordArgs {
    ...
    pub struct GetCaaRecordResult {
        ...
        pub records: pulumi_gestalt_rust::Output<
            Vec<super::super::super::types::dns::GetCaaRecordRecord>,
        >,
    ...
    pub fn invoke(
        ...
        let request = pulumi_gestalt_rust::InvokeResourceRequest {
            token: "azure:dns/getCAARecord:getCAARecord".into(),
