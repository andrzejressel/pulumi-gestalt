...
pub struct GetWorkspaceManagedDiskIdentity {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetWorkspaceManagedDiskIdentity {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetWorkspaceManagedDiskIdentity {
