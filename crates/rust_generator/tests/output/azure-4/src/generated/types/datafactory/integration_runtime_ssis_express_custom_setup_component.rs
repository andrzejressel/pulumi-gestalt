...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for IntegrationRuntimeSsisExpressCustomSetupComponent {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "key_vault_license".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#key_vault_license,
                )
                .await,
            );
            map.insert(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for IntegrationRuntimeSsisExpressCustomSetupComponent {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#key_vault_license: {
                        let field_value = match fields_map.get("key_vault_license") {
                            Some(value) => value,
                            None => bail!("Missing field 'key_vault_license' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
