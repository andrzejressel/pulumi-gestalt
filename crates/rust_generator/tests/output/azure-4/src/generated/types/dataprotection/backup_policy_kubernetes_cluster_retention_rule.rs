...
pub struct BackupPolicyKubernetesClusterRetentionRule {
    ...
    pub r#life_cycles: Vec<super::super::types::dataprotection::BackupPolicyKubernetesClusterRetentionRuleLifeCycle>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BackupPolicyKubernetesClusterRetentionRule {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BackupPolicyKubernetesClusterRetentionRule {
