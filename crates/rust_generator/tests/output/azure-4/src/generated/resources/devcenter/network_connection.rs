...
pub mod network_connection {
    ...
    fn __create(
        ...
        let domain_join_type_binding = args.domain_join_type.get_output(ctx);
        let domain_name_binding = args.domain_name.get_output(ctx);
        let domain_password_binding = args.domain_password.get_output(ctx);
        let domain_username_binding = args.domain_username.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let organization_unit_binding = args.organization_unit.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &domain_join_type_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &domain_password_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "domainUsername".into(),
                    value: &domain_username_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "location".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &organization_unit_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
