...
pub mod integration_runtime_rule {
    ...
    fn __create(
        ...
        let cleanup_enabled_binding = args.cleanup_enabled.get_output(ctx);
        let compute_type_binding = args.compute_type.get_output(ctx);
        let core_count_binding = args.core_count.get_output(ctx);
        let data_factory_id_binding = args.data_factory_id.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let time_to_live_min_binding = args.time_to_live_min.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &cleanup_enabled_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
