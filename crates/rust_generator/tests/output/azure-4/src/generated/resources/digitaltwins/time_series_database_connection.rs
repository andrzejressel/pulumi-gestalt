...
pub mod time_series_database_connection {
    ...
    fn __create(
        ...
        let digital_twins_id_binding = args.digital_twins_id.get_output(ctx);
        ...
        let eventhub_namespace_endpoint_uri_binding = args
            ...
            .get_output(ctx);
        let eventhub_namespace_id_binding = args.eventhub_namespace_id.get_output(ctx);
        let kusto_cluster_id_binding = args.kusto_cluster_id.get_output(ctx);
        let kusto_cluster_uri_binding = args.kusto_cluster_uri.get_output(ctx);
        let kusto_database_name_binding = args.kusto_database_name.get_output(ctx);
        let kusto_table_name_binding = args.kusto_table_name.get_output(ctx);
