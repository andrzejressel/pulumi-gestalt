...
pub mod monitor {
    ...
    fn __create(
        ...
        let datadog_organization_binding = args.datadog_organization.get_output(ctx);
        let identity_binding = args.identity.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let monitoring_enabled_binding = args.monitoring_enabled.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &datadog_organization_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "identity".into(),
