...
pub mod dataset_azure_blob {
    ...
    pub struct DatasetAzureBlobArgs {
        ...
        #[builder(into, default)]
        pub dynamic_filename_enabled: pulumi_gestalt_rust::Input<Option<bool>>,
        /// Is the `path` using dynamic expression, function or system variables? Defaults to `false`.
        #[builder(into, default)]
        pub dynamic_path_enabled: pulumi_gestalt_rust::Input<Option<bool>>,
    ...
    fn __create(
        ...
        let dynamic_filename_enabled_binding = args
            ...
            .get_output(ctx);
        let dynamic_path_enabled_binding = args.dynamic_path_enabled.get_output(ctx);
