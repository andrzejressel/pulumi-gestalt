...
///             .build_struct(),
///     );
///     let exampleDatasetMysql = dataset_mysql::create(
///         "exampleDatasetMysql",
///         DatasetMysqlArgs::builder()
///             .data_factory_id("${exampleFactory.id}")
///             .linked_service_name("${exampleLinkedServiceMysql.name}")
///             .name("example")
///             .build_struct(),
///     );
...
pub mod dataset_mysql {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct DatasetMysqlArgs {
