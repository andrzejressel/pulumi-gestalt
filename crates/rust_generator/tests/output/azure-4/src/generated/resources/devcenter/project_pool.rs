...
pub mod project_pool {
    ...
    fn __create(
        ...
        let dev_center_attached_network_name_binding = args
            ...
            .get_output(ctx);
        let dev_center_project_id_binding = args.dev_center_project_id.get_output(ctx);
        ...
        ProjectPoolResult {
            ...
            local_administrator_enabled: o.get_field("localAdministratorEnabled"),
            location: o.get_field("location"),
            name: o.get_field("name"),
            stop_on_disconnect_grace_period_minutes: o
                .get_field("stopOnDisconnectGracePeriodMinutes"),
