...
pub mod schedule {
    ...
    fn __create(
        ...
        let daily_recurrence_binding = args.daily_recurrence.get_output(ctx);
        let hourly_recurrence_binding = args.hourly_recurrence.get_output(ctx);
        let lab_name_binding = args.lab_name.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let notification_settings_binding = args.notification_settings.get_output(ctx);
        let resource_group_name_binding = args.resource_group_name.get_output(ctx);
        let status_binding = args.status.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let task_type_binding = args.task_type.get_output(ctx);
        let time_zone_id_binding = args.time_zone_id.get_output(ctx);
        let weekly_recurrence_binding = args.weekly_recurrence.get_output(ctx);
