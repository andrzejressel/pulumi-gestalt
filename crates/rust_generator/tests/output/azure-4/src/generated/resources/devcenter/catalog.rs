...
pub mod catalog {
    ...
    fn __create(
        ...
        let catalog_adogit_binding = args.catalog_adogit.get_output(ctx);
        let catalog_github_binding = args.catalog_github.get_output(ctx);
        let dev_center_id_binding = args.dev_center_id.get_output(ctx);
