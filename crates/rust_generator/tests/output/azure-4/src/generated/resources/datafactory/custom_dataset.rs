...
pub mod custom_dataset {
    ...
    fn __create(
        ...
        let linked_service_binding = args.linked_service.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let parameters_binding = args.parameters.get_output(ctx);
        let schema_json_binding = args.schema_json.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &linked_service_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &schema_json_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "type".into(),
