...
pub mod dataset_http {
    ...
    pub struct DatasetHttpArgs {
        ...
        #[builder(into, default)]
        pub relative_url: pulumi_gestalt_rust::Input<Option<String>>,
        /// The body for the HTTP request.
        #[builder(into, default)]
        pub request_body: pulumi_gestalt_rust::Input<Option<String>>,
        /// The HTTP method for the HTTP request. (e.g. GET, POST)
        #[builder(into, default)]
        pub request_method: pulumi_gestalt_rust::Input<Option<String>>,
    ...
    fn __create(
        ...
        let relative_url_binding = args.relative_url.get_output(ctx);
        let request_body_binding = args.request_body.get_output(ctx);
        let request_method_binding = args.request_method.get_output(ctx);
