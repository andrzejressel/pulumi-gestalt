...
pub mod policy {
    ...
    fn __create(
        ...
        let evaluator_type_binding = args.evaluator_type.get_output(ctx);
        let fact_data_binding = args.fact_data.get_output(ctx);
        let lab_name_binding = args.lab_name.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let policy_set_name_binding = args.policy_set_name.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &evaluator_type_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "factData".into(),
                    value: &fact_data_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "labName".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &policy_set_name_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
