...
pub mod dataset_azure_sql_table {
    ...
    pub struct DatasetAzureSqlTableArgs {
        ...
        #[builder(into)]
        pub linked_service_id: pulumi_gestalt_rust::Input<String>,
    ...
    fn __create(
        ...
        let linked_service_id_binding = args.linked_service_id.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &linked_service_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
