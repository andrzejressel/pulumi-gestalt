...
pub mod workspace {
    ...
    pub struct WorkspaceArgs {
        ...
        pub access_connector_id: pulumi_gestalt_rust::Input<Option<String>>,
        /// A `custom_parameters` block as documented below.
        #[builder(into, default)]
        pub custom_parameters: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub default_storage_firewall_enabled: pulumi_gestalt_rust::Input<Option<bool>>,
        /// An `enhanced_security_compliance` block as documented below. This feature is only valid if `sku` is set to `premium`.
        #[builder(into, default)]
        pub enhanced_security_compliance: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub load_balancer_backend_address_pool_id: pulumi_gestalt_rust::Input<
            Option<String>,
        >,
        ...
        #[builder(into, default)]
        pub managed_disk_cmk_key_vault_id: pulumi_gestalt_rust::Input<Option<String>>,
        /// Customer managed encryption properties for the Databricks Workspace managed disks.
        #[builder(into, default)]
        pub managed_disk_cmk_key_vault_key_id: pulumi_gestalt_rust::Input<
            Option<String>,
        >,
        /// Whether customer managed keys for disk encryption will automatically be rotated to the latest version.
        #[builder(into, default)]
        pub managed_disk_cmk_rotation_to_latest_version_enabled: pulumi_gestalt_rust::Input<
            Option<bool>,
        >,
        ...
        #[builder(into, default)]
        pub managed_services_cmk_key_vault_id: pulumi_gestalt_rust::Input<
            Option<String>,
        >,
        /// Customer managed encryption properties for the Databricks Workspace managed resources(e.g. Notebooks and Artifacts).
        #[builder(into, default)]
        pub managed_services_cmk_key_vault_key_id: pulumi_gestalt_rust::Input<
            Option<String>,
        >,
        ...
        #[builder(into, default)]
        pub network_security_group_rules_required: pulumi_gestalt_rust::Input<
            Option<String>,
        >,
