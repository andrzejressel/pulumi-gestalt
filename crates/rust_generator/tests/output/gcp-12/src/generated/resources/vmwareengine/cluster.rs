...
pub mod cluster {
    ...
    fn __create(
        ...
        let autoscaling_settings_binding = args.autoscaling_settings.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let node_type_configs_binding = args.node_type_configs.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &autoscaling_settings_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "name".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &node_type_configs_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "parent".into(),
