...
pub mod workstation_iam_binding {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct WorkstationIamBindingArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::Input<
            Option<super::super::types::workstations::WorkstationIamBindingCondition>,
        >,
    ...
    #[allow(dead_code)]
    pub struct WorkstationIamBindingResult {
