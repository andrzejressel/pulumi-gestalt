...
pub mod workstation_iam_member {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct WorkstationIamMemberArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::workstations::WorkstationIamMemberCondition>,
        >,
    ...
    #[allow(dead_code)]
    pub struct WorkstationIamMemberResult {
    ...
    fn __create(
        ...
        let workstation_id_binding = args.workstation_id.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:workstations/workstationIamMember:WorkstationIamMember".into(),
            name: name.to_string(),
