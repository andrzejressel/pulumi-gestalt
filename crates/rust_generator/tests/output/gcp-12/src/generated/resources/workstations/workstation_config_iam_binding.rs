...
pub mod workstation_config_iam_binding {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct WorkstationConfigIamBindingArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<
                super::super::types::workstations::WorkstationConfigIamBindingCondition,
            >,
        >,
    ...
    #[allow(dead_code)]
    pub struct WorkstationConfigIamBindingResult {
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:workstations/workstationConfigIamBinding:WorkstationConfigIamBinding"
                .into(),
            name: name.to_string(),
