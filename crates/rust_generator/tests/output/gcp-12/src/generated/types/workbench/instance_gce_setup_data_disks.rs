...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for InstanceGceSetupDataDisks {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for InstanceGceSetupDataDisks {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#disk_encryption: {
                        let field_value = match fields_map.get("diskEncryption") {
                            Some(value) => value,
                            None => bail!("Missing field 'diskEncryption' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
