...
pub struct ClusterAutoscalingSettings {
    ...
    pub r#autoscaling_policies: Vec<super::super::types::vmwareengine::ClusterAutoscalingSettingsAutoscalingPolicy>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClusterAutoscalingSettings {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "autoscaling_policies".to_string(),
            ...
            map.insert(
                "max_cluster_node_count".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "min_cluster_node_count".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ClusterAutoscalingSettings {
