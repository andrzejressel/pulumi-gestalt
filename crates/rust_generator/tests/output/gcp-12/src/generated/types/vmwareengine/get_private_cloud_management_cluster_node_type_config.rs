...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetPrivateCloudManagementClusterNodeTypeConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetPrivateCloudManagementClusterNodeTypeConfig {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#custom_core_count: {
                        let field_value = match fields_map.get("customCoreCount") {
                            Some(value) => value,
                            None => bail!("Missing field 'customCoreCount' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
