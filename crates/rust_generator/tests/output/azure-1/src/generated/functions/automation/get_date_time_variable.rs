...
pub mod get_date_time_variable {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct GetDateTimeVariableArgs {
    ...
    #[allow(dead_code)]
    pub struct GetDateTimeVariableResult {
    ...
    pub fn invoke(
        ...
        let request = pulumi_gestalt_rust::InvokeResourceRequest {
            token: "azure:automation/getDateTimeVariable:getDateTimeVariable".into(),
