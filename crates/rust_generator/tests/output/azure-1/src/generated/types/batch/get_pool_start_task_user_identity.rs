...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetPoolStartTaskUserIdentity {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetPoolStartTaskUserIdentity {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#auto_users: {
                        let field_value = match fields_map.get("auto_users") {
                            Some(value) => value,
                            None => bail!("Missing field 'auto_users' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
