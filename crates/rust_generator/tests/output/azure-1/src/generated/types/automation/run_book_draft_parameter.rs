...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RunBookDraftParameter {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RunBookDraftParameter {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#mandatory: {
                        let field_value = match fields_map.get("mandatory") {
                            Some(value) => value,
                            None => bail!("Missing field 'mandatory' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#position: {
