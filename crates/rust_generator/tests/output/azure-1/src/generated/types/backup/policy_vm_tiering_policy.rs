...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PolicyVmTieringPolicy {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "archived_restore_point".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#archived_restore_point,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PolicyVmTieringPolicy {
