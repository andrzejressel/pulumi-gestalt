            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#frequency_in_minutes: {
                        let field_value = match fields_map.get("frequencyInMinutes") {
                            Some(value) => value,
                            None => bail!("Missing field 'frequencyInMinutes' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#time: {
