...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ProviderFeaturesTemplateDeployment {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "delete_nested_items_during_deletion".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#delete_nested_items_during_deletion,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ProviderFeaturesTemplateDeployment {
