...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PoolUserAccount {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "linux_user_configurations".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "windows_user_configurations".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PoolUserAccount {
