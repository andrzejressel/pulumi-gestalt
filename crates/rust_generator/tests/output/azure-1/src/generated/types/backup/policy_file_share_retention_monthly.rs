...
pub struct PolicyFileShareRetentionMonthly {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PolicyFileShareRetentionMonthly {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for PolicyFileShareRetentionMonthly {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#include_last_days: {
                        let field_value = match fields_map.get("includeLastDays") {
                            Some(value) => value,
                            None => bail!("Missing field 'includeLastDays' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#weekdays: {
