...
pub struct GetPoolAutoScale {
    ...
    pub r#evaluation_interval: String,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetPoolAutoScale {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetPoolAutoScale {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#formula: {
                        let field_value = match fields_map.get("formula") {
                            Some(value) => value,
                            None => bail!("Missing field 'formula' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
