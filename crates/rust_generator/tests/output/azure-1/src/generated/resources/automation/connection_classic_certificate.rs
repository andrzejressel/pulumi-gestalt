...
pub mod connection_classic_certificate {
    ...
    pub struct ConnectionClassicCertificateArgs {
        ...
        #[builder(into)]
        pub certificate_asset_name: pulumi_gestalt_rust::Input<String>,
    ...
    fn __create(
        ...
        let automation_account_name_binding = args
            ...
            .get_output(ctx);
        let certificate_asset_name_binding = args.certificate_asset_name.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let resource_group_name_binding = args.resource_group_name.get_output(ctx);
        let subscription_id_binding = args.subscription_id.get_output(ctx);
        let subscription_name_binding = args.subscription_name.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &certificate_asset_name_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
