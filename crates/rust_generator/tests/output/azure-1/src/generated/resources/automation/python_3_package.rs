...
pub mod python_3_package {
    ...
    fn __create(
        ...
        let automation_account_name_binding = args
            ...
            .get_output(ctx);
        let content_uri_binding = args.content_uri.get_output(ctx);
        let content_version_binding = args.content_version.get_output(ctx);
        let hash_algorithm_binding = args.hash_algorithm.get_output(ctx);
        let hash_value_binding = args.hash_value.get_output(ctx);
