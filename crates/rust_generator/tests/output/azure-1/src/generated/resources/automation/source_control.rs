...
pub mod source_control {
    ...
    fn __create(
        ...
        let automatic_sync_binding = args.automatic_sync.get_output(ctx);
        ...
        let folder_path_binding = args.folder_path.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let publish_runbook_enabled_binding = args
            .publish_runbook_enabled
            .get_output(ctx);
        let repository_url_binding = args.repository_url.get_output(ctx);
        let security_binding = args.security.get_output(ctx);
        let source_control_type_binding = args.source_control_type.get_output(ctx);
