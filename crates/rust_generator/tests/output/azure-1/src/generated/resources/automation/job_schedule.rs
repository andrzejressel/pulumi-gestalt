...
pub mod job_schedule {
    ...
    fn __create(
        ...
        let automation_account_name_binding = args
            ...
            .get_output(ctx);
        let job_schedule_id_binding = args.job_schedule_id.get_output(ctx);
        let parameters_binding = args.parameters.get_output(ctx);
        let resource_group_name_binding = args.resource_group_name.get_output(ctx);
        let run_on_binding = args.run_on.get_output(ctx);
        let runbook_name_binding = args.runbook_name.get_output(ctx);
        let schedule_name_binding = args.schedule_name.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &job_schedule_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "runOn".into(),
                    value: &run_on_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "runbookName".into(),
                    value: &runbook_name_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
