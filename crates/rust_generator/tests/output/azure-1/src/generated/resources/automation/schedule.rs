...
pub mod schedule {
    ...
    fn __create(
        ...
        let month_days_binding = args.month_days.get_output(ctx);
        let monthly_occurrence_binding = args.monthly_occurrence.get_output(ctx);
        ...
        let week_days_binding = args.week_days.get_output(ctx);
