...
///             .build_struct(),
///     );
///     let exampleBoolVariable = bool_variable::create(
///         "exampleBoolVariable",
///         BoolVariableArgs::builder()
...
pub mod bool_variable {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct BoolVariableArgs {
        ...
        #[builder(into, default)]
        pub value: pulumi_gestalt_rust::InputOrOutput<Option<bool>>,
    }
    #[allow(dead_code)]
    pub struct BoolVariableResult {
        ...
        /// The value of the Automation Variable as a `boolean`.
        pub value: pulumi_gestalt_rust::Output<Option<bool>>,
    }
    ///
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "azure:automation/boolVariable:BoolVariable".into(),
            name: name.to_string(),
