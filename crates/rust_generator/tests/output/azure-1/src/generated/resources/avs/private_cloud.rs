...
pub mod private_cloud {
    ...
    fn __create(
        ...
        let management_cluster_binding = args.management_cluster.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let network_subnet_cidr_binding = args.network_subnet_cidr.get_output(ctx);
        let nsxt_password_binding = args.nsxt_password.get_output(ctx);
        let resource_group_name_binding = args.resource_group_name.get_output(ctx);
        let sku_name_binding = args.sku_name.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let vcenter_password_binding = args.vcenter_password.get_output(ctx);
