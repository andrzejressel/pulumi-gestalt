...
pub mod data_exchange_iam_member {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct DataExchangeIamMemberArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<
                super::super::types::bigqueryanalyticshub::DataExchangeIamMemberCondition,
            >,
        >,
    ...
    #[allow(dead_code)]
    pub struct DataExchangeIamMemberResult {
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:bigqueryanalyticshub/dataExchangeIamMember:DataExchangeIamMember"
                .into(),
            name: name.to_string(),
