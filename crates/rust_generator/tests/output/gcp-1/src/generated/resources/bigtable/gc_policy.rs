...
pub mod gc_policy {
    ...
    fn __create(
        ...
        let column_family_binding = args.column_family.get_output(ctx);
        let deletion_policy_binding = args.deletion_policy.get_output(ctx);
        let gc_rules_binding = args.gc_rules.get_output(ctx);
        ...
        let max_age_binding = args.max_age.get_output(ctx);
        let max_versions_binding = args.max_versions.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &column_family_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "gcRules".into(),
                    value: &gc_rules_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "maxAge".into(),
                    value: &max_age_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "maxVersions".into(),
                    value: &max_versions_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "mode".into(),
