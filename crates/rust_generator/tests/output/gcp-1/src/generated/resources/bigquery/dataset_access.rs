...
pub mod dataset_access {
    ...
    pub struct DatasetAccessArgs {
        ...
        pub authorized_dataset: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub group_by_email: pulumi_gestalt_rust::Input<Option<String>>,
        /// Some other type of member that appears in the IAM Policy but isn't a user,
        /// group, domain, or special group. For example: `allUsers`
        #[builder(into, default)]
        pub iam_member: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        /// Structure is documented below.
        #[builder(into, default)]
        pub routine: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub special_group: pulumi_gestalt_rust::Input<Option<String>>,
        /// An email address of a user to grant access to. For example:
        /// fred@example.com
        #[builder(into, default)]
        pub user_by_email: pulumi_gestalt_rust::Input<Option<String>>,
