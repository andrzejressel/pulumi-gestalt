...
pub mod listing_iam_member {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct ListingIamMemberArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::bigqueryanalyticshub::ListingIamMemberCondition>,
        >,
    ...
    #[allow(dead_code)]
    pub struct ListingIamMemberResult {
    ...
    fn __create(
        ...
        let listing_id_binding = args.listing_id.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let member_binding = args.member.get_output(ctx);
        let project_binding = args.project.get_output(ctx);
        let role_binding = args.role.get_output(ctx);
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "gcp:bigqueryanalyticshub/listingIamMember:ListingIamMember".into(),
            name: name.to_string(),
