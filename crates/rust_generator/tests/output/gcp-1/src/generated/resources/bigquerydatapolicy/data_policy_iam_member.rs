...
pub mod data_policy_iam_member {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct DataPolicyIamMemberArgs {
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::Input<
            Option<super::super::types::bigquerydatapolicy::DataPolicyIamMemberCondition>,
        >,
        #[builder(into)]
    ...
    #[allow(dead_code)]
    pub struct DataPolicyIamMemberResult {
    ...
    fn __create(
        ...
        let data_policy_id_binding = args.data_policy_id.get_output(ctx);
