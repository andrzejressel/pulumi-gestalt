...
pub mod job {
    ...
    fn __create(
        ...
        let copy_binding = args.copy.get_output(ctx);
        let extract_binding = args.extract.get_output(ctx);
        let job_id_binding = args.job_id.get_output(ctx);
        let job_timeout_ms_binding = args.job_timeout_ms.get_output(ctx);
        let labels_binding = args.labels.get_output(ctx);
        let load_binding = args.load.get_output(ctx);
