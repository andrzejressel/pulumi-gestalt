...
pub mod attestor_iam_binding {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct AttestorIamBindingArgs {
        /// Used to find the parent resource to bind the IAM policy to
        #[builder(into)]
        pub attestor: pulumi_gestalt_rust::Input<String>,
        #[builder(into, default)]
        pub condition: pulumi_gestalt_rust::Input<
            Option<super::super::types::binaryauthorization::AttestorIamBindingCondition>,
        >,
    ...
    #[allow(dead_code)]
    pub struct AttestorIamBindingResult {
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "attestor".into(),
                    value: &attestor_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "condition".into(),
