...
pub mod backup_plan {
    ...
    fn __create(
        ...
        let backup_rules_binding = args.backup_rules.get_output(ctx);
        let backup_vault_binding = args.backup_vault.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &backup_rules_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "backupVault".into(),
                    value: &backup_vault_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
