...
pub struct DatasetAccessDataset {
    /// The dataset this entry applies to
    /// Structure is documented below.
    #[builder(into)]
    #[serde(rename = "dataset")]
    pub r#dataset: Box<super::super::types::bigquery::DatasetAccessDatasetDataset>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DatasetAccessDataset {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DatasetAccessDataset {
