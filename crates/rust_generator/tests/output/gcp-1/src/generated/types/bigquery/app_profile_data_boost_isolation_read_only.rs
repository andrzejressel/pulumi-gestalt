...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AppProfileDataBoostIsolationReadOnly {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "compute_billing_owner".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#compute_billing_owner,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AppProfileDataBoostIsolationReadOnly {
