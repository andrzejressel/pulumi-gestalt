            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#ascii_armored_pgp_public_key: {
                        let field_value = match fields_map.get("asciiArmoredPgpPublicKey") {
                            Some(value) => value,
                            None => bail!("Missing field 'asciiArmoredPgpPublicKey' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                    ...
                    r#pkix_public_key: {
                        let field_value = match fields_map.get("pkixPublicKey") {
                            Some(value) => value,
                            None => bail!("Missing field 'pkixPublicKey' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
