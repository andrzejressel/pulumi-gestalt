        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#jar_uris: {
                        let field_value = match fields_map.get("jarUris") {
                            Some(value) => value,
                            None => bail!("Missing field 'jarUris' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#main_class: {
                    ...
                    r#main_file_uri: {
                        let field_value = match fields_map.get("mainFileUri") {
                            Some(value) => value,
                            None => bail!("Missing field 'mainFileUri' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#properties: {
                    ...
                    r#py_file_uris: {
                        let field_value = match fields_map.get("pyFileUris") {
                            Some(value) => value,
                            None => bail!("Missing field 'pyFileUris' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#runtime_version: {
