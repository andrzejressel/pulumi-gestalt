...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for JobLoadTimePartitioning {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for JobLoadTimePartitioning {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#expiration_ms: {
                        let field_value = match fields_map.get("expirationMs") {
                            Some(value) => value,
                            None => bail!("Missing field 'expirationMs' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
