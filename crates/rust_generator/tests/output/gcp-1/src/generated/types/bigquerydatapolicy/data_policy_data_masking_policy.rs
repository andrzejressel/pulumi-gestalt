            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#predefined_expression: {
                        let field_value = match fields_map.get("predefinedExpression") {
                            Some(value) => value,
                            None => bail!("Missing field 'predefinedExpression' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
