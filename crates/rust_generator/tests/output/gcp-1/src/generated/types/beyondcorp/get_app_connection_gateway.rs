...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetAppConnectionGateway {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetAppConnectionGateway {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#app_gateway: {
                        let field_value = match fields_map.get("app_gateway") {
                            Some(value) => value,
                            None => bail!("Missing field 'app_gateway' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
