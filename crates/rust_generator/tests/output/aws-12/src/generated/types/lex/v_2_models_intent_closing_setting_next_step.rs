...
pub struct V2ModelsIntentClosingSettingNextStep {
    ...
    pub r#dialog_action: Option<Box<super::super::types::lex::V2ModelsIntentClosingSettingNextStepDialogAction>>,
    /// Configuration block for override settings to configure the intent state. See `intent`.
    #[builder(into)]
    #[serde(rename = "intent")]
    pub r#intent: Option<Box<super::super::types::lex::V2ModelsIntentClosingSettingNextStepIntent>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for V2ModelsIntentClosingSettingNextStep {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for V2ModelsIntentClosingSettingNextStep {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#dialog_action: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentClosingSettingNextStepDialogAction>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#intent: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentClosingSettingNextStepIntent>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
