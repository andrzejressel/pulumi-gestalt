...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for V2ModelsSlotValueElicitationSettingSlotResolutionSetting {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "slot_resolution_strategy".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#slot_resolution_strategy,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for V2ModelsSlotValueElicitationSettingSlotResolutionSetting {
