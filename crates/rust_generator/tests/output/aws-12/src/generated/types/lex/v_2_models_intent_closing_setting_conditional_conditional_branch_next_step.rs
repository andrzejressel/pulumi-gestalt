...
pub struct V2ModelsIntentClosingSettingConditionalConditionalBranchNextStep {
    /// Configuration block for action that the bot executes at runtime when the conversation reaches this step. See `dialog_action`.
    #[builder(into)]
    #[serde(rename = "dialogAction")]
    pub r#dialog_action: Option<Box<super::super::types::lex::V2ModelsIntentClosingSettingConditionalConditionalBranchNextStepDialogAction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for V2ModelsIntentClosingSettingConditionalConditionalBranchNextStep {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#dialog_action: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentClosingSettingConditionalConditionalBranchNextStepDialogAction>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#intent: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentClosingSettingConditionalConditionalBranchNextStepIntent>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
