        ...
        async move {
            ...
            let field_futures: Vec<ToPulumiObjectFieldFuture<'_>> = vec![
                to_pulumi_object_field(
                    ...
                    &self.r#grammar_slot_type_setting,
                ),
            ];
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#grammar_slot_type_setting: {
                        let field_value = match fields_map.get("grammarSlotTypeSetting") {
                            Some(value) => value,
                            None => bail!("Missing field 'grammarSlotTypeSetting' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
