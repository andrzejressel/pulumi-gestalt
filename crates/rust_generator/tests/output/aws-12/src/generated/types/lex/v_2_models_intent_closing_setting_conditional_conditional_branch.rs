            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#condition: {
                        ...
                        <Box<super::super::types::lex::V2ModelsIntentClosingSettingConditionalConditionalBranchCondition> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#name: {
                    ...
                    r#next_step: {
                        ...
                        <Box<super::super::types::lex::V2ModelsIntentClosingSettingConditionalConditionalBranchNextStep> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#response: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentClosingSettingConditionalConditionalBranchResponse>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
