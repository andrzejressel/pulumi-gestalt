...
pub struct IntentFollowUpPromptRejectionStatementMessage {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for IntentFollowUpPromptRejectionStatementMessage {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("group_number".to_string(), self.r#group_number.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for IntentFollowUpPromptRejectionStatementMessage {
