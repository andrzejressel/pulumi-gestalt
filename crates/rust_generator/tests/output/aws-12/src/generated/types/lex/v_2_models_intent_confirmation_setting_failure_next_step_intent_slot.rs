...
pub struct V2ModelsIntentConfirmationSettingFailureNextStepIntentSlot {
    ...
    #[builder(into)]
    #[serde(rename = "value")]
    pub r#value: Option<Box<super::super::types::lex::V2ModelsIntentConfirmationSettingFailureNextStepIntentSlotValue>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for V2ModelsIntentConfirmationSettingFailureNextStepIntentSlot {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for V2ModelsIntentConfirmationSettingFailureNextStepIntentSlot {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#value: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentConfirmationSettingFailureNextStepIntentSlotValue>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
