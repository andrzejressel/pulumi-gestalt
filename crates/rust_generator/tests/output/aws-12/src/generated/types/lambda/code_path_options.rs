...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CodePathOptions {
    ...
    > {
        async move {
            ...
            map.insert("extra_exclude_packages".to_string(), self.r#extra_exclude_packages.to_pulumi_value().await);
            map.insert("extra_include_packages".to_string(), self.r#extra_include_packages.to_pulumi_value().await);
            map.insert("extra_include_paths".to_string(), self.r#extra_include_paths.to_pulumi_value().await);
