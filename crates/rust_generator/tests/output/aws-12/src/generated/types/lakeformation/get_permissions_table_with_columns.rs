...
pub struct GetPermissionsTableWithColumns {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetPermissionsTableWithColumns {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetPermissionsTableWithColumns {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#column_names: {
                        let field_value = match fields_map.get("columnNames") {
                            Some(value) => value,
                            None => bail!("Missing field 'columnNames' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#database_name: {
                    ...
                    r#excluded_column_names: {
                        let field_value = match fields_map.get("excludedColumnNames") {
                            Some(value) => value,
                            None => bail!("Missing field 'excludedColumnNames' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#name: {
