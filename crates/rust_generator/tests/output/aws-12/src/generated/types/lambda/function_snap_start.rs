...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FunctionSnapStart {
    ...
    > {
        async move {
            ...
            map.insert("apply_on".to_string(), self.r#apply_on.to_pulumi_value().await);
            map.insert("optimization_status".to_string(), self.r#optimization_status.to_pulumi_value().await);
