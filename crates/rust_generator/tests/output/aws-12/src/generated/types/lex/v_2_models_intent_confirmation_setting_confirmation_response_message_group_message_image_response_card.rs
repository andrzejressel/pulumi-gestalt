            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#buttons: {
                        ...
                        <Option<Vec<super::super::types::lex::V2ModelsIntentConfirmationSettingConfirmationResponseMessageGroupMessageImageResponseCardButton>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#image_url: {
