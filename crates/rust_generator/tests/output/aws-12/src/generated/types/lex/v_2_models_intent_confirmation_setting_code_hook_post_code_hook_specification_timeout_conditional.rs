            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#conditional_branches: {
                        ...
                        <Option<Vec<super::super::types::lex::V2ModelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationTimeoutConditionalConditionalBranch>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#default_branch: {
                        ...
                        <Box<super::super::types::lex::V2ModelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationTimeoutConditionalDefaultBranch> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
