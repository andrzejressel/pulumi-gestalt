            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#host_header: {
                        ...
                        <Option<Box<super::super::types::lb::GetListenerRuleConditionHostHeader>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#http_header: {
                        ...
                        <Option<Box<super::super::types::lb::GetListenerRuleConditionHttpHeader>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#http_request_method: {
                        ...
                        <Option<Box<super::super::types::lb::GetListenerRuleConditionHttpRequestMethod>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#path_pattern: {
                        ...
                        <Option<Box<super::super::types::lb::GetListenerRuleConditionPathPattern>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#query_string: {
                        ...
                        <Option<Box<super::super::types::lb::GetListenerRuleConditionQueryString>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#source_ip: {
                        ...
                        <Option<Box<super::super::types::lb::GetListenerRuleConditionSourceIp>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
