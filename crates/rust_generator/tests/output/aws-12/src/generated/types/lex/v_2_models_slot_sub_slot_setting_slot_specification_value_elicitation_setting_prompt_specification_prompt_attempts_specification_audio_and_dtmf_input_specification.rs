            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#audio_specification: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingPromptSpecificationPromptAttemptsSpecificationAudioAndDtmfInputSpecificationAudioSpecification>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#dtmf_specification: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingPromptSpecificationPromptAttemptsSpecificationAudioAndDtmfInputSpecificationDtmfSpecification>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#start_timeout_ms: {
