...
pub struct V2ModelsIntentConfirmationSettingConfirmationNextStepIntentSlot {
    ...
    #[builder(into)]
    #[serde(rename = "value")]
    pub r#value: Option<Box<super::super::types::lex::V2ModelsIntentConfirmationSettingConfirmationNextStepIntentSlotValue>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for V2ModelsIntentConfirmationSettingConfirmationNextStepIntentSlot {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for V2ModelsIntentConfirmationSettingConfirmationNextStepIntentSlot {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#value: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentConfirmationSettingConfirmationNextStepIntentSlotValue>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
