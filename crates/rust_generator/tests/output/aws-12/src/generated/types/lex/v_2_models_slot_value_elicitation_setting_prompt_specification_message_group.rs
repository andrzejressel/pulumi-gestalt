...
pub struct V2ModelsSlotValueElicitationSettingPromptSpecificationMessageGroup {
    ...
    pub r#message: Box<super::super::types::lex::V2ModelsSlotValueElicitationSettingPromptSpecificationMessageGroupMessage>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for V2ModelsSlotValueElicitationSettingPromptSpecificationMessageGroup {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for V2ModelsSlotValueElicitationSettingPromptSpecificationMessageGroup {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#message: {
                        ...
                        <Box<super::super::types::lex::V2ModelsSlotValueElicitationSettingPromptSpecificationMessageGroupMessage> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#variations: {
                        ...
                        <Option<Vec<super::super::types::lex::V2ModelsSlotValueElicitationSettingPromptSpecificationMessageGroupVariation>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
