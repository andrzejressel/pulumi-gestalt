            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#fulfillment_updates_specification: {
                        let field_value = match fields_map.get("fulfillmentUpdatesSpecification") {
                            Some(value) => value,
                            None => bail!("Missing field 'fulfillmentUpdatesSpecification' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#post_fulfillment_status_specification: {
                        let field_value = match fields_map.get("postFulfillmentStatusSpecification") {
                            Some(value) => value,
                            None => bail!("Missing field 'postFulfillmentStatusSpecification' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
