...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DistributionCacheBehaviorSettingsForwardedHeaders {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("headers_allow_lists".to_string(), self.r#headers_allow_lists.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DistributionCacheBehaviorSettingsForwardedHeaders {
