...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for V2ModelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingWaitAndContinueSpecification {
    ...
    > {
        async move {
            ...
            map.insert("continue_responses".to_string(), self.r#continue_responses.to_pulumi_value().await);
            map.insert("still_waiting_responses".to_string(), self.r#still_waiting_responses.to_pulumi_value().await);
            map.insert("waiting_responses".to_string(), self.r#waiting_responses.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#continue_responses: {
                        ...
                        <Option<Vec<super::super::types::lex::V2ModelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingWaitAndContinueSpecificationContinueResponse>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#still_waiting_responses: {
                        ...
                        <Option<Vec<super::super::types::lex::V2ModelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingWaitAndContinueSpecificationStillWaitingResponse>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#waiting_responses: {
                        ...
                        <Option<Vec<super::super::types::lex::V2ModelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingWaitAndContinueSpecificationWaitingResponse>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
