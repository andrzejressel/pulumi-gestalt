            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#authenticate_cognito: {
                        ...
                        <Option<Box<super::super::types::lb::ListenerDefaultActionAuthenticateCognito>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#authenticate_oidc: {
                        ...
                        <Option<Box<super::super::types::lb::ListenerDefaultActionAuthenticateOidc>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#fixed_response: {
                        ...
                        <Option<Box<super::super::types::lb::ListenerDefaultActionFixedResponse>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#forward: {
                        ...
                        <Option<Box<super::super::types::lb::ListenerDefaultActionForward>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#order: {
                    ...
                    r#redirect: {
                        ...
                        <Option<Box<super::super::types::lb::ListenerDefaultActionRedirect>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#target_group_arn: {
