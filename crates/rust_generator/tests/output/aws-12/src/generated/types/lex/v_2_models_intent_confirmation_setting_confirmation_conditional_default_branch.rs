            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#next_step: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentConfirmationSettingConfirmationConditionalDefaultBranchNextStep>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#response: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentConfirmationSettingConfirmationConditionalDefaultBranchResponse>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
