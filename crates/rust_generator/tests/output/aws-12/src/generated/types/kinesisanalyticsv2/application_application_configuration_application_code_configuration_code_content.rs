...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ApplicationApplicationConfigurationApplicationCodeConfigurationCodeContent {
    ...
    > {
        async move {
            ...
            map.insert("s_3_content_location".to_string(), self.r#s_3_content_location.to_pulumi_value().await);
            map.insert("text_content".to_string(), self.r#text_content.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#s_3_content_location: {
                        ...
                        <Option<Box<super::super::types::kinesisanalyticsv2::ApplicationApplicationConfigurationApplicationCodeConfigurationCodeContentS3ContentLocation>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#text_content: {
