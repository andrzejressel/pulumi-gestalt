...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSource {
    ...
    > {
        async move {
            ...
            map.insert("reference_schema".to_string(), self.r#reference_schema.to_pulumi_value().await);
            map.insert("s_3_reference_data_source".to_string(), self.r#s_3_reference_data_source.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#reference_schema: {
                        ...
                        <Box<super::super::types::kinesisanalyticsv2::ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceReferenceSchema> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#s_3_reference_data_source: {
                        ...
                        <Box<super::super::types::kinesisanalyticsv2::ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceS3ReferenceDataSource> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#table_name: {
