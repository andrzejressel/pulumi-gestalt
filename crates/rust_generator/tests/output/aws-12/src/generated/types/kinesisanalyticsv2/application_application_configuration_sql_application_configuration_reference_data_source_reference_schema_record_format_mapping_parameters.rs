            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#csv_mapping_parameters: {
                        let field_value = match fields_map.get("csvMappingParameters") {
                            Some(value) => value,
                            None => bail!("Missing field 'csvMappingParameters' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#json_mapping_parameters: {
                        let field_value = match fields_map.get("jsonMappingParameters") {
                            Some(value) => value,
                            None => bail!("Missing field 'jsonMappingParameters' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
