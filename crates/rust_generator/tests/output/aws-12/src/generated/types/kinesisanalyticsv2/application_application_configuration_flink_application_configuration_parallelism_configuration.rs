...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ApplicationApplicationConfigurationFlinkApplicationConfigurationParallelismConfiguration {
    ...
    > {
        async move {
            ...
            map.insert("auto_scaling_enabled".to_string(), self.r#auto_scaling_enabled.to_pulumi_value().await);
            ...
            map.insert("parallelism_per_kpu".to_string(), self.r#parallelism_per_kpu.to_pulumi_value().await);
