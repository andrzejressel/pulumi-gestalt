            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#allowed_input_types: {
                        ...
                        <Box<super::super::types::lex::V2ModelsSlotValueElicitationSettingPromptSpecificationPromptAttemptsSpecificationAllowedInputTypes> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#audio_and_dtmf_input_specification: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsSlotValueElicitationSettingPromptSpecificationPromptAttemptsSpecificationAudioAndDtmfInputSpecification>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#map_block_key: {
                    ...
                    r#text_input_specification: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsSlotValueElicitationSettingPromptSpecificationPromptAttemptsSpecificationTextInputSpecification>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
