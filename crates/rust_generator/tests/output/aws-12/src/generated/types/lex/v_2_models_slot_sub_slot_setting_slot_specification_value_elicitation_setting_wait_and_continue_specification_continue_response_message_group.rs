            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#message: {
                        ...
                        <Box<super::super::types::lex::V2ModelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingWaitAndContinueSpecificationContinueResponseMessageGroupMessage> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#variations: {
                        ...
                        <Option<Vec<super::super::types::lex::V2ModelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingWaitAndContinueSpecificationContinueResponseMessageGroupVariation>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
