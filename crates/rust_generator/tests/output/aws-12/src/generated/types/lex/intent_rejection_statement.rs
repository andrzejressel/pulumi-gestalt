...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for IntentRejectionStatement {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for IntentRejectionStatement {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#messages: {
                        ...
                        <Vec<super::super::types::lex::IntentRejectionStatementMessage> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#response_card: {
