...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for V2ModelsSlotTypeExternalSourceSettingGrammarSlotTypeSetting {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for V2ModelsSlotTypeExternalSourceSettingGrammarSlotTypeSetting {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#source: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsSlotTypeExternalSourceSettingGrammarSlotTypeSettingSource>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
