...
pub struct V2ModelsIntentConfirmationSettingFailureNextStep {
    /// Configuration block for action that the bot executes at runtime when the conversation reaches this step. See `dialog_action`.
    #[builder(into)]
    #[serde(rename = "dialogAction")]
    pub r#dialog_action: Option<Box<super::super::types::lex::V2ModelsIntentConfirmationSettingFailureNextStepDialogAction>>,
    /// Configuration block for override settings to configure the intent state. See `intent`.
    #[builder(into)]
    #[serde(rename = "intent")]
    pub r#intent: Option<Box<super::super::types::lex::V2ModelsIntentConfirmationSettingFailureNextStepIntent>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for V2ModelsIntentConfirmationSettingFailureNextStep {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for V2ModelsIntentConfirmationSettingFailureNextStep {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#dialog_action: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentConfirmationSettingFailureNextStepDialogAction>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#intent: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentConfirmationSettingFailureNextStepIntent>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
