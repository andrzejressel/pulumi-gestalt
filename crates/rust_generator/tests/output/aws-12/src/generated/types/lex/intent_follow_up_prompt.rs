...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for IntentFollowUpPrompt {
    ...
    > {
        async move {
            ...
            map.insert("prompt".to_string(), self.r#prompt.to_pulumi_value().await);
            map.insert("rejection_statement".to_string(), self.r#rejection_statement.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#prompt: {
                        ...
                        <Box<super::super::types::lex::IntentFollowUpPromptPrompt> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#rejection_statement: {
                        ...
                        <Box<super::super::types::lex::IntentFollowUpPromptRejectionStatement> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
