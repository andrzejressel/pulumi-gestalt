...
pub struct V2ModelsIntentInitialResponseSettingConditionalConditionalBranchNextStep {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for V2ModelsIntentInitialResponseSettingConditionalConditionalBranchNextStep {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for V2ModelsIntentInitialResponseSettingConditionalConditionalBranchNextStep {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#dialog_action: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentInitialResponseSettingConditionalConditionalBranchNextStepDialogAction>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#intent: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentInitialResponseSettingConditionalConditionalBranchNextStepIntent>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
