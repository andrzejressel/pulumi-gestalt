...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GrantConstraint {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("encryption_context_equals".to_string(), self.r#encryption_context_equals.to_pulumi_value().await);
            map.insert("encryption_context_subset".to_string(), self.r#encryption_context_subset.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GrantConstraint {
