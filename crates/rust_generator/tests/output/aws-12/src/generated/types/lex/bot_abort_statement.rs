...
pub struct BotAbortStatement {
    ...
    pub r#messages: Vec<super::super::types::lex::BotAbortStatementMessage>,
    #[builder(into)]
    #[serde(rename = "responseCard")]
    pub r#response_card: Option<String>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BotAbortStatement {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BotAbortStatement {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#messages: {
                        ...
                        <Vec<super::super::types::lex::BotAbortStatementMessage> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#response_card: {
