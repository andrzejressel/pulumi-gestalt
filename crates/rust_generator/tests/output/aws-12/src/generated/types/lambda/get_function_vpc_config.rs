            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#ipv_6_allowed_for_dual_stack: {
                        let field_value = match fields_map.get("ipv6AllowedForDualStack") {
                            Some(value) => value,
                            None => bail!("Missing field 'ipv6AllowedForDualStack' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
