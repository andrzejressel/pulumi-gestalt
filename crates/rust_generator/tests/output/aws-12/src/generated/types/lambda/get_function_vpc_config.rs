...
pub struct GetFunctionVpcConfig {
    ...
    pub r#ipv_6_allowed_for_dual_stack: bool,
    #[builder(into)]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetFunctionVpcConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("ipv_6_allowed_for_dual_stack".to_string(), self.r#ipv_6_allowed_for_dual_stack.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetFunctionVpcConfig {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#ipv_6_allowed_for_dual_stack: {
                        let field_value = match fields_map.get("ipv_6_allowed_for_dual_stack") {
                            Some(value) => value,
                            None => bail!("Missing field 'ipv_6_allowed_for_dual_stack' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
