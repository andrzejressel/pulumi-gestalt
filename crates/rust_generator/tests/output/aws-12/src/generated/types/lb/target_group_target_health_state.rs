...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TargetGroupTargetHealthState {
    ...
    > {
        async move {
            ...
            map.insert("enable_unhealthy_connection_termination".to_string(), self.r#enable_unhealthy_connection_termination.to_pulumi_value().await);
            map.insert("unhealthy_draining_interval".to_string(), self.r#unhealthy_draining_interval.to_pulumi_value().await);
