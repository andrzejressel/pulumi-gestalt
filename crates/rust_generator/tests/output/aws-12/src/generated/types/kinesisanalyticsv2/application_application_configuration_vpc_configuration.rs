            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#vpc_configuration_id: {
                        let field_value = match fields_map.get("vpcConfigurationId") {
                            Some(value) => value,
                            None => bail!("Missing field 'vpcConfigurationId' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#vpc_id: {
