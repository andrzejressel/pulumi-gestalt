...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ApplicationApplicationConfigurationVpcConfiguration {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("vpc_configuration_id".to_string(), self.r#vpc_configuration_id.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ApplicationApplicationConfigurationVpcConfiguration {
        ...
        match value.content {
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#vpc_configuration_id: {
                        let field_value = match fields_map.get("vpc_configuration_id") {
                            Some(value) => value,
                            None => bail!("Missing field 'vpc_configuration_id' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
