...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for V2ModelsSlotObfuscationSetting {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("obfuscation_setting_type".to_string(), self.r#obfuscation_setting_type.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for V2ModelsSlotObfuscationSetting {
