...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ContainerServicePublicDomainNames {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ContainerServicePublicDomainNames {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#certificates: {
                        ...
                        <Vec<super::super::types::lightsail::ContainerServicePublicDomainNamesCertificate> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
