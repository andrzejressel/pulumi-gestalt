...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for V2ModelsIntentConfirmationSettingDeclinationConditionalDefaultBranch {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for V2ModelsIntentConfirmationSettingDeclinationConditionalDefaultBranch {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#next_step: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentConfirmationSettingDeclinationConditionalDefaultBranchNextStep>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#response: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentConfirmationSettingDeclinationConditionalDefaultBranchResponse>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
