...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ContainerServicePublicDomainNamesCertificate {
    ...
    > {
        async move {
            ...
            map.insert("certificate_name".to_string(), self.r#certificate_name.to_pulumi_value().await);
            map.insert("domain_names".to_string(), self.r#domain_names.to_pulumi_value().await);
