...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BotIntent {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("intent_name".to_string(), self.r#intent_name.to_pulumi_value().await);
            map.insert("intent_version".to_string(), self.r#intent_version.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BotIntent {
