...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ApplicationApplicationConfigurationRunConfigurationApplicationRestoreConfiguration {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("application_restore_type".to_string(), self.r#application_restore_type.to_pulumi_value().await);
            map.insert("snapshot_name".to_string(), self.r#snapshot_name.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ApplicationApplicationConfigurationRunConfigurationApplicationRestoreConfiguration {
