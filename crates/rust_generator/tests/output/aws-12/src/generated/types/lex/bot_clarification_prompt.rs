...
pub struct BotClarificationPrompt {
    ...
    pub r#messages: Vec<super::super::types::lex::BotClarificationPromptMessage>,
    #[builder(into)]
    #[serde(rename = "responseCard")]
    pub r#response_card: Option<String>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for BotClarificationPrompt {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for BotClarificationPrompt {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#messages: {
                        ...
                        <Vec<super::super::types::lex::BotClarificationPromptMessage> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#response_card: {
