...
pub struct V2ModelsIntentConfirmationSettingConfirmationResponseMessageGroupVariation {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for V2ModelsIntentConfirmationSettingConfirmationResponseMessageGroupVariation {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for V2ModelsIntentConfirmationSettingConfirmationResponseMessageGroupVariation {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#custom_payload: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentConfirmationSettingConfirmationResponseMessageGroupVariationCustomPayload>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#image_response_card: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentConfirmationSettingConfirmationResponseMessageGroupVariationImageResponseCard>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#plain_text_message: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentConfirmationSettingConfirmationResponseMessageGroupVariationPlainTextMessage>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#ssml_message: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentConfirmationSettingConfirmationResponseMessageGroupVariationSsmlMessage>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
