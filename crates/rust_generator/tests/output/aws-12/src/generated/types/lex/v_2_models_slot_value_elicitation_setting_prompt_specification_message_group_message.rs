...
pub struct V2ModelsSlotValueElicitationSettingPromptSpecificationMessageGroupMessage {
    #[builder(into)]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for V2ModelsSlotValueElicitationSettingPromptSpecificationMessageGroupMessage {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for V2ModelsSlotValueElicitationSettingPromptSpecificationMessageGroupMessage {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#custom_payloads: {
                        ...
                        <Option<Vec<super::super::types::lex::V2ModelsSlotValueElicitationSettingPromptSpecificationMessageGroupMessageCustomPayload>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#image_response_card: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsSlotValueElicitationSettingPromptSpecificationMessageGroupMessageImageResponseCard>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#plain_text_message: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsSlotValueElicitationSettingPromptSpecificationMessageGroupMessagePlainTextMessage>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#ssml_message: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsSlotValueElicitationSettingPromptSpecificationMessageGroupMessageSsmlMessage>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
