...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetCodeSigningConfigPolicy {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("untrusted_artifact_on_deployment".to_string(), self.r#untrusted_artifact_on_deployment.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetCodeSigningConfigPolicy {
