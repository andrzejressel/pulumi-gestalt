...
pub struct V2ModelsIntentClosingSettingClosingResponse {
    ...
    pub r#message_groups: Option<Vec<super::super::types::lex::V2ModelsIntentClosingSettingClosingResponseMessageGroup>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for V2ModelsIntentClosingSettingClosingResponse {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for V2ModelsIntentClosingSettingClosingResponse {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#message_groups: {
                        ...
                        <Option<Vec<super::super::types::lex::V2ModelsIntentClosingSettingClosingResponseMessageGroup>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
