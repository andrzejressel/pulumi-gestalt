...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for IntentFulfillmentActivity {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for IntentFulfillmentActivity {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#code_hook: {
                        ...
                        <Option<Box<super::super::types::lex::IntentFulfillmentActivityCodeHook>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#type_: {
