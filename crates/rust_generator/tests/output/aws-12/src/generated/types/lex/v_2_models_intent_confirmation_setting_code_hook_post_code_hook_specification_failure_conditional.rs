...
pub struct V2ModelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationFailureConditional {
    ...
    pub r#conditional_branches: Option<Vec<super::super::types::lex::V2ModelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationFailureConditionalConditionalBranch>>,
    ...
    pub r#default_branch: Box<super::super::types::lex::V2ModelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationFailureConditionalDefaultBranch>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for V2ModelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationFailureConditional {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for V2ModelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationFailureConditional {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#conditional_branches: {
                        ...
                        <Option<Vec<super::super::types::lex::V2ModelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationFailureConditionalConditionalBranch>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#default_branch: {
                        ...
                        <Box<super::super::types::lex::V2ModelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationFailureConditionalDefaultBranch> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
