            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#slot_specifications: {
                        let field_value = match fields_map.get("slotSpecifications") {
                            Some(value) => value,
                            None => bail!("Missing field 'slotSpecifications' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
