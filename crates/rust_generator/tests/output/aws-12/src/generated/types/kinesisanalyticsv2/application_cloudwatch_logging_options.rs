...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ApplicationCloudwatchLoggingOptions {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("cloudwatch_logging_option_id".to_string(), self.r#cloudwatch_logging_option_id.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ApplicationCloudwatchLoggingOptions {
