            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#dialog_action: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentFulfillmentCodeHookPostFulfillmentStatusSpecificationTimeoutConditionalDefaultBranchNextStepDialogAction>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#intent: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentFulfillmentCodeHookPostFulfillmentStatusSpecificationTimeoutConditionalDefaultBranchNextStepIntent>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
