            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#condition: {
                        ...
                        <Box<super::super::types::lex::V2ModelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationTimeoutConditionalConditionalBranchCondition> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#name: {
                    ...
                    r#next_step: {
                        ...
                        <Box<super::super::types::lex::V2ModelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationTimeoutConditionalConditionalBranchNextStep> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#response: {
                        ...
                        <Option<Box<super::super::types::lex::V2ModelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationTimeoutConditionalConditionalBranchResponse>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
