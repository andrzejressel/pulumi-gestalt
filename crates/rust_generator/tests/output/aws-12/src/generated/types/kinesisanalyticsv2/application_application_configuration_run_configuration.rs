...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ApplicationApplicationConfigurationRunConfiguration {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("application_restore_configuration".to_string(), self.r#application_restore_configuration.to_pulumi_value().await);
            map.insert("flink_run_configuration".to_string(), self.r#flink_run_configuration.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ApplicationApplicationConfigurationRunConfiguration {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#application_restore_configuration: {
                        ...
                        <Option<Box<super::super::types::kinesisanalyticsv2::ApplicationApplicationConfigurationRunConfigurationApplicationRestoreConfiguration>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#flink_run_configuration: {
                        ...
                        <Option<Box<super::super::types::kinesisanalyticsv2::ApplicationApplicationConfigurationRunConfigurationFlinkRunConfiguration>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
