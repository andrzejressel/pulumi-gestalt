...
pub mod invocation {
    ...
    fn __create(
        ...
        let lifecycle_scope_binding = args.lifecycle_scope.get_output(ctx);
        let qualifier_binding = args.qualifier.get_output(ctx);
        let terraform_key_binding = args.terraform_key.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &lifecycle_scope_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "qualifier".into(),
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &terraform_key_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "triggers".into(),
