...
pub mod tracker {
    ...
    pub struct TrackerArgs {
        ...
        #[builder(into, default)]
        pub position_filtering: pulumi_gestalt_rust::Input<Option<String>>,
    ...
    fn __create(
        ...
        let position_filtering_binding = args.position_filtering.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &position_filtering_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "tags".into(),
