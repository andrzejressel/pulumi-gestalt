...
pub mod key {
    ...
    pub struct KeyArgs {
        ...
        #[builder(into, default)]
        pub customer_master_key_spec: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub enable_key_rotation: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub key_usage: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub rotation_period_in_days: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub xks_key_id: pulumi_gestalt_rust::Input<Option<String>>,
    }
    #[allow(dead_code)]
    ...
    fn __create(
        ...
        let enable_key_rotation_binding = args.enable_key_rotation.get_output(ctx);
        let is_enabled_binding = args.is_enabled.get_output(ctx);
        let key_usage_binding = args.key_usage.get_output(ctx);
        let multi_region_binding = args.multi_region.get_output(ctx);
        let policy_binding = args.policy.get_output(ctx);
        let rotation_period_in_days_binding = args
            .rotation_period_in_days
            .get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let xks_key_id_binding = args.xks_key_id.get_output(ctx);
