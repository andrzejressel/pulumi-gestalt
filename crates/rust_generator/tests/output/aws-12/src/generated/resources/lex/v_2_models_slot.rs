...
pub mod v_2_models_slot {
    ...
    fn __create(
        ...
        let intent_id_binding = args.intent_id.get_output(ctx);
        ...
        let obfuscation_settings_binding = args.obfuscation_settings.get_output(ctx);
        let slot_type_id_binding = args.slot_type_id.get_output(ctx);
        let sub_slot_settings_binding = args.sub_slot_settings.get_output(ctx);
