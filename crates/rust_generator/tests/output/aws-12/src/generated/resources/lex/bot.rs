...
pub mod bot {
    ...
    pub struct BotArgs {
        ...
        #[builder(into, default)]
        pub detect_sentiment: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub enable_model_improvements: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into)]
        pub intents: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub voice_id: pulumi_gestalt_rust::Input<Option<String>>,
    }
    #[allow(dead_code)]
