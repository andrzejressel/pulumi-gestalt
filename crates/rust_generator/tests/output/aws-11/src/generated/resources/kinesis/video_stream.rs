...
pub mod video_stream {
    ...
    pub struct VideoStreamArgs {
        ...
        pub data_retention_in_hours: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub media_type: pulumi_gestalt_rust::Input<Option<String>>,
    ...
    fn __create(
        ...
        let media_type_binding = args.media_type.get_output(ctx);
