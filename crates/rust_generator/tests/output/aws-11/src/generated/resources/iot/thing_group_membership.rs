...
pub mod thing_group_membership {
    ...
    fn __create(
        ...
        let override_dynamic_group_binding = args.override_dynamic_group.get_output(ctx);
        let thing_group_name_binding = args.thing_group_name.get_output(ctx);
        let thing_name_binding = args.thing_name.get_output(ctx);
