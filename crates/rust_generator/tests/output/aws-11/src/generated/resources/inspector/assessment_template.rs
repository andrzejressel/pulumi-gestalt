...
pub mod assessment_template {
    ...
    fn __create(
        ...
        let event_subscriptions_binding = args.event_subscriptions.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let rules_package_arns_binding = args.rules_package_arns.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let target_arn_binding = args.target_arn.get_output(ctx);
