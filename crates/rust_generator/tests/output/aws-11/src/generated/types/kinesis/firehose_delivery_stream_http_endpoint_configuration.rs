...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FirehoseDeliveryStreamHttpEndpointConfiguration {
    ...
    > {
        async move {
            ...
            map.insert("access_key".to_string(), self.r#access_key.to_pulumi_value().await);
            ...
            map.insert("request_configuration".to_string(), self.r#request_configuration.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#cloudwatch_logging_options: {
                        ...
                        <Option<Box<super::super::types::kinesis::FirehoseDeliveryStreamHttpEndpointConfigurationCloudwatchLoggingOptions>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#name: {
                    ...
                    r#processing_configuration: {
                        ...
                        <Option<Box<super::super::types::kinesis::FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfiguration>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#request_configuration: {
                        ...
                        <Option<Box<super::super::types::kinesis::FirehoseDeliveryStreamHttpEndpointConfigurationRequestConfiguration>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#retry_duration: {
                    ...
                    r#s_3_configuration: {
                        ...
                        <Box<super::super::types::kinesis::FirehoseDeliveryStreamHttpEndpointConfigurationS3Configuration> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#secrets_manager_configuration: {
                        ...
                        <Option<Box<super::super::types::kinesis::FirehoseDeliveryStreamHttpEndpointConfigurationSecretsManagerConfiguration>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#url: {
