...
pub struct FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessor {
    ...
    pub r#parameters: Option<Vec<super::super::types::kinesis::FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorParameter>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessor {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessor {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#parameters: {
                        ...
                        <Option<Vec<super::super::types::kinesis::FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorParameter>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#type_: {
