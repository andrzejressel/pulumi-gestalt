...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AnalyticsApplicationInputsSchemaRecordFormat {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AnalyticsApplicationInputsSchemaRecordFormat {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#mapping_parameters: {
                        ...
                        <Option<Box<super::super::types::kinesis::AnalyticsApplicationInputsSchemaRecordFormatMappingParameters>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
