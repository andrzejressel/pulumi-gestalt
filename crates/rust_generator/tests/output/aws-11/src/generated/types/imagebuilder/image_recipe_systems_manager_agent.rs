...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ImageRecipeSystemsManagerAgent {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "uninstall_after_build".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ImageRecipeSystemsManagerAgent {
