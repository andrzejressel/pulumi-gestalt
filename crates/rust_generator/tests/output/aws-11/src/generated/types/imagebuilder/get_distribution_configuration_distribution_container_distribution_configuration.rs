...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetDistributionConfigurationDistributionContainerDistributionConfiguration {
    ...
    > {
        async move {
            ...
            map.insert("target_repositories".to_string(), self.r#target_repositories.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#target_repositories: {
                        ...
                        <Vec<super::super::types::imagebuilder::GetDistributionConfigurationDistributionContainerDistributionConfigurationTargetRepository> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
