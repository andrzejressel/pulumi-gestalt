...
pub struct DataSourceConfigurationWebCrawlerConfiguration {
    ...
    pub r#max_content_size_per_page_in_mega_bytes: Option<f64>,
    ...
    pub r#max_links_per_page: Option<i32>,
    ...
    pub r#max_urls_per_minute_crawl_rate: Option<i32>,
    ...
    pub r#url_exclusion_patterns: Option<Vec<String>>,
    ...
    pub r#url_inclusion_patterns: Option<Vec<String>>,
