...
pub struct DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationConditionConditionOnValue {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationConditionConditionOnValue {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("date_value".to_string(), self.r#date_value.to_pulumi_value().await);
            map.insert("long_value".to_string(), self.r#long_value.to_pulumi_value().await);
            map.insert("string_list_values".to_string(), self.r#string_list_values.to_pulumi_value().await);
            map.insert("string_value".to_string(), self.r#string_value.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationConditionConditionOnValue {
