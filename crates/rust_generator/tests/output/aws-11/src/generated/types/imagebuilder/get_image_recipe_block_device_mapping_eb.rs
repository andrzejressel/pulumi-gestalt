...
pub struct GetImageRecipeBlockDeviceMappingEb {
    ...
    pub r#delete_on_termination: String,
    /// Whether to encrypt the volume. Defaults to unset, which is the value inherited from the parent image.
    #[builder(into)]
    #[serde(rename = "encrypted")]
    pub r#encrypted: String,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetImageRecipeBlockDeviceMappingEb {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetImageRecipeBlockDeviceMappingEb {
