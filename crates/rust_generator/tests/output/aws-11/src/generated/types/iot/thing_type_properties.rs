...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ThingTypeProperties {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "searchable_attributes".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ThingTypeProperties {
