    ...
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#payload_version: {
                        let field_value = match fields_map.get("payloadVersion") {
                            Some(value) => value,
                            None => bail!("Missing field 'payloadVersion' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
