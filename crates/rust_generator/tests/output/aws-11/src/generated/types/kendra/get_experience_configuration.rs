...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetExperienceConfiguration {
    ...
    > {
        async move {
            ...
            map.insert("content_source_configurations".to_string(), self.r#content_source_configurations.to_pulumi_value().await);
            map.insert("user_identity_configurations".to_string(), self.r#user_identity_configurations.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#content_source_configurations: {
                        ...
                        <Vec<super::super::types::kendra::GetExperienceConfigurationContentSourceConfiguration> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#user_identity_configurations: {
                        ...
                        <Vec<super::super::types::kendra::GetExperienceConfigurationUserIdentityConfiguration> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
