...
pub struct ContainerRecipeInstanceConfigurationBlockDeviceMappingEbs {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ContainerRecipeInstanceConfigurationBlockDeviceMappingEbs {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("throughput".to_string(), self.r#throughput.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ContainerRecipeInstanceConfigurationBlockDeviceMappingEbs {
