...
pub struct FirehoseDeliveryStreamSplunkConfigurationS3Configuration {
    ...
    pub r#cloudwatch_logging_options: Box<Option<super::super::types::kinesis::FirehoseDeliveryStreamSplunkConfigurationS3ConfigurationCloudwatchLoggingOptions>>,
