...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TopicRuleErrorActionCloudwatchMetric {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for TopicRuleErrorActionCloudwatchMetric {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#metric_timestamp: {
                        let field_value = match fields_map.get("metricTimestamp") {
                            Some(value) => value,
                            None => bail!("Missing field 'metricTimestamp' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#metric_unit: {
                    ...
                    r#metric_value: {
                        let field_value = match fields_map.get("metricValue") {
                            Some(value) => value,
                            None => bail!("Missing field 'metricValue' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#role_arn: {
