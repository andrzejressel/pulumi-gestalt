...
pub struct FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfigurationProcessorParameter {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfigurationProcessorParameter {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("parameter_name".to_string(), self.r#parameter_name.to_pulumi_value().await);
            map.insert("parameter_value".to_string(), self.r#parameter_value.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfigurationProcessorParameter {
