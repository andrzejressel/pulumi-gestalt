...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DataSourceConfigurationWebCrawlerConfigurationUrlsSeedUrlConfiguration {
    ...
    > {
        async move {
            ...
            map.insert("seed_urls".to_string(), self.r#seed_urls.to_pulumi_value().await);
            map.insert("web_crawler_mode".to_string(), self.r#web_crawler_mode.to_pulumi_value().await);
