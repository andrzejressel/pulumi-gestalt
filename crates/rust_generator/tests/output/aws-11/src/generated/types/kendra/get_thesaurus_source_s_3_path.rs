...
pub struct GetThesaurusSourceS3Path {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetThesaurusSourceS3Path {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetThesaurusSourceS3Path {
