        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#custom_time_zone: {
                        let field_value = match fields_map.get("customTimeZone") {
                            Some(value) => value,
                            None => bail!("Missing field 'customTimeZone' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#data_format_conversion_configuration: {
                        let field_value = match fields_map.get("dataFormatConversionConfiguration") {
                            Some(value) => value,
                            None => bail!("Missing field 'dataFormatConversionConfiguration' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#dynamic_partitioning_configuration: {
                        let field_value = match fields_map.get("dynamicPartitioningConfiguration") {
                            Some(value) => value,
                            None => bail!("Missing field 'dynamicPartitioningConfiguration' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    ...
                    r#file_extension: {
                        let field_value = match fields_map.get("fileExtension") {
                            Some(value) => value,
                            None => bail!("Missing field 'fileExtension' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#kms_key_arn: {
                    ...
                    r#s_3_backup_configuration: {
                        let field_value = match fields_map.get("s3BackupConfiguration") {
                            Some(value) => value,
                            None => bail!("Missing field 's3BackupConfiguration' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#s_3_backup_mode: {
