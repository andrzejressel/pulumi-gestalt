...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for KeyspaceReplicationSpecification {
    ...
    > {
        async move {
            ...
            map.insert("region_lists".to_string(), self.r#region_lists.to_pulumi_value().await);
            map.insert("replication_strategy".to_string(), self.r#replication_strategy.to_pulumi_value().await);
