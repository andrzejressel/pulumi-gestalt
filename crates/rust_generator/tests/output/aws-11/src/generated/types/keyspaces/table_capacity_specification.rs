...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TableCapacitySpecification {
    ...
    > {
        async move {
            ...
            map.insert("read_capacity_units".to_string(), self.r#read_capacity_units.to_pulumi_value().await);
            map.insert("throughput_mode".to_string(), self.r#throughput_mode.to_pulumi_value().await);
            map.insert("write_capacity_units".to_string(), self.r#write_capacity_units.to_pulumi_value().await);
