...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for IndexDocumentMetadataConfigurationUpdate {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("relevance".to_string(), self.r#relevance.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for IndexDocumentMetadataConfigurationUpdate {
        ...
        match value.content {
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#relevance: {
                        let field_value = match fields_map.get("relevance") {
                            Some(value) => value,
                            None => bail!("Missing field 'relevance' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        <Option<Box<super::super::types::kendra::IndexDocumentMetadataConfigurationUpdateRelevance>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#search: {
                        ...
                        <Option<Box<super::super::types::kendra::IndexDocumentMetadataConfigurationUpdateSearch>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#type_: {
