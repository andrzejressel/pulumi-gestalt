...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for RoomMessageReviewHandler {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("fallback_result".to_string(), self.r#fallback_result.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for RoomMessageReviewHandler {
