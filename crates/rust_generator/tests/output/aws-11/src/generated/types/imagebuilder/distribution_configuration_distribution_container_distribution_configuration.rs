...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DistributionConfigurationDistributionContainerDistributionConfiguration {
    ...
    > {
        async move {
            ...
            map.insert("target_repository".to_string(), self.r#target_repository.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#target_repository: {
                        ...
                        <Box<super::super::types::imagebuilder::DistributionConfigurationDistributionContainerDistributionConfigurationTargetRepository> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
