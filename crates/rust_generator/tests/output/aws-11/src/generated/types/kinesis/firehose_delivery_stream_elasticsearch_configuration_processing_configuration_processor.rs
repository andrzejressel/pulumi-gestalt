...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfigurationProcessor {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfigurationProcessor {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#parameters: {
                        ...
                        <Option<Vec<super::super::types::kinesis::FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfigurationProcessorParameter>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#type_: {
