...
pub struct DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationCondition {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationCondition {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("condition_document_attribute_key".to_string(), self.r#condition_document_attribute_key.to_pulumi_value().await);
            map.insert("condition_on_value".to_string(), self.r#condition_on_value.to_pulumi_value().await);
            map.insert("operator".to_string(), self.r#operator.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationCondition {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#condition_on_value: {
                        ...
                        <Option<Box<super::super::types::kendra::DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationConditionConditionOnValue>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#operator: {
