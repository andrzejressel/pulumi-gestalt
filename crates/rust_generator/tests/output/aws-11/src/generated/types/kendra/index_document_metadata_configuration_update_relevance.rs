...
pub struct IndexDocumentMetadataConfigurationUpdateRelevance {
    ...
    #[builder(into)]
    pub r#rank_order: Option<String>,
    ...
    #[builder(into)]
    pub r#values_importance_map: Option<std::collections::BTreeMap<String, i32>>,
}
