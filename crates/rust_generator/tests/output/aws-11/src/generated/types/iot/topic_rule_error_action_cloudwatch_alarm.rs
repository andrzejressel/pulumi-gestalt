...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TopicRuleErrorActionCloudwatchAlarm {
    ...
    > {
        async move {
            ...
            map.insert("alarm_name".to_string(), self.r#alarm_name.to_pulumi_value().await);
            map.insert("role_arn".to_string(), self.r#role_arn.to_pulumi_value().await);
            map.insert("state_reason".to_string(), self.r#state_reason.to_pulumi_value().await);
            map.insert("state_value".to_string(), self.r#state_value.to_pulumi_value().await);
