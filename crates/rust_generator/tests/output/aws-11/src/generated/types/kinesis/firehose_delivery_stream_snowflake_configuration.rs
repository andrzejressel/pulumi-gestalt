    ...
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#account_url: {
                        let field_value = match fields_map.get("accountUrl") {
                            Some(value) => value,
                            None => bail!("Missing field 'accountUrl' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                    ...
                    r#content_column_name: {
                        let field_value = match fields_map.get("contentColumnName") {
                            Some(value) => value,
                            None => bail!("Missing field 'contentColumnName' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#data_loading_option: {
                        let field_value = match fields_map.get("dataLoadingOption") {
                            Some(value) => value,
                            None => bail!("Missing field 'dataLoadingOption' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#database: {
                    ...
                    r#key_passphrase: {
                        let field_value = match fields_map.get("keyPassphrase") {
                            Some(value) => value,
                            None => bail!("Missing field 'keyPassphrase' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#metadata_column_name: {
                        let field_value = match fields_map.get("metadataColumnName") {
                            Some(value) => value,
                            None => bail!("Missing field 'metadataColumnName' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#private_key: {
                    ...
                    r#snowflake_role_configuration: {
                        let field_value = match fields_map.get("snowflakeRoleConfiguration") {
                            Some(value) => value,
                            None => bail!("Missing field 'snowflakeRoleConfiguration' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#snowflake_vpc_configuration: {
                        let field_value = match fields_map.get("snowflakeVpcConfiguration") {
                            Some(value) => value,
                            None => bail!("Missing field 'snowflakeVpcConfiguration' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#table: {
