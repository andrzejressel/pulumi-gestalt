...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TopicRuleHttp {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for TopicRuleHttp {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#confirmation_url: {
                        let field_value = match fields_map.get("confirmationUrl") {
                            Some(value) => value,
                            None => bail!("Missing field 'confirmationUrl' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
