...
pub struct FirehoseDeliveryStreamSnowflakeConfigurationS3Configuration {
    ...
    pub r#cloudwatch_logging_options: Box<Option<super::super::types::kinesis::FirehoseDeliveryStreamSnowflakeConfigurationS3ConfigurationCloudwatchLoggingOptions>>,
