...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DataSourceConfiguration {
    ...
    > {
        async move {
            ...
            map.insert("web_crawler_configuration".to_string(), self.r#web_crawler_configuration.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#s_3_configuration: {
                        ...
                        <Option<Box<super::super::types::kendra::DataSourceConfigurationS3Configuration>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#web_crawler_configuration: {
                        ...
                        <Option<Box<super::super::types::kendra::DataSourceConfigurationWebCrawlerConfiguration>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
