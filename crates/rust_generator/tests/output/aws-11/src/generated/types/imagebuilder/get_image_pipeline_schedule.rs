...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetImagePipelineSchedule {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("pipeline_execution_start_condition".to_string(), self.r#pipeline_execution_start_condition.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetImagePipelineSchedule {
