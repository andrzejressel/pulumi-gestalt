            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#authentication_configuration: {
                        ...
                        <Box<super::super::types::kinesis::FirehoseDeliveryStreamMskSourceConfigurationAuthenticationConfiguration> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#msk_cluster_arn: {
