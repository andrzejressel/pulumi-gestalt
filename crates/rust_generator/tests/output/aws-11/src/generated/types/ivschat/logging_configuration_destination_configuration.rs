...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for LoggingConfigurationDestinationConfiguration {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for LoggingConfigurationDestinationConfiguration {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#cloudwatch_logs: {
                        ...
                        <Option<Box<super::super::types::ivschat::LoggingConfigurationDestinationConfigurationCloudwatchLogs>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#firehose: {
                        ...
                        <Option<Box<super::super::types::ivschat::LoggingConfigurationDestinationConfigurationFirehose>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#s_3: {
                        ...
                        <Option<Box<super::super::types::ivschat::LoggingConfigurationDestinationConfigurationS3>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
