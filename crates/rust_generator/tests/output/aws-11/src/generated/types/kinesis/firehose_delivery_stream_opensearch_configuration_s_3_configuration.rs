...
pub struct FirehoseDeliveryStreamOpensearchConfigurationS3Configuration {
    ...
    pub r#cloudwatch_logging_options: Box<Option<super::super::types::kinesis::FirehoseDeliveryStreamOpensearchConfigurationS3ConfigurationCloudwatchLoggingOptions>>,
