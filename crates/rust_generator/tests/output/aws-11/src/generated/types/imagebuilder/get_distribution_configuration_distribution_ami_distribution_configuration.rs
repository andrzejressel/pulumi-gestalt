...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetDistributionConfigurationDistributionAmiDistributionConfiguration {
    ...
    > {
        async move {
            ...
            map.insert("launch_permissions".to_string(), self.r#launch_permissions.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#launch_permissions: {
                        ...
                        <Vec<super::super::types::imagebuilder::GetDistributionConfigurationDistributionAmiDistributionConfigurationLaunchPermission> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#name: {
