...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTarget {
    ...
    > {
        async move {
            ...
            map.insert("target_document_attribute_key".to_string(), self.r#target_document_attribute_key.to_pulumi_value().await);
            map.insert("target_document_attribute_value".to_string(), self.r#target_document_attribute_value.to_pulumi_value().await);
            map.insert("target_document_attribute_value_deletion".to_string(), self.r#target_document_attribute_value_deletion.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#target_document_attribute_value: {
                        ...
                        <Option<Box<super::super::types::kendra::DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTargetTargetDocumentAttributeValue>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
