...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetStreamStreamModeDetail {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("stream_mode".to_string(), self.r#stream_mode.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetStreamStreamModeDetail {
