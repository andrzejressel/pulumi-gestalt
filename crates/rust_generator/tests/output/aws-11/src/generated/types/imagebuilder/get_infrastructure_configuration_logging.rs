...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetInfrastructureConfigurationLogging {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetInfrastructureConfigurationLogging {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#s_3_logs: {
                        ...
                        <Vec<super::super::types::imagebuilder::GetInfrastructureConfigurationLoggingS3Log> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
