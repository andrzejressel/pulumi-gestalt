...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetIndexIndexStatisticTextDocumentStatistic {
    fn to_pulumi_value(
        &self,
        ...
        async move {
            ...
            map.insert(
                ...
                ToPulumiValue::to_pulumi_value(
                    &self.r#indexed_text_bytes,
                )
                .await,
            );
            map.insert(
                "indexed_text_documents_count".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#indexed_text_documents_count,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetIndexIndexStatisticTextDocumentStatistic {
