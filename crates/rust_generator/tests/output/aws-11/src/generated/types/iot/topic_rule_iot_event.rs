...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TopicRuleIotEvent {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("input_name".to_string(), self.r#input_name.to_pulumi_value().await);
            map.insert("message_id".to_string(), self.r#message_id.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for TopicRuleIotEvent {
        ...
        match value.content {
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#input_name: {
                        let field_value = match fields_map.get("input_name") {
                            Some(value) => value,
                            None => bail!("Missing field 'input_name' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
