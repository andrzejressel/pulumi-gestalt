...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for IndexingConfigurationThingGroupIndexingConfiguration {
    ...
    > {
        async move {
            ...
            map.insert("thing_group_indexing_mode".to_string(), self.r#thing_group_indexing_mode.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#custom_fields: {
                        ...
                        <Option<Vec<super::super::types::iot::IndexingConfigurationThingGroupIndexingConfigurationCustomField>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#managed_fields: {
                        ...
                        <Option<Vec<super::super::types::iot::IndexingConfigurationThingGroupIndexingConfigurationManagedField>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
