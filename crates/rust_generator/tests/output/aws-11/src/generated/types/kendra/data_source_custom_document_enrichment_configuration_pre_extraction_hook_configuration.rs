            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#invocation_condition: {
                        ...
                        <Option<Box<super::super::types::kendra::DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationCondition>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#lambda_arn: {
