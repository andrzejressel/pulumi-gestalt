...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TopicRuleRepublish {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("qos".to_string(), self.r#qos.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for TopicRuleRepublish {
