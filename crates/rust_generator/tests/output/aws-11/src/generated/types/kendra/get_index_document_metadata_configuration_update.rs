...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetIndexDocumentMetadataConfigurationUpdate {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("relevances".to_string(), self.r#relevances.to_pulumi_value().await);
            map.insert("searches".to_string(), self.r#searches.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetIndexDocumentMetadataConfigurationUpdate {
        ...
        match value.content {
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#relevances: {
                        let field_value = match fields_map.get("relevances") {
                            Some(value) => value,
                            None => bail!("Missing field 'relevances' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        <Vec<super::super::types::kendra::GetIndexDocumentMetadataConfigurationUpdateRelevance> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#searches: {
                        ...
                        <Vec<super::super::types::kendra::GetIndexDocumentMetadataConfigurationUpdateSearch> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#type_: {
