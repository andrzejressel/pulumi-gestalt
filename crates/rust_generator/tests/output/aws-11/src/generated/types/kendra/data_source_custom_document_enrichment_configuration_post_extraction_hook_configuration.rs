...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfiguration {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("invocation_condition".to_string(), self.r#invocation_condition.to_pulumi_value().await);
            map.insert("lambda_arn".to_string(), self.r#lambda_arn.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfiguration {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#invocation_condition: {
                        ...
                        <Option<Box<super::super::types::kendra::DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfigurationInvocationCondition>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#lambda_arn: {
