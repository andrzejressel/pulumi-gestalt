...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for TopicRuleErrorActionIotAnalytics {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("channel_name".to_string(), self.r#channel_name.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for TopicRuleErrorActionIotAnalytics {
        ...
        match value.content {
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#channel_name: {
                        let field_value = match fields_map.get("channel_name") {
                            Some(value) => value,
                            None => bail!("Missing field 'channel_name' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
