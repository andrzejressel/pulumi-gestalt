...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for DistributionConfigurationDistributionFastLaunchConfiguration {
    ...
    > {
        async move {
            ...
            map.insert("snapshot_configuration".to_string(), self.r#snapshot_configuration.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#launch_template: {
                        ...
                        <Option<Box<super::super::types::imagebuilder::DistributionConfigurationDistributionFastLaunchConfigurationLaunchTemplate>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    ...
                    r#snapshot_configuration: {
                        ...
                        <Option<Box<super::super::types::imagebuilder::DistributionConfigurationDistributionFastLaunchConfigurationSnapshotConfiguration>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
