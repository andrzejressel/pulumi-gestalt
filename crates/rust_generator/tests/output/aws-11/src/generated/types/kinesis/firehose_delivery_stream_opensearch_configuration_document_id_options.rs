...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FirehoseDeliveryStreamOpensearchConfigurationDocumentIdOptions {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("default_document_id_format".to_string(), self.r#default_document_id_format.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FirehoseDeliveryStreamOpensearchConfigurationDocumentIdOptions {
