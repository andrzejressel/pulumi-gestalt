...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for IndexingConfigurationThingIndexingConfigurationFilter {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("named_shadow_names".to_string(), self.r#named_shadow_names.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for IndexingConfigurationThingIndexingConfigurationFilter {
