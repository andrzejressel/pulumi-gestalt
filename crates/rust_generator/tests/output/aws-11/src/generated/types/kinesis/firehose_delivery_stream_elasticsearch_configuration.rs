...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for FirehoseDeliveryStreamElasticsearchConfiguration {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("cluster_endpoint".to_string(), self.r#cluster_endpoint.to_pulumi_value().await);
            map.insert("domain_arn".to_string(), self.r#domain_arn.to_pulumi_value().await);
            map.insert("index_name".to_string(), self.r#index_name.to_pulumi_value().await);
            map.insert("index_rotation_period".to_string(), self.r#index_rotation_period.to_pulumi_value().await);
            ...
            map.insert("type_name".to_string(), self.r#type_name.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for FirehoseDeliveryStreamElasticsearchConfiguration {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#cloudwatch_logging_options: {
                        ...
                        <Option<Box<super::super::types::kinesis::FirehoseDeliveryStreamElasticsearchConfigurationCloudwatchLoggingOptions>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#cluster_endpoint: {
                    ...
                    r#processing_configuration: {
                        ...
                        <Option<Box<super::super::types::kinesis::FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfiguration>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#retry_duration: {
                    ...
                    r#s_3_configuration: {
                        ...
                        <Box<super::super::types::kinesis::FirehoseDeliveryStreamElasticsearchConfigurationS3Configuration> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#type_name: {
                    ...
                    r#vpc_config: {
                        ...
                        <Option<Box<super::super::types::kinesis::FirehoseDeliveryStreamElasticsearchConfigurationVpcConfig>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
