...
pub struct GetOrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfiguration {
    ...
    pub r#public_ip_addresses: Vec<super::super::types::compute::GetOrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetOrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfiguration {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetOrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfiguration {
