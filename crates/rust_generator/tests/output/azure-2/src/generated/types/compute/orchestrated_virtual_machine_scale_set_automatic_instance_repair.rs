...
pub struct OrchestratedVirtualMachineScaleSetAutomaticInstanceRepair {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for OrchestratedVirtualMachineScaleSetAutomaticInstanceRepair {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for OrchestratedVirtualMachineScaleSetAutomaticInstanceRepair {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#grace_period: {
                        let field_value = match fields_map.get("gracePeriod") {
                            Some(value) => value,
                            None => bail!("Missing field 'gracePeriod' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
