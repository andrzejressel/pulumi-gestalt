...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GalleryApplicationVersionManageAction {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GalleryApplicationVersionManageAction {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#install: {
                        let field_value = match fields_map.get("install") {
                            Some(value) => value,
                            None => bail!("Missing field 'install' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
