...
pub struct GetVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress {
    ...
    #[builder(into)]
    #[serde(rename = "ipTags")]
    pub r#ip_tags: Vec<super::super::types::compute::GetVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddressIpTag>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress {
