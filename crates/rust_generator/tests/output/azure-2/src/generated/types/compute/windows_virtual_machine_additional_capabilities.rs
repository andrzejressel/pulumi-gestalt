...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WindowsVirtualMachineAdditionalCapabilities {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WindowsVirtualMachineAdditionalCapabilities {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#hibernation_enabled: {
                        let field_value = match fields_map.get("hibernationEnabled") {
                            Some(value) => value,
                            None => bail!("Missing field 'hibernationEnabled' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
