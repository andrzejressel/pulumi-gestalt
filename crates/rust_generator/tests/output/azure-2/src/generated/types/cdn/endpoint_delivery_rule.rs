...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EndpointDeliveryRule {
    ...
    > {
        async move {
            ...
            map.insert(
                "request_method_condition".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "request_scheme_condition".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "url_file_name_conditions".to_string(),
                ToPulumiValue::to_pulumi_value(
