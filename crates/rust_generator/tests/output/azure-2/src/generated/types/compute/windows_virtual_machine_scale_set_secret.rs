...
pub struct WindowsVirtualMachineScaleSetSecret {
    ...
    pub r#certificates: Vec<super::super::types::compute::WindowsVirtualMachineScaleSetSecretCertificate>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WindowsVirtualMachineScaleSetSecret {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WindowsVirtualMachineScaleSetSecret {
