...
pub struct WindowsVirtualMachineOsDisk {
    ...
    pub r#diff_disk_settings: Option<Box<super::super::types::compute::WindowsVirtualMachineOsDiskDiffDiskSettings>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WindowsVirtualMachineOsDisk {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WindowsVirtualMachineOsDisk {
