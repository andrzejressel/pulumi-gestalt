...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WindowsVirtualMachineGalleryApplication {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "configuration_blob_uri".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "treat_failure_as_deployment_failure_enabled".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WindowsVirtualMachineGalleryApplication {
