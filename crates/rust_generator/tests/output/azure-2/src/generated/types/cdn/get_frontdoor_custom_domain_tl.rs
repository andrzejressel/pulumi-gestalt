...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetFrontdoorCustomDomainTl {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "cdn_frontdoor_secret_id".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetFrontdoorCustomDomainTl {
