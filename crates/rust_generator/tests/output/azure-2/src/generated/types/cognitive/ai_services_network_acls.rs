...
pub struct AiServicesNetworkAcls {
    ...
    pub r#virtual_network_rules: Option<Vec<super::super::types::cognitive::AiServicesNetworkAclsVirtualNetworkRule>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AiServicesNetworkAcls {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AiServicesNetworkAcls {
