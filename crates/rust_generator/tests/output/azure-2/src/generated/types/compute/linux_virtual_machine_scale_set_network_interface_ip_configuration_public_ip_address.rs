...
pub struct LinuxVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress {
    ...
    #[builder(into)]
    #[serde(rename = "ipTags")]
    pub r#ip_tags: Option<Vec<super::super::types::compute::LinuxVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddressIpTag>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for LinuxVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for LinuxVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress {
