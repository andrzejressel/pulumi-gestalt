...
pub struct SnapshotEncryptionSettings {
    ...
    pub r#key_encryption_key: Option<Box<super::super::types::compute::SnapshotEncryptionSettingsKeyEncryptionKey>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for SnapshotEncryptionSettings {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for SnapshotEncryptionSettings {
