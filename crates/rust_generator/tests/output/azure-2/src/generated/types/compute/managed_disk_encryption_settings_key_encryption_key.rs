...
pub struct ManagedDiskEncryptionSettingsKeyEncryptionKey {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ManagedDiskEncryptionSettingsKeyEncryptionKey {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ManagedDiskEncryptionSettingsKeyEncryptionKey {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#key_url: {
                        let field_value = match fields_map.get("key_url") {
                            Some(value) => value,
                            None => bail!("Missing field 'key_url' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
