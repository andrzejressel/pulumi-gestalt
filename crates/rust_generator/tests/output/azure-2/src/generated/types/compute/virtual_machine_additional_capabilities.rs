...
pub struct VirtualMachineAdditionalCapabilities {
    ...
    pub r#ultra_ssd_enabled: bool,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for VirtualMachineAdditionalCapabilities {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for VirtualMachineAdditionalCapabilities {
