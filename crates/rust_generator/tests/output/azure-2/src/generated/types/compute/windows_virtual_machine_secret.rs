...
pub struct WindowsVirtualMachineSecret {
    ...
    pub r#certificates: Vec<super::super::types::compute::WindowsVirtualMachineSecretCertificate>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WindowsVirtualMachineSecret {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WindowsVirtualMachineSecret {
