...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AiServicesCustomerManagedKey {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AiServicesCustomerManagedKey {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#managed_hsm_key_id: {
                        let field_value = match fields_map.get("managedHsmKeyId") {
                            Some(value) => value,
                            None => bail!("Missing field 'managedHsmKeyId' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
