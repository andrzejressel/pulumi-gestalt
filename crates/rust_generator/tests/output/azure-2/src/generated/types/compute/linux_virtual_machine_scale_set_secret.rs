...
pub struct LinuxVirtualMachineScaleSetSecret {
    ...
    pub r#certificates: Vec<super::super::types::compute::LinuxVirtualMachineScaleSetSecretCertificate>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for LinuxVirtualMachineScaleSetSecret {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for LinuxVirtualMachineScaleSetSecret {
