...
pub struct WindowsVirtualMachineScaleSetIdentity {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for WindowsVirtualMachineScaleSetIdentity {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for WindowsVirtualMachineScaleSetIdentity {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#identity_ids: {
                        let field_value = match fields_map.get("identity_ids") {
                            Some(value) => value,
                            None => bail!("Missing field 'identity_ids' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
