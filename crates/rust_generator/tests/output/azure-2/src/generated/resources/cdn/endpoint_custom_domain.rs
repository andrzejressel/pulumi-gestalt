...
pub mod endpoint_custom_domain {
    ...
    fn __create(
        ...
        let cdn_endpoint_id_binding = args.cdn_endpoint_id.get_output(ctx);
        let cdn_managed_https_binding = args.cdn_managed_https.get_output(ctx);
        let host_name_binding = args.host_name.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let user_managed_https_binding = args.user_managed_https.get_output(ctx);
