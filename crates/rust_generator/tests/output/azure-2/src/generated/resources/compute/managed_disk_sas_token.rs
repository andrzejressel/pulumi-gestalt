...
pub mod managed_disk_sas_token {
    ...
    fn __create(
        ...
        let duration_in_seconds_binding = args.duration_in_seconds.get_output(ctx);
        let managed_disk_id_binding = args.managed_disk_id.get_output(ctx);
