...
pub mod service_azure_bot {
    ...
    fn __create(
        ...
        let cmk_key_vault_key_url_binding = args.cmk_key_vault_key_url.get_output(ctx);
        ...
        let icon_url_binding = args.icon_url.get_output(ctx);
        let local_authentication_enabled_binding = args
            .local_authentication_enabled
            .get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let luis_app_ids_binding = args.luis_app_ids.get_output(ctx);
        let luis_key_binding = args.luis_key.get_output(ctx);
        let microsoft_app_id_binding = args.microsoft_app_id.get_output(ctx);
        let microsoft_app_msi_id_binding = args.microsoft_app_msi_id.get_output(ctx);
        let microsoft_app_tenant_id_binding = args
            .microsoft_app_tenant_id
            .get_output(ctx);
        let microsoft_app_type_binding = args.microsoft_app_type.get_output(ctx);
