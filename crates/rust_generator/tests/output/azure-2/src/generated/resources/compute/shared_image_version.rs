...
pub mod shared_image_version {
    ...
    fn __create(
        ...
        let blob_uri_binding = args.blob_uri.get_output(ctx);
        ...
        let managed_image_id_binding = args.managed_image_id.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let os_disk_snapshot_id_binding = args.os_disk_snapshot_id.get_output(ctx);
        let replication_mode_binding = args.replication_mode.get_output(ctx);
