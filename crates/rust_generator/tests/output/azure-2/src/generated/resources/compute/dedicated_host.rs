...
pub mod dedicated_host {
    ...
    pub struct DedicatedHostArgs {
        ...
        pub auto_replace_on_failure: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into)]
        pub dedicated_host_group_id: pulumi_gestalt_rust::Input<String>,
        ...
        #[builder(into)]
        pub platform_fault_domain: pulumi_gestalt_rust::Input<i32>,
