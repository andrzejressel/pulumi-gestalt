...
pub mod channel_slack {
    ...
    fn __create(
        ...
        let landing_page_url_binding = args.landing_page_url.get_output(ctx);
        let location_binding = args.location.get_output(ctx);
        let resource_group_name_binding = args.resource_group_name.get_output(ctx);
        let signing_secret_binding = args.signing_secret.get_output(ctx);
        let verification_token_binding = args.verification_token.get_output(ctx);
