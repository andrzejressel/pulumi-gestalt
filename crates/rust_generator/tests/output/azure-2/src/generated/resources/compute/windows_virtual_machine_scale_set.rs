...
pub mod windows_virtual_machine_scale_set {
    ...
    pub struct WindowsVirtualMachineScaleSetArgs {
        ...
        #[builder(into, default)]
        pub additional_unattend_contents: pulumi_gestalt_rust::Input<
            Option<
                Vec<
        ...
        #[builder(into)]
        pub admin_password: pulumi_gestalt_rust::Input<String>,
        ...
        #[builder(into, default)]
        pub automatic_os_upgrade_policy: pulumi_gestalt_rust::Input<
            Option<
        ...
        #[builder(into, default)]
        pub enable_automatic_updates: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub health_probe_id: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into)]
        pub instances: pulumi_gestalt_rust::Input<i32>,
        ...
        #[builder(into, default)]
        pub overprovision: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub rolling_upgrade_policy: pulumi_gestalt_rust::Input<
            Option<
        ...
        #[builder(into, default)]
        pub scale_in: pulumi_gestalt_rust::Input<
        ...
        #[builder(into, default)]
        pub spot_restore: pulumi_gestalt_rust::Input<
            Option<
        ...
        #[builder(into, default)]
        pub upgrade_mode: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub winrm_listeners: pulumi_gestalt_rust::Input<
            Option<
                Vec<
    ...
    fn __create(
        ...
        let capacity_reservation_group_id_binding = args
            ...
            .get_output(ctx);
        let computer_name_prefix_binding = args.computer_name_prefix.get_output(ctx);
        let custom_data_binding = args.custom_data.get_output(ctx);
        ...
        let gallery_applications_binding = args.gallery_applications.get_output(ctx);
        ...
        let provision_vm_agent_binding = args.provision_vm_agent.get_output(ctx);
        ...
        let scale_in_binding = args.scale_in.get_output(ctx);
        let secrets_binding = args.secrets.get_output(ctx);
        let secure_boot_enabled_binding = args.secure_boot_enabled.get_output(ctx);
        ...
        let spot_restore_binding = args.spot_restore.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let termination_notification_binding = args
            .termination_notification
            .get_output(ctx);
        let timezone_binding = args.timezone.get_output(ctx);
        let upgrade_mode_binding = args.upgrade_mode.get_output(ctx);
        let user_data_binding = args.user_data.get_output(ctx);
        let vtpm_enabled_binding = args.vtpm_enabled.get_output(ctx);
        let winrm_listeners_binding = args.winrm_listeners.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &additional_unattend_contents_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &enable_automatic_updates_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &winrm_listeners_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
