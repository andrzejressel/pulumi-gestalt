...
pub fn create(
    ...
    ProviderResult {
        auxiliary_tenant_ids: _o.get_field("auxiliaryTenantIds"),
        client_certificate: _o.get_field("clientCertificate"),
        client_certificate_password: _o.get_field("clientCertificatePassword"),
        client_certificate_path: _o.get_field("clientCertificatePath"),
        client_id: _o.get_field("clientId"),
        client_id_file_path: _o.get_field("clientIdFilePath"),
        client_secret: _o.get_field("clientSecret"),
        client_secret_file_path: _o.get_field("clientSecretFilePath"),
        disable_correlation_request_id: _o.get_field("disableCorrelationRequestId"),
        disable_terraform_partner_id: _o.get_field("disableTerraformPartnerId"),
        environment: _o.get_field("environment"),
        features: _o.get_field("features"),
        metadata_host: _o.get_field("metadataHost"),
        msi_endpoint: _o.get_field("msiEndpoint"),
        oidc_request_token: _o.get_field("oidcRequestToken"),
        oidc_request_url: _o.get_field("oidcRequestUrl"),
        oidc_token: _o.get_field("oidcToken"),
        oidc_token_file_path: _o.get_field("oidcTokenFilePath"),
        partner_id: _o.get_field("partnerId"),
        resource_provider_registrations: _o.get_field("resourceProviderRegistrations"),
        resource_providers_to_registers: _o.get_field("resourceProvidersToRegisters"),
        skip_provider_registration: _o.get_field("skipProviderRegistration"),
        storage_use_azuread: _o.get_field("storageUseAzuread"),
        subscription_id: _o.get_field("subscriptionId"),
        tenant_id: _o.get_field("tenantId"),
        use_aks_workload_identity: _o.get_field("useAksWorkloadIdentity"),
        use_cli: _o.get_field("useCli"),
        use_msi: _o.get_field("useMsi"),
        use_oidc: _o.get_field("useOidc"),
    }
}
