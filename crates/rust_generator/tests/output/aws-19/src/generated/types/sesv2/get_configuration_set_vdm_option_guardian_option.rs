...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetConfigurationSetVdmOptionGuardianOption {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("optimized_shared_delivery".to_string(), self.r#optimized_shared_delivery.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetConfigurationSetVdmOptionGuardianOption {
