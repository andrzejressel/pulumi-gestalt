...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetPatchBaselineSource {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("products".to_string(), self.r#products.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetPatchBaselineSource {
