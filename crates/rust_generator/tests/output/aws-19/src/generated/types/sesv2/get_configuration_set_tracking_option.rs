...
pub struct GetConfigurationSetTrackingOption {
    ...
    pub r#https_policy: String,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetConfigurationSetTrackingOption {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("custom_redirect_domain".to_string(), self.r#custom_redirect_domain.to_pulumi_value().await);
            map.insert("https_policy".to_string(), self.r#https_policy.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetConfigurationSetTrackingOption {
