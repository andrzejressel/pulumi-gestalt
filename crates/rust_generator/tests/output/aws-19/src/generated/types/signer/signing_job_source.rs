...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for SigningJobSource {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for SigningJobSource {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#s_3: {
                        ...
                        <Box<super::super::types::signer::SigningJobSourceS3> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
