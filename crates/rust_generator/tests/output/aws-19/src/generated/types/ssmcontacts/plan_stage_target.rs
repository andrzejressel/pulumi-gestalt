...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PlanStageTarget {
    ...
    > {
        async move {
            ...
            map.insert("channel_target_info".to_string(), self.r#channel_target_info.to_pulumi_value().await);
            map.insert("contact_target_info".to_string(), self.r#contact_target_info.to_pulumi_value().await);
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#channel_target_info: {
                        ...
                        <Option<Box<super::super::types::ssmcontacts::PlanStageTargetChannelTargetInfo>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#contact_target_info: {
                        ...
                        <Option<Box<super::super::types::ssmcontacts::PlanStageTargetContactTargetInfo>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
