...
pub struct GetSigningJobSignedObjectS3 {
    #[builder(into)]
    #[serde(rename = "bucket")]
    pub r#bucket: String,
    #[builder(into)]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetSigningJobSignedObjectS3 {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetSigningJobSignedObjectS3 {
