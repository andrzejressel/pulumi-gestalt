...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for PlanStageTargetChannelTargetInfo {
    ...
    > {
        async move {
            ...
            map.insert("contact_channel_id".to_string(), self.r#contact_channel_id.to_pulumi_value().await);
            map.insert("retry_interval_in_minutes".to_string(), self.r#retry_interval_in_minutes.to_pulumi_value().await);
