            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#dashboard_options: {
                        ...
                        <Option<Box<super::super::types::sesv2::ConfigurationSetVdmOptionsDashboardOptions>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                    r#guardian_options: {
                        ...
                        <Option<Box<super::super::types::sesv2::ConfigurationSetVdmOptionsGuardianOptions>> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
