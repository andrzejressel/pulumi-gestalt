...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetSigningProfileRevocationRecord {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("revocation_effective_from".to_string(), self.r#revocation_effective_from.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetSigningProfileRevocationRecord {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    r#revocation_effective_from: {
                        let field_value = match fields_map.get("revocation_effective_from") {
                            Some(value) => value,
                            None => bail!("Missing field 'revocation_effective_from' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
