...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ActivityEncryptionConfiguration {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ActivityEncryptionConfiguration {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#kms_data_key_reuse_period_seconds: {
                        let field_value = match fields_map.get("kmsDataKeyReusePeriodSeconds") {
                            Some(value) => value,
                            None => bail!("Missing field 'kmsDataKeyReusePeriodSeconds' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
