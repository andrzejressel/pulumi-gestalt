...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetPlanStage {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert("duration_in_minutes".to_string(), self.r#duration_in_minutes.to_pulumi_value().await);
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetPlanStage {
            ...
            PulumiValueContent::Object(ref obj) => {
                ...
                Ok(Self {
                    ...
                    r#targets: {
                        ...
                        <Vec<super::super::types::ssmcontacts::GetPlanStageTarget> as FromPulumiValue>::from_pulumi_value(field_value)?
                    },
                })
            }
