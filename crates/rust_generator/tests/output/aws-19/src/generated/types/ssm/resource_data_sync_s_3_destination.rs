...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ResourceDataSyncS3Destination {
    fn to_pulumi_value(
        &self,
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#sync_format: {
                        let field_value = match fields_map.get("syncFormat") {
                            Some(value) => value,
                            None => bail!("Missing field 'syncFormat' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
