...
pub mod maintenance_window {
    ...
    fn __create(
        ...
        let allow_unassociated_targets_binding = args
            ...
            .get_output(ctx);
        let cutoff_binding = args.cutoff.get_output(ctx);
        ...
        let schedule_offset_binding = args.schedule_offset.get_output(ctx);
        let schedule_timezone_binding = args.schedule_timezone.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &allow_unassociated_targets_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "cutoff".into(),
                    value: &cutoff_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &schedule_offset_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "scheduleTimezone".into(),
                    value: &schedule_timezone_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "startDate".into(),
