...
pub mod signing_profile {
    ...
    fn __create(
        ...
        let signature_validity_period_binding = args
            ...
            .get_output(ctx);
        let signing_material_binding = args.signing_material.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &signature_validity_period_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "signingMaterial".into(),
                    value: &signing_material_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "tags".into(),
