...
pub mod queue {
    ...
    pub struct QueueArgs {
        ...
        #[builder(into, default)]
        pub delay_seconds: pulumi_gestalt_rust::Input<Option<i32>>,
        /// Boolean designating a FIFO queue. If not set, it defaults to `false` making it standard.
        #[builder(into, default)]
        pub fifo_queue: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub max_message_size: pulumi_gestalt_rust::Input<Option<i32>>,
        /// The number of seconds Amazon SQS retains a message. Integer representing seconds, from 60 (1 minute) to 1209600 (14 days). The default for this attribute is 345600 (4 days).
        #[builder(into, default)]
        pub message_retention_seconds: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub receive_wait_time_seconds: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        #[builder(into, default)]
        pub redrive_allow_policy: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub sqs_managed_sse_enabled: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub visibility_timeout_seconds: pulumi_gestalt_rust::Input<Option<i32>>,
    }
    #[allow(dead_code)]
    ...
    fn __create(
        ...
        let content_based_deduplication_binding = args
            ...
            .get_output(ctx);
        let deduplication_scope_binding = args.deduplication_scope.get_output(ctx);
        let delay_seconds_binding = args.delay_seconds.get_output(ctx);
        let fifo_queue_binding = args.fifo_queue.get_output(ctx);
        let fifo_throughput_limit_binding = args.fifo_throughput_limit.get_output(ctx);
        let kms_data_key_reuse_period_seconds_binding = args
            .kms_data_key_reuse_period_seconds
            .get_output(ctx);
        let kms_master_key_id_binding = args.kms_master_key_id.get_output(ctx);
        let max_message_size_binding = args.max_message_size.get_output(ctx);
