...
pub mod file_upload {
    ...
    pub struct FileUploadArgs {
        ...
        #[builder(into, default)]
        pub default_ttl: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub notifications_enabled: pulumi_gestalt_rust::Input<Option<bool>>,
        ...
        #[builder(into, default)]
        pub sas_ttl: pulumi_gestalt_rust::Input<Option<String>>,
    }
    #[allow(dead_code)]
