...
pub mod managed_storage_account_sas_token_definition {
    ...
    fn __create(
        ...
        let sas_template_uri_binding = args.sas_template_uri.get_output(ctx);
        let sas_type_binding = args.sas_type.get_output(ctx);
        let tags_binding = args.tags.get_output(ctx);
        let validity_period_binding = args.validity_period.get_output(ctx);
