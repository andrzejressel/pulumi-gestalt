...
pub mod cache_nfs_target {
    ...
    pub struct CacheNfsTargetArgs {
        ...
        #[builder(into)]
        pub namespace_junctions: pulumi_gestalt_rust::Input<
        ...
        #[builder(into)]
        pub target_host_name: pulumi_gestalt_rust::Input<String>,
    ...
    fn __create(
        ...
        let cache_name_binding = args.cache_name.get_output(ctx);
        let name_binding = args.name.get_output(ctx);
        let namespace_junctions_binding = args.namespace_junctions.get_output(ctx);
        let resource_group_name_binding = args.resource_group_name.get_output(ctx);
        let target_host_name_binding = args.target_host_name.get_output(ctx);
        let usage_model_binding = args.usage_model.get_output(ctx);
        ...
        CacheNfsTargetResult {
            ...
            target_host_name: o.get_field("targetHostName"),
            usage_model: o.get_field("usageModel"),
            verification_timer_in_seconds: o.get_field("verificationTimerInSeconds"),
            write_back_timer_in_seconds: o.get_field("writeBackTimerInSeconds"),
        }
    }
}
