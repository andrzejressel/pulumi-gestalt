...
pub mod key {
    ...
    fn __create(
        ...
        let curve_binding = args.curve.get_output(ctx);
        let expiration_date_binding = args.expiration_date.get_output(ctx);
        let key_opts_binding = args.key_opts.get_output(ctx);
        ...
        let not_before_date_binding = args.not_before_date.get_output(ctx);
        let rotation_policy_binding = args.rotation_policy.get_output(ctx);
