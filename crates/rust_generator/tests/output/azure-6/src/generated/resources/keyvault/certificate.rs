...
pub mod certificate {
    ...
    pub struct CertificateResult {
        ...
        pub certificate_attributes: pulumi_gestalt_rust::Output<
            Vec<super::super::types::keyvault::CertificateCertificateAttribute>,
        >,
        ...
        pub certificate_policy: pulumi_gestalt_rust::Output<
            super::super::types::keyvault::CertificateCertificatePolicy,
        >,
        /// The ID of the Key Vault where the Certificate should be created. Changing this forces a new resource to be created.
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "azure:keyvault/certificate:Certificate".into(),
            name: name.to_string(),
