...
pub mod service {
    ...
    fn __create(
        ...
        let cosmosdb_key_vault_key_versionless_id_binding = args
            ...
            .get_output(ctx);
        let cosmosdb_throughput_binding = args.cosmosdb_throughput.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &cosmosdb_key_vault_key_versionless_id_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "cosmosdbThroughput".into(),
                    value: &cosmosdb_throughput_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "identity".into(),
