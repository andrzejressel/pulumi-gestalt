...
pub mod managed_hardware_security_module {
    ...
    pub struct ManagedHardwareSecurityModuleArgs {
        ...
        #[builder(into)]
        pub admin_object_ids: pulumi_gestalt_rust::Input<Vec<String>>,
        ...
        #[builder(into, default)]
        pub security_domain_key_vault_certificate_ids: pulumi_gestalt_rust::Input<
            Option<Vec<String>>,
        >,
        ...
        #[builder(into, default)]
        pub security_domain_quorum: pulumi_gestalt_rust::Input<Option<i32>>,
