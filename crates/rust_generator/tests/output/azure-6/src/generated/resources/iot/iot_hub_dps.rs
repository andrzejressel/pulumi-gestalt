...
pub mod iot_hub_dps {
    ...
    fn __create(
        ...
        let allocation_policy_binding = args.allocation_policy.get_output(ctx);
        let data_residency_enabled_binding = args.data_residency_enabled.get_output(ctx);
        let ip_filter_rules_binding = args.ip_filter_rules.get_output(ctx);
        let linked_hubs_binding = args.linked_hubs.get_output(ctx);
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &allocation_policy_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "dataResidencyEnabled".into(),
                    value: &data_residency_enabled_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "ipFilterRules".into(),
                    value: &ip_filter_rules_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "linkedHubs".into(),
                    value: &linked_hubs_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "location".into(),
