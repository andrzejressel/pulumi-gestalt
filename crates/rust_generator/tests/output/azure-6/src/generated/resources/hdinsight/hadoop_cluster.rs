...
///             .build_struct(),
///     );
///     let exampleHadoopCluster = hadoop_cluster::create(
///         "exampleHadoopCluster",
///         HadoopClusterArgs::builder()
///             .cluster_version("3.6")
///             .component_version(
///                 HadoopClusterComponentVersion::builder().hadoop("2.7").build_struct(),
///             )
///             .gateway(
///                 HadoopClusterGateway::builder()
...
///             .resource_group_name("${example.name}")
///             .roles(
///                 HadoopClusterRoles::builder()
///                     .headNode(
///                         HadoopClusterRolesHeadNode::builder()
...
///                     )
///                     .workerNode(
///                         HadoopClusterRolesWorkerNode::builder()
///                             .password("AccTestvdSC4daf986!")
...
///                     )
///                     .zookeeperNode(
///                         HadoopClusterRolesZookeeperNode::builder()
///                             .password("AccTestvdSC4daf986!")
///                             .username("acctestusrvm")
///                             .vmSize("Standard_D3_V2")
///                             .build_struct(),
...
///             .storage_accounts(
///                 vec![
///                     HadoopClusterStorageAccount::builder().isDefault(true)
...
pub mod hadoop_cluster {
    ...
    pub struct HadoopClusterArgs {
        ...
        pub component_version: pulumi_gestalt_rust::InputOrOutput<
            super::super::types::hdinsight::HadoopClusterComponentVersion,
        >,
        /// A `compute_isolation` block as defined below.
        #[builder(into, default)]
        pub compute_isolation: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::hdinsight::HadoopClusterComputeIsolation>,
        >,
        /// One or more `disk_encryption` block as defined below.
        #[builder(into, default)]
        pub disk_encryptions: pulumi_gestalt_rust::InputOrOutput<
            Option<Vec<super::super::types::hdinsight::HadoopClusterDiskEncryption>>,
        >,
        /// An `extension` block as defined below.
        #[builder(into, default)]
        pub extension: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::hdinsight::HadoopClusterExtension>,
        >,
        /// A `gateway` block as defined below.
        #[builder(into)]
        pub gateway: pulumi_gestalt_rust::InputOrOutput<
            super::super::types::hdinsight::HadoopClusterGateway,
        >,
        ...
        pub metastores: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::hdinsight::HadoopClusterMetastores>,
        >,
        /// A `monitor` block as defined below.
        #[builder(into, default)]
        pub monitor: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::hdinsight::HadoopClusterMonitor>,
        >,
        ...
        pub network: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::hdinsight::HadoopClusterNetwork>,
        >,
        /// A `private_link_configuration` block as defined below.
        #[builder(into, default)]
        pub private_link_configuration: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::hdinsight::HadoopClusterPrivateLinkConfiguration>,
        >,
        ...
        pub roles: pulumi_gestalt_rust::InputOrOutput<
            super::super::types::hdinsight::HadoopClusterRoles,
        >,
        /// A `security_profile` block as defined below. Changing this forces a new resource to be created.
        #[builder(into, default)]
        pub security_profile: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::hdinsight::HadoopClusterSecurityProfile>,
        >,
        /// A `storage_account_gen2` block as defined below.
        #[builder(into, default)]
        pub storage_account_gen2: pulumi_gestalt_rust::InputOrOutput<
            Option<super::super::types::hdinsight::HadoopClusterStorageAccountGen2>,
        >,
        /// One or more `storage_account` block as defined below.
        #[builder(into, default)]
        pub storage_accounts: pulumi_gestalt_rust::InputOrOutput<
            Option<Vec<super::super::types::hdinsight::HadoopClusterStorageAccount>>,
        >,
    ...
    #[allow(dead_code)]
    pub struct HadoopClusterResult {
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            type_: "azure:hdinsight/hadoopCluster:HadoopCluster".into(),
            name: name.to_string(),
