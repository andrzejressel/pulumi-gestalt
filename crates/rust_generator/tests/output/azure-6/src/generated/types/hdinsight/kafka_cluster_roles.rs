            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#kafka_management_node: {
                        let field_value = match fields_map.get("kafkaManagementNode") {
                            Some(value) => value,
                            None => bail!("Missing field 'kafkaManagementNode' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#worker_node: {
