...
pub struct KafkaClusterRolesZookeeperNode {
    ...
    pub r#script_actions: Option<Vec<super::super::types::hdinsight::KafkaClusterRolesZookeeperNodeScriptAction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for KafkaClusterRolesZookeeperNode {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for KafkaClusterRolesZookeeperNode {
