...
pub struct KafkaClusterRolesHeadNode {
    ...
    pub r#script_actions: Option<Vec<super::super::types::hdinsight::KafkaClusterRolesHeadNodeScriptAction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for KafkaClusterRolesHeadNode {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for KafkaClusterRolesHeadNode {
