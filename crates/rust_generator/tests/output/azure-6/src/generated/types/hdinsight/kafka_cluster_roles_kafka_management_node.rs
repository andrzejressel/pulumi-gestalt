...
pub struct KafkaClusterRolesKafkaManagementNode {
    ...
    pub r#script_actions: Option<Vec<super::super::types::hdinsight::KafkaClusterRolesKafkaManagementNodeScriptAction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for KafkaClusterRolesKafkaManagementNode {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for KafkaClusterRolesKafkaManagementNode {
