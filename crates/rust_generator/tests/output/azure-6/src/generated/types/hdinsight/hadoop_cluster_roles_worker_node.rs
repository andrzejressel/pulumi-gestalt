...
pub struct HadoopClusterRolesWorkerNode {
    ...
    pub r#autoscale: Option<Box<super::super::types::hdinsight::HadoopClusterRolesWorkerNodeAutoscale>>,
    ...
    pub r#script_actions: Option<Vec<super::super::types::hdinsight::HadoopClusterRolesWorkerNodeScriptAction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for HadoopClusterRolesWorkerNode {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for HadoopClusterRolesWorkerNode {
