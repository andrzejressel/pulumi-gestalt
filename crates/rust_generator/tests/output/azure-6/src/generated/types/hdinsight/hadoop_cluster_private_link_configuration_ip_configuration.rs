...
pub struct HadoopClusterPrivateLinkConfigurationIpConfiguration {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for HadoopClusterPrivateLinkConfigurationIpConfiguration {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for HadoopClusterPrivateLinkConfigurationIpConfiguration {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#private_ip_allocation_method: {
                        let field_value = match fields_map.get("privateIpAllocationMethod") {
                            Some(value) => value,
                            None => bail!("Missing field 'privateIpAllocationMethod' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#subnet_id: {
