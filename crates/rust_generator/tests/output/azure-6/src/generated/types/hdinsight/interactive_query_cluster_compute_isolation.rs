...
pub struct InteractiveQueryClusterComputeIsolation {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for InteractiveQueryClusterComputeIsolation {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "compute_isolation_enabled".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for InteractiveQueryClusterComputeIsolation {
