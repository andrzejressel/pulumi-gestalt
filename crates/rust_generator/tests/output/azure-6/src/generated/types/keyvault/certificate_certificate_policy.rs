...
pub struct CertificateCertificatePolicy {
    ...
    pub r#lifetime_actions: Option<Vec<super::super::types::keyvault::CertificateCertificatePolicyLifetimeAction>>,
    ...
    pub r#x_509_certificate_properties: Option<Box<super::super::types::keyvault::CertificateCertificatePolicyX509CertificateProperties>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for CertificateCertificatePolicy {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for CertificateCertificatePolicy {
