...
pub struct SparkClusterRolesHeadNode {
    ...
    pub r#script_actions: Option<Vec<super::super::types::hdinsight::SparkClusterRolesHeadNodeScriptAction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for SparkClusterRolesHeadNode {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for SparkClusterRolesHeadNode {
