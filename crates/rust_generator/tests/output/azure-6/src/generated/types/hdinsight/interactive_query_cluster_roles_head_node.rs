...
pub struct InteractiveQueryClusterRolesHeadNode {
    ...
    pub r#script_actions: Option<Vec<super::super::types::hdinsight::InteractiveQueryClusterRolesHeadNodeScriptAction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for InteractiveQueryClusterRolesHeadNode {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for InteractiveQueryClusterRolesHeadNode {
