...
pub struct KafkaClusterRolesWorkerNode {
    ...
    #[builder(into)]
    #[serde(rename = "numberOfDisksPerNode")]
    pub r#number_of_disks_per_node: i32,
    ...
    pub r#script_actions: Option<Vec<super::super::types::hdinsight::KafkaClusterRolesWorkerNodeScriptAction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for KafkaClusterRolesWorkerNode {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for KafkaClusterRolesWorkerNode {
