...
pub struct HBaseClusterRolesWorkerNode {
    /// A `autoscale` block as defined below.
    #[builder(into)]
    #[serde(rename = "autoscale")]
    pub r#autoscale: Option<Box<super::super::types::hdinsight::HBaseClusterRolesWorkerNodeAutoscale>>,
    ...
    pub r#script_actions: Option<Vec<super::super::types::hdinsight::HBaseClusterRolesWorkerNodeScriptAction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for HBaseClusterRolesWorkerNode {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for HBaseClusterRolesWorkerNode {
