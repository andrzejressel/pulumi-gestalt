...
pub struct SparkClusterRolesWorkerNodeAutoscaleRecurrence {
    ...
    pub r#schedules: Vec<super::super::types::hdinsight::SparkClusterRolesWorkerNodeAutoscaleRecurrenceSchedule>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for SparkClusterRolesWorkerNodeAutoscaleRecurrence {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for SparkClusterRolesWorkerNodeAutoscaleRecurrence {
