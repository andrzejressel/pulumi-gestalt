...
pub struct KafkaClusterPrivateLinkConfiguration {
    ...
    pub r#ip_configuration: Box<super::super::types::hdinsight::KafkaClusterPrivateLinkConfigurationIpConfiguration>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for KafkaClusterPrivateLinkConfiguration {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for KafkaClusterPrivateLinkConfiguration {
