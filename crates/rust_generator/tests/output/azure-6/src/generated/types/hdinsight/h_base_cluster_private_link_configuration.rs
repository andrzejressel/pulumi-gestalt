...
pub struct HBaseClusterPrivateLinkConfiguration {
    ...
    pub r#ip_configuration: Box<super::super::types::hdinsight::HBaseClusterPrivateLinkConfigurationIpConfiguration>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for HBaseClusterPrivateLinkConfiguration {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for HBaseClusterPrivateLinkConfiguration {
