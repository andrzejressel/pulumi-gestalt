...
pub struct HadoopClusterStorageAccountGen2 {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for HadoopClusterStorageAccountGen2 {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for HadoopClusterStorageAccountGen2 {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#managed_identity_resource_id: {
                        let field_value = match fields_map.get("managedIdentityResourceId") {
                            Some(value) => value,
                            None => bail!("Missing field 'managedIdentityResourceId' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
