...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for IoTHubEnrichment {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for IoTHubEnrichment {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#endpoint_names: {
                        let field_value = match fields_map.get("endpointNames") {
                            Some(value) => value,
                            None => bail!("Missing field 'endpointNames' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
