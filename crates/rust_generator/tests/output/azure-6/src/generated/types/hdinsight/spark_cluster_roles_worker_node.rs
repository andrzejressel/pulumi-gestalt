...
pub struct SparkClusterRolesWorkerNode {
    /// A `autoscale` block as defined below.
    #[builder(into)]
    #[serde(rename = "autoscale")]
    pub r#autoscale: Option<Box<super::super::types::hdinsight::SparkClusterRolesWorkerNodeAutoscale>>,
    ...
    pub r#script_actions: Option<Vec<super::super::types::hdinsight::SparkClusterRolesWorkerNodeScriptAction>>,
    /// A list of SSH Keys which should be used for the local administrator on the Worker Nodes. Changing this forces a new resource to be created.
    /// 
    /// > **NOTE:** Either a `password` or one or more `ssh_keys` must be specified - but not both.
    #[builder(into)]
    #[serde(rename = "sshKeys")]
    pub r#ssh_keys: Option<Vec<String>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for SparkClusterRolesWorkerNode {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for SparkClusterRolesWorkerNode {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#autoscale: {
                        let field_value = match fields_map.get("autoscale") {
                            Some(value) => value,
                            None => bail!("Missing field 'autoscale' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
