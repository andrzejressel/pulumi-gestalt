...
pub struct HadoopClusterRolesZookeeperNode {
    ...
    pub r#script_actions: Option<Vec<super::super::types::hdinsight::HadoopClusterRolesZookeeperNodeScriptAction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for HadoopClusterRolesZookeeperNode {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for HadoopClusterRolesZookeeperNode {
