...
pub struct HBaseClusterRolesZookeeperNode {
    ...
    pub r#script_actions: Option<Vec<super::super::types::hdinsight::HBaseClusterRolesZookeeperNodeScriptAction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for HBaseClusterRolesZookeeperNode {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for HBaseClusterRolesZookeeperNode {
