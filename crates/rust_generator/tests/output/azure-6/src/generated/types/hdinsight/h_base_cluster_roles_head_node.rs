...
pub struct HBaseClusterRolesHeadNode {
    ...
    pub r#script_actions: Option<Vec<super::super::types::hdinsight::HBaseClusterRolesHeadNodeScriptAction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for HBaseClusterRolesHeadNode {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for HBaseClusterRolesHeadNode {
