            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#apply_to_builtin_eventhub_endpoint: {
                        let field_value = match fields_map.get("applyToBuiltinEventhubEndpoint") {
                            Some(value) => value,
                            None => bail!("Missing field 'applyToBuiltinEventhubEndpoint' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
