...
pub struct HadoopClusterRolesHeadNode {
    ...
    pub r#script_actions: Option<Vec<super::super::types::hdinsight::HadoopClusterRolesHeadNodeScriptAction>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for HadoopClusterRolesHeadNode {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for HadoopClusterRolesHeadNode {
