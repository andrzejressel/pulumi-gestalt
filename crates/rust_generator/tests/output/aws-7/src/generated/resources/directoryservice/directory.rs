...
pub mod directory {
    ...
    fn __create(
        ...
        let connect_settings_binding = args.connect_settings.get_output(ctx);
        let description_binding = args.description.get_output(ctx);
        let desired_number_of_domain_controllers_binding = args
            .desired_number_of_domain_controllers
            .get_output(ctx);
        let edition_binding = args.edition.get_output(ctx);
        let enable_sso_binding = args.enable_sso.get_output(ctx);
        ...
        let vpc_settings_binding = args.vpc_settings.get_output(ctx);
