...
pub mod network_profile {
    ...
    pub struct NetworkProfileArgs {
        ...
        #[builder(into, default)]
        pub downlink_bandwidth_bits: pulumi_gestalt_rust::Input<Option<i32>>,
        /// Delay time for all packets to destination in milliseconds as an integer from `0` to `2000`.
        #[builder(into, default)]
        pub downlink_delay_ms: pulumi_gestalt_rust::Input<Option<i32>>,
        /// Time variation in the delay of received packets in milliseconds as an integer from `0` to `2000`.
        #[builder(into, default)]
        pub downlink_jitter_ms: pulumi_gestalt_rust::Input<Option<i32>>,
        /// Proportion of received packets that fail to arrive from `0` to `100` percent.
        #[builder(into, default)]
        pub downlink_loss_percent: pulumi_gestalt_rust::Input<Option<i32>>,
        ...
        /// The data throughput rate in bits per second, as an integer from `0` to `104857600`. Default value is `104857600`.
        #[builder(into, default)]
        pub uplink_bandwidth_bits: pulumi_gestalt_rust::Input<Option<i32>>,
        /// Delay time for all packets to destination in milliseconds as an integer from `0` to `2000`.
        #[builder(into, default)]
        pub uplink_delay_ms: pulumi_gestalt_rust::Input<Option<i32>>,
        /// Time variation in the delay of received packets in milliseconds as an integer from `0` to `2000`.
        #[builder(into, default)]
        pub uplink_jitter_ms: pulumi_gestalt_rust::Input<Option<i32>>,
        /// Proportion of received packets that fail to arrive from `0` to `100` percent.
        #[builder(into, default)]
        pub uplink_loss_percent: pulumi_gestalt_rust::Input<Option<i32>>,
    }
    #[allow(dead_code)]
