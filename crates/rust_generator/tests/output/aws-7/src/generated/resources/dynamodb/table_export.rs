...
pub mod table_export {
    ...
    pub struct TableExportArgs {
        ...
        pub export_format: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub export_time: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub s3_bucket_owner: pulumi_gestalt_rust::Input<Option<String>>,
        ...
        #[builder(into, default)]
        pub s3_sse_algorithm: pulumi_gestalt_rust::Input<Option<String>>,
        /// ID of the AWS KMS managed key used to encrypt the S3 bucket where export data will be stored (if applicable).
        #[builder(into, default)]
        pub s3_sse_kms_key_id: pulumi_gestalt_rust::Input<Option<String>>,
        /// ARN associated with the table to export.
        ///
        /// The following arguments are optional:
        #[builder(into)]
        pub table_arn: pulumi_gestalt_rust::Input<String>,
    }
    #[allow(dead_code)]
    ...
    fn __create(
        ...
        let export_format_binding = args.export_format.get_output(ctx);
        let export_time_binding = args.export_time.get_output(ctx);
        let s3_bucket_binding = args.s3_bucket.get_output(ctx);
        let s3_bucket_owner_binding = args.s3_bucket_owner.get_output(ctx);
        let s3_prefix_binding = args.s3_prefix.get_output(ctx);
        let s3_sse_algorithm_binding = args.s3_sse_algorithm.get_output(ctx);
        let s3_sse_kms_key_id_binding = args.s3_sse_kms_key_id.get_output(ctx);
        let table_arn_binding = args.table_arn.get_output(ctx);
