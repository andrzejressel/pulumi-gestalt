...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ServiceIntegrationKmsServerSideEncryption {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "opt_in_status".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#opt_in_status,
                )
                .await,
            );
            map.insert(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ServiceIntegrationKmsServerSideEncryption {
