...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EventSourcesConfigEventSource {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "amazon_code_guru_profilers".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#amazon_code_guru_profilers,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for EventSourcesConfigEventSource {
