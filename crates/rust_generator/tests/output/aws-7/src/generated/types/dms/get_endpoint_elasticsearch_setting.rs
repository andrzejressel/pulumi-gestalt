...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetEndpointElasticsearchSetting {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "error_retry_duration".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "full_load_error_percentage".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetEndpointElasticsearchSetting {
