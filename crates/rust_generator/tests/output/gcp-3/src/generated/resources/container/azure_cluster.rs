...
pub mod azure_cluster {
    ...
    pub fn create(
        ...
        let request = pulumi_gestalt_rust::RegisterResourceRequest {
            ...
            object: &[
                ...
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    ...
                    value: &azure_region_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "azureServicesAuthentication".into(),
                    value: &azure_services_authentication_binding.drop_type(),
                },
                pulumi_gestalt_rust::ResourceRequestObjectField {
                    name: "client".into(),
        ...
        AzureClusterResult {
            ...
            azure_region: o.get_field("azureRegion"),
            azure_services_authentication: o.get_field("azureServicesAuthentication"),
