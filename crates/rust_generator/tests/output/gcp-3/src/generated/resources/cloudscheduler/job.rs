...
pub mod job {
    ...
    fn __create(
        ...
        let app_engine_http_target_binding = args.app_engine_http_target.get_output(ctx);
        let attempt_deadline_binding = args.attempt_deadline.get_output(ctx);
        ...
        let pubsub_target_binding = args.pubsub_target.get_output(ctx);
        let region_binding = args.region.get_output(ctx);
        let retry_config_binding = args.retry_config.get_output(ctx);
