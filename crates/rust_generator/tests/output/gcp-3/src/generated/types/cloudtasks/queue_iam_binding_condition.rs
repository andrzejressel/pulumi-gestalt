...
pub struct QueueIamBindingCondition {
    #[builder(into)]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for QueueIamBindingCondition {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for QueueIamBindingCondition {
