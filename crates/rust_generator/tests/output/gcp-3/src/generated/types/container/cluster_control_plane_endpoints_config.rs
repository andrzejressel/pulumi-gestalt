...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClusterControlPlaneEndpointsConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "dns_endpoint_config".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#dns_endpoint_config,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ClusterControlPlaneEndpointsConfig {
