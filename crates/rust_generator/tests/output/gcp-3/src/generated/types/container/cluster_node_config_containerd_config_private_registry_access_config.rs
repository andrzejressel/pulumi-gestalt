...
pub struct ClusterNodeConfigContainerdConfigPrivateRegistryAccessConfig {
    ...
    pub r#certificate_authority_domain_configs: Option<Vec<super::super::types::container::ClusterNodeConfigContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfig>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClusterNodeConfigContainerdConfigPrivateRegistryAccessConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ClusterNodeConfigContainerdConfigPrivateRegistryAccessConfig {
