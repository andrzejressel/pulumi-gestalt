...
pub struct ServiceTemplateSpecVolumeCsi {
    ...
    #[builder(into)]
    pub r#volume_attributes: Option<std::collections::BTreeMap<String, String>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ServiceTemplateSpecVolumeCsi {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ServiceTemplateSpecVolumeCsi {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#volume_attributes: {
                        let field_value = match fields_map.get("volumeAttributes") {
                            Some(value) => value,
                            None => bail!("Missing field 'volumeAttributes' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
