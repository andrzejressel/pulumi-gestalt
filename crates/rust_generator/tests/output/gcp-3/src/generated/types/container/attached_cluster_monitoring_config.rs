...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AttachedClusterMonitoringConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "managed_prometheus_config".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AttachedClusterMonitoringConfig {
