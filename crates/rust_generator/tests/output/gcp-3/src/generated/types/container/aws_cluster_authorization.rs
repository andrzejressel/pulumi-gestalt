...
pub struct AwsClusterAuthorization {
    ...
    pub r#admin_groups: Option<Vec<super::super::types::container::AwsClusterAuthorizationAdminGroup>>,
    /// Users to perform operations as a cluster admin. A managed ClusterRoleBinding will be created to grant the `cluster-admin` ClusterRole to the users. Up to ten admin users can be provided. For more info on RBAC, see https://kubernetes.io/docs/reference/access-authn-authz/rbac/#user-facing-roles
    #[builder(into)]
    #[serde(rename = "adminUsers")]
    pub r#admin_users: Vec<super::super::types::container::AwsClusterAuthorizationAdminUser>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for AwsClusterAuthorization {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for AwsClusterAuthorization {
