...
pub struct GetServiceTemplateContainerStartupProbe {
    /// Minimum consecutive failures for the probe to be considered failed after having succeeded. Defaults to 3. Minimum value is 1.
    #[builder(into)]
    pub r#failure_threshold: i32,
    /// GRPC specifies an action involving a GRPC port.
    #[builder(into)]
    pub r#grpcs: Vec<super::super::types::cloudrunv2::GetServiceTemplateContainerStartupProbeGrpc>,
    /// HTTPGet specifies the http request to perform. Exactly one of HTTPGet or TCPSocket must be specified.
    #[builder(into)]
    pub r#http_gets: Vec<super::super::types::cloudrunv2::GetServiceTemplateContainerStartupProbeHttpGet>,
    ...
    #[builder(into)]
    pub r#tcp_sockets: Vec<super::super::types::cloudrunv2::GetServiceTemplateContainerStartupProbeTcpSocket>,
    /// Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1. Maximum value is 3600. Must be smaller than periodSeconds. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
    #[builder(into)]
    pub r#timeout_seconds: i32,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetServiceTemplateContainerStartupProbe {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetServiceTemplateContainerStartupProbe {
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#tcp_sockets: {
                        let field_value = match fields_map.get("tcpSockets") {
                            Some(value) => value,
                            None => bail!("Missing field 'tcpSockets' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#timeout_seconds: {
