...
pub struct EnvironmentConfigNodeConfig {
    ...
    pub r#composer_internal_ipv_4_cidr_block: Option<String>,
    ...
    pub r#composer_network_attachment: Option<String>,
    ...
    pub r#enable_ip_masq_agent: Option<bool>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EnvironmentConfigNodeConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for EnvironmentConfigNodeConfig {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#composer_internal_ipv_4_cidr_block: {
                        let field_value = match fields_map.get("composerInternalIpv4CidrBlock") {
                            Some(value) => value,
                            None => bail!("Missing field 'composerInternalIpv4CidrBlock' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#composer_network_attachment: {
                        let field_value = match fields_map.get("composerNetworkAttachment") {
                            Some(value) => value,
                            None => bail!("Missing field 'composerNetworkAttachment' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#disk_size_gb: {
                    ...
                    r#enable_ip_masq_agent: {
                        let field_value = match fields_map.get("enableIpMasqAgent") {
                            Some(value) => value,
                            None => bail!("Missing field 'enableIpMasqAgent' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#ip_allocation_policy: {
                        let field_value = match fields_map.get("ipAllocationPolicy") {
                            Some(value) => value,
                            None => bail!("Missing field 'ipAllocationPolicy' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#machine_type: {
