        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#network_config: {
                        let field_value = match fields_map.get("networkConfig") {
                            Some(value) => value,
                            None => bail!("Missing field 'networkConfig' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#node_config: {
                    ...
                    r#placement_policy: {
                        let field_value = match fields_map.get("placementPolicy") {
                            Some(value) => value,
                            None => bail!("Missing field 'placementPolicy' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#queued_provisioning: {
                        let field_value = match fields_map.get("queuedProvisioning") {
                            Some(value) => value,
                            None => bail!("Missing field 'queuedProvisioning' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#upgrade_settings: {
