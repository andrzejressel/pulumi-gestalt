...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClusterIpAllocationPolicy {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "additional_pod_ranges_config".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#additional_pod_ranges_config,
                )
                .await,
            );
            map.insert(
            ...
            map.insert(
                "pod_cidr_overprovision_config".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ClusterIpAllocationPolicy {
