...
pub struct GetServiceTemplateSpecContainerLivenessProbe {
    ...
    #[builder(into)]
    #[serde(rename = "grpcs")]
    pub r#grpcs: Vec<super::super::types::cloudrun::GetServiceTemplateSpecContainerLivenessProbeGrpc>,
    /// HttpGet specifies the http request to perform.
    #[builder(into)]
    #[serde(rename = "httpGets")]
    pub r#http_gets: Vec<super::super::types::cloudrun::GetServiceTemplateSpecContainerLivenessProbeHttpGet>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetServiceTemplateSpecContainerLivenessProbe {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetServiceTemplateSpecContainerLivenessProbe {
