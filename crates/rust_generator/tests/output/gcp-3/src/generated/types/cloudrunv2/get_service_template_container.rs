...
pub struct GetServiceTemplateContainer {
    ...
    pub r#depends_ons: Vec<String>,
    /// List of environment variables to set in the container.
    #[builder(into)]
    #[serde(rename = "envs")]
    pub r#envs: Vec<super::super::types::cloudrunv2::GetServiceTemplateContainerEnv>,
    ...
    pub r#liveness_probes: Vec<super::super::types::cloudrunv2::GetServiceTemplateContainerLivenessProbe>,
    ...
    #[builder(into)]
    #[serde(rename = "ports")]
    pub r#ports: Vec<super::super::types::cloudrunv2::GetServiceTemplateContainerPort>,
    /// Compute Resource requirements by this container. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#resources
    #[builder(into)]
    #[serde(rename = "resources")]
    pub r#resources: Vec<super::super::types::cloudrunv2::GetServiceTemplateContainerResource>,
    /// Startup probe of application within the container. All other probes are disabled if a startup probe is provided, until it succeeds. Container will not be added to service endpoints if the probe fails. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
    #[builder(into)]
    #[serde(rename = "startupProbes")]
    pub r#startup_probes: Vec<super::super::types::cloudrunv2::GetServiceTemplateContainerStartupProbe>,
    /// Volume to mount into the container's filesystem.
    #[builder(into)]
    #[serde(rename = "volumeMounts")]
    pub r#volume_mounts: Vec<super::super::types::cloudrunv2::GetServiceTemplateContainerVolumeMount>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetServiceTemplateContainer {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetServiceTemplateContainer {
