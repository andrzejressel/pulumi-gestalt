...
pub struct JobTemplateTemplateVpcAccess {
    ...
    pub r#network_interfaces: Option<Vec<super::super::types::cloudrunv2::JobTemplateTemplateVpcAccessNetworkInterface>>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for JobTemplateTemplateVpcAccess {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for JobTemplateTemplateVpcAccess {
