...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for JobTemplateTemplateVolume {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for JobTemplateTemplateVolume {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#cloud_sql_instance: {
                        let field_value = match fields_map.get("cloudSqlInstance") {
                            Some(value) => value,
                            None => bail!("Missing field 'cloudSqlInstance' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
