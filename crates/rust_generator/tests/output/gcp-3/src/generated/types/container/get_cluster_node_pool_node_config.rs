...
pub struct GetClusterNodePoolNodeConfig {
    ...
    pub r#advanced_machine_features: Vec<super::super::types::container::GetClusterNodePoolNodeConfigAdvancedMachineFeature>,
    ...
    pub r#confidential_nodes: Vec<super::super::types::container::GetClusterNodePoolNodeConfigConfidentialNode>,
    /// Parameters for containerd configuration.
    #[builder(into)]
    #[serde(rename = "containerdConfigs")]
    pub r#containerd_configs: Vec<super::super::types::container::GetClusterNodePoolNodeConfigContainerdConfig>,
    ...
    pub r#effective_taints: Vec<super::super::types::container::GetClusterNodePoolNodeConfigEffectiveTaint>,
    ...
    pub r#ephemeral_storage_configs: Vec<super::super::types::container::GetClusterNodePoolNodeConfigEphemeralStorageConfig>,
    /// Parameters for the ephemeral storage filesystem. If unspecified, ephemeral storage is backed by the boot disk.
    #[builder(into)]
    #[serde(rename = "ephemeralStorageLocalSsdConfigs")]
    pub r#ephemeral_storage_local_ssd_configs: Vec<super::super::types::container::GetClusterNodePoolNodeConfigEphemeralStorageLocalSsdConfig>,
    /// Enable or disable NCCL Fast Socket in the node pool.
    #[builder(into)]
    #[serde(rename = "fastSockets")]
    pub r#fast_sockets: Vec<super::super::types::container::GetClusterNodePoolNodeConfigFastSocket>,
    /// GCFS configuration for this node.
    #[builder(into)]
    #[serde(rename = "gcfsConfigs")]
    pub r#gcfs_configs: Vec<super::super::types::container::GetClusterNodePoolNodeConfigGcfsConfig>,
    /// List of the type and count of accelerator cards attached to the instance.
    #[builder(into)]
    #[serde(rename = "guestAccelerators")]
    pub r#guest_accelerators: Vec<super::super::types::container::GetClusterNodePoolNodeConfigGuestAccelerator>,
    /// Enable or disable gvnic in the node pool.
    #[builder(into)]
    #[serde(rename = "gvnics")]
    pub r#gvnics: Vec<super::super::types::container::GetClusterNodePoolNodeConfigGvnic>,
    /// The maintenance policy for the hosts on which the GKE VMs run on.
    #[builder(into)]
    #[serde(rename = "hostMaintenancePolicies")]
    pub r#host_maintenance_policies: Vec<super::super::types::container::GetClusterNodePoolNodeConfigHostMaintenancePolicy>,
    ...
    pub r#kubelet_configs: Vec<super::super::types::container::GetClusterNodePoolNodeConfigKubeletConfig>,
    ...
    pub r#linux_node_configs: Vec<super::super::types::container::GetClusterNodePoolNodeConfigLinuxNodeConfig>,
    /// Parameters for raw-block local NVMe SSDs.
    #[builder(into)]
    #[serde(rename = "localNvmeSsdBlockConfigs")]
    pub r#local_nvme_ssd_block_configs: Vec<super::super::types::container::GetClusterNodePoolNodeConfigLocalNvmeSsdBlockConfig>,
    ...
    pub r#reservation_affinities: Vec<super::super::types::container::GetClusterNodePoolNodeConfigReservationAffinity>,
    ...
    pub r#sandbox_configs: Vec<super::super::types::container::GetClusterNodePoolNodeConfigSandboxConfig>,
    /// Secondary boot disks for preloading data or container images.
    #[builder(into)]
    #[serde(rename = "secondaryBootDisks")]
    pub r#secondary_boot_disks: Vec<super::super::types::container::GetClusterNodePoolNodeConfigSecondaryBootDisk>,
    ...
    pub r#shielded_instance_configs: Vec<super::super::types::container::GetClusterNodePoolNodeConfigShieldedInstanceConfig>,
    /// Node affinity options for sole tenant node pools.
    #[builder(into)]
    #[serde(rename = "soleTenantConfigs")]
    pub r#sole_tenant_configs: Vec<super::super::types::container::GetClusterNodePoolNodeConfigSoleTenantConfig>,
    ...
    #[builder(into)]
    #[serde(rename = "taints")]
    pub r#taints: Vec<super::super::types::container::GetClusterNodePoolNodeConfigTaint>,
    /// The workload metadata configuration for this node.
    #[builder(into)]
    #[serde(rename = "workloadMetadataConfigs")]
    pub r#workload_metadata_configs: Vec<super::super::types::container::GetClusterNodePoolNodeConfigWorkloadMetadataConfig>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetClusterNodePoolNodeConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetClusterNodePoolNodeConfig {
