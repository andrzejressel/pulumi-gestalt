...
pub struct GetEnvironmentConfigSoftwareConfig {
    ...
    pub r#airflow_config_overrides: std::collections::HashMap<String, String>,
    ...
    pub r#env_variables: std::collections::HashMap<String, String>,
    ...
    pub r#pypi_packages: std::collections::HashMap<String, String>,
