...
pub struct GetServiceTemplateVolume {
    ...
    pub r#cloud_sql_instances: Vec<super::super::types::cloudrunv2::GetServiceTemplateVolumeCloudSqlInstance>,
    /// Ephemeral storage used as a shared volume.
    #[builder(into)]
    #[serde(rename = "emptyDirs")]
    pub r#empty_dirs: Vec<super::super::types::cloudrunv2::GetServiceTemplateVolumeEmptyDir>,
    /// Cloud Storage bucket mounted as a volume using GCSFuse. This feature is only supported in the gen2 execution environment.
    #[builder(into)]
    #[serde(rename = "gcs")]
    pub r#gcs: Vec<super::super::types::cloudrunv2::GetServiceTemplateVolumeGc>,
    ...
    #[builder(into)]
    #[serde(rename = "nfs")]
    pub r#nfs: Vec<super::super::types::cloudrunv2::GetServiceTemplateVolumeNf>,
    /// Secret represents a secret that should populate this volume. More info: https://kubernetes.io/docs/concepts/storage/volumes#secret
    #[builder(into)]
    #[serde(rename = "secrets")]
    pub r#secrets: Vec<super::super::types::cloudrunv2::GetServiceTemplateVolumeSecret>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetServiceTemplateVolume {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetServiceTemplateVolume {
