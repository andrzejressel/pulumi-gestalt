...
pub struct GetEnvironmentConfigPrivateEnvironmentConfig {
    ...
    pub r#cloud_composer_connection_subnetwork: String,
    ...
    pub r#cloud_composer_network_ipv_4_cidr_block: String,
    /// The CIDR block from which IP range in tenant project will be reserved for Cloud SQL. Needs to be disjoint from web_server_ipv4_cidr_block.
    #[builder(into)]
    #[serde(rename = "cloudSqlIpv4CidrBlock")]
    pub r#cloud_sql_ipv_4_cidr_block: String,
    ...
    pub r#web_server_ipv_4_cidr_block: String,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetEnvironmentConfigPrivateEnvironmentConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetEnvironmentConfigPrivateEnvironmentConfig {
