...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetServiceTemplateSpecContainerEnvFromSecretRef {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetServiceTemplateSpecContainerEnvFromSecretRef {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#local_object_references: {
                        let field_value = match fields_map.get("localObjectReferences") {
                            Some(value) => value,
                            None => bail!("Missing field 'localObjectReferences' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
