...
pub struct GetClusterPrivateClusterConfig {
    ...
    pub r#master_global_access_configs: Vec<super::super::types::container::GetClusterPrivateClusterConfigMasterGlobalAccessConfig>,
    ...
    pub r#private_endpoint_subnetwork: String,
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#master_global_access_configs: {
                        let field_value = match fields_map.get("masterGlobalAccessConfigs") {
                            Some(value) => value,
                            None => bail!("Missing field 'masterGlobalAccessConfigs' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
