...
pub struct ClusterMasterAuthorizedNetworksConfig {
    ...
    pub r#cidr_blocks: Option<Vec<super::super::types::container::ClusterMasterAuthorizedNetworksConfigCidrBlock>>,
    /// Whether Kubernetes master is
    /// accessible via Google Compute Engine Public IPs.
    #[builder(into)]
    #[serde(rename = "gcpPublicCidrsAccessEnabled")]
    pub r#gcp_public_cidrs_access_enabled: Option<bool>,
    ...
    pub r#private_endpoint_enforcement_enabled: Option<bool>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClusterMasterAuthorizedNetworksConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "gcp_public_cidrs_access_enabled".to_string(),
                ToPulumiValue::to_pulumi_value(
            ...
            map.insert(
                "private_endpoint_enforcement_enabled".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ClusterMasterAuthorizedNetworksConfig {
