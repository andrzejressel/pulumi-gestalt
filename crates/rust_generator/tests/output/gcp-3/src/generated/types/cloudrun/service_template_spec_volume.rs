...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ServiceTemplateSpecVolume {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ServiceTemplateSpecVolume {
    fn from_pulumi_value(
        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#csi: {
                        let field_value = match fields_map.get("csi") {
                            Some(value) => value,
                            None => bail!("Missing field 'csi' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
