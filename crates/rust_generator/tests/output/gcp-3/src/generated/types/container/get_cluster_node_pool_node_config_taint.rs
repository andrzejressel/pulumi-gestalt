...
pub struct GetClusterNodePoolNodeConfigTaint {
    /// Effect for taint.
    #[builder(into)]
    #[serde(rename = "effect")]
    pub r#effect: String,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetClusterNodePoolNodeConfigTaint {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetClusterNodePoolNodeConfigTaint {
