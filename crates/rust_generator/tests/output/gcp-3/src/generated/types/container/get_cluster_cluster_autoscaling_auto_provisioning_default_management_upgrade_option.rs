...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetClusterClusterAutoscalingAutoProvisioningDefaultManagementUpgradeOption {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "auto_upgrade_start_time".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#auto_upgrade_start_time,
                )
                .await,
            );
            map.insert(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetClusterClusterAutoscalingAutoProvisioningDefaultManagementUpgradeOption {
