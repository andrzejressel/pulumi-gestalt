...
pub struct EnvironmentConfigNodeConfigIpAllocationPolicy {
    ...
    pub r#use_ip_aliases: Option<bool>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EnvironmentConfigNodeConfigIpAllocationPolicy {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for EnvironmentConfigNodeConfigIpAllocationPolicy {
