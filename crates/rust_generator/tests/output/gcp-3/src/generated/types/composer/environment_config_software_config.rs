...
pub struct EnvironmentConfigSoftwareConfig {
    ...
    #[builder(into)]
    pub r#airflow_config_overrides: Option<std::collections::BTreeMap<String, String>>,
    ...
    #[builder(into)]
    pub r#env_variables: Option<std::collections::BTreeMap<String, String>>,
    ...
    #[builder(into)]
    pub r#pypi_packages: Option<std::collections::BTreeMap<String, String>>,
