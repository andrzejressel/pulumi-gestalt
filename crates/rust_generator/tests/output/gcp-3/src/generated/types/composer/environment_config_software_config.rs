...
pub struct EnvironmentConfigSoftwareConfig {
    ...
    pub r#airflow_config_overrides: Option<std::collections::HashMap<String, String>>,
    ...
    pub r#env_variables: Option<std::collections::HashMap<String, String>>,
    ...
    pub r#pypi_packages: Option<std::collections::HashMap<String, String>>,
    ...
    pub r#scheduler_count: Option<i32>,
    /// Should be either 'ENABLED' or 'DISABLED'. Defaults to 'ENABLED'. Used in Composer 3.
    #[builder(into)]
    #[serde(rename = "webServerPluginsMode")]
    pub r#web_server_plugins_mode: Option<String>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for EnvironmentConfigSoftwareConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "cloud_data_lineage_integration".to_string(),
                ToPulumiValue::to_pulumi_value(
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for EnvironmentConfigSoftwareConfig {
