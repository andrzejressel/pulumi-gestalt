...
pub struct GetServiceTemplateContainerLivenessProbe {
    ...
    #[builder(into)]
    #[serde(rename = "grpcs")]
    pub r#grpcs: Vec<super::super::types::cloudrunv2::GetServiceTemplateContainerLivenessProbeGrpc>,
    /// HTTPGet specifies the http request to perform.
    #[builder(into)]
    #[serde(rename = "httpGets")]
    pub r#http_gets: Vec<super::super::types::cloudrunv2::GetServiceTemplateContainerLivenessProbeHttpGet>,
    ...
    pub r#tcp_sockets: Vec<super::super::types::cloudrunv2::GetServiceTemplateContainerLivenessProbeTcpSocket>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetServiceTemplateContainerLivenessProbe {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetServiceTemplateContainerLivenessProbe {
