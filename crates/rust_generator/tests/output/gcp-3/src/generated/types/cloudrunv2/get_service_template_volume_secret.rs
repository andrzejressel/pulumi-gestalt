...
pub struct GetServiceTemplateVolumeSecret {
    ...
    #[builder(into)]
    #[serde(rename = "items")]
    pub r#items: Vec<super::super::types::cloudrunv2::GetServiceTemplateVolumeSecretItem>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetServiceTemplateVolumeSecret {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetServiceTemplateVolumeSecret {
