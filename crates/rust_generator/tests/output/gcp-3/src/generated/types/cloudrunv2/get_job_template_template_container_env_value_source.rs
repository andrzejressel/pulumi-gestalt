...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetJobTemplateTemplateContainerEnvValueSource {
    fn to_pulumi_value(
        &self,
    ...
    > {
        ...
        async move {
            ...
            map.insert(
                "secret_key_reves".to_string(),
                ToPulumiValue::to_pulumi_value(
                    &self.r#secret_key_reves,
                )
                .await,
            );
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetJobTemplateTemplateContainerEnvValueSource {
