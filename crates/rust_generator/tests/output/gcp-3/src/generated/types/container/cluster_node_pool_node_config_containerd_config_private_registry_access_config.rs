...
pub struct ClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfig {
    ...
    pub r#certificate_authority_domain_configs: Option<Vec<super::super::types::container::ClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfigCertificateAuthorityDomainConfig>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfig {
    fn to_pulumi_value(
        &self,
    ...
    > {
        async move {
            ...
            map.insert(
                "certificate_authority_domain_configs".to_string(),
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ClusterNodePoolNodeConfigContainerdConfigPrivateRegistryAccessConfig {
