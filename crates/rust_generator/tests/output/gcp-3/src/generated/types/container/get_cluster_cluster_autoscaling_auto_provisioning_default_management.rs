...
pub struct GetClusterClusterAutoscalingAutoProvisioningDefaultManagement {
    ...
    pub r#upgrade_options: Vec<super::super::types::container::GetClusterClusterAutoscalingAutoProvisioningDefaultManagementUpgradeOption>,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetClusterClusterAutoscalingAutoProvisioningDefaultManagement {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetClusterClusterAutoscalingAutoProvisioningDefaultManagement {
