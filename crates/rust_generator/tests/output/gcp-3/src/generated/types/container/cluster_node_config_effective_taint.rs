...
pub struct ClusterNodeConfigEffectiveTaint {
    /// Effect for taint.
    #[builder(into)]
    #[serde(rename = "effect")]
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for ClusterNodeConfigEffectiveTaint {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for ClusterNodeConfigEffectiveTaint {
