...
pub struct GetClusterMonitoringConfigAdvancedDatapathObservabilityConfig {
    ...
    pub r#enable_metrics: bool,
    /// Whether or not Relay is enabled.
    #[builder(into)]
    #[serde(rename = "enableRelay")]
    pub r#enable_relay: bool,
}

impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for GetClusterMonitoringConfigAdvancedDatapathObservabilityConfig {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetClusterMonitoringConfigAdvancedDatapathObservabilityConfig {
