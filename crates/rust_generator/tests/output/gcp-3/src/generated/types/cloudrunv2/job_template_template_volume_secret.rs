...
pub struct JobTemplateTemplateVolumeSecret {
    ...
    #[builder(into)]
    #[serde(rename = "items")]
    pub r#items: Option<Vec<super::super::types::cloudrunv2::JobTemplateTemplateVolumeSecretItem>>,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::ToPulumiValue for JobTemplateTemplateVolumeSecret {
    fn to_pulumi_value(
        &self,
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for JobTemplateTemplateVolumeSecret {
