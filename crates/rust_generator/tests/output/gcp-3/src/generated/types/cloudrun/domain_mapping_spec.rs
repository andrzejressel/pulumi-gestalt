        ...
        match value.content {
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    ...
                    r#force_override: {
                        let field_value = match fields_map.get("forceOverride") {
                            Some(value) => value,
                            None => bail!("Missing field 'forceOverride' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                    r#route_name: {
                        let field_value = match fields_map.get("routeName") {
                            Some(value) => value,
                            None => bail!("Missing field 'routeName' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
                        FromPulumiValue::from_pulumi_value(field_value)?
                    },
                })
