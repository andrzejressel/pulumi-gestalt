...
pub struct GetSQuotaInfosQuotaInfoDimensionsInfo {
...
impl pulumi_gestalt_rust::__private::pulumi_gestalt_model::FromPulumiValue for GetSQuotaInfosQuotaInfoDimensionsInfo {
            ...
            PulumiValueContent::Object(ref _obj) => {
                ...
                Ok(Self {
                    r#applicable_locations: {
                        let field_value = match fields_map.get("applicableLocations") {
                            Some(value) => value,
                            None => bail!("Missing field 'applicableLocations' while converting PulumiValue to {}", std::any::type_name::<Self>()),
                        };
