...
pub mod get_queue_iam_policy {
    #[derive(pulumi_gestalt_rust::__private::bon::Builder)]
    #[builder(finish_fn = build_struct)]
    #[allow(dead_code)]
    pub struct GetQueueIamPolicyArgs {
    ...
    #[allow(dead_code)]
    pub struct GetQueueIamPolicyResult {
    ...
    pub fn invoke(
        ...
        args: GetQueueIamPolicyArgs,
    ) -> GetQueueIamPolicyResult {
        let location_binding = args.location.get_output(context);
        let name_binding = args.name.get_output(context);
        let project_binding = args.project.get_output(context);
        let request = pulumi_gestalt_rust::InvokeResourceRequest {
            token: "gcp:cloudtasks/getQueueIamPolicy:getQueueIamPolicy".into(),
